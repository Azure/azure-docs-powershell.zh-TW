...
### 範例 1：在位於 westus2 位置的資源群組 MyResourceGroup 中，建立名為 MyService 的新 Azure healthcareapis fhir 服務，其提供輸送量 = 400
```powershell
...
### 範例 2：在位於 westus2 位置的資源群組 MyResourceGroup 中，建立名為 MyService 的新 Azure healthcareapis fhir 服務，其提供輸送量 = 400 且金鑰庫金鑰 uri "HTTPs:// \<my-keyvault> \<my-key> .vault.azure.net/keys/"
```powershell
...
### -授權
醫療保健Apis Fhir Service Authority.
...
### -CorsMethod
Cors Method 的 HealthcareApis Fhir Service List.
...
### -一些高能專案
HealthcareApis Fhir Service一些OfferThroughput.
