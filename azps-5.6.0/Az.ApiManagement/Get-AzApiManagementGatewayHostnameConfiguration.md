...
## 描述
**Get-AzApiManagementGatewayHostnameConfiguration** Cmdlet 會取得現有閘道的所有或特定主機名稱組。
...
此命令會針對「0123456789」閘道進行「123」主機名稱組配置。
