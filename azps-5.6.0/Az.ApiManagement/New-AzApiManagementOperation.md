...
## 描述
**New-AzApiManagementOperation Cmdlet** 會建立 API 作業。
...
### -ApiRevision
API 修訂的識別碼。 此參數為選擇性。 如果未指定，作業會附加至目前使用中的 api 修訂。
...
### -TemplateParameters
指定參數 *UrlTemplate* 中定義的參數陣列。
如果您未指定此參數，將會根據 *UrlTemplate* 產生預設值。
