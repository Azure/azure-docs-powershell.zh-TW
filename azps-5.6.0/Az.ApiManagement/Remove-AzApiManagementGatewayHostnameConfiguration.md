...
## 描述
**Remove-AzApiManagementGatewayHostnameConfiguration** Cmdlet 會移除現有閘道的主機名稱組式。
...
### -InputObject
PsApiManagementGatewayHostnameConfiguration 的實例。 此參數為必填項。
...
### -ResourceId
GatewayHostnameConfiguration 的 Arm ResourceId。 此參數為必填項。
