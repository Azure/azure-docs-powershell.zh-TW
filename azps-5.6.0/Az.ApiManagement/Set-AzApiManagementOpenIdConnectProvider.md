...
## 描述
**Set-AzApiManagementOpenIdConnectProvider Cmdlet** 會修改 Azure API 管理中的 OpenID Connect 提供者。
...
### -PassThru
表示此 Cmdlet 會返回 **此 Cmdlet 修改的 PsApiManagementOpenIdConnectProvider。**
