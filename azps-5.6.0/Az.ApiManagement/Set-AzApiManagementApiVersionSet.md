...
此命令會使用版本配置和 Header 參數更新現有的 API 版本 `Header` 集 `api-version` 。
...
### -InputObject
PsApiManagementApiVersionSet 實例。 此參數為必填項。
...
### -PassThru
如果指定的話，代表已修改 apiVersionSet 的 Microsoft.Azure.Commands.ApiManagement.ServiceManagement.Models.PsApiManagementApiVersionSet 類型就會寫入輸出。
...
### Microsoft.Azure.Commands.ApiManagement.ServiceManagement.models.PsApiManagementVersioningS方體
