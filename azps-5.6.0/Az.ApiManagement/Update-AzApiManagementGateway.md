...
## 描述
**Update-AzApiManagementGateway** Cmdlet 會設定 API 管理閘道。
...
### -PassThru
如果指定的話，代表已修改閘道的 Microsoft.Azure.Commands.ApiManagement.ServiceManagement.Models.PsApiManagementGateway 類型實例。
