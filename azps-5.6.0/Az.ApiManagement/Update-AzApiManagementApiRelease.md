...
## 描述
**Update-AzApiManagementApiRelease** Cmdlet 會修改 Azure API 管理 API 版本。

## 例子

### 範例 1：更新 API 修訂的 API 版本
```powershell
PS C:\>$ApiMgmtContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-WestUS" -ServiceName "contoso"
PS C:\>Update-AzApiManagementApiRelease -Context $ApiMgmtContext -ApiId "echo-api" -ReleaseId "echo-api-release" -Note "Releasing version 2 of the echo-api to public"
```

此命令會以 `echo-api-release` 新的附注更新 API 的 API `echo-api` 版本。
...
### -InputObject
類型為 Microsoft.Azure.Commands.ApiManagement.ServiceManagement.models.PsApiManagementApiRelease 的實例。
...
### -PassThru
如果指定的話，代表已設定 API 發行之 Microsoft.Azure.Commands.ApiManagement.ServiceManagement.Models.PsApiManagementApiRelease 類型的實例。
