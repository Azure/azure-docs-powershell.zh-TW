...
### 範例 1：為 Swagger Petstore Extensive API 建立新架構
```powershell
...
Cmdlet **New-AzApiManagementApiSchema** 會建立或更新 `swagger-petstore-extensive` aPI 的架構。
