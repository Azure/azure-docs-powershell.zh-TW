...
## 描述
**Get-AzApiManagementCertificate Cmdlet** 會取得您指定的所有 Azure API 管理憑證或憑證。
...
### -ResourceId
憑證的 Arm 資源識別碼。 如果指定，會嘗試根據識別碼尋找憑證。 此參數為必填項。
