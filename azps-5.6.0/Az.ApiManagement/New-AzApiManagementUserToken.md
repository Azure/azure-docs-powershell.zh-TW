...
## 描述
Cmdlet **New-AzApiManagementUserToken** 會為指定的使用者產生共用存取權杖

## 例子

### 範例 1：產生 Git 使用者的共用存取權杖
```powershell
...
此腳本在 ApiManagement 服務中將 Git 使用者進行組組，並產生使用主鍵有效達 8 小時的共用存取權杖。
