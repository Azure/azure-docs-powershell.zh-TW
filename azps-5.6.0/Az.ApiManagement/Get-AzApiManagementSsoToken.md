...
## 簡介
使用 SSO 權杖連結至 API 管理服務的部署管理入口網站。
...
## 描述
**Get-AzApiManagementSsoToken Cmdlet** 會傳送連結 (URL) ，其中包含單一登入 (SSO) 權杖至 API 管理服務的部署管理入口網站。

## 例子

### 範例 1：取得 API 管理服務的 SSO 權杖
```
PS C:\>Get-AzApiManagementSsoToken -ResourceGroupName "Contoso" -Name "ContosoApi"
```

此命令會獲得 API 管理服務的 SSO 權杖。
