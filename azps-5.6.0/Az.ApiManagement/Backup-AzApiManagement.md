...
## 描述
**Backup-AzApiManagement** Cmdlet 可備份 Azure API 管理服務的實例。
此 Cmdlet 將備份儲存為 Azure 儲存體 Blob。
...
### -PassThru
表示此 Cmdlet 會返回備份 **的 PsApiManagement** 物件 ，如果作業成功。
...
此 Cmdlet 會根據下列模式產生預設值：{Name}-{yyyy-MM-dd-HH-mm}.apimbackup
