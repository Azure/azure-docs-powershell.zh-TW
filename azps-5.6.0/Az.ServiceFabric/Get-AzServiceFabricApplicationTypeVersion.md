...
## 簡介
取得 Service Fabric 應用程式類型版本詳細資料。 僅支援 ARM 部署的應用程式類型版本。
...
## 描述
使用此 Cmdlet 取得指定資源群組和群組中的應用程式類型版本詳細資料。
...
此範例會使用版本 "v1" 的應用程式類型"testAppType"，如果找不到資源，就會傳出例外。
