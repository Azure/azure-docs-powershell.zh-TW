...
## 描述
**New-AzImageConfig** Cmdlet 會建立可配置的影像物件。
...
接下來三個命令會指派 os 磁片的路徑和兩個數據磁片$osDiskVhdUri、$dataDiskVhdUri 1 及$dataDiskVhdUri 2 個變數。 此方法僅適用于下列命令的可讀性。
...
### Microsoft.Azure.management.Compute.models.ImageOSAz

### Microsoft.Azure.management.Compute.models.ImageDataAz[]
