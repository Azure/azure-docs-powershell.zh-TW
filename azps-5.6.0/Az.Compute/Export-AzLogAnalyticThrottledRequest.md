...
## 描述
這會匯出節流 Microsoft.Compute API 呼叫的總數。
記錄可以五個選項進一步匯總：GroupByOperationName、GroupByThrottlePolicy、GroupByResourceName、GroupByUserAgent 或 GroupByApplicationId。
請注意，此 Cmdlet 只會收集 CRP 記錄。
...
此命令將 2018-02-20T17：54：14 和 2018-02-22T17：54：17：54：17 之間的總節流 Microsoft.Compute API 呼叫儲存在指定 SAS URI 中，並按作業名稱匯總。
...
此命令將 2018-02-20T17：54：14 與 2018-02-22T17：54：17 之間受節流 Microsoft.Compute API 呼叫的總時間儲存于所給的 SAS URI 中，並按應用程式識別碼匯總。
...
此命令將 2018-02-20T17：54：14 和 2018-02-22T17：54：17 之間受節流 Microsoft.Compute API 呼叫的總時間儲存于由使用者代理程式匯總的 MICROSOFT.Compute API 呼叫。
