...
## 描述
**Get-AzCMExtensionImdlet** 會取得 Azure 擴充功能的所有版本。
...
此命令會針對指定的位置、發行者及類型，獲得擴充影像的所有版本。

### 範例 2：取得具有版本篩選的擴充功能圖像版本
```
...
此命令會從 12 開始，獲得指定位置、發行者、類型和版本的所有副檔名影像版本。

### 範例 3：取得具有版本篩選的擴充功能圖像版本
```
...
此命令會針對指定的位置、發行者、類型和版本，獲得所有版本的擴充功能影像。
...
### -類型
指定擴充功能的類型。
若要取得擴充功能類型，請使用 Get-AzVMExtensionImageType Cmdlet。
