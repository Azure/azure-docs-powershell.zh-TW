...
## 描述
**Grant-AzSnapshotAccess** Cmdlet 會授予快照的存取權。
...
在名為 "ResourceGroup01" 的資源群組中，將名為 "Snapshot01" 的快照授予 60 秒的讀取存取權。
...
### Microsoft.Azure.Commands.Compute.Automation.models.PSAccesssUri
