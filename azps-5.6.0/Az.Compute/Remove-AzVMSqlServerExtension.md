...
## 描述
**Remove-AzCMSqlServerExtension** Cmdlet 會從虛擬機器移除 AzureSQL Server 擴充功能。

## 例子

### 範例 1：移除 SQL Server 擴充功能
```
PS C:\> Remove-AzVMSqlServerExtension -ResourceGroupName "ResourceGroup11" -VMName "ContosoVM22" -Name "SqlIaaSAgent"
```

此命令會從名為 Contoso VIRTUAL22 的虛擬機器移除 SQL Server 擴充功能。
...
### -名稱
指定此 Cmdlet 移除的擴充功能 SQL Server 名稱。
...
### -VMName
指定此 Cmdlet 會移除 SQL Server 副檔名的虛擬機器名稱。
