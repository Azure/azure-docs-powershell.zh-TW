...
## 描述
**Remove-Az VmssDiagnosticsExtension** Cmdlet 會從虛擬機器縮放集 (VMSS) 移除診斷副檔名。

## 例子

### 範例 1：從 VMSS 移除診斷擴充功能
```
...
[Add-AzEvssDiagnosticsExtension](./Add-AzVmssDiagnosticsExtension.md)
