...
## 描述
**Get-Az VIRTUALDiagnosticsExtension** Cmdlet 會取得虛擬機器上的 Azure 診斷擴充功能設定。

## 例子

### 範例 1：取得適用于虛擬機器的診斷擴充功能
```powershell
PS C:\> Get-AzVMDiagnosticsExtension -ResourceGroupName "ResourceGroup11" -VMName "ContosoVM22"
```

此命令會套用診斷擴充功能至名為 Contoso VIRTUAL22 的虛擬機器。
