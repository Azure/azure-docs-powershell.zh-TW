...
## 描述
**Get-AzDOMADDomainExtension** Cmdlet 會取得指定 Azure Active Directory (AD) 副檔名的資訊。
...
[Set-AzDOMADDomainExtension](./Set-AzVMADDomainExtension.md)
