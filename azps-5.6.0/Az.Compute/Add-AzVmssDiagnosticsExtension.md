...
## 描述
**Add-Az VmssDiagnosticsExtension** Cmdlet 會將診斷擴充功能新增到虛擬機器縮放集 (VMSS) 實例。
...
### -TypeHandlerVersion
指定要用於此 VMSS 的擴充功能版本。
若要取得版本，請針對 [Type 參數執行 Get-Az解說ExtensionImdlet](./Get-AzVMExtensionImage.md)與 Microsoft.Azure.Diagnostics 值 *與 PublisherName* 參數和IaaSDiagnostics 值。 
...
[Remove-AzEvssDiagnosticsExtension](./Remove-AzVmssDiagnosticsExtension.md)
