...
取得資源群組「testGroup」中資源「測試」的應用程式深入資訊 API 金鑰。

### 範例 2 取得應用程式深入資訊資源的特定 API 金鑰
```
...
取得識別碼為 "dd173f38-4fd1-4c75-8af5-9 9c29aa0f867" 的特定應用程式深入資訊 api 金鑰，以用於資源群組 "testGroup" 中的資源"test"。
