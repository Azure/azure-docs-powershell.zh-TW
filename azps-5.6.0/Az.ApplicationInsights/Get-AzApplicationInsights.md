...
在資源群組「測試群組」中取得名為「測試」的應用程式深入資訊資源

### 範例 2 使用定價計畫資訊取得應用程式深入資訊資源
```
...
取得應用程式深入資訊資源，並包含資源群組「測試群組」中名為「測試」之資源的定價計畫資訊
...
### -完整
如果指定，它會取得應用程式深入資訊元件的價格方案/每日上限和狀態。
