...
## 描述
**Join-AzDataLakeStoreItem** Cmdlet 會聯集一或多個檔案，在 Data Lake Store 中建立一個檔案。
...
此命令會聯File01.txtFile02.txt，以建立檔案CombinedFile.txt。
...
### -目的地
指定聯聯專案的 Data Lake Store 路徑，從根目錄開始 (/) 。
...
### -路徑
指定要合併之檔案的 Data Lake Store 路徑陣列，從根目錄開始 (/) 。
