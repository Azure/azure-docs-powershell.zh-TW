...
## 描述
**Add-AzDataLakeStoreTrustedIdProvider Cmdlet** 會將信任的身分識別提供者新增到指定的 Data Lake Store 帳戶。
...
將提供者 "MyProvider" 新增到帳戶 "ContosoADL" 與提供者端點 https://sts.windows.net/6b04908c-b91f-40ce-8024-7ee8a4fd6150 "

## 參數

### -帳戶
要新增指定信任的身分識別提供者的 Data Lake Store 帳戶名稱。
...
### -ProviderEndpoint
格式為「」的有效信任提供者 https://sts.windows.net/ 端點： \<provider identity\>
