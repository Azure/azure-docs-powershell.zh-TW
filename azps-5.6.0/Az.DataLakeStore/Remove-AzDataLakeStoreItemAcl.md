...
## 描述
**Remove-AzDataLakeStoreItemAcl** Cmdlet 會清除 Data Lake 市集 (檔案或資料夾的存取控制清單 (ACL) 。
...
### -路徑
指定專案的 Data Lake Store 路徑，從 / (根目錄開始) 。
