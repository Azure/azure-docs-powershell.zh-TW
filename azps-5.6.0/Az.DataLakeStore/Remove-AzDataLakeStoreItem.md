...
## 描述
**Remove-AzDataLakeStoreItem** Cmdlet 會刪除 Data Lake Store 中的檔案或資料夾。
...
此命令會從 Data Lake Store File01.txtFile.csv和檔案。
...
### -路徑
指定要移除之檔案的 Data Lake Store 路徑陣列，從根目錄開始 (/) 。
