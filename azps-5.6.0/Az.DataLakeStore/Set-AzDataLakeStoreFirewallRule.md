...
## 描述
**Set-AzDataLakeStoreFirewallRule** Cmdlet 會修改指定 Data Lake Store 中指定的防火牆規則。

## 例子

### 範例 1：更新防火牆規則的開始與結束 IP 範圍
```
...
將帳戶 "ContosoADL" 中的防火牆規則「MyFirewallRule」更新為範圍 127.0.0.1 - 127.0.0.2
