...
## 描述
**Set-AzDataLakeStoreTrustedIdProvider Cmdlet** 會修改指定 Data Lake Store 中指定的信任身分識別提供者。
...
### -ProviderEndpoint
格式為有效信任的提供者端點： https://sts.windows.net/\<provider identity\>
