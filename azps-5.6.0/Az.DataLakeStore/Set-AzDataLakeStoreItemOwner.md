...
## 描述
**Set-AzDataLakeStoreItem Ownerer Cmdlet** 會修改 Data Lake Store 中檔案或資料夾的擁有者。
...
### -Id
指定 AzureActive Directory 使用者、群組或服務主體的物件識別碼，以做為擁有者。
...
### -路徑
指定要修改之專案的 Data Lake Store 路徑，從根目錄開始 (/) 。
