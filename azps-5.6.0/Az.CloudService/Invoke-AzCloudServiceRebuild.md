...
此命令會重建 2 個角色實例ContosoFrontEnd_IN_0，ContosoBackEnd_IN_1名為 ContosoCS 的雲端服務，這些角色實例屬於名為 ContosOrg 的資源群組。
...
此命令會重建名為 ContosoCS 的所有雲端服務角色實例，這些角色實例屬於名為 ContosOrg 的資源群組。
