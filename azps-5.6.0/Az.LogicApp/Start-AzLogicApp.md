...
## 描述
**Start-AzLogicApp** Cmdlet 會使用邏輯應用程式功能執行邏輯應用程式。
指定名稱、資源群組和觸發項。
此模組支援動態參數。
若要使用動態參數，請于命令中輸入。
...
此命令在名為 ResourceGroup11 的資源群組中執行邏輯應用程式。
