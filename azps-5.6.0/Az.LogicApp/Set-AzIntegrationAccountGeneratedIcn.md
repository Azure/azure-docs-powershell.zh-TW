...
## 簡介
更新 Azure 資源群組中 (ICN) 整合帳戶產生的交換控制編號。
...
## 描述
此Set-AzIntegrationAccountGeneratedIcn Cmdlet 會更新現有的整合帳戶產生的交換控制編號 (ICN) ，並會返回代表整合帳戶產生的交換控制項編號的物件。
使用此 Cmdlet 更新整合帳戶產生的交換控制編號。
您可以指定整合帳戶名稱、資源組名和協定名稱，以更新整合帳戶產生的交換控制編號。
您無法使用此命令建立新整合帳戶產生的交換控制編號。
...
此命令會針對特定整合帳戶協定，獲得整合帳戶產生的 X12 交換控制編號，增加其值 100，然後回寫更新的值。
...
此命令會針對特定整合帳戶協定，獲得整合帳戶產生的 EdifactCountAgreement 交換控制編號，增加其值 100，然後回寫更新的值。
...
[Get-AzCountGeneratedIcn](./Get-AzIntegrationAccountGeneratedIcn.md)
