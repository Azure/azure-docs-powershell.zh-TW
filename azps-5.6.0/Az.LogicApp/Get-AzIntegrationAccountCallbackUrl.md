...
## 描述
**Get-Az有AccountCallbackUrl** Cmdlet 會從資源群組取得整合帳戶的 url。
此 Cmdlet 會傳回代表整合帳戶轉場 URL 的 **一個Url** 物件。
指定整合帳戶名稱和資源組名。
此模組支援動態參數。
若要使用動態參數，請于命令中輸入。
...
### Microsoft.Azure.management.Logic.models.UvUrl

## 筆記

## 相關連結

[Get-AzLogicAppTriallcallbackUrl](./Get-AzLogicAppTriggerCallbackUrl.md)
