...
## 描述
**Set-AzDtlAutoShutdownPolicy** Cmdlet 會設定實驗室的自動關機政策，自動在一天中指定的時間關閉實驗室內的所有虛擬機器。
Cmdlet 會使用指定的資源群組和實驗室名稱來設定策略。

## 例子

### 範例 1

設定實驗室 DevTest 實驗室的自動關機政策。  (自動) 
...
### -時間
指定當實驗室中的虛擬機器必須關機時，做為 **DateTime** 物件的時間。
