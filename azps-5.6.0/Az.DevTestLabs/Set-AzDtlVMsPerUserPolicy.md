...
## 描述
**Set-AzDtlVMsPerUserPolicy** Cmdlet 會設定每個實驗室使用者策略的虛擬機器，設定每個使用者允許的虛擬機器數量上限。
...
### -LabName
指定此 Cmdlet 會針對每個使用者策略設定虛擬機器的實驗室名稱。
