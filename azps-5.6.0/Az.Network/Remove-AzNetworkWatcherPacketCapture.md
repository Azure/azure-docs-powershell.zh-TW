...
## 描述
此Remove-AzNetworkWatcherPacketCapture移除封包捕獲資源。 建議您在呼叫 Remove-AzNetworkWatcherPacketCapture Stop-AzNetworkWatcherPacketCapture之前先撥打至您的電話。 如果封包捕獲會話在封包Remove-AzNetworkWatcherPacketCapture稱為封包捕獲時，可能不會儲存。 如果會話在移除包含捕獲資料的 .cap 檔案之前已經停止，系統不會移除。 
