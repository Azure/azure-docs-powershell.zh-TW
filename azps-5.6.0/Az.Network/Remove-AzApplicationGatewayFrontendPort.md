...
## 描述
**Remove-AzApplicationGatewayFrontendPort** Cmdlet 會從 Azure 應用程式閘道移除前端埠。
...
第一個命令會獲得名為 ApplicationGateway01 的應用程式閘道，它屬於名為 ResourceGroup01 的資源群組，並且將閘道儲存在 $AppGw 變數中。
