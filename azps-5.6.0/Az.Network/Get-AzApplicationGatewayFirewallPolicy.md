...
## 描述
**Get-AzApplicationGatewayFirewallPolicy** Cmdlet 會取得應用程式閘道防火牆策略。
...
此命令會獲得名為 FirewallPolicy1 的應用程式閘道防火牆策略，該策略屬於名為 ResourceGroup01 的資源群組，並儲存在 $AppGwFirewallPolicy 變數中。
