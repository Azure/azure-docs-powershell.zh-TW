...
## 描述
**New-AzApplicationGatewayFirewallPolicyManagedRule** 會建立防火牆原則的受管理規則。
...
該命令會建立 ManagedRuleSet 清單與 $managedRuleSet，以及包含專案為 $exclusion 1，$exclusion 2 的排除清單。
