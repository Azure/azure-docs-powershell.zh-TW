...
## 描述
**Get-AzApplicationGatewayURLPathMapConfig** Cmdlet 會取得後端伺服器集區 URL 路徑的陣列。
...
此命令會從名為閘道的應用程式閘道上的後端伺服器，獲得 URL 路徑地圖組配置。

## 參數

### -ApplicationGateway
指定此 Cmdlet 會獲得 URL 路徑地圖配置的應用程式閘道。
...
### -名稱
指定此 Cmdlet 取得路徑地圖配置的 URL 路徑地圖名稱。
