...
## 描述
**Set-AzExpressRouteCircuitPeeringConfig** Cmdlet 會將經過修改的 ExpressRoute 對等設定存回 Azure。
...
會保存經過修改的 ExpressRoute 對等互連組。  (自動) 
