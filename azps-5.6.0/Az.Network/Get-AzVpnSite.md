...
## 簡介
根據名稱獲得 Azure VpnSite 資源，或列出 ResourceGroup 或 SubscriptionId 中所有的 VpnSite。 

這是已上傳至 Azure 以使用 Cortex 虛擬中樞進行 S2S 連接的客戶分支 RM 表示。
