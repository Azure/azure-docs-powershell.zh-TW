...
**Set-AzExpressRouteGateway** Cmdlet 可讓您更新現有 ExpressRouteGateway 的縮放單位或更新資源標籤。
...
上述步驟將在 Azure 的 「testRG」資源群組中，建立資源群組、虛擬 WAN、虛擬網路、美國西部的虛擬中樞。 在此之後，將會以 2 個縮放單位在虛擬中心建立 ExpressRoute 閘道，之後將會修改為 3 個縮放單位
