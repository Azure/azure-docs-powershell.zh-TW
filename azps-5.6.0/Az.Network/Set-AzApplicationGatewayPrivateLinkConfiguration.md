...
## 描述
**Set-AzApplicationGatewayPrivateLinkConfiguration** Cmdlet 會修改 Azure 應用程式閘道的 privateLink 設定。

## 例子

### 範例 1：設定 PrivateLink 設定
```
...
第二個命令會設定 privateLink 設定與名稱 privateLinkConfig01，以使用儲存在 $privateLinkIpConfiguration 01 中的 ip 設定
