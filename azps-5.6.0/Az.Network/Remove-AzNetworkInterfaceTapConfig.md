...
## 描述
**Remove-AzNetworkInterfaceTapConfig** Cmdlet 會從網路介面清單中移除 Azure 點一下組式。
...
此命令會從資源群組 ResourceGroup1 中的 NetworkInterface1 移除 TapConfiguration。
