...
## 描述
**Update-Az VpnConnection** Cmdlet 會更新 VPN 連接。  
VPN 連接會建立 IPsec 連接，將 VPN 閘道連接至 Azure 中以 VPN 網站表示的遠端客戶分支。
...
接著，使用 Set-AzVpnConnection 命令更新該連接以擁有新的 IpSecPolicy。
...
此 VpnConnection 所需的 VpnSiteLinkConnection 清單。
...
[New-Az VpnConnection](./New-AzVpnConnection.md)
