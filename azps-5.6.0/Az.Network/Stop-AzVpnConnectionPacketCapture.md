...
## 描述
停止 Vpn 連接上的封包捕獲作業，並上傳給儲存容器的 SasUrl 上的結果。
...
### -ResourceId
要開始封包捕獲之 VpnConnection 的 Azure 資源識別碼。
...
### Microsoft.Azure.Commands.Network.models.PS VpnPacketCaptureResult

## 筆記

## 相關連結

[Start-Az VpnConnectionPacketCapture](./Start-AzVpnConnectionPacketCapture.md)