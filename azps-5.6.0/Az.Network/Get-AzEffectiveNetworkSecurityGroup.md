...
## 描述
**Get-AzEffectiveNetworkSecurityGroup** Cmdlet 會返回網路介面上所適用的有效網路安全性群組。

## 例子

### 範例 1：在網路介面上取得有效的網路安全性群組
```
PS C:\>Get-AzEffectiveNetworkSecurityGroup -NetworkInterfaceName "MyNetworkInterface" -ResourceGroupName "myResourceGroup"
```

此命令會獲得與名為 myResourceGroup 之資源群組中名為 MyNetworkInterface 的網路介面相關聯的所有有效網路安全性規則。
