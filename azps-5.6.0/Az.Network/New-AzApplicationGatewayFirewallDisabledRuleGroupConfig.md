...
## 描述
**New-AzApplicationGatewayFirewallDisabledRuleGroupConfig** Cmdlet 會建立新的停用規則組組。
...
該命令會針對名為「REQUEST-942-APPLICATION-ATTACK-SQLI」的規則群組，建立一個新的已停用規則組，並停用規則 942130 和規則 942140。 新的已停用規則組組會儲存于 $disabledRuleGroup 1。
