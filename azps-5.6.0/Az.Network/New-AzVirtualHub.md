...
此範例與範例 1 類似，但使用資源識別碼來參照建立虛擬中樞所需的虛擬 WAN。
...
上述步驟將在 Azure 資源群組中建立資源群組「testRG」、一個虛擬 WAN，以及美國西部的虛擬中樞。 虛擬中樞會附加位址空間"10.0.1.0/24"和路由資料表。

此範例與範例 2 類似，但也將路由資料表附加到虛擬中樞。
