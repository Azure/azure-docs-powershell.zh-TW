...
## 描述
**New-AzExpressRouteRouteCircuitPeeringConfig** Cmdlet 會新增對等組配置至 ExpressRoute 回路。 ExpressRoute 回路會使用連接提供者而非公用網際網路，將您的內部部署網路連接至 Microsoft 雲端。

## 例子

### 範例 1：使用對等配置建立新 ExpressRoute 回路
```powershell
$parameters = @{
