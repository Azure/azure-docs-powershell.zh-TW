...
## 描述
**Get-AzNetworkInterface** Cmdlet 會取得 Azure 網路介面或資源群組中的 Azure 網路介面清單。
...
此命令會取得資源群組中所有網路介面，該資源群組名為 ResourceGroup1，其提供狀態為成功。
...
### -VirtualMachineIndex
指定此 Cmdlet 從其中獲得網路介面之虛擬機器縮放集的虛擬機器索引。
...
指定此 Cmdlet 從其中獲得網路介面的虛擬機器縮放集名稱。
