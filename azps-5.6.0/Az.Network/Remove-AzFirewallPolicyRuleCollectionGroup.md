...
## 簡介
移除 Azure 防火牆原則中的 Azure 防火牆原則規則集合群組
...
## 描述
**Remove-AzFirewallPolicyRuleCollectionGroup** Cmdlet 會從 Azure 防火牆原則移除規則集合群組。
...
此範例會移除防火牆原則物件中名為"testRcGroup"的防火牆原則規則$fp
...
此範例會移除名為 "fpName" frpm 之防火牆中名為 "testRcGroup" 的防火牆原則規則 colelction 群組 "testRg"
...
### Microsoft.Azure.Commands.Network.models.PSAzureFirewallPolicyRuleCollectionGroupWallapper
