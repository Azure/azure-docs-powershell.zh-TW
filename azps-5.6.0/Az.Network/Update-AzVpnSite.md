...
### By VpnSiteNameNoVirtualWanUpdate (預設) 
```
...
### By VpnSiteNameByVirtualWanName
```
...
### By VpnSiteNameByVirtualWanResourceId
```
...
### By VpnSiteNameByVirtualWanObject
```
...
### By VpnSiteObjectByVirtualWanName
```
...
### By VpnSiteObjectByVirtualWanResourceId
```
...
### By VpnSiteObjectByVirtualWanObject
```
...
### By VpnSiteObjectNoVirtualWanUpdate
```
...
### By VpnSiteResourceIdByVirtualWanName
```
...
### By VpnSiteResourceIdByVirtualWanResourceId
```
...
### By VpnSiteResourceIdByVirtualWanObject
```
...
### By VpnSiteResourceIdNoVirtualWanUpdate
```
...
## 描述
**Update-Az VpnSite** Cmdlet 會更新 VPN 網站。
...
上述步驟將在 Azure 的「testRG」資源群組中，建立資源群組「美國西部虛擬 WAN」。 

接著，它會建立一個 VpnSite 來代表客戶分支，並連結至虛擬 WAN。

網站建立後，會使用 Set-AzVpnSite 命令更新網站的 ipAddress。

## 參數

### -AddressSpace
虛擬網路的位址首碼。
請使用這個或 AddressSpaceObject，但不要同時使用兩者。
...
[New-Az VpnSite](./New-AzVpnSite.md)
