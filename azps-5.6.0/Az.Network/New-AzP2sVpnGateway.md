...
## 簡介
在 VirtualHub 下建立新 P2S VpnGateway，以指向網站連接。

## 語法

### ByVirtualHubNameBy VpnServerConfigurationObject (預設) 
```
...
### ByVirtualHubNameBy VpnServerConfigurationResourceId
```
New-AzP2sVpnGateway -ResourceGroupName <String> -Name <String> -VpnGatewayScaleUnit <UInt32>
...
### ByVirtualHubObjectBy VpnServerConfigurationObject
```
New-AzP2sVpnGateway -ResourceGroupName <String> -Name <String> -VpnGatewayScaleUnit <UInt32>
...
### ByVirtualHubObjectBy VpnServerConfigurationResourceId
```
New-AzP2sVpnGateway -ResourceGroupName <String> -Name <String> -VpnGatewayScaleUnit <UInt32>
...
### ByVirtualHubResourceIdBy VpnServerConfigurationObject
```
New-AzP2sVpnGateway -ResourceGroupName <String> -Name <String> -VpnGatewayScaleUnit <UInt32>
...
### ByVirtualHubResourceIdBy VpnServerConfigurationResourceId
```
New-AzP2sVpnGateway -ResourceGroupName <String> -Name <String> -VpnGatewayScaleUnit <UInt32>
...
## 描述
此New-AzP2sVpnGateway Cmdlet 可讓您在 VirtualHub 下建立新 P2S VpnGateway，從點到網站用戶端到 Azure VirtualWan 的指向網站連接。
...
此New-AzP2sVpnGateway Cmdlet 可讓您在 VirtualHub 下建立新 P2S VpnGateway，以建立指向網站的連結。
...
### -VirtualHub
與此 P2S VpnGateway 相關聯的 VirtualHub。
...
### -VirtualHubId
此 P2S VpnGateway 的 VirtualHub 識別碼必須相關聯。
...
在此 P2S VpnGateway 上啟用路由喜好設定網際網路的標標。
