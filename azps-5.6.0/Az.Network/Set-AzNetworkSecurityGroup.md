...
## 描述
**Set-AzNetworkSecurityGroup** Cmdlet 會更新網路安全性群組。
...
此命令會獲得名為 Nsg1 的 Azure 網路安全性群組，並新增名為 Rdp-Rule 的網路安全性規則，以允許埠 3389 上的網際網路流量使用 Add-AzNetworkSecurityRuleConfig 將網際網路流量新增到已取取的網路安全性群組物件。
此命令會持續使用 **Set-AzNetworkSecurityGroup** 修改過的 Azure 網路安全性群組。
