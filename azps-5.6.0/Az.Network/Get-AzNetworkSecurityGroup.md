...
## 描述
**Get-AzNetworkSecurityGroup** Cmdlet 會取得 Azure 網路安全性群組。
...
此命令會返回資源群組 "rg1" 中 Azure 網路安全性群組 "nsg1" 的內容

### 範例 2：使用篩選列出現有的網路安全性群組
```powershell
...
此命令會以 "nsg" 做為起始的 Azure 網路安全性群組內容
