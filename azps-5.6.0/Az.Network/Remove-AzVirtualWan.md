...
此範例在資源群組中建立虛擬 WAN，然後立即刪除。 若要隱藏刪除虛擬 WAN 時提示，請使用 -Force 旗標。
...
此範例在資源群組中建立虛擬 WAN，然後立即刪除。 此刪除會使用 New-AzVirtual Wan 所返回的虛擬 wan 物件執行。
若要隱藏刪除虛擬 WAN 時提示，請使用 -Force 旗標。
...
此範例在資源群組中建立虛擬 WAN，然後立即刪除。 此刪除會使用 New-AzVirtual Wan 所返回的虛擬 wan 資源識別碼進行。
若要隱藏刪除虛擬 WAN 時提示，請使用 -Force 旗標。
