...
## 描述
**Get-AzExpressRoutePortLinkConfig** Cmdlet 會取得 ExpressRoutePort 連結的組式。
...
在 ExpressRoutePort $id中使用 ResourceId 連結$erport
