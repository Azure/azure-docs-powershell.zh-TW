...
## 描述
**Set-AzPrivateEndpoint** Cmdlet 會更新私人端點。

## 例子

### 1：建立私人端點，並將其其中一個子網取代為另一個子網
```
...
此範例會建立一個子網的私人端點，然後從虛擬網路的記憶體中表示方式取代為另一個子網。 然後Set-PrivateEndpoint Cmdlet，在服務端寫入經過修改的私人端點狀態。 
