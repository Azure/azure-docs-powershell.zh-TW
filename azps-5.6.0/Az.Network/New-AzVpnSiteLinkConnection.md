...
使用此連結連接時，請使用本地 azure ip 位址做為來源 IP。
...
### Microsoft.Azure.Commands.Network.models.PS VpnSiteLink

## 輸出

### Microsoft.Azure.Commands.Network.models.PS VpnSiteLinkConnection
