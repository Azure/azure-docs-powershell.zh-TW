...
## 描述
**Remove-AzExpressRoutePortIdentity Cmdlet** 會移除本地 Azure ExpressRoutePort 物件的身分識別。 使用 **Remove-AzExpressRoutePort** 將其從 ExpressRoutePort 移除。
