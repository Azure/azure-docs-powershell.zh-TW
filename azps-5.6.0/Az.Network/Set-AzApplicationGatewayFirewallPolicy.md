...
## 描述
**Set-AzApplicationGatewayFirewallPolicy** Cmdlet 會更新 Azure 應用程式閘道防火牆政策。
...
此命令會使用 $AppGwFirewallPolicy 變數中的設定來更新應用程式閘道防火牆$UpdatedAppGwFirewallPolicy變數中儲存更新的閘道。
