...
## 簡介
讓使用者輕鬆下載使用命令小命令產生的 vpn 設定檔套件New-AzVpnClientConfiguration套件。
...
## 描述
此Get-AzVpnClientConfiguration會返回可從其中下載 VPN 用戶端的 URL。
...
獲得 URL 以下載先前使用 New-AzVpnClientConfiguration 產生的 VpnClient 設定檔。
...
[New-Az VpnClientConfiguration](./New-AzVpnClientConfiguration.md)
