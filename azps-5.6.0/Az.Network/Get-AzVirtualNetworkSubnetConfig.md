...
## 描述
**Get-AzVirtualNetworkSubnetConfig** Cmdlet 在 Azure 虛擬網路中取得一或多個子網組配置。
...
此範例會建立資源群組，以及該資源群組中單一子網的虛擬網路。 然後，它會從該子網中取回資料。
...
### -VirtualNetwork
指定 **包含此 Cmdlet** 所獲得子網配置的 VirtualNetwork 物件。
