...
## 描述
**Get-AzServiceEndpointPolicyDefinition** Cmdlet 會取得服務端點策略定義。
...
此命令會獲得 ServiceEndpointPolicy 中名為 ServiceEndpointPolicyDefinition1 的服務端點$Policy儲存于 $policydef 變數。
