...
## 描述
**Set-AzPrivateLinkService** Cmdlet 會更新私人連結服務。
...
此範例會建立稱為 mypls 的私人連結服務。 接著，它會從記憶體 ipConfiguratiuon 物件取代其 ipConfigurations。 接著Set-AzPrivateLinkService Cmdlet，在服務端撰寫經過修改的私人連結服務狀態。 
