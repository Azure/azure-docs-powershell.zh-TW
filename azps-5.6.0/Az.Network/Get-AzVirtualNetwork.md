...
## 描述
**Get-AzVirtualNetwork** Cmdlet 會取得資源群組中的一或多個虛擬網路。
...
此命令會獲得資源群組 TestResourceGroup 中名為 MyVirtualNetwork 的虛擬網路
...
此命令會獲得以「MyVirtualNetwork」為起點的所有虛擬網路。
