...
## 簡介
在 VpnGateway 上建立可以與 VpnSiteLinkConnection 相關聯的 NAT 規則。
...
## 描述
在 VpnGateway 上建立可以與 VpnGateway 相關聯的 NAT 規則。
...
上述將建立資源群組、虛擬 WAN、虛擬網路、虛擬中樞。 接著，我們將建立虛擬中樞下的 VpnGateway。 然後，使用此命令：New-Az VpnGatewayNatRule，NAT 規則可以建立，並與已建立 VpnGateway 相關聯。
