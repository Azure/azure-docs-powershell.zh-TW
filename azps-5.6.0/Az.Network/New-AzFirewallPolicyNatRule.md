...
## 描述
**New-AzFirewallPolicyNatRule** Cmdlet 會建立 Azure 防火牆原則的 NAT 規則。
...
此範例會建立具有來源位址、通訊協定、目的地位址、目的地埠、翻譯位址和翻譯埠的 NAT 規則。
...
此範例會建立具有來源位址、通訊協定、目的地位址、目的地埠、翻譯 fqdn 和翻譯埠的 NAT 規則。
