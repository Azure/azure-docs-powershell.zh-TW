...
## 描述
**Add-AzVirtualNetworkGatewayIpConfig** Cmdlet 會新增 IP 設定檔至虛擬網路閘道。
...
此 Cmdlet 會修改您指定的 **PSVirtualNetworkGateway** 物件。
您可以使用 Cmdlet Get-AzVirtualNetworkGateway **PSVirtualNetworkGateway** 物件。
