...
## 描述
**New-AzServiceEndpointPolicyDefinition** Cmdlet 會建立服務端點策略定義。
...
此命令會建立服務端點策略定義，其名稱為 ServiceEndpointPolicyDefinition1、Service Microsoft.Storage、服務資源訂閱/sub1，以及屬於 ResourceGroup01 資源群組的「新定義」，並儲存在 $policydef 變數中。
