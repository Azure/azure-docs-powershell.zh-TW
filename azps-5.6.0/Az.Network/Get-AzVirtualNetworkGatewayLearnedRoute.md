...
## 描述
列舉 Azure 虛擬網路閘道從各種來源得知的路由。 這包括從 BGP 學習的路由，以及靜態路由。 
...
針對資源群組資源群組中名為閘道名稱的 Azure 虛擬網路閘道，會取回 Azure 閘道知道路由。 在此案例中，Azure 虛擬網路閘道有兩個靜態路由 (10.1.0.0/16 和 10.0.0.254/32) ，以及一個從 BGP (10.0.0.0/16) 學習的路由。
