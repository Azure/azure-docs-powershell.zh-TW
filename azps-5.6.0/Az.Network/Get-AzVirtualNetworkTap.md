...
## 描述
**Get-AzVirtualNetworkTap** Cmdlet 會取得 Azure 虛擬網路點一下，或在資源群組中點一下 Azure 虛擬網路清單。
...
此命令會針對 "ResourceGroup1" 中給 "VirtualTap1" 的 VirtualNetwork 點一下參照。

### 範例 2：使用篩選取得所有虛擬網路點一下
```
PS C:\> Get-AzVirtualNetworkTap -Name "VirtualTap*"
```

此命令會獲得以 "VirtualTap" 為起點的所有 VirtualNetwork 點一下參照。
