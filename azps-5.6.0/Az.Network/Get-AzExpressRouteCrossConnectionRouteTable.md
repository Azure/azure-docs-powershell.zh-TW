...
## 描述
**Get-AzExpressRouteCrossConnectionRouteTable** Cmdlet 會取得 ExpressRoute 回路的詳細路由資料表。 路由資料表會顯示所有路由，或可以篩選以顯示特定對等類型的路由。 您可以使用路由資料表驗證對等配置和連接。
