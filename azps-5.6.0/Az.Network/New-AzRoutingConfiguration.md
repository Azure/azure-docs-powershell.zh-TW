...
上述命令會建立一個 RoutingConfiguration 物件，然後可以新加入到連接資源中。 靜態路由只能與 HubVirtualNetworkConnection 物件一起允許。 
...
### -Id
所有中樞路由資料表的資源識別碼清單，以將路由宣告給傳播資料表屬性。
...
[New-AzP2s VpnGateway](./New-AzP2sVpnGateway.md)

[Update-AzP2s VpnGateway](./Update-AzP2sVpnGateway.md)
