...
## 描述
**Remove-AzNetworkInterface** Cmdlet 會移除 Azure 網路介面。
...
此命令會移除資源群組 ResourceGroup1 中的網路介面 NetworkInterface1。
...
此命令會移除資源群組 ResourceGroup1 中所有的網路介面。
