...
## 描述
**Set-AzApplicationGatewayCustomError** Cmdlet 會更新應用程式閘道的 HTTP 聆聽者中的自訂錯誤。

## 例子

### 範例 1：從 HTTP 聆聽者更新自訂錯誤
```powershell
...
此命令會更新 HTTP 聆聽程式 $listener 01 中 HTTP 狀態碼 502 的自訂錯誤，並返回更新的聆聽者。
