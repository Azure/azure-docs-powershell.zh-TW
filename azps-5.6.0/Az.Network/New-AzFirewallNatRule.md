...
### 範例 1：建立規則給所有 TCP 流量從 10.0.0.0/24 到目的地 10.1.2.3：80 到目的地 10.4.5.6：8080
```powershell
New-AzFirewallNatRule -Name "dnat-rule" -Protocol "TCP" -SourceAddress "10.0.0.0/24" -DestinationAddress "10.1.2.3" -DestinationPort "80" -TranslatedAddress "10.4.5.6" -TranslatedPort "8080"
```

此範例會建立規則，讓所有來自 10.0.0.0/24 的流量，目的地為 10.1.2.3：80 到 10.4.5.6：8080
...
指定此規則要篩選的流量類型。
支援的通訊協定為 TCP 和 UDP。
允許特殊值 「Any」，表示它會同時符合 TCP 和 UDP，但無法比對其他通訊協定。
