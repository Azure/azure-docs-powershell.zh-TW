...
## 描述
**Get-AzApplicationGatewayWebApplicationFirewallConfiguration** Cmdlet 會取得 Web 應用程式防火牆 (WAF) 應用程式閘道的組式。

## 例子

### 範例 1：取得應用程式閘道 Web 應用程式防火牆組
```
...
第二個命令會獲得應用程式閘道在 $AppGW 中的防火牆$FirewallConfig。
