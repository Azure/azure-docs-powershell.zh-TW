...
## 簡介
獲得與此 VirtualWan 相關聯的所有 VpnServerConfigurations 清單。
...
## 描述
**Get-AzVirtualWan VpnServerConfiguration Cmdlet** 會返回與此 VirtualWan 相關聯的所有 VpnServerConfiguration 清單。 i.e. 所有附加至虛擬網站 V一alHubs 下任何 P2S VpnGateway 的 VpnServerConfigurations。
...
### Microsoft.Azure.Commands.Network.models.PS VpnServerConfigurationsResponse
