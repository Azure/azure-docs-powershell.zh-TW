...
## 描述
**Get-AzExpressRouteRouteCircuitPeeringConfig** Cmdlet 會針對 ExpressRoute 回路取得對等互連關係的組式。

## 例子

### 範例 1：顯示 ExpressRoute 回路的對等組
```
