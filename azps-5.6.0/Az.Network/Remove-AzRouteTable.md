...
## 描述
**Remove-AzRouteTable** Cmdlet 會移除 Azure 路由資料表。
...
此命令會移除名為 ResourceGroup11 的資源群組中名為 RouteTable01 的路由資料表。
Cmdlet 會先提示您確認，然後再移除表格。
