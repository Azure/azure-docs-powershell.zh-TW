...
## 描述
**Get-AzRouteTable** Cmdlet 會取得 Azure 路由資料表。
您可以取得單一路由資料表，或取得資源群組或訂閱中所有路由資料表。
...
此命令在名為 ResourceGroup11 的資源群組中，會獲得名為 RouteTable01 的路由資料表。
...
此命令會獲得名稱以 「RouteTable」開頭的所有路由資料表
