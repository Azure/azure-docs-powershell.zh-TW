...
## 簡介
建立 IPSec 連接，將 VpnGateway 連接至以 RM 表示為 VpnSite 的遠端客戶分支。

## 語法

### By VpnGatewayNameBy VpnSiteObject (預設) 
```
...
### By VpnGatewayNameBy VpnSiteResourceId
```
...
### By VpnGatewayObjectBy VpnSiteObject
```
...
### By VpnGatewayObjectBy VpnSiteResourceId
```
...
### By VpnGatewayResourceIdBy VpnSiteObject
```
...
### By VpnGatewayResourceIdBy VpnSiteResourceId
```
...
上述專案將在 Azure 的 「testRG」資源群組中，建立一個資源群組、虛擬 WAN、虛擬網路、虛擬中樞，以及美國西部有 1 個 VpnSiteLink 的 VpnSite 網站。
在此之後，將在虛擬中樞中建立 VPN 閘道。
閘道建立之後，它會使用 New-AzVpnConnection 命令與 1 個 VpnSiteLinkConnections 連接至 VpnSiteLink VpnSiteLink。
...
此 VpnConnection 的 VpnSiteLinkConnection 清單。
...
### Microsoft.Azure.Commands.Network.models.PS VpnConnection

## 筆記

## 相關連結

[Get-Az VpnConnection](./Get-AzVpnConnection.md)

[Remove-Az VpnConnection](./Remove-AzVpnConnection.md)

[Update-Az VpnConnection](./Update-AzVpnConnection.md)
