...
## 描述
Cmdlet New-AzNetworkWatcherConnectionMonitorTestConfigurationObject建立連接監視器測試組。
...
名稱 ： HTTPTC TestFrequencySec ： 120 PreferredIPVersion ： ProtocolConfiguration ： { "Port"： 443， "Method"： "GET"， "RequestHeaders"： [ { "Name"： "Allow"， "Value"： "GET" } ]， "ValidStatusCodeRanges"： [ "2xx"， "300-308" ]， "PreferHTTPS"： true } SuccessThreshold ： { "ChecksFailedPercent"： 20， "RoundTripTimeMs"： 30 } 
...
### -PreferredIPVersion
用於測試評估的偏好 IP 版本。 根據其他參數，連接監視器可能會選擇使用不同的版本。
