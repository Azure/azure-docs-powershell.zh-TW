...
## 描述
**Remove-AzExpressRouteCircuit Cmdlet** 會移除 ExpressRoute 回路。

## 例子

### 範例 1：刪除 ExpressRoute 回路
```
Remove-AzExpressRouteCircuit -Name $CircuitName -ResourceGroupName $rg
```

### 範例 2：使用管線刪除 ExpressRoute 回路
```
