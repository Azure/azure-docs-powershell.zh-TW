...
## 描述
**New-AzApplicationGatewayFirewallPolicyManagedRuleSet** 會建立防火牆原則的受管理規則。
...
使用 ruleSetType 建立 ManagedRuleSet 做為 $ruleSetType，ruleSetVersion 為 $ruleSetVersion，RuleGroupOverrides 為清單，包含 $ruleGroupOverride 1，$ruleGroupOverride 2 新的 ManagedRuleSet 會指派給 $managedRuleSet
...
### -RuleSetType
指定 ManagedRuleSet 中的 RuleSetType
...
### -RuleSetVersion
指定 ManagedRuleSet 中的 RuleSetVersion
