...
## 描述
**Add-AzApplicationGatewayRequestRoutingRule** Cmdlet 會建立 Azure 應用程式閘道的要求路由規則。

## 例子

### 範例 1：建立應用程式閘道的要求路由規則
```
...
此命令會建立名為 Rule01 的基本要求路由規則，並且將結果儲存在名為 $Rule 的變數中。

## 參數

### -後端AddressPool
指定要建立要求路由規則的後端位址集區做為物件。
