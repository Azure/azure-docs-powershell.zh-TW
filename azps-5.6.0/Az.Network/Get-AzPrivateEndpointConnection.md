...
## 描述
**Get-AzPrivateEndpointConnection** Cmdlet 會取回私人端點連接資源。
...
此範例會返回所有私人端點連結的清單屬於名為 Mysql 的 sql 伺服器。
...
此範例取得名為 MyPrivateEndpointConnection1 的私人端點連接屬於名為 MyPrivateLinkService 的私人連結服務
...
私人端點連接所屬的私人連結資源的 Azure 資源管理器識別碼。
