...
## 描述
**Add-AzLoadBalancerOutboundRuleConfig** Cmdlet 會將輸出規則組配置新增到 Azure 負載平衡器。
...
第二個命令會使用管線運算子，將 $slb 中的負載平衡器傳遞到 **Add-AzLoadBalancerOutboundRuleConfig，** 此為負載平衡器新增輸出規則組式。
