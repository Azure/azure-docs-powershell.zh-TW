...
## 描述
**Set-AzApplicationGatewayFrontendPort** Cmdlet 會修改應用程式閘道的前端埠。

## 例子

### 範例 1：將應用程式閘道前端埠設定為 80
```
...
第二個命令會修改 $AppGw 中的閘道，為名為 FrontEndPort01 的前端埠使用埠 80。

## 參數

### -ApplicationGateway
指定此 Cmdlet 與前端埠關聯的應用程式閘道物件。
