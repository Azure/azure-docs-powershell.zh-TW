...
## 描述
**Get-AzBatchApplicationPackage Cmdlet** 會取得 Azure Batch 帳戶中應用程式套件的資訊。

## 例子

### 範例 1：取得 Batch 帳戶中的應用程式套件詳細資料
```
...
此命令會獲得 Litware 套件版本 1.0 的詳細資訊。

## 參數

### -AccountName
指定此 Cmdlet 從哪個批次帳戶獲得資訊的名稱。
