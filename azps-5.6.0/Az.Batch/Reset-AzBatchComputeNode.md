...
## 描述
**Reset-AzBatchComputeNode** Cmdlet 會重新安裝指定計算節點上的作業系統。
...
### -ComputeNode
指定代表要重新映射之計算節點的 **PSComputeNode** 物件。
