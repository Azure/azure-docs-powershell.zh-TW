...
## 描述
**Stop-AzBatchCertificateDeletion Cmdlet** 會取消 Azure Batch Service 中憑證的失敗刪除。
只有當憑證位於 **DeleteFailed** 狀態時，才能停止刪除。
此 Cmdlet 會將憑證還原為 **使用中** 狀態。
