...
## 描述
**Get-AzBatchCertificate** Cmdlet 會取得 *BatchCoNtext* 參數指定的 Azure Batch 帳戶中的憑證。
若要取得特定憑證，請指定 *ThumbprintAlgorithm* 和 *Thumbprint* 參數。
指定 *Filter* 參數，以取得與 OData 和篩選 (相符) 憑證。
