...
使用證明類型 SymmetricKey 和初始啟動狀態建立註冊。
...
### -PrimaryCertificate
包含主憑證之檔案的路徑。
X509 憑證 .cer 檔案或 .pem 檔案路徑的 Base-64 標記法。
