...
## 描述
上傳新的憑證，或以相同的名稱取代現有的憑證。
有關 Azure IoT Hub 裝置設置服務中 CA 憑證的詳細說明，請參閱 https://docs.microsoft.com/azure/iot-dps/how-to-verify-certificates 。
...
將 CA 憑證 CER 檔案上傳至 Azure IoT Hub 裝置設置服務。
...
上傳新的CEC檔案，以更新 IoT 中樞裝置設置服務中的 CA 憑證。 
...
### -路徑
base-64 表示 X509 憑證 .cer 檔案或 .pem 檔案路徑
