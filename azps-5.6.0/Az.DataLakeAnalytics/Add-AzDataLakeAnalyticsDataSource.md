...
## 描述
**Add-AzDataLakeAnalyticsDataSource** Cmdlet 會將資料來源新增到 Azure Data Lake Analytics 帳戶。
...
此命令會將 Data Lake Store 資料來源新增到 Data Lake Analytics 帳戶。

### 範例 2

新增資料來源至 Data Lake Analytics 帳戶。  (自動) 
...
### -DataLakeStore
指定要新增的 Azure Data Lake Store 帳戶名稱。
