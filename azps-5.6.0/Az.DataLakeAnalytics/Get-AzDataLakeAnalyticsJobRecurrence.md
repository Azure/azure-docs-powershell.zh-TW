...
## 描述
**Get-AzDataLakeAnalyticsJobRecurrence 會** 取得指定的 Azure Data Lake Analytics Job 週期或週期清單。
...
此命令會獲得指定的工作週期，其帳戶 'contocbdla' 中的 id '83cb7ad2-3523-4b82-b909-d478b0d8aea3'。
...
此命令會獲得帳戶 "contola" 中所有週期的清單

## 參數

### -帳戶
資料湖分析帳戶名稱的名稱，其下想要取回工作週期。
