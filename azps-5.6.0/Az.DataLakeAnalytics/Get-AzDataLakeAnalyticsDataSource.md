...
## 描述
**Get-AzDataLakeAnalyticsDataSource** Cmdlet 會取得 Azure Data Lake Analytics 資料來源。
...
此命令會從 Data Lake Analytics 帳戶獲得名為 ContosoAdls 的 Data Lake Store 資料來源。

### 範例 2：取得 Data Lake Analytics 帳戶中的 Data Lake Store 帳戶清單
```
PS C:\>Get-AzDataLakeAnalyticsDataSource -AccountName "ContosoAdlA" -DataSource "DataLakeStore"
```

此命令會從 Data Lake Analytics 帳戶獲得所有 Data Lake Store 帳戶。

## 參數

### -帳戶
指定此 Cmdlet 會獲得資料來源的 Data Lake Analytics 帳戶。
