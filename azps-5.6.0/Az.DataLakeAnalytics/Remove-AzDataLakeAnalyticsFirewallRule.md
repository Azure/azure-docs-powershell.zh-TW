...
## 描述
**Remove-AzDataLakeAnalyticsFirewallRule** Cmdlet 會從 Azure Data Lake Analytics 帳戶移除防火牆規則。
...
此命令會從帳戶 "ContosoAdlAcct" 移除名為「我的防火牆規則」的防火牆規則

## 參數

### -帳戶
移除防火牆規則的 Data Lake Analytics 帳戶
