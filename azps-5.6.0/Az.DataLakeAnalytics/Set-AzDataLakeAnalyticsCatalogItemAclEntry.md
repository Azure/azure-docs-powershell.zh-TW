...
## 描述
**Set-AzDataLakeAnalyticsCatalogItemAclEntry Cmdlet** 新增或修改存取控制清單 (ACE) 中的專案 (ACL) of Data Lake Analytics 中的目錄或型錄專案。
...
此命令會修改帕提 Fuller 的目錄 ACE，以擁有讀取權限。
...
此命令會修改資料庫 ACE，讓帕提 Fuller 具有讀取權限。
