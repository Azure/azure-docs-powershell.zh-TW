...
## 描述
**Remove-AzDataLakeAnalyticsDataSource** Cmdlet 會從 Azure Data Lake Analytics 帳戶移除資料來源。
...
此命令會從名為 ContosoAdlAccount的帳戶移除名為 AzureStorage01 的資料來源。
...
### -DataLakeStore
指定要移除的 AzureData Lake Store 帳戶名稱。
