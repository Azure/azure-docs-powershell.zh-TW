...
啟用或停用 Azure 資訊安全中心訂閱的 Azure Defender 方案。
...
啟用 **適用于訂閱之伺服器的 Azure Defender。**

「標準」是指 Azure Defender 計畫的「On」狀態，如 Azure 資訊安全中心的 Azure 入口網站定價和設定區域所示。
