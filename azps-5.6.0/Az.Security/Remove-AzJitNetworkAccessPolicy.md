...
## 描述
刪除即時網路存取策略。
執行此動作之後，使用者將無法要求在已刪除之策略內所配置的虛擬機器上建立暫時網路連接。
...
### -ResourceId
jit Network Access Policy 資源的資源識別碼。
...
### Microsoft.Azure.Commands.Security.models.JitNetworkAccesssPolicies.PSSecurityJitNetworkAccessPolicy
