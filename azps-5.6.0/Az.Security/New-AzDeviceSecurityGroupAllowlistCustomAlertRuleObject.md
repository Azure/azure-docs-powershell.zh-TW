...
## 描述
Cmdlet New-AzDeviceSecurityGroupAllowlistCustomAlertRuleObject為 IoT 安全性解決方案中的裝置安全性群組建立允許的自訂通知規則新清單。
...
從類型 "LocalUserNotAllowed" 建立新允許清單自訂通知 rull，狀態設為停用
