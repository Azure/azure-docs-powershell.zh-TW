...
## 描述
Cmdlet Set-AzIotSecuritySolution或更新特定的 iot 安全性解決方案。 IoT 安全性解決方案會收集 iot 裝置和 iot 中樞的安全性資料和事件，協助防範和偵測威脅。
iot 安全性解決方案的名稱應該與 iot 中心的名稱相同。
...
使用資源識別碼 "/subscriptions/XXXXXXXX-XXXX-XXXXXXXXXXXX/resourceGroups/MichalResourceGroup/providers/Microsoft.Devices/IotHubs/MySample" 為 IoT 中樞建立新的 iot 安全性解決方案 "MySample" (解決方案的名稱應該與 IoT 中心的名稱相同) 
