...
## 描述
Cmdlet Get-AzIotSecurityAnalyticsAggregatedAlert iot 中樞裝置上，會返回一或多個匯總通知。
匯總警示的名稱是警示類型和警示被打平的日期組合，以 '/' 分隔。
...
取得匯總警示 "IoT_Bruteforce_Fail/2019-02-02" (名稱結合來自警示類型及其匯總日期) 的解決方案 "MySolution" 和資源群組 "MyResourceGroup"
...
取得解決方案 "MySolution" 和資源群組 "MyResourceGroup" 中所有匯總通知的清單
