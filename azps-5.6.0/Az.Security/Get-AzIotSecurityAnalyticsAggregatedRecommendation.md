...
## 描述
Cmdlet Get-AzIotSecurityAnalyticsAggregatedAlert iot 中樞裝置上，會返回一或多個匯總建議。 匯總建議的名稱是它的類型
...
在安全性解決方案 "MySolution" IoT_OpenPorts資源群組 "MyResourceGroup" 中取得匯總建議 "IoT_OpenPorts"
...
在安全性解決方案 「MySolution」和資源群組 「MyResourceGroup」中取得匯總建議清單
