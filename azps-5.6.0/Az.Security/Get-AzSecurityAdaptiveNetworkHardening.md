...
```
## 描述
由 Azure 資訊安全中心自動計算自適性網路轉切，使用此 Cmdlet 取得延伸資源範圍中的自適性網路增強資源清單。
...
### Microsoft.Azure.Commands.Security.models.AdaptiveNetworkWorkenings.PSSecurityAdaptiveNetwork。</a0>
