...
## 描述
在資源上建立或更新安全性評定結果，可用來變更現有結果的狀態或新增其他資料。
只能用於「CustomerManaged」評定類型，而且只能在建立相符的評定中繼資料之後使用。
...
將訂閱結果標記為「不健康」，以評定類型 "4FB6C0A0-1137-42C7-A1C7-4BD37C91DE8D" - 評估Metadata 類型下會找到評定類型的詳細資訊

## 參數

### -AdditionalData
附加至評定結果的資料，可改善調查或狀態明確性。
