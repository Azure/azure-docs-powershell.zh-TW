...
## 描述
此Get-AzIotSecurityAnalytics Cmdlet 會針對特定 iot 安全性解決方案，會返回一組安全性分析
...
在 Reasource 群組 "MyResourceGroup" 中取得聽障的 IoT 安全性分析以取得安全性解決方案 "MySolution"

## 參數

### -預設
如果有，請取得預設的分析集，否則，取得所有分析集的清單。
