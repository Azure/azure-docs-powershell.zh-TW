...
## 描述
此New-AzDeviceSecurityGroupTimeWindowRuleObject Cmdlet 會針對 IoT 安全性解決方案中的裝置安全性群組，建立一份新的時間視窗警示規則清單。
...
從「ActiveConnectionsNotInAllowedRange」類型建立新時間視窗規則
