...
## 描述
**Test-AzStreamAnalyticsOutput** Cmdlet 會測試 Stream Analytics 連接至輸出的能力。
...
### -JobName
指定您想要的 Azure Stream Analytics 輸出所屬的 Azure Stream Analytics 工作名稱。
...
### -名稱
指定要測試的 Azure Stream Analytics 輸出名稱。
