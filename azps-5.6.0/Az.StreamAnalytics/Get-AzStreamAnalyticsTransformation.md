...
## 描述
**Get-AzStreamAnalyticsTransformation** Cmdlet 會取得 Stream Analytics 工作上定義的轉換相關資訊。

## 例子

### 範例 1：取得 Stream Analytics 轉換的資訊
```
PS C:\>Get-AzStreamAnalyticsTransformation -ResourceGroupName "StreamAnalytics-Default-West-US" -JobName "StreamingJob" -Name "StreamingJob"
```

此命令會回到名為 StreamingJob 的工作上稱為 StreamingJob 的轉換相關資訊。
...
### -JobName
指定 Azure Stream Analytics 轉換所屬的 Azure Stream Analytics 工作名稱。
...
### -名稱
指定要取回的 Azure Stream Analytics 轉換名稱。
...
### -ResourceGroupName
指定 Azure Stream Analytics 轉換所屬的資源組名。
