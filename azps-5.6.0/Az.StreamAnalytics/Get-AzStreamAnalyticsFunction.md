...
## 描述
**Get-AzStreamAnalytics Functiondlet** 會取得 Azure Stream Analytics 工作所定義之函數的清單，或特定函數的資訊。

## 例子

### 範例 1：取得所有 Stream Analytics 函數
```
PS C:\>Get-AzStreamAnalyticsFunction -ResourceGroupName "StreamAnalytics-Default-West-US" -JobName "StreamJob22"
```

此命令會獲得在名為 StreamJob22 的工作上定義的函數。

### 範例 2：取得特定的 Stream Analytics 函數
```
PS C:\>Get-AzStreamAnalyticsFunction -ResourceGroupName "StreamAnalytics-Default-West-US" -JobName "StreamJob22" -Name "ScoreTweet"
```

此命令會取得名稱為 ScoreTweet 的函數在名為 StreamJob22 的工作上定義的資訊。
...
### -名稱
指定此 Cmdlet 所獲得 Stream Analytics 函數的名稱。
