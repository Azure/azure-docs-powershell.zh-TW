...
## 描述
**Remove-AzPolicyRemediation** Cmdlet 會刪除策略補救。
...
此命令會刪除資源群組 "myRG" 中名為 "remediation1" 的補救。
...
此命令會從管理群組 "mg1" 中刪除名為 "remediation1" 的補救。 刪除資源之前，將會顯示確認提示。
...
此命令會刪除資源群組 "myRG" 中名為 "remediation1" 的補救。 如果補救正在進行中，則先取消修復再刪除。
