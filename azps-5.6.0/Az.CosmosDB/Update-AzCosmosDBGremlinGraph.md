...
## 簡介
更新一些更新的一些資訊。 讀取現有的 Graph 以執行用戶端修補作業。
...
類型 PSConflictResolutionPolicy 的 ConflictResolutionPolicy 物件，如果提供此選項，則設為容器的 ConflictResolutionPolicy。
...
### -IndexingPolicy
類型為 Microsoft.Azure.Commands.CosmosDB.PSIndexingPolicy 的索引策略物件。
...
### -UniqueKeyPolicy
類型為 Microsoft.Azure.Commands.代斯DB.PSUniqueKeyPolicy 的 UniqueKeyPolicy 物件。
...
### Microsoft.Azure.Commands.AzsDB.models.PSIndexingPolicy

### Microsoft.Azure.Commands.AzsDB.models.PSUniqueKeyPolicy

### Microsoft.Azure.Commands.AzsDB.Models.PSConflictResolutionPolicy

### Microsoft.Azure.Commands.AzsDB.models.PSGremlinDatabaseGetResults
