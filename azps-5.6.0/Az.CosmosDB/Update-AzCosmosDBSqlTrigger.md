...
## 簡介
更新了一些更新的一些 Sql Trigger。 讀取現有的觸發程式，以執行用戶端修補程式作業。
...
### Microsoft.Azure.Commands.AzsDB.Models.PSSqlContainerGetResults

### Microsoft.Azure.Commands.AzsDB.Models.PSSqlTrigetResults
