...
## 簡介
在 PSVirtualNetworkRule (建立一個新的一個部 10000000000) 。
...
### -Id
子網的資源識別碼，例如：/subscriptions/{subscriptionId}/resourceGroups/{groupName}/providers/Microsoft.Network/virtualNetworks/{virtualNetworkName}/子網/{子網Name}
...
布林值，指出在啟用 vnet 服務端點之前，是否建立防火牆規則。
...
### Microsoft.Azure.Commands.AzsDB.models.PSVirtualNetworkRule
