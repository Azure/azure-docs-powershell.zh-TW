...
## 描述
**Remove-AzCosmosDBSqlStoredProcedure Cmdlet** 會刪除對應至給定 ResourceGroupName、AccountName 和 DatabaseName 的一個系統管理中心 Sql StoredProcedure。
