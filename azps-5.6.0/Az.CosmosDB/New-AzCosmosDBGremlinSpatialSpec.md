...
## 簡介
建立 PSSpatialSpec 類型的新物件。 它可以傳遞為 Set-AzCosmosDBGremlinIndexingPolicy 的參數值。
...
### -類型
包含可接受值的字串陣列：Point、LineString、多邊形、MultiPolygon。
代表路徑的空間類型。
...
### Microsoft.Azure.Commands.AzsDB.models.PSSpatialSpec
