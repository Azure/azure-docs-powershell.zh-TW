...
## 描述
**Get-AzCosmosDBCassandraKeyspace** Cmdlet 會建立一個新或更新現有的一個OsosDB Cassandra Keyspace。
...
Get-AzCosmosDBCassandraKeyspace現有 CassandraKeyspace 的屬性。 您可以展開資源以取得_etag、_ts_rid屬性。
