...
類型 PSSqlConflictResolutionPolicy 的 ConflictResolutionPolicy 物件，如果提供此選項，則設為容器的 ConflictResolutionPolicy。
...
如果與 ConflictResolutionPolicy 參數一起提供，則忽略此參數。
...
### -IndexingPolicy
類型為 Microsoft.Azure.Commands.AzsDB.PSSqlIndexingPolicy 的索引策略物件。
...
### -UniqueKeyPolicy
UniqueKeyPolicy Object of type Microsoft.Azure.Commands.代斯DB.PSSqlUniqueKeyPolicy.
...
### Microsoft.Azure.Commands.AzsDB.Models.PSSqlIndexingPolicy

### Microsoft.Azure.Commands.AzsDB.Models.PSSqlUniqueKeyPolicy

### Microsoft.Azure.Commands.AzsDB.Models.PSSqlConflictResolutionPolicy
