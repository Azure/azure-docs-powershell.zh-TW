...
## 描述
**Get-AzCosmosDBCassandraTable** Cmdlet 會建立一個新或更新現有的一個OsosDB Cassandra Keyspace。
...
{{ Get-AzCosmosDBCassandraTable會獲得現有 CassandraKeyspace 的屬性。 您可以展開資源以取得 DefaultTtl、架構、_etag、_ts、_rid屬性}}
