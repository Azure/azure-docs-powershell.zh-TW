...
## 描述
**Add-AzHDInsightStorage Cmdlet** 會將 Azure 儲存體帳戶專案新增到由 New-AzHDInsightClusterConfig Cmdlet 所建立之 Azure HDInsight 組New-AzHDInsightClusterConfig物件。

## 例子

### 範例 1：新增 Azure 儲存鍵至組組物件
```
...
此命令會將 Blob 儲存帳戶專案新增到名為 your-hadoop-001 的 HDInsight 設定檔。
