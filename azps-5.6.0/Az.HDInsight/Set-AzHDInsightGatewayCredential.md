...
## 描述
**Set-AzHDInsightGatewayCredential Cmdlet** 會設定 Azure HDInsight 套件的閘道認證。
...
此命令會根據名稱參數集，設定名為 your-hadoop-001 的組組閘道認證。
...
此命令會根據 ResourceId 參數集設定名為 your-hadoop-001 的該組組閘道認證。
...
此命令會根據 InputObject 參數集，設定名為 your-hadoop-001 的組組閘道認證。
