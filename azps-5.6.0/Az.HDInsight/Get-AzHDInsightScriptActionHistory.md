...
## 描述
**Get-AzHDInsightScriptActionHistory Cmdlet** 會取得 Azure HDInsight 集區腳本動作歷程記錄，並按相反的時間順序列出，或取得先前執行的腳本動作詳細資料。

## 例子

### 範例 1：取得該組組腳本動作執行歷程記錄
```
PS C:\>Get-AzHDInsightScriptActionHistory -ClusterName "your-hadoop-001"
```

此命令會獲得您-hadoop-001 該組組腳本動作的歷程記錄。
