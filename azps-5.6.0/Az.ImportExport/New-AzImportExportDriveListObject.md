...
### 範例 1：為 ImportExport 工作建立新 DriveList
```powershell
...
這些 Cmdlet 會為 ImportExport 工作建立一個新的 DriveList。

## 參數

### -BitLockerKey
用來加密硬碟的 BitLocker 金鑰。
