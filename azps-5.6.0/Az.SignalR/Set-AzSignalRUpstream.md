...
使用 splatting 語法傳遞 templates 參數的範例：@{UrlTemplate=' http://host-connections1.com '， HubPattern= 'chat';EventPattern='broadcast' }，@{UrlTemplate=' http://host-connections2.com '}
...
[如何使用 Splatting 將參數傳遞到 PowerShell 中的命令](https://docs.microsoft.com/powershell/module/microsoft.powershell.core/about/about_splatting?view=powershell-7)
