...
## 簡介
如果媒體服務已存在，會建立媒體服務，其所有屬性會隨著提供的輸入更新。
...
## 描述
**New-AzMediaService** Cmdlet 會建立媒體服務。
如果媒體服務已存在，此 Cmdlet 會更新其屬性。

## 例子

### 範例1：僅使用主要儲存空間帳戶建立媒體服務
```
PS C:\># Variables
## Global
...
此範例顯示如何建立只指定主要儲存空間帳戶的媒體服務。
此腳本使用數個其他 Cmdlet。

### 範例 2：建立具有多個儲存空間的媒體服務
```
PS C:\># Variables
