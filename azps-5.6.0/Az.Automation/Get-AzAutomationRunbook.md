...
## 描述
**Get-AzAutomationRunbook** Cmdlet 會取得 Azure Automation Runbooks。
...
此命令會獲得 Azure Automation 帳戶中名為 Contoso17 的所有 runbook。

## 參數

### -AutomationAccountName
指定此 Cmdlet 可在此獲得 runbooks 的自動化帳戶名稱。
...
### -ResourceGroupName
指定此 Cmdlet 會獲得 runbook 之資源組的名稱。
