...
## 描述
**Get-AzAutomationAccount** Cmdlet 會取得資源群組中的 Azure Automation 帳戶。
...
此命令會獲得資源群組中名為 ResourceGroup03 的所有自動化帳戶。
...
此命令在名為 ContosoResourceGroup 的資源群組中，會獲得名為 ContosoAutomationAccount 的自動化帳戶。
