...
## 描述
**取消註冊-AzAutomationDscNode** Cmdlet 會移除 Azure Automation 帳戶管理中的 APS 想要狀態組態 (DSC) 節點。

## 例子

### 範例 1：使用自動化帳戶從管理移除 Azure DSC 節點
```
...
此命令會從名為 Contoso17 的自動化帳戶管理移除具有指定 GUID 的 DSC 節點。

## 參數

### -AutomationAccountName
指定此 Cmdlet 移除 DSC 節點的自動化帳戶名稱。
