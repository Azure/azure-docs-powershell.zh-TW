...
## 描述
此Get-AzAutomationSoftwareUpdateConfiguration會返回軟體更新組配置清單。 若要取得特定的軟體更新設定，請指定名稱參數。 您也可以指定此虛擬機器的 Azure 資源識別碼，以列出特定 Azure 虛擬機器的軟體更新群組原則。
