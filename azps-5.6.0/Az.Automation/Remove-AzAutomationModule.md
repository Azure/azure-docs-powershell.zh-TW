...
## 描述
**Remove-AzAutomationModule Cmdlet** 會從 Azure Automation 中的自動化帳戶移除模組。
...
此命令會從名為 Contoso17 的自動化帳戶移除名為 ContosoModule 的模組。

## 參數

### -AutomationAccountName
指定此 Cmdlet 移除模組的自動化帳戶名稱。
