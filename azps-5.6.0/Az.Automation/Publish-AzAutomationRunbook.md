...
## 描述
**Publish-AzAutomationRunbook** Cmdlet 會發佈用於 Azure Automation 生產環境的 Runbook。
...
此命令在名為 Contoso17 的 Azure 自動化帳戶中發佈名為 Runbk01 的 runbook。
