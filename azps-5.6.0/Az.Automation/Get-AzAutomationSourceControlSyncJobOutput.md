...
## 描述
**Get-AzAutomationSourceControlSyncJobOutput** Cmdlet 會取得 Azure 自動化原始程式碼管理同步作業的輸出結果。

## 例子

### 範例 1
此命令會獲得原始程式碼管理同步處理工作的輸出，以及原始程式碼管理 VSTSNative 的 id 08d6d266-27b6-463c-beea-bc48a67ace15。 
