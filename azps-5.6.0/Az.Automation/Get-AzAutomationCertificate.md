...
## 描述
**Get-AzAutomationCertificate** Cmdlet 會取得一或多個 Azure 自動化憑證。
根據預設，此 Cmdlet 會獲得所有憑證。
指定憑證的名稱以取得特定憑證。
...
此命令會獲得自動化帳戶中所有憑證的中繼資料，名稱為 Contoso17。
...
此命令會獲得名稱為 ContosoCertificate 之憑證的中繼資料。

## 參數

### -AutomationAccountName
指定此 Cmdlet 所取取憑證的自動化帳戶名稱。
