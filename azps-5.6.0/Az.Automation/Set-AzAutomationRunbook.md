...
## 描述
**Set-AzAutomationRunbook** Cmdlet 會修改 APS 中 Azure Automation Runbook 的設定。

## 例子

### 範例 1：為 runbook 啟用詳細記錄
```
PS C:\>Set-AzAutomationRunbook -AutomationAccountName "Contoso17" -Name "Runbook02" -LogVerbose $True -ResourceGroupName "ResourceGroup01"
```

此命令會針對 Azure Automation 帳戶 Contoso17 中指定 runbook 的工作啟用詳細記錄。
