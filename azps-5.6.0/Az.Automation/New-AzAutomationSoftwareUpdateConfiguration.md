...
## 描述
建立可排程執行的更新軟體更新組式，以更新電腦清單。 電腦包括 Azure 虛擬機器或非 az 電腦。

## 例子

### 範例 1
建立軟體更新組式，以每週六晚上 9 點在兩部 Windows Azure 虛擬機器上安裝一次重大更新。 在此範例中，更新持續時間設定為 2 小時。
