...
## 描述
**New-AzAutomationCredential Cmdlet** 在 Azure Automation 中將認證建立為 **PSCredential** 物件。
...
最後一個命令會建立一個名為 ContosoCredential 的自動化認證，該認證$Credential。

## 參數

### -AutomationAccountName
指定此 Cmdlet 儲存認證之自動化帳戶的名稱。
