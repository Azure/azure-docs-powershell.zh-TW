...
## 描述
**Remove-AzAutomationConnection** Cmdlet 會從 Azure Automation 移除一個連接。
...
此命令會移除自動化帳戶中名為 Contoso17 的 ContosoConnection 憑證。

## 參數

### -AutomationAccountName
指定此 Cmdlet 移除連接的自動化帳戶名稱。
