...
## 描述
此Update-AzAutomationSourceControl Cmdlet 會修改 Azure Automation 中原始程式碼管理中的欄位值。

## 例子

### 範例 1
這個命令會針對名為 devAccount 的帳戶中名為 VSTSNative 的 Azure Automation 原始程式碼管理，將 PublishRunbook 欄位設定為 False。
