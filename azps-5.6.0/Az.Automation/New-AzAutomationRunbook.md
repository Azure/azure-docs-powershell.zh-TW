...
## 描述
**New-AzAutomationRunbook** Cmdlet 會使用 APS 建立空白的 Azure Automation Runbook。
指定 runbook 的名稱。
...
此命令在 Azure Automation 帳戶中建立名為 Contoso17 的 Runbook02。
...
指定此 Cmdlet 建立 runbook 的自動化帳戶名稱。
