...
## 描述
**Reset-AzSynapseSqlPoolAdvancedThreatProtectionSetting** Cmdlet 會從 Azure Synapse Analytics SQL 資料庫移除進位威脅防護設定。
...
此命令會從名為 ContosoWorkspace 的工作區下，名為 ContosoSqlPool 的 SQL 資料庫移除進一步威脅防護設定。
