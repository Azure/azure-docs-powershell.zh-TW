...
## 描述
**Remove-AzSynapsePipeline** Cmdlet 會從工作區移除管線。
...
此 Cmdlet 會從名為 ContosoWorkspace 的工作區移除名為 ContosoPipeline 的管線。
...
此 Cmdlet 會從名為 ContosoWorkspace 的工作區透過管線移除名為 ContosoPipeline 的管線。
