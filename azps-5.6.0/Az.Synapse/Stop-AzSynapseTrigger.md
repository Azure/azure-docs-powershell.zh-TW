...
## 描述
**Stop-AzSynapseTrigger Cmdlet** 會停止工作區中的觸發程式。 如果觸發程式位於 'Started' 狀態，Cmdlet 會停止觸發程式，不再會啟動管線。 如果觸發人已經進入 '已停止' 狀態，此 Cmdlet 沒有作用。
...
在工作區 ContosoWorkspace 中透過管線停止名為 ContosoTrigger 的觸發程式。
