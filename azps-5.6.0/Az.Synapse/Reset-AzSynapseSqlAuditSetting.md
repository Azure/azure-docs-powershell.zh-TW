...
## 簡介
移除 Azure Synapse Analytics Workspace 的稽核設定。
...
## 描述
**Reset-AzSynapseSqlAuditSetting** Cmdlet 會移除 Azure Synapse Analytics Workspace 的稽核設定。
...
此命令會移除名為 ContosoWorkspace 的 Azure Synapse Analytics Workspace 的稽核設定。
...
此命令會透過管道移除名為 ContosoWorkspace 的 Azure Synapse Analytics Workspace 的稽核設定。
