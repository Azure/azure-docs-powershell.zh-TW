...
## 描述
**Stop-AzSynapseSparkStatement Cmdlet** 會取消 Synapse Analytics Spark 語句。
...
此命令會透過管線取消具有指定 利忘識別碼的 Spark 語句。
