...
## 描述
**Get-AzSynapseNotebook** Cmdlet 會取得工作區中筆記本的資訊。 如果您指定筆記本的名稱，Cmdlet 會獲得該筆記本的資訊。 如果您未指定名稱，Cmdlet 會獲得工作區中所有筆記本的資訊。
...
在工作區 ContosoWorkspace 中，獲得所有筆記本的清單。
...
在工作區 ContosoWorkspace 中，獲得名為 ContosoNotebook 的單一筆記本。
...
透過管道在工作區 ContosoWorkspace 中，獲得名為 ContosoNotebook 的單一筆記本。
