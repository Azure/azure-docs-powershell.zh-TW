...
## 描述
**Set-AzSynapseLinkedService** Cmdlet 會連結資料存放區或雲端服務至工作區。
...
此命令在名為 ContosoWorkspace 的工作區中建立名為 ContosoLinkedService 的連結服務。
...
此命令會透過管線在名為 ContosoWorkspace 的工作區中建立名為 ContosoLinkedService 的連結服務。
