...
## 簡介
獲得 Synapse Analytics Workspace 的 Azure AD 系統管理員相關資訊。
...
## 描述
**Get-AzSynapseSqlActiveDirectoryAdministrator** Cmdlet 會取得目前訂閱中 Azure Synapse Analytics Workspace 的 Azure Active Directory (Azure AD) 系統管理員相關資訊。
...
此命令會針對名為 ContosoWorkspace 的工作區，獲得 Azure AD 系統管理員的資訊。
