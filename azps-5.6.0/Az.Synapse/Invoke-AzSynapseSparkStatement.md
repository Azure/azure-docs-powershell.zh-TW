...
## 簡介
會使用 Synapse Analytics Spark 語句。
...
## 描述
**Invoke-AzSynapseSparkStatement Cmdlet** 會調用 Synapse Analytics Spark 語句。
...
這些命令會啟動 Spark 會話，然後透過管線來啟動內嵌 Spark 語句。
...
這些命令會啟動 Spark 會話，然後啟動內嵌 Spark 語句。
...
這些命令會啟動 Spark 會話，然後在檔案中啟動 Spark 語句。
