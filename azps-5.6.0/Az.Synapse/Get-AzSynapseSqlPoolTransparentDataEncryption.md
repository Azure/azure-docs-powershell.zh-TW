...
## 描述
**Get-AzSynapseSqlPoolTransparentDataEncryption** Cmdlet 取得 Azure Synapse Analytics SQL 資料庫的透明資料加密 (TDE) 狀態。
...
此命令會針對名為 ContosoWorkspace 的工作區下名為 ContosoSqlPool 的 SQL 資料庫，獲得 TDE 的狀態。
