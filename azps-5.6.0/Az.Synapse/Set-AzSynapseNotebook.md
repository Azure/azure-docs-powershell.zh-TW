...
## 描述
**Set-AzSynapseNotebook** Cmdlet 會建立或更新工作區中的筆記本。
...
此命令會從名為 ContosoWorkspace 的工作區中的筆記本檔案筆記本.ipynb 建立或更新筆記本。
...
此命令會透過管道從名為 ContosoWorkspace 的工作區中的筆記本檔案 notebook.ipynb 建立或更新筆記本。
...
此命令會從筆記本檔案筆記本.ipynb 建立或更新筆記本，該筆記本會附加到 ContosoSparkPool，並使用名為 ContosoWorkspace 的工作區中的 2 個執行器。
