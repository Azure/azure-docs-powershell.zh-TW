...
## 簡介
刪除 Synapse Analytics Spark 資料庫。
...
## 描述
**Remove-AzSynapseSparkPool Cmdlet** 會永久刪除 Azure Synapse Analytics Spark 資料庫。
...
此命令會刪除 Azure Synapse Analytics Spark 資料庫。
...
此命令會刪除透過管線的 Azure Synapse Analytics Spark 資料庫。
...
此命令會刪除具有資源識別碼的 Azure Synapse Analytics Spark 資料庫。
