...
## 描述
**Remove-AzSynapseSqlPool** Cmdlet 會永久刪除 Azure Synapse Analytics SQL 資料庫。
...
此命令會刪除 Azure Synapse Analytics SQL 資料庫。
...
此命令會透過管線刪除 Azure Synapse Analytics SQL 資料庫。
...
此命令會刪除具有指定資源識別碼的 Azure Synapse Analytics SQL 資料庫。
