...
## 簡介
會取回可還原 Synapse Analytics SQL 資料庫的明顯還原點。
...
## 描述
**Get-AzSynapseSqlPoolRestorePoint** Cmdlet 會從 Azure Synapse Analytics SQL 資料庫還原到不同的還原點。
...
此命令會針對名為 ContosoSqlPool 的 Azure Synapse Analytics SQL Pool，會返回所有可用的還原點。
