...
## 描述
**Stop-AzSynapseSparkSession** Cmdlet 會停止 Synapse Analytics Spark 會話。
...
此命令會停止 Synapse Analytics Spark 會話。
...
此命令會停止透過管線的 Synapse Analytics Spark 會話。
