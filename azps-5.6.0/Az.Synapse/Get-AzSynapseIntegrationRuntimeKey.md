...
## 描述
**Get-AzSynapse RuntimeRuntimeKey** Cmdlet 會取得整合執行時間的金鑰。 這些金鑰是用來註冊整合執行時間節點。
...
Cmdlet 會針對名為"test-selfhost-ir"的整合執行時間來取金鑰。
...
### Microsoft.Azure.Commands.Synapse.Models.PS方格RuntimeKeys
