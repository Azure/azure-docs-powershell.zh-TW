...
## 描述
**Get-AzSynapseRoleAssignment Cmdlet** 會取得 Azure Synapse Analytics 角色指派。
如果您未指定角色定義或使用者主體名稱，此 Cmdlet 會獲得所有角色指派。
...
此命令會獲得工作區 ContosoWorkspace 下所有角色指派與角色名稱 ContosoRole。
...
此命令在工作區 ContosoWorkspace 下獲得角色指派，其角色名稱為 ContosoRole 和使用者主體名稱 ContosoName。
