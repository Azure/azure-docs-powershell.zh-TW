...
## 描述
**Disable-AzSynapseSqlAdvancedDataSecurity** Cmdlet 會停用工作區上的進位資料安全性。
...
此命令會停用名為 ContosoWorkspace 之工作區上的進位資料安全性。
...
此命令會透過管道停用名為 ContosoWorkspace 的工作區上的進位資料安全性。
