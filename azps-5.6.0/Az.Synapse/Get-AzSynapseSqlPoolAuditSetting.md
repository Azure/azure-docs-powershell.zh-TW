...
## 簡介
獲得 Azure Synapse Analytics SQL 資料庫的稽核設定。
...
## 描述
**Get-AzSynapseSqlPoolAuditSetting** Cmdlet 會取得 Azure Synapse Analytics SQL 資料庫的稽核設定。
...
此命令會獲得工作區 ContosoWorkspace 中稱為 ContosoSqlPool 的 SQL 資料庫的稽核設定。
...
此命令會透過管線在工作區 ContosoWorkspace 中，獲得稱為 ContosoSqlPool 的 SQL 資料庫的稽核設定。
