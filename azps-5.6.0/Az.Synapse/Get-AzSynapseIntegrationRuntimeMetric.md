...
## 描述
**Get-AzSynapse RuntimeRuntimeMetric** Cmdlet 會取得工作區中整合執行時間的公制資料。
...
此命令會在名為 ContosoWorkspace 的工作區中顯示名為"test-selfhost-ir"的整合執行時間的公制資料。
...
### Microsoft.Azure.Commands.Synapse.models.PSMetricRuntimeMetrics
