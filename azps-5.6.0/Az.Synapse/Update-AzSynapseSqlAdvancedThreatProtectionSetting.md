...
## 描述
**Update-AzSynapseSqlAdvancedThreatProtectionSetting** Cmdlet 會更新 Azure Synapse Analytics Workspace 上的進一代威脅防護設定。 若要在工作區上啟用進位威脅防護，必須在該工作區上啟用稽核設定。
...
此命令會更新名為 ContosoWorkspace 之工作區的進位威脅防護設定。
