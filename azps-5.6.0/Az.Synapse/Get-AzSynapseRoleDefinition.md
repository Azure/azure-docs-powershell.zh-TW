...
## 描述
**Get-AzSynapseRoleDefinition** Cmdlet 會取得 Azure Synapse Analytics 角色定義。
如果您未指定角色名稱或角色識別碼，此 Cmdlet 會獲得所有角色定義。
...
此命令會獲得 Workspace ContosoWorkspace 下的角色定義，名稱為 ContosoRole。
