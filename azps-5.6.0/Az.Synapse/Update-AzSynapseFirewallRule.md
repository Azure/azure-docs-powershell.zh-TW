...
## 描述
**Update-AzSynapseFirewallRule** Cmdlet 會修改 Azure Synapse Analytics 防火牆規則。
...
此命令會更新工作區 ContosoWorkspace 下名為 ContosoFirewallRule 的防火牆規則，並命名為 ContosoFirewallRule。
...
此命令會透過管線更新工作區下名為 ContosoFirewallRule 的防火牆規則。
