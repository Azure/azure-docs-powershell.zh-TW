...
## 描述
**Remove-AzSynapseLinkedService** Cmdlet 會從工作區移除連結的服務。
...
此命令會從名為 ContosoWorkspace 的工作區移除名為 ContosoLinkedService 的連結服務。
...
此命令會透過管線從名為 ContosoWorkspace 的工作區移除名為 ContosoLinkedService 的連結服務。
