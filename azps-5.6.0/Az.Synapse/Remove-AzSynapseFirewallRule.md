...
## 描述
**Remove-AzSynapseFirewallRule** Cmdlet 會永久刪除 Azure Synapse Analytics 防火牆規則。
...
此命令會刪除工作區 ContosoWorkspace 下名為 ContosoFirewallRule 與名稱 ContosoFirewallRule 的防火牆規則。
...
此命令會透過管線刪除工作區下名為 ContosoFirewallRule 的防火牆規則。
