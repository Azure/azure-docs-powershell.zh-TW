...
## 描述
**Get-AzSynapseTriggerRun** 命令會針對指定時間範圍內指定的觸發程式，會針對觸發程式執行，以取得詳細資訊。
...
此命令會顯示在 「2018-09-01T21：00」和「2019-09-01T21：00」之間開始之工作區 ContosoTrigger 執行的資訊。
...
此命令會顯示在工作區 ContosoWorkspace 中，從 「2018-09-01T21：00」到「2019-09-01T21：00」透過管線開始執行 ContosoTrigger 的資訊。
