...
## 簡介
移除 Synapse Analytics Workspace 的 Azure AD 系統管理員。
...
## 描述
**Remove-AzSynapseSqlActiveDirectoryAdministrator** Cmdlet 會移除 Azure Synapse Analytics Workspace 的 Azure Active Directory (Azure AD) 系統管理員。
...
此命令會移除名為 ContosoWorkspace 之工作區的 Azure AD 系統管理員。
