...
## 簡介
變更 Azure Synapse Analytics Workspace 的稽核設定。
...
## 描述
**Set-AzSynapseSqlAuditSetting** Cmdlet 會變更 Azure Synapse Analytics Workspace 的稽核設定。
...
啟用名為 ContosoWorkspace 的 Azure Synapse Analytics Workspace 的 Blob 儲存稽核原則。
...
停用名為 ContosoWorkspace 之 Azure Synapse Analytics Workspace 的 Blob 儲存稽核原則。
...
啟用 Azure Synapse Analytics Workspace 的 Blob 儲存稽核原則，該工作區名為 ContosoWorkspace，使用 T-SQL 謂詞進行進一級的篩選。
...
從名為 ContosoWorkspace 的 Azure Synapse Analytics Workspace 稽核原則移除進位篩選設定。
...
透過管道停用名為 ContosoWorkspace 的 Azure Synapse Analytics Workspace 的 Blob 儲存稽核原則。
