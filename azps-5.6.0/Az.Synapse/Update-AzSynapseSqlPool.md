...
## 描述
**Update-AzSynapseSqlPool** Cmdlet 會更新 Azure Synapse Analytics SQL 資料庫。
...
此命令會更新 Azure Synapse Analytics SQL 資料庫。
...
此命令會透過管線更新 Azure Synapse Analytics SQL 資料庫。
...
此命令會以資源識別碼更新 Azure Synapse Analytics SQL 資料庫。
