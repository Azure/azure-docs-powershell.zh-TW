...
## 描述
**Get-AzSynapseFirewallRule** Cmdlet 會取得 Azure Synapse Analytics Firewall Rule。
如果您未指定規則名稱，此 Cmdlet 會獲得所有規則。
...
此命令會獲得工作區 ContosoWorkspace 下的防火牆規則，名稱為 ContosoFirewallRule。
