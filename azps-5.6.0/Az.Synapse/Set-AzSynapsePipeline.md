...
## 描述
**Set-AzSynapsePipeline** Cmdlet 會建立工作區中的管線。
...
此命令在名為 ContosoWorkspace 的工作區中建立名為 ContosoPipeline 的管線。
命令會依據檔案中pipeline.js的資訊。
此檔案包含活動相關資訊。
...
此命令在名為 ContosoWorkspace 的工作區中，透過管線建立名為 ContosoPipeline 的管線。
命令會依據檔案中pipeline.js的資訊。
此檔案包含活動相關資訊。
