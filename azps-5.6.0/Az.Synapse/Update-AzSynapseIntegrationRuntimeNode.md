...
## 描述
**Update-AzSynapse RuntimeRuntimeNode** Cmdlet 會更新工作區中自我託管整合執行時間節點的屬性。 目前僅支援更新 'ConcurrentJobsLimit'。
...
### Microsoft.Azure.Commands.Synapse.Models.PSSelfHosted方格RuntimeStatus
