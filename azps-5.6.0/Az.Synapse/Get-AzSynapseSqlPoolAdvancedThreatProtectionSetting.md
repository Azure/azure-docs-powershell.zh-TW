...
## 描述
**Get-AzSynapseSqlPoolAdvancedThreatProtectionSetting** Cmdlet 取得 Azure Synapse Analytics SQL 資料庫的進一代威脅防護設定。
...
此命令會針對名為 ContosoWorkspace 的工作區下名為 ContosoSqlPool 的 SQL 資料庫，獲得進一步的威脅防護設定。
