...
## 描述
**Get-AzSynapseSqlPool** Cmdlet 會取得 Azure Synapse Analytics SQL 資料庫相關資訊。
...
此命令會獲得工作區 ContosoWorkspace 下的 SQL 資料庫，名稱為 ContosoSqlPool。
...
### -版本
[此功能在有限的預覽版中，一開始只有特定訂閱才能使用。]Synapse SQL 資料庫的版本。 例如 2 或 3。
