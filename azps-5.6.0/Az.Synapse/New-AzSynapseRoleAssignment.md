...
## 描述
**New-AzSynapseRoleAssignment Cmdlet** 會建立 Azure Synapse Analytics 角色指派。
...
此命令會指派 ContosoRole 給主體名稱為 ContosoName 的使用者。
...
此命令會指派 ContosoRole 給使用者，其主體名稱為 ContosoName 透過管線。
