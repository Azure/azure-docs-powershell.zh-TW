...
## 描述
**Get-AzSynapseSparkStatement Cmdlet** 會取得有關 Azure Synapse Analytics Spark 語句的資訊。
...
此命令會透過管線，在 Spark 會話下獲得所有 Spark 語句。
