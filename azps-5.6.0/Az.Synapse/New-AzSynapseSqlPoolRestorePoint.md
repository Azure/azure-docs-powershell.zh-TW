...
## 簡介
在 Azure Synapse Analytics SQL 資料庫中建立新還原點。
...
## 描述
**New-AzSynapseSqlPoolRestorePoint** Cmdlet 會建立一個新的還原點，以還原 Azure Synapse Analytics SQL 資料庫。
...
此命令為工作區 ContosoWorkspace 中的 SQL 資料庫建立還原點，稱為 ContosoSqlPool。
