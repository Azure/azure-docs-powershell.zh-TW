...
## 描述
此Get-AzAnalysisServicesServer Cmdlet 會獲得 Analysis Services 伺服器的詳細資訊。
...
此命令會獲得資源群組中名為 ResourceGroup03 的所有 Azure Analysis Services 伺服器。
...
此命令會獲得名為 ResourceGroup03 的資源群組中名為 testserver 的 Azure Analysis Services 伺服器。
