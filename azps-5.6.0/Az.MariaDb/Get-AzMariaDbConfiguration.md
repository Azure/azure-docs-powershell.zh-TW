...
ms.locfileid: "101906590"
---
# <span data-ttu-id="b7720-101">Get-AzMariaDbConfiguration</span><span class="sxs-lookup"><span data-stu-id="b7720-101">Get-AzMariaDbConfiguration</span></span>

## <span data-ttu-id="b7720-102">簡介</span><span class="sxs-lookup"><span data-stu-id="b7720-102">SYNOPSIS</span></span>
<span data-ttu-id="b7720-103">獲得伺服器組配置的資訊。</span><span class="sxs-lookup"><span data-stu-id="b7720-103">Gets information about a configuration of server.</span></span>

## <span data-ttu-id="b7720-104">語法</span><span class="sxs-lookup"><span data-stu-id="b7720-104">SYNTAX</span></span>

### <span data-ttu-id="b7720-105">清單 (預設) </span><span class="sxs-lookup"><span data-stu-id="b7720-105">List (Default)</span></span>
```
Get-AzMariaDbConfiguration -ResourceGroupName <String> -ServerName <String> [-SubscriptionId <String[]>]
 [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### <span data-ttu-id="b7720-106">獲取</span><span class="sxs-lookup"><span data-stu-id="b7720-106">Get</span></span>
```
Get-AzMariaDbConfiguration -Name <String> -ResourceGroupName <String> -ServerName <String>
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### <span data-ttu-id="b7720-107">GetViaIdentity</span><span class="sxs-lookup"><span data-stu-id="b7720-107">GetViaIdentity</span></span>
```
Get-AzMariaDbConfiguration -InputObject <IMariaDbIdentity> [-DefaultProfile <PSObject>] [<CommonParameters>]
```

## <span data-ttu-id="b7720-108">描述</span><span class="sxs-lookup"><span data-stu-id="b7720-108">DESCRIPTION</span></span>
<span data-ttu-id="b7720-109">獲得伺服器組配置的資訊。</span><span class="sxs-lookup"><span data-stu-id="b7720-109">Gets information about a configuration of server.</span></span>

## <span data-ttu-id="b7720-110">例子</span><span class="sxs-lookup"><span data-stu-id="b7720-110">EXAMPLES</span></span>

### <span data-ttu-id="b7720-111">範例 1：在 MariaDB 下列出所有組</span><span class="sxs-lookup"><span data-stu-id="b7720-111">Example 1: List all configuration under a MariaDB</span></span>
```powershell
...
<span data-ttu-id="b7720-112">此命令會列出 MariaDB 下的所有組配置。</span><span class="sxs-lookup"><span data-stu-id="b7720-112">This command lists all configuration under a MariaDB.</span></span>

### <span data-ttu-id="b7720-113">範例 2：取得 MariaDB 的組配置</span><span class="sxs-lookup"><span data-stu-id="b7720-113">Example 2: Get a configuration of MariaDB</span></span>
```powershell
...
<span data-ttu-id="b7720-114">此命令會獲得 MariaDB 的組配置。</span><span class="sxs-lookup"><span data-stu-id="b7720-114">This command gets a configuration of MariaDB.</span></span>

## <span data-ttu-id="b7720-115">參數</span><span class="sxs-lookup"><span data-stu-id="b7720-115">PARAMETERS</span></span>

### <span data-ttu-id="b7720-116">-DefaultProfile</span><span class="sxs-lookup"><span data-stu-id="b7720-116">-DefaultProfile</span></span>
<span data-ttu-id="b7720-117">用於與 Azure 通訊的認證、帳戶、租使用者和訂閱。</span><span class="sxs-lookup"><span data-stu-id="b7720-117">The credentials, account, tenant, and subscription used for communication with Azure.</span></span>
...
### <span data-ttu-id="b7720-118">-InputObject</span><span class="sxs-lookup"><span data-stu-id="b7720-118">-InputObject</span></span>
<span data-ttu-id="b7720-119">身分識別參數若要建構，請參閱 INPUTOBJECT 屬性的 NOTES 區段，並建立雜湊表。</span><span class="sxs-lookup"><span data-stu-id="b7720-119">Identity Parameter To construct, see NOTES section for INPUTOBJECT properties and create a hash table.</span></span>
...
### <span data-ttu-id="b7720-120">-名稱</span><span class="sxs-lookup"><span data-stu-id="b7720-120">-Name</span></span>
<span data-ttu-id="b7720-121">伺服器組名。</span><span class="sxs-lookup"><span data-stu-id="b7720-121">The name of the server configuration.</span></span>
...
### <span data-ttu-id="b7720-122">-ResourceGroupName</span><span class="sxs-lookup"><span data-stu-id="b7720-122">-ResourceGroupName</span></span>
<span data-ttu-id="b7720-123">包含資源的資源組名。</span><span class="sxs-lookup"><span data-stu-id="b7720-123">The name of the resource group that contains the resource.</span></span>
<span data-ttu-id="b7720-124">您可以從 Azure Resource Manager API 或入口網站取得此值。</span><span class="sxs-lookup"><span data-stu-id="b7720-124">You can obtain this value from the Azure Resource Manager API or the portal.</span></span>
...
### <span data-ttu-id="b7720-125">-ServerName</span><span class="sxs-lookup"><span data-stu-id="b7720-125">-ServerName</span></span>
<span data-ttu-id="b7720-126">伺服器名稱。</span><span class="sxs-lookup"><span data-stu-id="b7720-126">The name of the server.</span></span>
...
### <span data-ttu-id="b7720-127">-SubscriptionId</span><span class="sxs-lookup"><span data-stu-id="b7720-127">-SubscriptionId</span></span>
<span data-ttu-id="b7720-128">可識別 Azure 訂閱的訂閱識別碼。</span><span class="sxs-lookup"><span data-stu-id="b7720-128">The subscription ID that identifies an Azure subscription.</span></span>
...
### <span data-ttu-id="b7720-129">CommonParameters</span><span class="sxs-lookup"><span data-stu-id="b7720-129">CommonParameters</span></span>
<span data-ttu-id="b7720-130">此 Cmdlet 支援常見的參數：-Debug、-ErrorAction、-ErrorVariable、-InformationAction、-InformationVariable、-OutVariable、-OutBuffer、-PipelineVariable、-Verbose、-WarningAction 和 -WarningVariable。</span><span class="sxs-lookup"><span data-stu-id="b7720-130">This cmdlet supports the common parameters: -Debug, -ErrorAction, -ErrorVariable, -InformationAction, -InformationVariable, -OutVariable, -OutBuffer, -PipelineVariable, -Verbose, -WarningAction, and -WarningVariable.</span></span> <span data-ttu-id="b7720-131">詳細資訊[請參閱about_CommonParameters。](http://go.microsoft.com/fwlink/?LinkID=113216)</span><span class="sxs-lookup"><span data-stu-id="b7720-131">For more information, see [about_CommonParameters](http://go.microsoft.com/fwlink/?LinkID=113216).</span></span>

## <span data-ttu-id="b7720-132">輸入</span><span class="sxs-lookup"><span data-stu-id="b7720-132">INPUTS</span></span>

### <span data-ttu-id="b7720-133">Microsoft.Azure.PowerShell.Cmdlets.MariaDb.models.IAzaDbIdentity</span><span class="sxs-lookup"><span data-stu-id="b7720-133">Microsoft.Azure.PowerShell.Cmdlets.MariaDb.Models.IMariaDbIdentity</span></span>

## <span data-ttu-id="b7720-134">輸出</span><span class="sxs-lookup"><span data-stu-id="b7720-134">OUTPUTS</span></span>

### <span data-ttu-id="b7720-135">Microsoft.Azure.PowerShell.Cmdlets.MariaDb.Models.Api20180601Preview.IConfiguration</span><span class="sxs-lookup"><span data-stu-id="b7720-135">Microsoft.Azure.PowerShell.Cmdlets.MariaDb.Models.Api20180601Preview.IConfiguration</span></span>

## <span data-ttu-id="b7720-136">筆記</span><span class="sxs-lookup"><span data-stu-id="b7720-136">NOTES</span></span>

<span data-ttu-id="b7720-137">別名</span><span class="sxs-lookup"><span data-stu-id="b7720-137">ALIASES</span></span>

<span data-ttu-id="b7720-138">複雜的參數屬性</span><span class="sxs-lookup"><span data-stu-id="b7720-138">COMPLEX PARAMETER PROPERTIES</span></span>

<span data-ttu-id="b7720-139">若要建立下列描述的參數，請建構包含適當屬性的雜湊表。</span><span class="sxs-lookup"><span data-stu-id="b7720-139">To create the parameters described below, construct a hash table containing the appropriate properties.</span></span> <span data-ttu-id="b7720-140">有關雜湊表的資訊，請執行Get-Help about_Hash_Tables。</span><span class="sxs-lookup"><span data-stu-id="b7720-140">For information on hash tables, run Get-Help about_Hash_Tables.</span></span>


<span data-ttu-id="b7720-141">INPUTOBJECT： <IMariaDbIdentity> 身分識別參數</span><span class="sxs-lookup"><span data-stu-id="b7720-141">INPUTOBJECT <IMariaDbIdentity>: Identity Parameter</span></span>
  - <span data-ttu-id="b7720-142">`[ConfigurationName <String>]`：伺服器組組的名稱。</span><span class="sxs-lookup"><span data-stu-id="b7720-142">`[ConfigurationName <String>]`: The name of the server configuration.</span></span>
  - <span data-ttu-id="b7720-143">`[DatabaseName <String>]`：資料庫的名稱。</span><span class="sxs-lookup"><span data-stu-id="b7720-143">`[DatabaseName <String>]`: The name of the database.</span></span>
  - <span data-ttu-id="b7720-144">`[FirewallRuleName <String>]`：伺服器防火牆規則的名稱。</span><span class="sxs-lookup"><span data-stu-id="b7720-144">`[FirewallRuleName <String>]`: The name of the server firewall rule.</span></span>
  - <span data-ttu-id="b7720-145">`[Id <String>]`：資源識別路徑</span><span class="sxs-lookup"><span data-stu-id="b7720-145">`[Id <String>]`: Resource identity path</span></span>
  - <span data-ttu-id="b7720-146">`[LocationName <String>]`：位置的名稱。</span><span class="sxs-lookup"><span data-stu-id="b7720-146">`[LocationName <String>]`: The name of the location.</span></span>
  - <span data-ttu-id="b7720-147">`[ResourceGroupName <String>]`：包含資源的資源組名。</span><span class="sxs-lookup"><span data-stu-id="b7720-147">`[ResourceGroupName <String>]`: The name of the resource group that contains the resource.</span></span> <span data-ttu-id="b7720-148">您可以從 Azure Resource Manager API 或入口網站取得此值。</span><span class="sxs-lookup"><span data-stu-id="b7720-148">You can obtain this value from the Azure Resource Manager API or the portal.</span></span>
  - <span data-ttu-id="b7720-149">`[SecurityAlertPolicyName <SecurityAlertPolicyName?>]`：安全性警示策略的名稱。</span><span class="sxs-lookup"><span data-stu-id="b7720-149">`[SecurityAlertPolicyName <SecurityAlertPolicyName?>]`: The name of the security alert policy.</span></span>
  - <span data-ttu-id="b7720-150">`[ServerName <String>]`：伺服器名稱。</span><span class="sxs-lookup"><span data-stu-id="b7720-150">`[ServerName <String>]`: The name of the server.</span></span>
  - <span data-ttu-id="b7720-151">`[SubscriptionId <String>]`：識別 Azure 訂閱的訂閱識別碼。</span><span class="sxs-lookup"><span data-stu-id="b7720-151">`[SubscriptionId <String>]`: The subscription ID that identifies an Azure subscription.</span></span>
  - <span data-ttu-id="b7720-152">`[VirtualNetworkRuleName <String>]`：虛擬網路規則的名稱。</span><span class="sxs-lookup"><span data-stu-id="b7720-152">`[VirtualNetworkRuleName <String>]`: The name of the virtual network rule.</span></span>

## <span data-ttu-id="b7720-153">相關連結</span><span class="sxs-lookup"><span data-stu-id="b7720-153">RELATED LINKS</span></span>
