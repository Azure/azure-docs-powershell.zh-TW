...
### 範例 1：根據伺服器名稱還原 PointInTime MariaDB。
```powershell
...
此命令會按伺服器名稱還原 PointInTime MariaDB。

### 範例 2：根據伺服器物件還原 PointInTime MariaDB
```powershell
...
此命令會按伺服器物件還原 PointInTime MariaDB。
