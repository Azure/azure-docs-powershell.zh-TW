...
### CognitiveServicesEncryption (預設) 
```
...
## 描述
**Set-AzCognitiveServicesAccount** Cmdlet 會修改指定認知服務帳戶的 SKU 或標籤。
...
### -ApiProperty
認知服務帳戶的 ApiProperties。 這是特定帳戶類型所要求。
...
### -AssignIdentity
為此儲存空間帳戶產生並指派新的認知服務帳戶身分識別，以用於 Azure KeyVault 等重要管理服務。
...
是否要將認知服務帳戶加密金鑰Source 設定為 Microsoft.CognitiveServices。
...
### -KeyName
認知服務帳戶加密金鑰Source KeyVault KeyName
...
### -KeyVaultEncryption
是否要將認知服務帳戶加密金鑰Source 設定為 Microsoft.KeyVault。 如果您指定 KeyName、KeyVersion 和 KeyVaultUri，則認知服務帳戶加密金鑰Source 也會設定為 Microsoft.KeyVault 天氣此參數為設定或不設定。
...
### -KeyVaultUri
認知服務帳戶加密金鑰Source KeyVault KeyVaultUri
...
### -KeyVersion
認知服務帳戶加密金鑰Source KeyVault KeyVersion
...
### -NetworkRuleSet
NetworkRuleSet 可用來定義一組防火牆和虛擬網路的組組設定規則，以及設定網路屬性值，例如如何處理與任何已定義規則不相符的要求
