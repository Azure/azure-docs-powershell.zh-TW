...
## 描述
啟用 Az 模組的 AzureRm 首碼別名。 如果指定 -Module，則只有列出的模組會啟用別名。 否則會啟用所有 AzureRm 別名。
...
針對目前程式與目前使用者啟用 Az.Accounts 模組的 AzureRm 別名。
