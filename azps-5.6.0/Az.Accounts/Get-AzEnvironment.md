...
## 描述
Cmdlet Get-AzEnvironment會獲得 Azure 服務實例的端點和中繼資料。

## 例子

### 範例 1：取得 AzureCloud 環境
```
...
此範例顯示如何取得 AzureCloud (預設環境) 中繼資料。

### 範例 2：取得 AzureChinaCloud 環境
```
...
此範例顯示如何取得 AzureChinaCloud 環境的端點和中繼資料。

### 範例 3：取得 AzureUSGovernment 環境
```
...
此範例顯示如何取得 AzureUSGovernment 環境的端點和中繼資料。
