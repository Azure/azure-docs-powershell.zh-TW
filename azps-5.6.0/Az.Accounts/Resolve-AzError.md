...
## 描述
解決並顯示目前 PowerShell 會話中錯誤的詳細資訊，包括錯誤在腳本中發生的位置、堆疊追蹤，以及所有內部及匯總例外。 針對 Azure PowerShell 錯誤提供其他詳細資料，可解決服務問題，包括要求的完整詳細資料，以及導致錯誤的伺服器回應。
...
### -錯誤
一或多個要解決的錯誤記錄。  如果沒有指定參數，會話的所有錯誤都一併解決。
...
### Microsoft.Azure.Commands.Profile.Errors.AzureAzCeptionRecord
