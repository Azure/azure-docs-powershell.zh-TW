...
## 描述
**Get-AzResourceLock** Cmdlet 會取得 Azure 資源鎖定。
...
此命令會獲得名為 ContosoSiteLock 的資源鎖定。

### 範例 2：取得資源群組層級或更高版本的鎖定
```
...
### -AtScope
表示此 Cmdlet 會返回指定範圍或上方的所有鎖定。
如果您未指定此參數，Cmdlet 會于範圍上方或下方，會返回所有鎖定。
