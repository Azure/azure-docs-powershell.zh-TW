...
## 描述
**Set-AzManagedApplication** Cmdlet 會更新受管理的應用程式
...
### -Id
完整受管理的應用程式識別碼，包括訂閱。 例如/subscriptions/{subscriptionId}/resourcegroups/{resourceGroupName
...
### -Parameter
受管理應用程式的 JSON 格式化參數字串。
這可以是檔案名或包含參數的 uri 路徑，或參數為字串。
