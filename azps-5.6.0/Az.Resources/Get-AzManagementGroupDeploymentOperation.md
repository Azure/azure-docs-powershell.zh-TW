...
## 描述
**Get-AzManagementGroupDeploymentOperation Cmdlet** 會列出屬於管理群組部署的所有作業，可協助識別特定部署失敗的確切作業，並提供有關其詳細資訊。
...
在管理群組 "myMG" 使用名稱 "Deploy01" 進行部署作業。
...
此命令會取得管理群組 「myMG」的部署「部署01」，並取得其部署作業。
