...
## 描述
**Get-AzResourceProvider Cmdlet** 會取得 Azure 資源提供者。

## 例子

### 範例 1：取得以目前訂閱註冊的所有資源提供者
...
### 範例 2：從特定 ProviderNamespace 取得所有資源提供者詳細資料
...
此命令會獲得 "Microsoft.Compute" 下的所有資源提供者。

### 範例 3：從特定 ProviderNamespace 陣列取得所有資源提供者詳細資料
...
此命令會獲得 "Microsoft.Compute" 和 "Microsoft.Network" 下的所有資源提供者。
