...
將物件識別碼為 "D9076BBC-D62C-4105-9C78-A7F5BC4A3405" 的使用者從物件識別碼為 '85F89C90-780E-4AA6-9F4F-6F268D322EEE'的群組移除。
...
使用物件識別碼為 '85F89C90-780E-4AA6-9F4F-6F268D322EEE' 的群組，並管道到 Remove-AzADGroupMember Cmdlet，將使用者移除至該群組。
