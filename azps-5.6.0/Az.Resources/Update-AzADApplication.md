...
將應用程式顯示名稱與物件識別碼 'fb7b3405-ca44-4b5b-8584-12392f5d96d7' 更新為 'MyNewDisplayName'。
...
以物件識別碼 'fb7b3405-ca44-4b5b-8584-12392f5d96d7'更新應用程式的屬性。
...
使用物件識別碼 'fb7b3405-ca44-4b5b-8584-12392f5d96d7' 和管道到 Update-AzADApplication Cmdlet 的應用程式，將應用程式的顯示名稱更新為 "MyNewDisplayName"。
...
### -AvailableToTentenants
如果應用程式與其他租使用者共用，則為 True;否則，為 False。
...
### -ReplyUrl
指定使用者權杖要送出以用於登錄的 URL，或 OAuth 2.0 授權碼和存取權杖所寄往的重新導向 URI。
