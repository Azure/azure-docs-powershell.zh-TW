...
## 描述
**Set-AzManagedApplicationDefinition** Cmdlet 會更新受管理的應用程式定義
...
### -授權
受管理的應用程式定義授權。
逗號分隔授權組的格式為 \<principalId\> ：\<roleDefinitionId\>
...
### -Id
完整受管理的應用程式定義識別碼，包括訂閱。 例如/subscriptions/{subscriptionId}/resourcegroups/{resourceGroupName
