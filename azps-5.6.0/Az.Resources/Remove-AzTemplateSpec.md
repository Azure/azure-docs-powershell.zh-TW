...
## 描述
移除指定的範本規格。如果提供版本 **-版本** 參數，則只會移除指定的版本。 如果沒有提供特定版本，將會移除範本規格及其所有版本。 如果 **-Force** 旗標存在，則沒有移除的確認提示。
...
移除資源群組 "myRG" 中名為 "MyTemplateSpec" 的範本規格版本 'v1.0'。
...
移除訂閱子Id 之資源群組 "myRG" 中名為 "MyTemplateSpec" 的範本規格 'v1.0'。 \{ \}
...
移除名為 "MyTemplateSpec" 的範本規格，以及資源群組 "myRG" 內的所有版本。

### 範例 3：移除範本規格，以及根據資源識別碼移除所有版本
```powershell
...
移除名為 "MyTemplateSpec" 的範本規格及其訂閱子Id 資源群組 "myRG" \{ 內的所有版本 \} 。
