...
## 描述
**Get-AzPolicySetDefinition Cmdlet** 會取得一組由名稱或識別碼識別之策略集定義或特定策略集定義的集合。
...
### 範例 2：根據名稱從目前的訂閱取得策略集定義
```
PS C:\> Get-AzPolicySetDefinition -Name 'VMPolicySetDefinition'
```

此命令會從目前的預設訂閱中，獲得名為 VMPolicySetDefinition 的組定義。
...
此命令會從訂閱中，從 ID 3bf44b72-c631-427a-b8c8-53e2595398ca 的訂閱中，獲得名為 VMPolicySetDefinition 的策略定義。

### 範例 4：從管理群組取得所有自訂策略集定義
```
PS C:\> Get-AzPolicySetDefinition -ManagementGroupName 'Dept42' -Custom
```

此命令會從名為 Dept42 的管理群組中，獲得所有自訂策略集定義。
...
此命令會獲得類別 "Virtual Machine" 的所有策略集定義。
