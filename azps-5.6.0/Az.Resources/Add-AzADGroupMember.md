...
### 範例 1：根據物件識別碼將使用者新增到群組

```powershell
PS C:\> Add-AzADGroupMember -MemberObjectId D9076BBC-D62C-4105-9C78-A7F5BC4A3405 -TargetGroupObjectId 85F89C90-780E-4AA6-9F4F-6F268D322EEE
```

將具有物件識別碼 "D9076BBC-D62C-4105-9C78-A7F5BC4A3405" 的使用者新增到物件識別碼為 '85F89C90-780E-4AA6-9F4F-6F268D322EEE'的群組。
...
使用物件識別碼為 '85F89C90-780E-4AA6-9F4F-6F268D322EEE' 的群組，並管道到 Add-AzADGroupMember Cmdlet，將使用者新增到該群組。

### 範例 3：根據主體名稱將使用者新增到群組
