...
### -NetworkBlock
您訂閱和內部部署中的 VNet 位址區塊應該是唯一的。
確認 CIDR 格式符合 (A.B.C.D/X) 其中 A、B、C、D 介於 0 到 255 之間，而 X 介於 0 到 22 之間
...
### -NsxtPassword
或者，在建立私人雲端時設定 NSX-T Manager 密碼
