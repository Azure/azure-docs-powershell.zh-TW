...
## 描述
此Set-AzEventHubNamespace Cmdlet 會更新指定事件中樞命名空間的屬性。
...
將命名空間 \` MyNamespaceName 的標記更新 \` 為已建立。
...
### -KeyProperty
Key Properties 清單、@ (@ (KeyName、KeyVaultUri、Keyversion) 、@ (KeyName、KeyVaultUri、Keyversion) ) 
...
啟用 AutoInflate 時，輸送量單位的上限，值應在 0 到 20 個輸送量單位內。
...
### System.Nullable'1[[Microsoft.Azure.Commands.EventHub.models.命名空間狀態，Microsoft.Azure.PowerShell.Cmdlets.EventHub， Version=1.4.3.0， Culture=neutral， PublicKeyToken=null]]
