...
## 描述
**New-AzEventHubGeoDRConfiguration** Cmdlet 會建立新的別名 (復原組) 
...
使用次要命名空間 "SampleNamespace_Primary" 建立具有主要命名空間 "SampleNamespace_Secondary" 的別名 "sampleDRConfigName"

## 參數

### -AlternateName
DR 組名與主要命名空間相同時，需要替代名稱
...
### -PartnerNamespace
DR Configuration PartnerNamespace ARM 識別碼
