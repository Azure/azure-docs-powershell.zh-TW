...
此命令會獲得資源群組中的 Datab一s 工作區。

### 範例 2：列出訂閱中所有的 Datab一s 工作區
```powershell
...
此命令會列出訂閱中所有 Datab一s 工作區。

### 範例 3：列出資源群組中所有 Datab一s 工作區
```powershell
...
此命令會列出資源群組中所有 Datab workspaces。
