...
如果您想要Update-AzMySqlFlexibleServerConfiguration伺服器參數 ，例如補救伺服器參數，wait_timeout或net_retry_count。
...
### -SKU
SKU 的名稱，通常是 tier + family + cores，例如Burstable_B1ms、Standard_D2ds_v4
