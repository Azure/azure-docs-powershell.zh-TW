...
此 Cmdlet 會按資源名稱獲得 MySql 伺服器。

### 範例 2：根據身分識別取得 MySql 資料庫
```powershell
...
此 Cmdlet 會以身分識別獲得 MySql 伺服器。

### 範例 3：列出指定伺服器中所有的 MySql 資料庫
```powershell
...
此 Cmdlet 會列出指定伺服器中所有的 MySql 伺服器。
