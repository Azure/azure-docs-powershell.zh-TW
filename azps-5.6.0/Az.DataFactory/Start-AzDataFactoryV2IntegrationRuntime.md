...
## 描述
**Start-AzDataFactoryV2 RuntimeRuntime** Cmdlet 會啟動受管理的專用整合執行時間。 資源已配置完成，且作業之後的狀態為'開始」。
...
此 Cmdlet 會啟動名為"test-dedicated-ir"的受管理專用整合執行時間。
...
### Microsoft.Azure.Commands.DataFactoryV2.models.PSManagedFactorRuntimeStatus

## 筆記

## 相關連結

[Stop-AzDataFactoryV2FactoryRuntime]()
