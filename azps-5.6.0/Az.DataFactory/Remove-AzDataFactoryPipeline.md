...
## 描述
**Remove-AzDataFactoryPipeline** Cmdlet 會從 Azure Data Factory 移除管線。
...
此 Cmdlet 會從名為 WikiADF 的資料工廠移除名為DPWikisample 的管線。
命令會返回 $True。
