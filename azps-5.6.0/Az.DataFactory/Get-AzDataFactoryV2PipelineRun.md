...
## 描述
**Get-AzDataFactoryV2PipelineRun** 命令會針對指定的管線，會傳送執行相關資訊。 如果指定 PipelineRunId，它會以該識別碼顯示執行詳細資料。 如果未指定 PipelineRunId，則會顯示 LastUpdatedAfter 和 LastUpdatedBefore 值之間發生之管線的所有執行資訊。
