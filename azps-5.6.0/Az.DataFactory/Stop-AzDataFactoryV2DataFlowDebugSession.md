...
## 簡介
在 Azure Data Factory 中停止資料流程的 Debug 會話
...
## 描述
此命令會停止 Debug 會話，如果沒有的話，系統就會根據該 Debug 會話的 Time To Live 設定自動關閉會話。
...
```
在資料工廠 "WikiADF" 中停止資料流程的 「fd76cd0d-8b37-4dc0-a370-3f9d43ac686d」
