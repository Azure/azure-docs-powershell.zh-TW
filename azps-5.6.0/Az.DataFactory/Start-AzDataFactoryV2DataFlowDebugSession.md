...
## 簡介
在 Azure Data Factory 中啟動資料流程的 Debug 會話
...
## 描述
這個長時間執行的命令會針對即將開始的 Debug 命令啟動資料流程的 Debug 會話。 此命令可以附加整合執行時間定義，以設定 Debug 會話組的大小/類型。
...
### Microsoft.Azure.Commands.DataFactoryV2.Models.PSDFlowDeSession
