...
## 描述
**Get-AzDataFactoryV2 RuntimeRuntimeNode** Cmdlet 會取得整合執行時間節點的詳細資訊。

## 例子

### 範例 1：獲得整合執行時間節點的詳細資料。
```
...
Cmdlet 會從 data factory 'test-df-eu2'的自行託管整合執行時間'test-selfhost-ir'中，獲得名為 "Node_1" 的節點資訊。

### 範例 2：使用 IP 位址一併獲取整合執行時間節點的詳細資料。
```
...
Cmdlet 會從 data factory 'test-df-eu2'的自我託管整合執行時間 'test-selfhost-ir'中，獲得名為 "Node_1" 的節點資訊，包括 IP 位址。
...
### Microsoft.Azure.Commands.DataFactoryV2.models.PSManagedFactorRuntimeNode

### Microsoft.Azure.Commands.DataFactoryV2.models.PSSelfHosted方格RuntimeNode
