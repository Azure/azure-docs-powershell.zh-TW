...
## 描述
**Stop-AzDataFactoryV2TriggerRun** Cmdlet 會停止以觸發程式名稱指定的資料工廠中的觸發程式執行，並觸發執行識別碼。
目前僅支援 WaitingOnDependency 狀態中的 WindowTriggers。
...
此命令會停止觸發程式在工廠 WikiADF 中以 id 為 '0858600246800588497807248799CU16'執行。
