...
## 簡介
使用 Azure Data Factory 取得所有使用中資料流程的 Debug 會話
...
## 描述
列出 Azure Data Factory 的所有使用中資料流程 Debug 會話，並包含詳細資料。
...
取得 Azure Data Factory "WikiADF" 中所有使用中資料流程的 Debug 會話。
...
### Microsoft.Azure.Commands.DataFactoryV2.Models.PSDFlowDesessionInfo
