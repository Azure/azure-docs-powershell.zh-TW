...
## 描述
**Remove-AzDataFactoryGateway** Cmdlet 會從 Azure Data Factory 移除指定的閘道。
...
此命令會從名為 WikiADF 的資料工廠移除名為 ContosoGateway 的閘道。

## 參數

### -DataFactory
指定 **PSDataFactory** 物件。
此 Cmdlet 會從此參數指定的資料工廠移除閘道。
