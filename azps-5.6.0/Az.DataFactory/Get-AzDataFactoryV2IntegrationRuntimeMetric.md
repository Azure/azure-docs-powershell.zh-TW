...
## 描述
Cmdlet Get-AzDataFactoryV2IntegrationRuntimeMetric在資料工廠中獲得整合執行時間的公制資料。
...
此命令會在名為'rg-test-dfv2'及名為'test-df-eu2'的資料工廠之資源群組訂閱中，顯示名為"test-selfhost-ir"之整合執行時間的計量資料。
...
### Microsoft.Azure.Commands.DataFactoryV2.models.PSMetricRuntimeMetrics
