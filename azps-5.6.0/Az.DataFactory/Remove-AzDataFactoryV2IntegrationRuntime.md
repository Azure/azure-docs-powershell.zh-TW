...
## 描述
Cmdlet Remove-AzDataFactoryV2IntegrationRuntime移除整合執行時間。
...
此命令會從名為"test-df"的資料工廠移除名為"test-reserved-ir"的整合執行時間。
此命令會返回 $True。
...
### Microsoft.Azure.Commands.DataFactoryV2.models.PSFactorRuntime
...
## 筆記
關鍵字：azure、azurerm、arm、資源、管理、管理員、資料、專案、複製、活動、整合執行時間

## 相關連結

[Set-AzDataFactoryV2FactoryRuntime]()

[Get-AzDataFactoryV2FactoryRuntime]()
