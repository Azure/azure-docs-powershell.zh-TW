...
## 描述
**Remove-AzDataFactoryDataset** Cmdlet 會從 Azure Data Factory 移除資料集。
...
此命令會從名為 WikiADF 的資料工廠移除名為 DAWikiAggregatedData 的資料集。
命令會返回 $True。
