...
## 描述
Cmdlet Remove-AzDataFactoryV2LinkedService Azure Data Factory 移除連結的服務。
...
此命令會從名為 WikiADF 的資料工廠移除名為 LinkedServiceTest 的連結服務。
此命令會返回 $True。
