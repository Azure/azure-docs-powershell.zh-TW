...
## 描述
**Set-AzDataFactoryGateway** Cmdlet 會設定 Azure Data Factory 中指定閘道的描述。
...
此命令會針對名為 WikiADF 的資料工廠中名為 ContosoGateway 的閘道設定描述。
描述參數會指定新的描述。
