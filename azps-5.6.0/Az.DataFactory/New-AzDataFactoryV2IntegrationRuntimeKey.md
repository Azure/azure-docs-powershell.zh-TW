...
## 描述
Cmdlet **New-AzDataFactoryV2 RuntimeRuntimeKey** 會以 KeyName' 參數指定的金鑰名稱重新產生整合執行時間金鑰。 上一個按鍵無效。
...
Cmdlet 會針對名為'test-selfhost-ir'的整合執行時間重新產生 Key 'authKey2'。
...
### Microsoft.Azure.Commands.DataFactoryV2.models.PSFactorRuntimeKeys

## 筆記

## 相關連結

[Get-AzDataFactoryV2FactoryRuntimeKey]()
