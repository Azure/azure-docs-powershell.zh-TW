...
## 描述
**New-AzDataFactoryGateway** Cmdlet 在 Azure Data Factory 中建立閘道。
...
此命令在名為 ADF 的資源群組中名為 WikiADF 的資料工廠中，建立名為 ContosoGateway 的閘道。

## 參數

### -DataFactory
指定 **PSDataFactory** 物件。
此 Cmdlet 會為此參數指定的資料工廠建立閘道。
