...
## 描述
**Get-AzDataFactoryV2ActivityRun** Cmdlet 會取得在 Azure Data Factory 中針對指定時間範圍內發生之指定管線執行執行的資訊。 此外，您可以指定活動名稱、執行執行之連結服務名稱，以及執行狀態的篩選。
...
此命令會詳細瞭解在管線執行期間執行的所有活動，其 ID "f288712d-fb08-4cb8-96ef-82d3b9b30621" 發生于 "2017-09-01" 和 "2017-09-30" 之間。
