...
## 描述
**Update-AzDataFactoryV2 RuntimeRuntime** Cmdlet 會更新整合執行時間屬性。 目前，Cmdlet 僅支援更新自我託管整合執行時間的 'AutoUpdate' 和 'AutoUpdateDelayOffset'。
...
Cmdlet 會更新名為'test-selfhost-ir'的自我託管整合執行時間。

## 參數

### -AutoUpdate
啟用或停用自行託管的整合執行時間自動更新。
...
### Microsoft.Azure.Commands.DataFactoryV2.Models.PSSelfHosted方格RuntimeStatus
