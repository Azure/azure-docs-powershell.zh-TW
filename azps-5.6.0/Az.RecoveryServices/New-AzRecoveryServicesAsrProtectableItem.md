...
## 描述
**New-AzRecoveryServicesrProtectableItem** 會將新的可保護專案新增到 ASR 布料容器內受保護專案的清單 (僅適用于 V 是否適用于 VBaa 布料類型) 。

## 例子

### 範例 1

將 (探索) 實體伺服器新增到可保護專案清單。  (自動) 
