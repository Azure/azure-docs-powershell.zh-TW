...
## 描述
**Remove-AzRecoveryServicesAsrReplicationProtecedItem** Cmdlet 會停用指定的 Azure 網站復原複寫受保護專案的複寫。
此作業會使受保護專案的複製停止。
...
針對指定的複製受保護的專案啟動停用複製作業，並返回用來追蹤作業的 ASR 工作。
...
### -InputObject
Cmdlet 的輸入物件：對應到要停用複製之複製受保護專案的 ASR 複製受保護的專案物件。
