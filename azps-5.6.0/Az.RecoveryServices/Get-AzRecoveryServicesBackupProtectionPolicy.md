...
## 描述
**Get-AzRecoveryServicesBackupProtectionPolicy** Cmdlet 會取得適用于儲存庫的 Azure 備份保護原則。
...
此命令會獲得名為 DefaultPolicy 的保護原則，然後將它儲存在$Pol變數中。

## 參數

### -BackupManagementType
受保護的資源類別。 此 Cmdlet 目前支援的值為 AzureCM、AzureStorage、AzureWorkload
...
### -WorkloadType
資源的工作量類型。 目前支援的值為 AzureMS、AzureFiles、MSSQL
