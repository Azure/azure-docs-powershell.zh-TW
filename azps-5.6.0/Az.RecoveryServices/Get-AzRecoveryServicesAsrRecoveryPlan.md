...
## 描述
**Get-AzRecoveryServicesAsrRecoveryPlan** Cmdlet 會取得指定復原計畫或修復服務庫中所有復原計畫的詳細資訊。
...
### -路徑
指定此 Cmdlet 會保存復原計畫 json 定義的檔案路徑。 您可以編輯 json 定義來修改復原計畫，並用來透過 Update-AzRecoveryServicesASRRecoveryPlan Cmdlet 更新復原計畫
