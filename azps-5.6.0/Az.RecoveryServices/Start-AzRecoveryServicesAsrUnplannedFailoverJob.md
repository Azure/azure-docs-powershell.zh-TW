...
## 描述
**Start-AzRecoveryServicesAsrUnplanedFailoverJob** Cmdlet 會啟動 Azure 網站復原複本保護專案或復原計畫外容錯移轉。
...
使用指定的參數啟動復原計畫非計畫的容錯移轉作業，並返回用來追蹤作業的 ASR 工作。
