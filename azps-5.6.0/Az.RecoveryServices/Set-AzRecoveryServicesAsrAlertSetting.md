...
## 描述
**Set-AzRecoveryServicesrNotificationSetting** Cmdlet 會針對保存庫 (電子郵件通知) Azure 網站復原通知設定。
...
設定自訂電子郵件地址的通知 (訂閱) 訂閱擁有者。

### 範例 3

針對保存庫 (電子郵件通知) Azure 網站復原通知設定。  (自動) 
