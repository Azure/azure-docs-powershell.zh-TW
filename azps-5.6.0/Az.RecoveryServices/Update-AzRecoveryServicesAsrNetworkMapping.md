...
## 描述
**Update-AzRecoveryServicesAsrNetworkMapping** Cmdlet 會更新指定的 Azure 網站復原網路地圖。
...
使用指定的參數啟動更新網路地圖作業，並返回用來追蹤作業的 ASR 工作。
...
### -InputObject
輸入物件：指定對應至 ASR 網路對應以更新的 ASR 網路對應物件。
