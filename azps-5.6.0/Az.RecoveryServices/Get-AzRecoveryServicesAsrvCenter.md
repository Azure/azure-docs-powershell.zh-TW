...
## 簡介
在 ASR 結構指定的 Configuration 伺服器上，獲得註冊用於探索的 vCenter 伺服器詳細資料。
...
## 描述
**Get-AzRecoveryServicesAsrvCenter Cmdlet** 會取得在 ASR 結構指定的 Configuration 伺服器上註冊用於探索的 vCenter 伺服器詳細資料。
...
根據結構名稱和 vCenter 名稱取得 Azure 網站復原 vCenter。
