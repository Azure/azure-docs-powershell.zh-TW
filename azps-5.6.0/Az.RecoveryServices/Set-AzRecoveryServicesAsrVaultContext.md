...
## 簡介
設定要用於目前 PowerShell 會話中後續 Azure 網站復原作業的修復服務庫上下文。
...
## 描述
**Set-AzRecoveryServicesAsrVaultCoNtext** Cmdlet 會設定 Azure 網站復原庫上下文，以進一步操作。
...
針對目前 PowerShell 會話中的後續 Azure 網站復原作業，將儲存庫上下文設定為指定的修復服務儲存庫。
