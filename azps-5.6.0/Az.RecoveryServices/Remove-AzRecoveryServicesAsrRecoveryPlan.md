...
## 描述
**Remove-AzRecoveryServicesrRecoveryPlan** Cmdlet 會從修復服務儲存庫刪除指定的復原計畫。
...
### -InputObject
Cmdlet 的輸入物件：對應到要刪除之復原計畫的 ASR 復原計畫物件。
