...
## 描述
**Start-AzRecoveryServicesrTestFailoverCleanupJob** Cmdlet 會啟動已執行測試容錯移轉的複本保護專案或復原計畫上的測試容錯移轉清理作業。

## 例子

### 範例 1

追蹤測試容錯移轉清理 Azure 網站復原計畫的工作。
