...
## 描述
**Edit-AzRecoveryServicesrRecoveryPlan** Cmdlet 會編輯 Azure 網站復原計畫。
...
將群組附加到現有的 Azure 網站復原計畫，並返回記憶體內更新的復原計畫。 
...
### -AddProtectedItem
要新加入復原計畫物件之復原計畫群組的 ASR 複本保護專案清單。
...
### -InputObject
要編輯的 ASR 復原計畫物件 (記憶體作業中。 若要使用編輯的復原計畫Update-AzASRRecoveryPlan更新復原計畫執行) 
...
### -RemoveProtectedItem
要從復原計畫物件復原計畫群組中移除的 ASR 複本保護專案清單。
