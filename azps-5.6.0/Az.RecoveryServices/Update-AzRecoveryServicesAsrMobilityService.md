...
## 描述
**Update-AzRecoveryServicesrMobilityService** Cmdlet 會嘗試將行動服務代理程式更新推送到受保護的電腦 (如果有可用的更新) 
...
追蹤更新複製受保護專案的行動性服務代理程式的工作。

## 參數

### -帳戶
以帳戶識別碼執行以推入更新。 必須是 ASR 結構中對應到電腦更新之執行帳戶清單中的一個帳戶。
