...
## 描述
**New-AzRecoveryServicesAsrvCenter** Cmdlet 會新增 vCenter 伺服器，以探索可保護的專案。 此 Cmdlet 會向 Configuration 伺服器登錄 vCenter 伺服器以用於探索。
...
### -布料
對應至 Configuration Server 的 ASR 結構。
