...
### 範例 1：在 ResourceGroup 中列出 AzDigitalTwinsEndpoint
```powershell
...
按 ResourceGroupName 列出所有 AzDigitalTwinsEndpoints

### 範例 2：Get AzDigitalTwinsEndpoint by EndpointName
```powershell
...
在 ResourceGroup 中取得 AzDigitalTwinsEndpoint by EndpointName

### 範例 3：Get AzDigitalTwinsEndpoint by 'AzDigitalTwinsEndpoint' Object
```powershell
...
使用 AzDigitalTwinsEndpoint 物件取得 AzDigitalTwinsEndpoint
