...
### 範例 1：刪除 EndPointName 的 azDigitalTwinsEndPoint
```powershell
...
刪除 EndPointName ResourceGroupName 和 ResourceName 的 azDigitalTwinsEndPoint

### 範例 2：刪除 azDigitalTwinsEndPoint by Object
```powershell
...
刪除 azDigitalTwinsEndPoint by Object
