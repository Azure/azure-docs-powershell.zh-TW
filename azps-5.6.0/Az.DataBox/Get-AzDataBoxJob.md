...
## 描述
**Get-AzDataBoxJobs** Cmdlet 會取得 Azure 訂閱中資料箱工作的資訊。
如果您指定資源群組，此 Cmdlet 會獲得該資源群組下的所有資料箱工作。 如果您指定工作名稱以及資源組名，此 Cmdlet 會獲得該特定資料箱工作的資訊。
如果您未指定訂閱識別碼外的其他專案，此 Cmdlet 會獲得該訂閱下所有資料箱工作的資訊。
...
Get-AzDataBoxJob參數的情況下，會抓取訂閱下的所有資料箱工作
...
Get-AzDataBoxJob ResourceGroupName 參數時，會抓取指定資源群組下的所有資料箱工作
...
Get-AzDataBoxJob ResourceGroupName 和 Name 的指定專案會抓取該特定資料箱工作
...
Get-AzDataBoxJob ResourceId 的作業會抓取該特定資料箱工作
