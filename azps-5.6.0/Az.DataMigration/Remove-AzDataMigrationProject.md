...
## 描述
此Remove-AzDataMigrationProject Cmdlet 會從 Azure 移除 Azure 資料庫移轉服務專案。 提供 DeleteRunningTask 參數會移除與要移除之專案相關聯的所有 Azure 資料庫移移服務工作。 
...
上述範例會根據名稱做為輸入參數，從 Azure 移除名為 myDMProject 的 Azure 資料庫移移服務專案
...
上述範例會移除以 PSProject 物件做為輸入參數的 Azure 資料庫移移服務專案。
