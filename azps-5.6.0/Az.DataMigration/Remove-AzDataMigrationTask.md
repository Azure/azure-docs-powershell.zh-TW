...
## 描述
此Remove-AzDataMigrationTask Cmdlet 會從 Azure 移除 Azure 資料庫移轉服務工作。
...
上述範例會根據工作名稱參數，從 Azure 移除名為 TestTask 的 Azure 資料庫移移服務工作。
...
上述範例會移除以傳遞的 PSProjectTask 物件為基礎的 Azure 資料庫移轉服務工作。
