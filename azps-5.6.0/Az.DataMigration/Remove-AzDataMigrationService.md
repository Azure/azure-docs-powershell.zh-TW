...
## 描述
此Remove-AzDataMigrationService Cmdlet 會從 Azure 移除 Azure 資料庫移轉服務的實例。 提供 DeleteRunningTask 參數會移除所有與要移除之服務相關聯的 Azure 資料庫移移服務工作。 
...
上述範例會移除名為 TestService 的 Azure 資料庫移移服務實例，該實例包含在名為 MyResourceGroup 的 Azure 資源群組中。
