...
## 描述
此Get-AzDataMigrationProject Cmdlet 會取回 Azure 資料庫移轉專案的屬性。
...
上述範例會從名為 testResourceGroup 且受服務稱為 testService 的資源群組中，取用名為 TestProject 的 Azure 資料庫移移專案
...
上述範例會根據傳遞的 PSProject 物件輸入參數，來取回 Azure 資料庫移轉專案。 
