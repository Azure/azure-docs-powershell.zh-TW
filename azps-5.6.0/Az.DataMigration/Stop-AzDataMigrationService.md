...
## 描述
此Stop-AzDataMigrationService Cmdlet 會停止執行中的 Azure 資料庫移轉服務實例。
...
上述範例會根據以輸入參數傳遞的服務名稱，停止名為 TestService 的 Azure 資料庫移轉服務實例
...
上述範例會停止以 PSDataMigrationService 物件作為輸入參數傳遞的 Azure 資料庫移轉服務實例。
