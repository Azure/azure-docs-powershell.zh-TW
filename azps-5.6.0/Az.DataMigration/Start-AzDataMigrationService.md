...
## 描述
此Start-AzDataMigrationService Cmdlet 會以已停止的狀態啟動 Azure 資料庫移轉服務的實例。 
...
上述範例會根據以輸入方式傳遞的服務名稱，以已停止狀態啟動名為 Test Service 的 Azure 資料庫移轉服務實例
...
上述範例會以以輸入參數傳遞的 PSDataMigrationService 為基礎啟動 Azure 資料庫移轉服務實例
