...
## 描述
此Get-AzDataMigrationTask Cmdlet 會取回與 Azure 資料庫移轉服務移轉工作關聯的屬性。
...
上述範例說明使用 Get-AzDataMigrationTask Cmdlet 根據以輸入參數傳遞的工作名稱，來取回與 Azure 資料庫移轉服務移轉工作關聯的屬性
...
上述範例說明如何使用 Get-AzDataMigrationTask Cmdlet 來取回以輸入參數傳遞之 PSProject 物件相關的所有移轉工作
