...
## 描述
Cmdlet Get-AzSqlVM一或多個 sql 虛擬機器。
...
此命令會獲得目前訂閱中所有 Azure SQL 虛擬機器的資訊。
...
此命令會獲得目前訂閱中指派給資源群組 ResourceGroup01 的所有 Azure SQL 虛擬機器相關資訊。
...
此命令會獲得指派給資源群組 ResourceGroup01 的 SQL 虛擬機器 "vm" 相關資訊。
...
### Microsoft.Azure.Commands.SqlVirtualMachine.SqlVirtualMachine.Model.AzureSqlMODELModel
