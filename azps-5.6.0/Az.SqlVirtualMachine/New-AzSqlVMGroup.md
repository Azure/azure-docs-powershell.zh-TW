...
## 描述
Cmdlet New-AzSqlVMGroup建立 Azure SQL 虛擬機器群組。
...
在資源群組 ResourceGroup01 中，使用 test-group vm 建立一個新的 Azure SQL 虛擬機器群組。
$profile是 Microsoft.Azure.Management.SqlVirtualMachine.Models.WsfcDomainProfile 類型的物件
...
### -SqlServiceAccount
SQL 服務在組集中所有參與的 SQL 虛擬機器上執行的名稱
