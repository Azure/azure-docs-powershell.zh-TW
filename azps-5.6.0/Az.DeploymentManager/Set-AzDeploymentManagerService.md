...
## 描述
**Set-AzDeploymentManagerService** Cmdlet 會以指定的服務物件更新服務。
Cmdlet 會返回更新的服務物件。
...
此命令會更新服務，其名稱、服務拓撲名稱及 ResourceGroup 會分別符合名稱、ServiceTop用Name 和 ResourceGroupName 屬性$serviceObject名稱。
服務會更新為 $serviceObject。
