...
## 描述
**Remove-AzDeploymentManagerServiceTop應 Cmdlet** 會刪除服務拓撲。
...
此命令會刪除 ContosoResourceGroup 中名為 ContosoServiceTopsource 的服務拓撲。
...
此命令會刪除服務拓撲，其名稱和資源組會分別符合每個$serviceTopologyObject名稱及 ResourceGroupName 屬性。
