...
## 描述
**Remove-AzDeploymentManagerRollout** Cmdlet 會刪除終端機狀態中的推出。
...
此命令會刪除 ContosoResourceGroup 中名為 ContosoRollout 的推出。
...
此命令會刪除其名稱和 ResourceGroup 分別符合其名稱及資源組名稱屬性的部署$rolloutObject。
