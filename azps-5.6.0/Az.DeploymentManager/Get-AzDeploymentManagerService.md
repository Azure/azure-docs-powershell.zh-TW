...
## 描述
**Get-AzDeploymentManagerService** Cmdlet 會依據服務拓撲取得服務，並會返回代表該服務的物件。
根據服務的名稱、服務拓撲和資源組名來指定服務。 或者，您也可以提供 Service 物件或 ResourceId。

您可以在本地修改此物件，然後使用 Cmdlet 將變更Set-AzDeploymentManagerService服務。
...
此命令會以 ContosoResourceGroup 中名為 ContosoServiceTop內的服務拓撲，獲得名為 ContosoService1 的服務。
