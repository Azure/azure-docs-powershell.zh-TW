...
上述命令會返回位於資源群組"testrg"中"testnewkustocluster"叢集中的所有 Kusto 資料庫。
...
上述命令會從資源群組 "testrg" 找到的現有叢集"testnewkustocluster"，在資料庫 "mykustodataconnection" 中，將名為 "mykustodataconnection" 的資料連線，
