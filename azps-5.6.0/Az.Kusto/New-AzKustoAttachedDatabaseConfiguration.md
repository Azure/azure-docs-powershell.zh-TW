...
### 範例 1：建立新 AttachedDatabaseConfiguration
```powershell
...
上述命令在叢集「testnewkustoclusterf」中建立 ReadOnly 資料庫"mykustodatabase"。
它遵循來自叢集"testnewkustocluster" 的資料庫"mykustodatabase"
...
### -DatabaseName
如果您想要附加的資料庫名稱，如果您想要追蹤所有目前和未來的資料庫，請使用 *。
