...
從指定的訂閱移除以名稱指定的藍圖工作分派。 執行命令之前，Cmdlet 會提示您確認。
...
### -PassThru
設定完成之後，Cmdlet 會返回代表已移除藍圖工作分派的物件。 根據預設，此 Cmdlet 不會產生任何輸出。
...
### Microsoft.Azure.Commands.藍圖.models.PSBlueprintAssignment[]
