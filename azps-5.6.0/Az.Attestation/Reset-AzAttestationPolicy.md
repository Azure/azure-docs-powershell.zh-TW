...
## 描述
Cmdlet Reset-AzAttestationPolicy Azure 的租使用者定義證明策略。
...
將 Tee 類型 *SgxEnclave* 之證明提供者 *pshtest* 的預設規則重設為預設值。
...
如果驗證提供者 *pshtest* 已設定為使用隔離信任模型，請包含已簽署之策略，將 Tee 類型 *SgxEnclave* 的預設值重設成預設。
