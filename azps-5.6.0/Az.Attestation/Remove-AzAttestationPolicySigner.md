...
## 描述
此Remove-AzAttestationPolicySigner Cmdlet 會移除 Azure 的租使用者信任之政策簽署者。
...
### -簽署者
指定 RFC7519 JSON Web Token，其中包含名為 "maa-policyCertificate" 的索賠，其值為 RFC7517 JSON Web Key，其中包含要移除的受信任簽署金鑰。
RFC7519 JWT 必須使用其中一個現有的信任簽署金鑰簽署。
