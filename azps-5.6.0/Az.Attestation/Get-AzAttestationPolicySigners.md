...
## 描述
此Get-AzAttestationPolicySigners Cmdlet 會從 Azure 的租使用者中，獲得信任之政策簽署者。
...
在 Resource Group *psh-test-rg* 中，為證明提供者 *pshtest* 獲得信任的策略簽署者。  請注意，此驗證提供者沒有受信任的簽署者。
...
在 Resource Group *psh-test-rg* 中，為證明提供者 *pshtest2* 獲得受信任的政策簽署者。  請注意，此驗證提供者有一個受信任的簽署者。
...
獲得美國中位置的認證預設提供者的可 *信任之政策簽署者*。  請注意，驗證預設提供者沒有信任的簽署者。
...
### Microsoft.Azure.Commands.點出ation.models.PSPolicySigners
