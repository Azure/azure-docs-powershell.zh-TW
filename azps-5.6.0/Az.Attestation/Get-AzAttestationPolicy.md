...
## 描述
Cmdlet Get-AzAttestationPolicy Azure 的租使用者中，從該租使用者獲得該策略。
...
針對 Tee 類型 *SgxEnclave，* 獲得證明提供者 *pshtest* 之政策。
...
從位置 UK *South* for Tee 類型 *SgxEnclave 獲得證明預設提供者的政策*。
...
### Microsoft.Azure.Commands.點出ation.models.PSPolicy
