...
## 描述
Cmdlet Add-AzAttestationPolicySigner Azure 的租使用者信任之政策簽署者。
...
為名為 pshtest 的 Atteestation 提供者新增信任 *的簽署者*。
...
### -簽署者
指定 RFC7519 JSON Web Token，其中包含名為"maa-policyCertificate"的索賠，其值為 RFC7517 JSON Web Key，其中包含要新增的新信任簽署金鑰。
