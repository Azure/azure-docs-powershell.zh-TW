...
此 Cmdlet 會依名稱更新 PostgreSql 防火牆規則。

### 範例 2：依身分識別更新 PostgreSql 防火牆規則。
```powershell
...
這些 Cmdlet 會依身分識別更新 PostgreSql 防火牆規則。

### 範例 3：更新 PostgreSql 防火牆規則 by -ClientIPAddress。
```powershell
...
這些 Cmdlet 會更新 PostgreSql 防火牆規則 By -ClientIPAddress。
