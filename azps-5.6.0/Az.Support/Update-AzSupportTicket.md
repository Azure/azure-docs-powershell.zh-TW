...
## 描述
使用此 Cmdlet 更新支援票證的嚴重性等級、狀態或客戶連絡人詳細資料。 請注意，將票證指派給支援工程師時，不允許更新支援票證的嚴重性等級或狀態。 如果您想要在票證指派後更新嚴重性等級或狀態，請傳送票證上的通訊給支援工程師。
...
### 範例 5：指定個別的連絡人參數來更新支援票證的連絡人詳細資料。
```powershell
...
### -名稱
此 Cmdlet 更新的 SupportTicket 資源名稱。
