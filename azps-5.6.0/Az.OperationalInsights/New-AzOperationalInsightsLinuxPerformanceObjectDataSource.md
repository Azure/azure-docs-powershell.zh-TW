...
## 描述
**New-AzOperationalInsightsDataPerformanceObjectDataSource** Cmdlet 新增了執行計數器，Azure 營運深入資訊會從這些計數器收集資料至工作區內的所有 Linux 電腦。
...
[Enable-AzOperationalInsights](./Enable-AzOperationalInsightsLinuxPerformanceCollection.md)
