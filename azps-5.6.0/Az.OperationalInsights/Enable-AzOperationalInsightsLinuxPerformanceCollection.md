...
## 描述
**Enable-AzOperationalInsights LinuxPerformanceCollection** Cmdlet 會啟動工作區中已連接 Linux 電腦之效能計數器的集合。
...
[Disable-AzOperationalInsights](./Disable-AzOperationalInsightsLinuxPerformanceCollection.md)
