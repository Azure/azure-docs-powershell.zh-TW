...
## 描述
**New-AzOperationalInsightsSavedSearch** Cmdlet 會使用工作區的指定參數，建立新的已儲存搜尋。
...
### -FunctionParameter
如果查詢做為函數，則選擇性函數參數。 值應採用下列格式：'param-name1：type1 = default_value1，param-name2：type2 = default_value2'。 如需更多範例和適當的語法，請參閱 https://docs.microsoft.com/azure/kusto/query/functions/user-defined-functions 。
