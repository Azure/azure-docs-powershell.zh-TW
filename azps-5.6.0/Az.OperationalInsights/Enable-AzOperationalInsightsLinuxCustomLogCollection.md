...
## 描述
**Enable-AzOperationalInsights LinuxCustomLogCollection** Cmdlet 會從工作區中連接的 Linux 電腦開始收集自訂記錄。
...
[Disable-AzOperationalInsightsTomLogCollection](./Disable-AzOperationalInsightsLinuxCustomLogCollection.md)
