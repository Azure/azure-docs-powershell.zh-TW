...
## 描述
**Enable-AzOperationalInsights WorkspaceSyslogCollection** Cmdlet 會開始從工作區中連接的 Linux 電腦收集 syslog 資料。
...
[Disable-AzOperationalInsights](./Disable-AzOperationalInsightsLinuxSyslogCollection.md)

[New-AzOperationalInsightsDataSource](./New-AzOperationalInsightsLinuxSyslogDataSource.md)
