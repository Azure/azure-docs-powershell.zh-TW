...
## 描述
**Get-AzUserAssignedIdentity 會** 取得現有使用者指派的身分識別。

## 例子

### 範例 1
此範例 Cmdlet 會從資源群組 PSRG 下，使用名稱 **識別碼 1** 獲得 **使用者指派的身分識別**
...
### 範例 2
此範例 Cmdlet 會獲得資源群組 **PSRG** 下的所有使用者指派身分
