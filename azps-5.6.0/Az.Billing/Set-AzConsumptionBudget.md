...
## 描述
Cmdlet Set-AzConsumptionBudget訂閱或資源群組中的預算。

## 例子

### 範例 1：以訂閱層級的預算名稱以新金額更新預算
```powershell
...
### 範例 2：當成本或使用量達到訂閱層級金額的 90% 閾值時，以通知更新預算
```powershell
...
### -NotificationKey
與預算相關聯的通知金鑰，用於建立啟用通知切換的通知、通知門檻、連絡人電子郵件、連絡人群組或連絡人角色。
