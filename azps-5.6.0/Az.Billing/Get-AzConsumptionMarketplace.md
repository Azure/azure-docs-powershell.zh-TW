...
## 描述
**Get-AzConsumptionMarketplace** Cmdlet 會取得訂閱的市場。

## 例子

### 範例 1：取得 Marketplaces 使用方式
```powershell
...
### 範例 2：取得具有日期範圍的 Marketplace 使用方式
```powershell
...
### 範例 3：取得 BillingPeriodName 的 Marketplace 使用方式
```powershell
...
### 範例 4：使用 InstanceName 篩選取得 Marketplace 使用方式
```powershell
