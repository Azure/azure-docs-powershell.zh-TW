...
## 描述
**Get-AzDataShareSubscription** Cmdlet 提供資料共用帳戶中共用訂閱的資訊。 如果提供共用訂閱名稱，Cmdlet 會提供特定共用訂閱的資訊。 否則，Cmdlet 會提供資料共用帳戶中的共用訂閱清單。
...
此命令提供資料共用帳戶 WikiAds 中共用訂閱 AdsShareSubscription 的資訊。
