...
## 描述
**Get-AzDataShareSynchrononization** Cmdlet 提供有關資料共用帳戶下共用中所有同步處理設定的資訊。
...
這個命令會提供資料共用帳戶 WikiAds 中 Share AdsShare 中所有同步處理設定的資訊。
...
### Microsoft.Azure.PowerShell.Cmdlets.DataShare.Models.PSDShareSynchrononization
