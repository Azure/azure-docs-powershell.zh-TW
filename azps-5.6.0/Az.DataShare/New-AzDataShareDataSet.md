...
## 描述
**New-AzDataShareDataSet** Cmdlet 在資料共用帳戶的 azure 資料共用中新增資料集。 您可以新增類型為 Blob、ADLS Gen2 和 ADLS Gen1 的資料集。
...
此命令會將類型 Blob 容器的 AdsDataSet 資料集新增到 Azure 資料共用 AdsShare。
