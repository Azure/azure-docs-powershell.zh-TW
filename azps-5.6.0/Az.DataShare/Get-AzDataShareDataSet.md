...
## 描述
**Get-AzDataShareDataSet** Cmdlet 會取得在 Azure 資料共用帳戶中共用新增的資料集相關資訊。 如果您指定資料集的名稱，此 Cmdlet 會獲得資料集相關資訊。 如果您未指定名稱，此 Cmdlet 會獲得共用中所有資料集的資訊。Ⅰ
...
此命令會顯示 Azure 資料共用帳戶 WikiAdsAccount和資源群組 ADS 中的 AdsDataSet 資料集相關資訊。
