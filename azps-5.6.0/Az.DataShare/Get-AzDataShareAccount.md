...
## 描述
**Get-AzDataShareAccount** Cmdlet 會取得 Azure 訂閱/資源群組中資料共用帳戶的資訊。
如果您指定帳戶的名稱，此 Cmdlet 會獲得該 datshare 帳戶的資訊。
如果您未指定名稱，此 Cmdlet 會獲得 Azure 訂閱/資源群組中所有資料共用帳戶的資訊。
