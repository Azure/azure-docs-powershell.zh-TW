...
## 描述
**Start-AzDataShareSubscriptionSynchronization** Cmdlet 會啟動共用訂閱的同步處理
...
這個命令會啟動帳戶 WikiAds 中名為 AdsShareSubscription 的共用訂閱同步處理。 
...
### Microsoft.Azure.PowerShell.Cmdlets.DataShare.Models.PSDShareSubscriptionSynchrononization
