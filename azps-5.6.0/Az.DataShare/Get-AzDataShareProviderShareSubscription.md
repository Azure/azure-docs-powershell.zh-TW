...
## 描述
**Get-AzDataShareProviderSubscription** Cmdlet 會取得提供者端消費者共用訂閱的資訊。 如果您指定共用子訂閱識別碼，此 Cmdlet 會獲得共用訂閱相關資訊。 如果您未指定共用訂閱識別碼，此 Cmdlet 會獲得與共享關聯的所有消費者共用訂閱相關資訊。
...
這個命令提供與資料共用帳戶 WikiAds 中共用 AdsShare 相關聯的消費者共用訂閱相關資訊。
