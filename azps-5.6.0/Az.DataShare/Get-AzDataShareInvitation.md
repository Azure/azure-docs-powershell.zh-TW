...
## 描述
**Get-AzDataShareInvitation** Cmdlet 會取得在資料共用中新增邀請的資訊。 如果您指定邀請的名稱，此 Cmdlet 會獲得邀請相關資訊。 如果您未指定名稱，此 Cmdlet 會獲得共用中所有邀請的資訊。
...
這個命令提供在資料共用 AdsShare 中呈現的邀請 AdsInvitation 相關資訊。
