...
## 描述
此Get-AzSqlDatabaseSensitivityRecommendation Cmdlet 會返回資料庫中資料行的建議資訊類型和敏感度標籤。

## 例子

### 範例 1：取得 Azure SQL 資料庫的建議資訊類型和敏感度標籤。
```powershell
...
### 範例 2：使用管道取得 Azure SQL 資料庫的建議資訊類型和敏感度標籤。
```powershell
