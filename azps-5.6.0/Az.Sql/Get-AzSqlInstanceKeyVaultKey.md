...
## 描述
此Get-AzSqlInstanceKeyVaultKey Cmdlet 會獲得 SQL 受管理實例上金鑰庫金鑰的資訊。 您可以查看受管理實例上的所有金鑰，或提供 KeyId 來查看特定金鑰。
...
此命令會獲得 SQL 受管理實例上的所有 Key Vault 鍵。
...
此命令會獲得具有 Id ' ''的 Key Vault https://contoso.vault.azure.net/keys/contosokey/01234567890123456789012345678901 鍵。
