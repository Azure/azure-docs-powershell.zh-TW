...
## 描述
Cmdlet Stop-AzSqlInstanceOperation SQL 受管理實例上提供的作業名稱停止作業。
...
此命令會停止在 SQL 受管理實例上名稱為 'd0f5bef5-e2b1-4ef8-bb42-2e54073874f9' 的作業。
...
此命令會停止使用資源識別碼 $managedInstanceOperation.Id。
...
此命令會停止使用物件或物件$managedInstanceOperation。
