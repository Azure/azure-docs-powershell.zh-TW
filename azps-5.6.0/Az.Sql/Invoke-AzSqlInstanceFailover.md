...
## 描述
**Invoke-AzSqlInstanceFailover** Cmdlet 容錯移轉 Azure SQL Managed 實例。
...
此命令將會容錯移轉名為「ManagedInstance01」實例的主要複本。
...
此命令將會容錯移轉受管理實例「ManagedInstance01」的可讀取次要複本。
