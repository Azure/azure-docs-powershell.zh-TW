...
## 描述
**Get-AzSqlServerFirewallRule** Cmdlet 會取得 Azure SQL Database 伺服器的防火牆規則。
如果您指定防火牆規則的名稱，此 Cmdlet 會獲得該特定防火牆規則的資訊。
...
此命令會獲得伺服器名稱為 Server01 的所有防火牆規則。
...
此命令會獲得伺服器名稱為「規則」的所有防火牆規則。伺服器名稱為「規則」。
