...
## 描述
**Set-AzSqlServerRecomactionActionState** Cmdlet 會更新 Azure SQL Server 建議動作的狀態。
此 Cmdlet 會根據新狀態來適用、還原或捨棄建議的動作。
...
將名稱為 "IR_test_schema \[ \] _ \[ test_table_0.0361551 _6C7AE8CC9C87E7FD5893" 的伺服器建議動作更新為 \] 「擱置中」
...
### Microsoft.Azure.Commands.sql.recommendedAction.Model.AzureSqlServerRecomactionModel

## 筆記
* 關鍵字：azure、azurerm、arm、resource、management、manager、sql、server、mssql、advisor、recommendedaction
...
[Set-AzSqlDatabaseRecomactionActionState](./Set-AzSqlDatabaseRecommendedActionState.md)
