...
## 描述
**Remove-AzSqlDatabaseRestorePoint** Cmdlet 會從 Azure SQL Database 移除提供還原點。
Azure SQL Database 上的 SQL Server Datawarehouse Service 目前支援此 Cmdlet。
...
此命令會移除 Azure SQL Database 建立日期的還原點。
