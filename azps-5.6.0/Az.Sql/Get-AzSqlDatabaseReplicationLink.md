...
## 簡介
在 Azure SQL Database 與資源群組或 SQL Server 之間，獲得異地複製連結。
...
## 描述
**Get-AzSqlDatabaseReplicationLink** Cmdlet 會取代 **Get-AzSqlDatabaseCopy** Cmdlet。
它會在指定的 Azure SQL Database 與資源群組或 AzureSQL Server 之間，獲得所有異地複製連結。

## 例子

### 範例 1

在 Azure SQL Database 與資源群組或 SQL Server 之間，獲得異地複製連結。  (自動) 
