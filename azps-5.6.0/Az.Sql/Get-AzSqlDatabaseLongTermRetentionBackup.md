...
## 描述
**Get-AzSqlDatabaseLongTermRetentionBackup** Cmdlet 會取得位置、伺服器或資料庫的所有長期保留備份，或取得特定的長期保留備份。
...
此命令會針對所有資料庫進行所有長期保留備份 (這些資料庫在 northeurope 中可能為) ，只有在伺服器為線上時，資源群組才能設定。
...
此命令會針對所有資料庫檔案 (保留備份，這些資料庫在 northeurope) 資源群組下可能為活動狀態或刪除。
...
此命令會以名稱 601061b7-d10b-46e0-bf77-a2bfb16a6add;1316556655000000
