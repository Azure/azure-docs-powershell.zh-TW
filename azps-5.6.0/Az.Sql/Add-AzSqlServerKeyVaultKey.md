...
## 描述
Cmdlet Add-AzSqlServerKeyVaultKey新增金鑰庫金鑰至提供的 SQL 伺服器。
伺服器必須具有對儲存庫的 'get， wrapKey， unwrapKey' 許可權。
...
此命令會將 Id 為 '' 的 Key Vault 鍵新增到資源群組 https://contoso.vault.azure.net/keys/contosokey/01234567890123456789012345678901 'ContosoResourceGroup'中名為 'ContosoServer'的 SQL 伺服器。
