...
## 簡介
修改 Azure SQL Server DNS 別名指向的伺服器
...
## 描述
此命令正在更新別名指向的伺服器。 此命令需要在登入訂閱時發出，新別名指向哪個伺服器的位置。
...
此命令正在更新先前指向 oldServer 指向伺服器 newServer 的別名
