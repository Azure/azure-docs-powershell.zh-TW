...
## 簡介
修改 Azure SQL Server 虛擬網路規則的組配置。
...
## 描述
此命令會修改 Azure SQL Server 虛擬網路規則的組配置。
若要控制伺服器中的一組虛擬網路規則，請改為使用 "Add-AzSqlServerVirtualNetworkRule" 和 'Remove-AzSqlServerVirtualNetworkRule'。
...
使用包含新虛擬網路相關資訊的新虛擬網路子網識別碼修改現有的虛擬網路規則
