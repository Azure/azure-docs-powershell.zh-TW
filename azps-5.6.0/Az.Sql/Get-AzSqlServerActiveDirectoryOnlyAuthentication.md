...
## 描述
**Get-AzSqlServerActiveDirectoryOnlyAuthentication** Cmdlet 會取得 Azure Active Directory (Azure AD) 目前訂閱中 AzureSQL Server 的驗證需求。
...
此命令會獲得 Azure Active Directory (Azure AD) AzureSQL 伺服器名稱為 Server01 的驗證需求，該伺服器與名為 ResourceGroup01 的資源群組相關聯。
