...
## 簡介
僅啟用特定 SQL Managed 實例的 Azure AD 驗證。
...
## 描述
**Enable-AzSqlInstanceActiveDirectoryOnlyAuthentication** Cmdlet 啟用 Azure Active Directory (Azure AD) 目前訂閱中 AzureSQL 受管理實例的驗證需求。
...
此命令會啟用 Azure Active Directory (Azure AD) 與名為 ResourceGroup01 的資源群組相關聯的 AzureSQL Managed Instance Managed Instance 的驗證需求。
