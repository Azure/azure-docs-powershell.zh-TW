...
## 描述
**Get-AzSqlDatabaseRecomactionAction** Cmdlet 會針對 Azure SQL 資料庫建議程式取得一或多個建議動作。
...
此命令會針對名為 wi-runner-australia-east 的資料庫，獲得建議者 CreateIndex 的所有建議動作清單。
...
此命令會針對名為 CreateIndex 的顧問IR_test_schema \[ \] _ \[ test_table_0.0361551 _6C7AE8CC9C87E7FD5893建議 \] 的動作。
