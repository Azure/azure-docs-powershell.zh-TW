...
## 描述
**Disable-AzSqlServerActiveDirectoryOnlyAuthentication** Cmdlet 會停用 Azure Active Directory (Azure AD) 目前訂閱中 AzureSQL Server 的驗證需求。
...
此命令會停用 Azure Active Directory (Azure AD) 僅與名為 ResourceGroup01 的資源群組相關聯的 AzureSQL 伺服器之驗證需求。
