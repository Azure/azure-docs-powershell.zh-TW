...
## 簡介
更新 Azure SQL Pool Pool 建議的動作狀態。
...
## 描述
**Set-AzSqlElasticPoolRecomactionActionState** Cmdlet 會更新 Azure SQL 集區建議動作的狀態。
此 Cmdlet 會根據新狀態，適用建議的動作、還原或捨棄。
...
此命令會更新稱為 IR_test_schema \[ \] _ \[ test_table_0.0361551 的_6C7AE8CC9C87E7FD5893狀態 \] 。
