...
## 簡介
移除 SQL Managed 實例的 Azure AD 系統管理員。
...
## 描述
**Remove-AzSqlInstanceActiveDirectoryAdministrator** Cmdlet 會移除目前訂閱中 Azure Active Directory (Azure AD) 系統管理員。
...
此命令會移除與資源群組 ResourceGroup01 相關聯的 ManagedInstanceName01 受管理實例的 Azure AD 系統管理員。
...
此命令會從受管理的實例物件移除 Azure AD 系統管理員。
...
此命令會使用受管理的實例資源識別碼移除 Azure AD 系統管理員。
