...
## 描述
**Get-AzSqlDatabaseAudit** Cmdlet 會取得 Azure SQL 資料庫的稽核設定。
若要使用 Cmdlet，請使用 *ResourceGroupName、ServerName* 和 *DatabaseName* 參數來識別資料庫。

## 例子

### 範例 1：取得 Azure SQL 資料庫的稽核設定
```
...
### 範例 2：透過管道取得 Azure SQL 資料庫的稽核設定
```
