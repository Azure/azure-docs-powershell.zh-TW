...
## 描述
**Get-AzSqlServerDsterRecoveryConfigurationActivity** Cmdlet 會取得 SQL 資料庫伺服器系統復原組式的活動。
...
### -ServerD星號RecoveryConfigurationName
指定伺服器系統復原群組原則的名稱。
...
### Microsoft.Azure.Commands.Sql.ServerDazsterRecoveryConfiguration.Model.AzureSqlServerDsterRecoveryConfigurationActivityModel
