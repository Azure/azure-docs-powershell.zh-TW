...
## 描述
此Get-AzSqlDatabaseSensitivityClassification Cmdlet 會返回 Azure SQL 資料庫中資料行的目前資訊類型和敏感度標籤。

## 例子

### 範例 1：取得 Azure SQL Database 的目前資訊類型和敏感度標籤。
```powershell
...
### 範例 2：使用管道取得 Azure SQL 資料庫的目前資訊類型和敏感度標籤。
```powershell
...
### 範例 3：取得 Azure SQL Database 特定資料行的目前資訊類型和敏感度標籤。
```powershell
...
### 範例 4：使用管道取得 Azure SQL 資料庫特定資料行的目前資訊類型和敏感度標籤。
```powershell
