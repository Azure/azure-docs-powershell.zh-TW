...
## 簡介
獲得 SQL Managed 實例的 Azure AD 系統管理員相關資訊。
...
## 描述
**Get-AzSqlInstanceActiveDirectoryAdministrator** Cmdlet 會取得目前訂閱中 Azure Active Directory (Azure AD) 系統管理員的 Azure Active Directory) 系統管理員相關資訊。
...
此命令會針對名為 ManagedInstance01 的受管理實例，獲得與名為 ResourceGroup01 的資源群組相關聯的 Azure AD 系統管理員相關資訊。
...
此命令會從受管理的實例物件中，獲得 Azure AD 系統管理員相關資訊。
...
此命令會使用受管理的實例資源識別碼，獲得有關 Azure AD 系統管理員的資訊。
