...
## 簡介
僅啟用特定 SQL Server 的 Azure AD 驗證。
...
## 描述
**Enable-AzSqlServerActiveDirectoryOnlyAuthentication** Cmdlet 啟用 Azure Active Directory (Azure AD) 目前訂閱中 AzureSQL Server 的驗證需求。
...
此命令會啟用 Azure Active Directory (Azure AD) 與名為 ResourceGroup01 的資源群組相關聯的 AzureSQL 伺服器僅需要驗證。
...
### -ServerName
Azure SQL Server 的名稱僅包含 Azure Active Directory 驗證。
