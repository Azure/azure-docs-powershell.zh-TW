...
## 描述
Cmdlet Set-AzSqlServerTransparentDataEncryptionProtector設定 SQL 伺服器的 TDE 載入器。
變更 TDE 軸向類型會旋轉轉軸軸。
...
此命令會補救伺服器，以使用具有 Id ' '的 Server Key Vault 鍵 https://contoso.vault.azure.net/keys/contosokey/01234567890123456789012345678901 做為 TDE 保護程式。
ResourceGroupName ServerName Type ServerKeyVaultKeyName
----------------- ----------                   ---- ---------------------
