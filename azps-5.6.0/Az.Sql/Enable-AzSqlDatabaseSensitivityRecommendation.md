...
## 描述
此Enable-AzSqlDatabaseSensitivityRecommendation Cmdlet 可針對資料庫中的資料行啟用敏感度建議。

## 例子

### 範例 1：在 Azure SQL Database 中為一個欄位啟用敏感度建議。
```powershell
...
### 範例 2：使用管道在給定欄 Azure SQL 資料庫上啟用敏感度建議。
```powershell
