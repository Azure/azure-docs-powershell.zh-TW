...
## 描述
**Stop-AzSqlElasticPoolActivity** Cmdlet 會取消彈性資料庫上的非同步更新作業。

## 例子

### 範例 1：取消彈性資料庫上的非同步更新作業
```
...
### Microsoft.Azure.Commands.Sql.Pool.Model.AzureSqlElasticPoolActivityModel
