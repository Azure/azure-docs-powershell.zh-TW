...
## 描述
**Set-AzSqlDatabaseAdvisorAutoExecuteStatus Cmdlet** 會修改 Azure SQL Database Advisor 的自動執行屬性。
目前，此 Cmdlet 支援啟用、停用和預設值的值。
...
此命令會變更名為 CreateIndex 的顧問的自動執行狀態為啟用。

## 參數

### -AdvisorName
指定此 Cmdlet 修改其狀態的顧問名稱。
