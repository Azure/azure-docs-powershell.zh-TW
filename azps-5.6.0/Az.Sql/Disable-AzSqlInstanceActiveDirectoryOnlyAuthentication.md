...
## 簡介
停用特定 SQL Managed 實例的 Azure AD 驗證。
...
## 描述
**Disable-AzSqlInstanceActiveDirectoryOnlyAuthentication** Cmdlet 會停用 Azure Active Directory (Azure AD) 目前訂閱中 AzureSQL Managed 實例的驗證需求。
...
此命令會停用 Azure Active Directory (Azure AD) 只有與 ResourceGroup01 資源群組相關聯的 AzureSQL Managed Instance Managed Instance 的驗證需求。
