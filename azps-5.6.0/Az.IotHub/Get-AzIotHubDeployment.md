...
## 描述
取得 IoT Edge 部署或 IoT 中心中清單 IoT Edge 部署的詳細資訊。
請參閱 https://docs.microsoft.com/azure/iot-edge/module-deployment-monitoring 詳細資訊。
