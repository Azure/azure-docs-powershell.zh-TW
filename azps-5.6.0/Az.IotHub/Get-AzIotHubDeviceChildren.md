...
## 描述
以逗號分隔清單顯示所有邊緣裝置或指定裝置的所有指派非邊緣裝置。
...
### Microsoft.Azure.Commands.Management.IotHub.Models.PSDevice以

### Microsoft.Azure.Commands.Management.IotHub.Models.PSDevices以[]
