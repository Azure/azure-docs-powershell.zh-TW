...
## 描述
在 IoT 中心中新增端點。 若要瞭解支援的端點，請參閱 https://docs.microsoft.com/azure/iot-hub/iot-hub-devguide-endpoints
...
將類型為 EventHub 的新端點 "E2" 新增到 "myiothub" IoT 中心。
...
將 AzureStorageContainer 類型的新端點 "S1" 新增到 "myiothub" IoT 中樞。
...
### -編碼
選取要路由資料的格式。 您可以選取 JSON 或 AVRO。 預設值設定為 AVRO。
