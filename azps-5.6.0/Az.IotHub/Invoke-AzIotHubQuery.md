...
## 描述
使用強大的 SQL 類似語言查詢 IoT 中樞，以取回裝置和模組元件、工作和郵件路由相關資訊。
請參閱 https://docs.microsoft.com/azure/iot-hub/iot-hub-devguide-query-language 詳細資訊。
