...
## 描述
**Get-AzAutoscaleSetting** Cmdlet 會取得與資源群組或指定的自動縮放設定相關聯的所有自動縮放設定。
...
此命令會獲得指派給資源群組 Default-Web-EastUS 的自動縮放設定。
...
此命令會獲得名為 DefaultServerFarm-Default-Web-EastUS 的自動縮放設定。
