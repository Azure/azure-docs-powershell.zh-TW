...
## 描述
**Remove-AzMetricAlertRuleV2** Cmdlet 會移除警示規則。 此 Cmdlet 實做 ShouldProcess 模式，即實際建立、修改或移除資源之前，可能會向使用者要求確認。
...
此命令會移除具有資源識別碼的警示規則 `/subscriptions/00000000-0000-0000-0000-0000000/resourceGroups/metricAlertRG/providers/microsoft.insights/metricAlerts/myAlertRule`
