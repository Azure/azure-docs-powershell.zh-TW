...
## 描述
**New-AzMetricAlertRuleV2Criteria** Cmdlet 會建立一個當地公制準則物件，做為 [輸入 Add-AzMetricAlertRuleV2](https://docs.microsoft.com/powershell/module/az.monitor/add-azmetricalertrulev2) Cmdlet，以建立新的公制警示規則。
...
此命令會建立可在公制警示規則中使用的 Webtest 可用性準則
...
允許讓系統略過公制驗證，以建立尚未過系統化之自訂計量的警示規則
