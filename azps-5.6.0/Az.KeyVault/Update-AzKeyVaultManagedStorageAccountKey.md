...
## 描述
重新產生金鑰保存庫受管理的 Azure 儲存體帳戶的指定金鑰，並設定該金鑰為使用中金鑰。 Key Vault 會代理呼叫給 Azure Resource Manager，以重新產生金鑰。 來電者必須擁有許可權，才能重新產生特定 Azure 儲存帳戶中的金鑰。
...
重新產生帳戶'mystorageaccount'的'key1'，並設定'key1'為金鑰保存庫管理 Azure 儲存帳戶的使用中。
