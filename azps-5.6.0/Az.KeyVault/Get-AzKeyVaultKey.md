...
此命令在名稱為 Contoso 的金鑰庫中，會獲得名為 test1 的金鑰的目前版本。
...
### 範例 6：針對此金鑰庫，獲得已被刪除但並未清除的金鑰 ITPfx。
```powershell
...
這是將受 HSM 保護的金鑰導入 Azure 金鑰庫的其中一個步驟。 看到 https://docs.microsoft.com/azure/key-vault/keys/hsm-protected-keys
