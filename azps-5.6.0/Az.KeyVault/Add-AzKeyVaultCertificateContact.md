...
## 描述
**Add-AzKeyVaultCertificateContact** Cmdlet 會新增 Azure 金鑰保存庫中憑證通知金鑰保存庫的連絡人。
連絡人會收到有關事件的更新，例如即將到期的憑證、憑證續約等等。
這些事件是由憑證策略決定。
...
此命令會將單一百分點陣圖新增為 ContosoKV01 金鑰庫的憑證連絡人，並返回 "ContosoKV01" 庫的連絡人清單。
