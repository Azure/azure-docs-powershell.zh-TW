...
修改屬性的一般模式是，要取回 Windows IoT 裝置服務中繼資料和安全性中繼資料，然後將它們與新內體中的修改值合併，以更新 Windows IoT 裝置服務。
...
### -Etag
不需要 Etag *欄位。*
如果這是在回應內內容中提供，也必須根據一般 ETag 慣例提供做為標頭。
