...
### 範例 1：取得 kubernetes cluster 的所有組式
```powershell
...
此命令會獲得 kubernetes 集區的所有組式。

### 範例 2：根據名稱取得 kubernetes cluster 的組式
```powershell
...
此命令會根據名稱獲得 kubernetes cluster 的組式。

### 範例 3：根據物件取得 kubernetes cluster 的組式
```powershell
...
此命令會根據物件獲得 kubernetes cluster 的組式。

### 範例 4：根據管線取得 kubernetes cluster 的組式
```powershell
...
此命令會根據管線獲得 kubernetes cluster 的組式。
...
### -ClusterRp
Kubernetes cluster RP - 適用于 AKS (的 Microsoft.ContainerService) 或適用于 OnPrem K8S (的 Microsoft.Kubernetes) 。
