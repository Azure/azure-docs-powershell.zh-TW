...
此命令會獲得 SAP 監視器下的所有實例。

### 範例 2：根據名稱取得 SAP 監視器的實例
```powershell
...
此命令會按名稱獲得 SAP 監視器的實例。

### 範例 3：根據物件取得 SAP 監視器的實例
```powershell
...
此命令會按物件獲得 SAP 監視器的實例。

### 範例 4：根據管線取得 SAP 監視器的實例
```powershell
