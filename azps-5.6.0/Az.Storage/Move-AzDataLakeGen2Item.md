...
## 描述
**Move-AzDataLakeGen2Item** Cmdlet 會將檔案或目錄移至同一個儲存帳戶中的另一個檔案或目錄。
...
此命令會在同一個檔案系統中將目錄 "dir1" 移至目錄 "dir3"。

### 範例 2：根據管線將檔案移至同一個儲存帳戶中的另一個檔案系統，而不提示
```
...
此命令將 'filesystem1' 中的檔案 'dir1/file1' 移至同一個儲存帳戶中的 'filesystem2' 中的 'dir2/file2'，而不會提示。
