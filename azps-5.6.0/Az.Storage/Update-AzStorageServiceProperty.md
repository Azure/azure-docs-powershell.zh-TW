...
## 描述
**Update-AzStorageServiceProperty** Cmdlet 會修改 Azure 儲存體服務的屬性。

## 例子

### 範例 1：將 Blob 服務 DefaultServiceVersion 設定為 2017-04-17
```
C:\PS>Update-AzStorageServiceProperty -ServiceType Blob -DefaultServiceVersion 2017-04-17
```

此命令將 Blob 服務的 DefaultServiceVersion 設為 2017-04-17
...
如果未指定傳入要求的版本，DefaultServiceVersion 會指出要求 Blob 服務的預設版本。 可能的值包括版本 2008-10-27 以及所有較新版本。 查看更多詳細資料，請參閱 https://docs.microsoft.com/rest/api/storageservices/versioning-for-the-az-storage-services
