...
此命令將名為 ContosoShare01 的共用儲存空間設為 1024 GB。
...
### -配額
指定配額值 ，以 GB (GB) 。
請參閱 中的配額限制 https://docs.microsoft.com/azure/azure-subscription-service-limits#azure-files-limits 。 
...
### -共用
指定 **CloudFileShare** 物件來代表此 Cmdlet 設定配額的共用。
