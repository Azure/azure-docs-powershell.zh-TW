...
## 描述
**Get-AzDataLakeGen2ItemContent** Cmdlet 在 Azure 儲存帳戶中的 Filesystem 中下載檔案。
...
此命令會下載檔案至本地檔案，而不需要提示。

### 範例 2：取得檔案，然後管道將檔案下載至本地檔案
```
