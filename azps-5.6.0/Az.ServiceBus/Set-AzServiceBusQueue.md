...
## 描述
**Set-AzServiceBusQueue** Cmdlet 會更新指定 Service Bus 命名空間中服務Bus佇列的描述。
...
使用指定命名空間中的新描述更新指定的佇列。 此範例將 **DeadLetteringOnMessageExpiration** 屬性更新為 **True，** 而 **SupportOrdering 更新為** **True。**
