...
## 描述
**Get-AzServiceBusTopic** Cmdlet 會針對指定的 Service Bus 命名空間，會返回主題描述。
...
會針對指定的 Service Bus 命名空間，返回指定主題的描述。
...
針對給定 Service Bus 命名空間，會返回主題清單。 根據預設，會退回 100 個主題，如果要退回的主題超過 100 個，請使用 -MaxCount 參數。
...
針對給定 Service Bus 命名空間，會返回前 150 個主題的清單。
