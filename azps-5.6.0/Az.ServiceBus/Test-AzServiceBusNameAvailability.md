...
## 描述
**Test-AzServiceBusNameAvailability** Cmdlet 檢查提供之佇列或主題名稱的可用性
...
如果提供的$nameQueue名稱為可用值，則$nameQueue為 False
...
如果提供的$nameTopic名稱為 Availableabile，則$nameTopic為 False;如果提供的功能變數名稱$nameTopic為 False
