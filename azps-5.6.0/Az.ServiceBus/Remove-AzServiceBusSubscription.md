...
## 描述
**Remove-AzServiceBusSubscription** Cmdlet 會從指定的 Service Bus 命名空間移除主題的訂閱。
...
移除指定 Service Bus 命名空間 `SB-TopicSubscription-Example1` `SB-Topic_exampl1` 中主題的訂閱 `SB-Example1` 。
...
移除 -ResourceId 參數的 $resourceid/string 中透過 ARM Id 提供的訂閱 
