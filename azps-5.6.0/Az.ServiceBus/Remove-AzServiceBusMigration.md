...
## 描述
**Remove-AzServiceBusMigration Cmdlet** 會刪除標準到進一步命名空間的移轉組
...
刪除 'TestingNamespaceStandardMigration' 移移組
...
### -InputObject
Service Bus Migration 標準命名空間物件
...
### -ResourceId
Service Bus Migration 標準命名空間資源識別碼
