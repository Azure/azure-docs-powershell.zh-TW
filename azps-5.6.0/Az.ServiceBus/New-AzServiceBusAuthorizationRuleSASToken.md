...
## 簡介
產生 AZURE Servicebus 授權規則的 SAS tolen 命名空間/佇列/topic。 
...
## 描述
Cmdlet New-AzServiceBusAuthorizationRuleSASToken Azure Eventhub Namesapce 或 Azure Eventhub 的 SAS (SAS) 權杖產生共用存取簽章
