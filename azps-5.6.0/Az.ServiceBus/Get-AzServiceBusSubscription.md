...
## 描述
**Get-AzServiceBusSubscription** Cmdlet 會針對指定的 Service Bus 主題，返回訂閱描述。
...
針對指定的 Service Bus 主題，會返回訂閱清單。 根據預設，將會退回 100 個訂閱，針對訂閱數目，請使用 -MaxCount 參數
...
針對指定的 Service Bus 主題，會返回前 150 個訂閱的清單。
