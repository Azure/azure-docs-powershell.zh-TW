...
## 描述
**Set-AzServiceBusSubscription** Cmdlet 會更新指定 Service Bus 命名空間中 Service Bus 主題的訂閱描述。
...
將指定訂閱的描述更新為指定主題。 此範例將 **DeadLetteringOnMessageExpiration** 屬性更新為 **true，****而 MaxDeliveryCount** 更新為 9。
