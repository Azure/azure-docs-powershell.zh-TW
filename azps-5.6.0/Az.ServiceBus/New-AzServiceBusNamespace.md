...
## 描述
**New-AzServiceBusNamespace** Cmdlet 會建立新的 Service Bus 命名空間。 建立後，命名空間資源清單可通通。 此作業為冪次元。
...
在指定的資源群組中建立新的 Service Bus 命名空間。
...
### -Sku以
Service Bus 進位命名空間輸送量單位，允許的值 1 或 2 或 4
