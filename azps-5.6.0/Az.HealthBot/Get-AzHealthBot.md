...
### 範例 2：取得 ResourceGroupName 的所有 HealthBot
```powershell
...
使用 ResourceGroupName 取得所有 HealthBot

### 範例 3：取得 HealthBot by ResourceGroupName 和 Name
```powershell
...
按 ResourceGroupName 和 Name 取得 HealthBot

### 範例 4：Get HealthBot by InputObject
```powershell
