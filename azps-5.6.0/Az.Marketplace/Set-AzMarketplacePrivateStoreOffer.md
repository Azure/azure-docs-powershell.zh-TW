...
針對在租使用者範圍下建立的私人市場，使用私人 + 公用方案建立優惠。 
...
更新提供在租使用者範圍下建立的私人市場之私人 + 公用方案。 需要 Etag。
...
只有訂閱範圍下所建立之私人方案的私人市場更新優惠。 需要 Etag。
...
### -ETag
Azure Marketplace privateStore 優惠的 eTag 更新
...
必要的 Azure Marketplace privateStore 優惠的特定方案識別碼限制
