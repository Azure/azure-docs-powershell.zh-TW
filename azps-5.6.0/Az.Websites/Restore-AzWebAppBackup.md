...
還原位於以下位置之 Blob 中 Default-Web-WestUS 中指定應用程式的備份：ContosoWebApp 位於 https://storageaccount.file.core.windows.net

### 範例 2

Cmdlet Restore-AzWebAppBackup還原 Azure Web App 備份。  (自動) 
...
### -AppServicePlan
還原 App 的應用程式服務方案名稱。 如果為空白，則使用應用程式目前的應用程式服務方案。
