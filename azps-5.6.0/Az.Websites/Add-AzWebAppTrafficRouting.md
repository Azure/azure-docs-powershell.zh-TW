...
## 描述
**Add-AzWebAppTrafficRoudlet** 會新增路由規則至 Azure Web App Slot。

## 例子

### 範例 1 新增路由規則以將 15% 生產流量轉移到 Stg slot
```powershell
PS C:\>Add-AzWebAppTrafficRouting -ResourceGroupName "Default-Web-WestUS" -WebAppName "ContosoSite" 
-RoutingRule @{ActionHostName='XXXX.azurewebsites.net';ReroutePercentage=15;Name='Stg'}
```

此命令會新增路由規則，將 15% 生產流量轉移到 Stg slot

### 範例 2 新增路由規則，以增量方式將生產流量轉移到 Stg slot 範圍從 50% 到 90%。
```powershell
PS C:\>Add-AzWebAppTrafficRouting -ResourceGroupName "Default-Web-WestUS" -WebAppName "ContosoSite" 
...
此命令會新增路由規則，以增量方式將生產流量傳輸至 Stg slot 範圍從 50% 到 90%。
