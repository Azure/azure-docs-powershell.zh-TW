...
## 描述
**Get-AzWebApp** Cmdlet 會取得 Azure Web App 相關資訊。

## 例子

### 範例 1：從資源群組取得 Web App
```
PS C:\>Get-AzWebApp -ResourceGroupName "Default-Web-WestUS" -Name "ContosoSite"
```

此命令會獲得名稱為 ContosoSite 的 Web App，該 Web App 屬於資源群組 Default-Web-WestUS。
