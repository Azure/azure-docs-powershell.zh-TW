...
## 描述
**Set-AzWebAppSlotConfigName** Cmdlet 將應用程式設定和連接字串標記為插槽設定
...
此命令會移除與資源群組 Default-Web-WestUS 相關聯的 Web App ContosoWebApp 的所有應用程式設定和連接字串

### 範例 2

設定 Web App Slot 設定名稱。  (自動) 
