...
## 描述
**Set-AzAppServicePlan** Cmdlet 會設定 Azure 應用程式服務計畫。
...
此命令在名為 ContosoASP 的應用程式服務方案上，將 PerSiteScaling 選項設定為 True，此方案屬於 Default-Web-WestUS 資源群組。

### 範例 2

設定 Azure 應用程式服務計畫。  (自動) 
