...
## 簡介
建立代表要安裝在 Web App 中的 Azure 儲存路徑的物件。 此參數應做為 ( AzureStoragePath) Set-AzWebAppSet-AzWebAppSlot
...
## 描述
建立代表要安裝在 Web App 內之 Azure 儲存路徑的物件。
