...
## 簡介
更新 Azure Web App 的主要網站 Access Restiction config 繼承至 SCM 網站。
...
## 描述
**Update-AzWebAppAccessRestrictionConfig** Cmdlet 會更新 Azure Web App 的存取限制設定檔。

## 例子

### 範例 1：更新 Web App SCM 網站以使用主要網站的存取限制

下列範例更新名為 IpRule 的 Web App，此 App 屬於資源群組 MyResourceGroup，以使用 scm 網站上主網站的存取限制設定檔。
