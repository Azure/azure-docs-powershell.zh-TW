...
## 描述
**Remove-AzWebApp** Cmdlet 會移除提供資源群組和 Web App 名稱的 Azure Web App。
此 Cmdlet 預設也會移除所有插槽和度量。
...
此命令會移除名稱為 ContosoSite 的 Azure Web App，此 App 屬於名為 Default-Web-WestUS 的資源群組。
...
### -確認
執行 Cmdlet 之前，提示您確認。執行 Cmdlet 之前，提示您確認。
