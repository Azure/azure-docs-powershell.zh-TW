...
## 描述
**Restart-AzWebAppSlot** Cmdlet 會停止，然後啟動 Azure Web App Slot。
如果 Web App Slot 已停止，請使用 Start-AzWebAppSlot Cmdlet。
...
此命令會重新開機與資源群組 Default-Web-WestUS 相關聯的 Web App ContosoWebApp 插槽 Slot001
