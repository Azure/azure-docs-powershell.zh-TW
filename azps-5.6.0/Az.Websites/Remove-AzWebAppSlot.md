...
## 描述
**Remove-AzWebAppSlot** Cmdlet 會移除提供資源群組和 Web App 名稱的 Azure Web App Slot。
此 Cmdlet 預設也會移除所有插槽和度量。

## 例子

### 範例 1：移除 Web App Slot
```
PS C:\>Remove-AzWebAppSlot -ResourceGroupName "Default-Web-WestUS" -Name "ContosoSite" -Slot "Slot001"
```

此命令會移除與屬於 Default-Web-WestUS 資源群組的 Web App ContosoSite 相關聯的 Slot。
