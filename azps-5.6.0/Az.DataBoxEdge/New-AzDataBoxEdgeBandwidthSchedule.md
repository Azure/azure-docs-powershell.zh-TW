...
## 描述
**New-AzDataBoxEdgeBandwidthSchedule** Cmdlet 為 Data Box Edge 裝置建立新的頻寬排程，協助管理頻寬使用量。
...
### -UnlimitedBandwidth
將設定無限頻寬，如果設為 False，預設值會設為 20 Mbps
...
### Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Models.PSDBoxEdgeBandWidthSchedule
