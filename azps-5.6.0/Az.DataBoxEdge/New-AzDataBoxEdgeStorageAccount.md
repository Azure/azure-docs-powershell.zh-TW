...
## 描述
**New-AzDataBoxEdgeStorageAccount** Cmdlet 在 Data Box Edge 裝置中建立新的 Edge 儲存空間帳戶。 針對裝置，最多隻能對應到一個雲端儲存空間帳戶的一個 Edge 儲存空間帳戶。
...
裝置上的 2 個 EdgeStorageAccount無法共用超過 1 個雲端儲存空間帳戶
...
### Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Models.PSDBoxEdgeStorageAccount
