...
## 描述
**Remove-AzDataBoxEdgeDevice Cmdlet** 會移除 Data Box Edge 裝置的配置。
請注意，只有在您下訂單之後，以及 Microsoft 準備出貨前，才能刪除裝置。

請參閱有關使用此[Cmdlet](https://docs.microsoft.com/azure/databox-online/data-box-edge-return-device#delete-the-resource)之前刪除資源的檔
