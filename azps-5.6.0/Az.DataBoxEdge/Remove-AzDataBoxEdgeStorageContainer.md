...
## 描述
**Remove-AzDataBoxEdgeStorageContainer Cmdlet** 會移除 Data Box Edge 裝置上 Edge 儲存空間帳戶的相關儲存容器。 您可以指定要移除的儲存容器名稱做為參數。
...
### Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Models.PSDBoxEdgeStorageContainer
