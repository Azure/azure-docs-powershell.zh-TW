...
## 描述
**New-AzDataBoxEdgeOrder** Cmdlet 為 Data Box Edge 裝置建立新訂單。 在建立訂單之前，必須先建立 Data Box Edge 裝置資源。 您可以將連絡人、公司名稱、電子郵件、位址等詳細資料指定為建立訂單的參數。
...
### Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Models.PSDBoxEdgeOrder
