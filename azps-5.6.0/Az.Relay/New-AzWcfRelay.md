...
## 描述
Cmdlet New-AzWcfRelay指定的 Relay 命名空間中建立 WcfRelay。
...
在指定的 Relay 命名空間 TestNameSpace-Relay 中建立一個新的 WcfRelay \` \` TestWCFRelay2。 \` \`
...
在指定的 Relay 命名空間 \` \` \` TestNameSpace-Relay1 中建立一個新的 WcfRelay TestWCFRelay。 \`
