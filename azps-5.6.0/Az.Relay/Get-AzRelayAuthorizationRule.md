...
## 描述
**Get-AzRelayAuthorizationRule** Cmdlet 會取得指定轉寄實體中指定授權規則的描述 (命名空間/WcfRelay/HybridConnection) 。
...
會針對指定的 HybridConnection，返回指定的授權規則描述。
