...
為指定的建議名稱建立預設 -Name 和預設天數為 -1 的預設建議名稱。
...
建立裝飾，從Get-AzAdvisorRecommendation到 Disable-AzAdvisorRecommendation。
...
### -InputObject
Powershell 物件類型 PsAzureAdvisorResourceRecommendationBase 由 Get-AzAdvisorRecommendation呼叫。
