...
## 說明
**AzureRmStorageAccountNetworkRule** Cmdlet 會從儲存空間帳戶的 NetWorkRule 屬性中移除 IpRules 或 VirtualNetworkRules
...
### -IPAddressOrRange
IpAddressOrRange 陣列會從 NetWorkRule 屬性移除具有相同 IpAddressOrRange 的 IpRule。
...
VirtualNetworkResourceId 陣列會從 NetWorkRule 屬性移除具有相同 VirtualNetworkResourceId 的 VirtualNetworkRule。
...
### -VirtualNetworkRule
要從 NetWorkRule 屬性移除的 VirtualNetworkRule 物件陣列。
