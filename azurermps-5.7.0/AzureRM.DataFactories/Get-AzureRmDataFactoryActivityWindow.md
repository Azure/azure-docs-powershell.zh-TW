...
## 說明
**AzureRmDataFactoryActivityWindow** Cmdlet 會取得與資料工廠關聯之使用中視窗的相關資訊。
...
### [System.object]。清單 ' 1 [PSActivyWindow，WindowsAzure. WindowsAzure = 0.8.2.0，Culture = 中性，PublicKeyToken = 31bf3856ad364e35]]」）））。

## 筆記

## 相關連結

[Azure 資料工廠 Cmdlet](./AzureRM.DataFactories.md)
