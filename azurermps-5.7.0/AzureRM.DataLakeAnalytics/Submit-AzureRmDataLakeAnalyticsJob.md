...
## 說明
**AzureRmDataLakeAnalyticsJob** Cmdlet 會提交 Azure Data Lake Analytics 作業。
...
U-SQL 腳本參數會在主要腳本內容的前面加上，例如：

宣告 @Department 字串 = "Sales";宣告 @NumRecords int = 1000;宣告 @StartDateTime datetime = New datetime (2017、12、6、0、0、0、0) ;
