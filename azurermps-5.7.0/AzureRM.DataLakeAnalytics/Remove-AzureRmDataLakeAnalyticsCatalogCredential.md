...
## 說明
Remove-AzureRmDataLakeAnalyticsCatalogCredential Cmdlet 會刪除 Azure Data Lake Analytics 目錄認證。
...
這個命令會移除指定的資料 Lake Analytics 編目認證。
...
### -遞迴
表示此刪除操作應該經過，而且也會刪除並丟棄所有依存于此認證的資源。
