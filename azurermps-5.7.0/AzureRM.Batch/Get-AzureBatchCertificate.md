...
## 說明
**AzureBatchCertificate** Cmdlet 會取得 Azure Batch 帳戶中 *BatchCoNtext* 參數指定的憑證。
若要取得特定的憑證，請指定 *ThumbprintAlgorithm* 和 *指紋* 參數。
指定 *篩選* 參數，以取得符合開放式資料通訊協定 (OData) 篩選的憑證。
...
### Microsoft.Azure.Commands.Batch。PSCertificate
