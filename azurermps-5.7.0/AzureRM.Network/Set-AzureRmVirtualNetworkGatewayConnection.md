...
## 說明
AzureRmVirtualNetworkGatewayConnection Cmdlet 會 **設定** 虛擬網路閘道連線。
...
指定此 Cmdlet 用來修改虛擬網路閘道連線的 PSVirtualNetworkGatewayConnection 物件。
...
形參 "VirtualNetworkGatewayConnection" 接受管線中 "PSVirtualNetworkGatewayConnection" 類型的值
