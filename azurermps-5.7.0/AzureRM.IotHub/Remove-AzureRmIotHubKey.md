...
從名為 "myiothub" 的 IotHub 中移除名為 iothubowner1 的索引鍵
...
### [System.object]。清單 ' 1 [IotHub. PSSharedAccessSignatureAuthorizationRule，IotHub，版本 = 1.0.0.0，Culture = 中性，PublicKeyToken = null]]。）））））
