...
## 說明
**AzureRmWebAppBackupList** Cmdlet 會取得 Azure Web App 備份的清單。
...
這個命令會傳回與資源群組 ContosoResourceGroup 相關聯之 WebApp WebAppStandard 的備份清單。
...
### AzureWebAppBackup []. WebApps [WebApps]
