...
## 說明
**AzureRmDataLakeStoreFirewallRule** Cmdlet 會在指定的資料 Lake store 帳戶中新增防火牆規則。

## 示例

### 範例1：將新的防火牆規則新增至 Data Lake Store 帳戶
```
