...
## 說明
**AzureRmDataLakeStoreItem** Cmdlet 會刪除 Data Lake store 中的檔案或資料夾。
...
這個命令會從 Data Lake Store 移除 File01.txt 和 File.csv 的檔案。
...
### -路徑
指定要移除之檔案的 Data Lake Store 路徑陣列，並從根目錄 (/) 。
...
### -遞迴
表示此操作會刪除目的檔案夾中的所有專案，包括子資料夾。
除非您指定 *Clean* 參數，否則目的檔案夾也會被刪除。
