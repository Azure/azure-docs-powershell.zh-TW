...
## 說明
**AzureRmDataLakeStoreItemAcl** Cmdlet 會清除 Data Lake Store 中檔案或資料夾的存取控制清單 (ACL) 。
...
### -Path
指定專案的 Data Lake Store 路徑，從 root 目錄開始 (/) 。
