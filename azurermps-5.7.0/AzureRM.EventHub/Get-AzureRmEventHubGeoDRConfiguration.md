...
## 說明
**AzureRmEventHubGeoDRConfiguration** 會在主要或次要命名空間中檢索別名 (災害復原配置) 
...
### [System.object]。清單 ' 1 [PSEventHubDRConfigurationAttributes，0.5.0.0，，版本 =，Culture = 中性，PublicKeyToken = null]]。）））
