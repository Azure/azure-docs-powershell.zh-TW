...
## 說明
Add-AzureRmHDInsightComponentVersion Cmdlet 會將在群集中執行的服務版本新增到由 New-AzureRmHDInsightClusterConfig Cmdlet 建立的 Azure HDInsight 設定物件。

## 示例

### --------------------------範例1：將 Spark 的版本新增至群集設定物件。  --------------------------
```
...
這個命令會將 Spark 版本新增到名為「您的 Spark-001」的 HDInsight 群集。
