...
## 說明
**AzureRmHDInsightPersistedScriptAction** Cmdlet 會取得 Azure HDInsight 群集的持久化腳本動作，並依時間順序列出這些作業，或取得指定的永久性腳本動作的詳細資料。
...
這個命令會在名為 [hadoop-001] 的群集上取得持續執行的腳本動作。
...
### System.object IList ' 1 [AzureHDInsightRuntimeScriptAction] （即 Azure. 命令..]
