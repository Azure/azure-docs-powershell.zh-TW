...
## 說明
**AzureRmStreamAnalyticsTransformation** Cmdlet 會取得對流分析作業上所定義轉換的相關資訊。
...
這個命令會傳回稱為 StreamingJob 的作業上稱為 StreamingJob 轉換的資訊。
...
### -JobName
指定 Azure 資料流程分析轉換所屬之 Azure 串流分析作業的名稱。
...
### [System.object]. 清單 ' 1 [StreamAnalytics. PSTransformation，StreamAnalytics]]]]]]]]]]]]
