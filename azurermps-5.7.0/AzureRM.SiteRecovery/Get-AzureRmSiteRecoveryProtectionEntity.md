...
## 說明
**AzureRmSiteRecoveryProtectionEntity** Cmdlet 會在目前的 Azure Site Recovery 保存庫中取得可存取或受保護實體的清單（例如虛擬機器）。
...
### System.object. IEnumerable ' 1 [SiteRecovery. ASRProtectionEntity] （）
