...
## 說明
**AzureRmApiManagementGroup** Cmdlet 會取得全部或特定的 API 管理群組。
...
這個命令會取得使用者 ID 為0123456789的所有使用者群組。
...
在 API 管理服務中設定之群組的詳細資料。

### IList<ApiManagement. ServiceManagement. PsApiManagementGroup]>
在 API 管理服務中設定的群組清單。
