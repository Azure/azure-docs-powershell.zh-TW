...
## 說明
**Restore-AzureRmApiManagement** Cmdlet 會從位於 Azurestorage blob 中的指定備份還原 API 管理服務。
...
這個命令會從 Azure 儲存區 blob 復原 API 管理服務。
