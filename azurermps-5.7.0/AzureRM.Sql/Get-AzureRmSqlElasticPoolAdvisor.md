...
## 說明
**AzureRmSqlElasticPoolAdvisor** Cmdlet 可取得 Azure Sql 彈性池的一個或多個 Azure Sql 彈性池顧問。
...
此命令會列出一個名為 WIRunnerPool 的彈性池的所有顧問。
...
這個命令會取得名為 WIRunnerPool 的彈性池名為 CreateIndex 的顧問。
...
表示 Cmdlet 在回應中包括 Advisor 的建議動作。
...
## 筆記
* 關鍵字： azure，azurerm，arm，資源，管理，管理員，sql，elasticpool，mssql，advisor
