...
## 說明
**AzureRmSqlServer** Cmdlet 會傳回一或多個 Azure SQL 資料庫伺服器的相關資訊。
指定伺服器的名稱，只查看該伺服器的資訊。
...
這個命令會取得指派給資源群組 ResourceGroup01 的所有 Azure SQL 資料庫伺服器的相關資訊。
...
這個命令會取得目前訂閱中所有 Azure SQL Database 伺服器的相關資訊。
