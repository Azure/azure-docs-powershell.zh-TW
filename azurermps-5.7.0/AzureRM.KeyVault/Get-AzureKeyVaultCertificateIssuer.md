...
## 說明
**AzureKeyVaultCertificateIssuer** Cmdlet 會針對 Azure 金鑰保存庫中的金鑰保存庫取得指定的憑證頒發者或所有憑證頒發者。
...
### KeyVault PSKeyVaultCertificateIssuerIdentityItem>，KeyVault...... PSKeyVaultCertificateIssuer<
