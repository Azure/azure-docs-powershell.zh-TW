...
## 說明
**新的-AzureRmLocationBasedServicesAccountKey** Cmdlet 會為 [以位置為基礎的服務] 帳戶再生 API 金鑰。
...
### System.object
LocationBasedServices. NewAzureLocationBasedServicesAccountKeyCommand + KeyNameType

## 輸出

### LocationBasedServicesAccountKeys 中的 LocationBasedServices。
