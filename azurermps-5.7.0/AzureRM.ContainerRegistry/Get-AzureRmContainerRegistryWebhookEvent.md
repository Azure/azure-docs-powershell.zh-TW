...
### ListWebhookEventsByNameResourceGroupParameterSet (預設) 
```
...
## 說明
Get-AzureRmContainerRegistryWebhookEvent Cmdlet 會列出 webhook 的所有事件。

## 示例

### 範例1：取得 webhook 的所有事件。
```powershell
...
### ContainerRegistry 集合. 泛型. IList "1 [PSContainerRegistryWebhookEvent，ContainerRegistry，版本 = 1.0.0.0，Culture = 中性，PublicKeyToken = null]] （"）]
