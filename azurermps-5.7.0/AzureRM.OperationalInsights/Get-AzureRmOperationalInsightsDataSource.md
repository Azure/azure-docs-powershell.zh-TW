...
## 說明
**AzureRmOperationalInsightsDataSource** Cmdlet 會取得資料來源。
您可以指定要取得的資料來源。
您可以根據資料來源的類型來篩選結果。
...
### [System.object]。清單 ' 1 [Microsoft.Azure.Commands.OperationalInsights.Models.PSDataSource]
