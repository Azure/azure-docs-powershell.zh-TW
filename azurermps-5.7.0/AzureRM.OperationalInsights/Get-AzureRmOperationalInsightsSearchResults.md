...
## 說明
**AzureRmOperationalInsightsSearchResults** Cmdlet 會根據指定的參數傳回搜尋結果。
...
**PSSearchGetSearchResultsResponse** 物件包含 Value 屬性，其中包含從搜尋中以 JSON 格式傳回的記錄，以及包含有關搜尋結果之資訊的中繼資料物件。
