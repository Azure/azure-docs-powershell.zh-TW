...
這個命令會新增一個新的 NodeType "n2" （容量為5），而 vm 管理員名稱是 "adminName"。
...
### System.object
參數： NodeType (ByValue) ，該級 (ByValue) ，VmSku (ByValue) ，VmUserName (ByValue) 

### System.object
參數：容量 (ByValue) 

### SecureString
參數： VmPassword (ByValue) 

### DurabilityLevel 中的 ServiceFabric。
參數： DurabilityLevel (ByValue) 
