...
## 說明
使用 [ **設定] AzureRmServiceFabricSetting** 在群集中新增或更新 Service Fabric 設定。
...
這個命令會將 [MaxFileOperationTimeout] 設定為「NamingService」區段下的值 ' 5000」。
...
### System.object
參數：參數 (ByValue) ，Section (ByValue) ，值 (ByValue) 

### PSSettingsSectionDescription [] 的 ServiceFabric []
參數： SettingsSectionDescription (ByValue) 
