...
### System.object
參數： CertificateFile (ByValue) )  (、CertificateSubjectName (ByValue) 、KeyVaultName (ByValue) 、KeyVaultResouceGroupName (ByValue) 、ByValue (ByValue) 、ParameterFile (ByValue) 、SecondaryCertificateFile (ByValue) 、SecretIdentifier (ByValue) 、TemplateFile (ByValue) 、VmUserName (ByValue) 、 () 、
