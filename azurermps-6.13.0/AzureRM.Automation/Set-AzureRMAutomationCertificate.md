...
## 說明
AzureRmAutomationCertificate Cmdlet 會修改 Azure 自動化中憑證的 **設定** 。
...
第二個命令會修改名為 ContosoCertificate 的憑證。
