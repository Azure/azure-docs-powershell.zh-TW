...
## 說明
**AzureRmAutomationConnectionFieldValue** Cmdlet 會修改 Azure 自動化中的連線中欄位的值。
...
這個命令會變更名為 AutomationAccount01 之自動化帳戶中名為 ContosoConnection 之 Azure 連線的訂閱 ID。

## 參數

### -AutomationAccountName
指定此 Cmdlet 修改連線中之欄位之自動化帳戶的名稱。
