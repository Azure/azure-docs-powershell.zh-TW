...
## 說明
**AzureRmDataLakeAnalyticsDataSource** Cmdlet 會從 Azure Data Lake Analytics 帳戶中移除資料來源。
...
這個命令會從名為 ContosoAdlAccount 的帳戶中移除名為 AzureStorage01 的資料來源。
...
### -DataLakeStore
指定要移除的 AzureData Lake Store 帳戶的名稱。
