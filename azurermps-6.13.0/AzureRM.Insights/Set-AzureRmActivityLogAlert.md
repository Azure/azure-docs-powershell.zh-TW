...
**注意** ：這個 Cmdlet 及其相關的 **AzureRmLogAlertRule** 會取代2017年11月) 的已過時的 (。
...
### [System.object]。清單 ' 1 [5.1.0.0 ActivityLogAlertLeafCondition，，版本 =，Culture = 中性，PublicKeyToken = null]」））））中的集合。

### [System.object]。清單 ' 1 [5.1.0.0 ActivityLogAlertActionGroup，，版本 =，Culture = 中性，PublicKeyToken = null]」））））中的集合。
