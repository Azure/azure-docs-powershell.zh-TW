...
## 說明
**AzureRmLoadBalancerOutboundRuleConfig** Cmdlet 會將輸出規則配置新增至 Azure 負載平衡器。
...
第二個命令使用管線運算子，將負載平衡器 $slb 至 **Add-AzureRmLoadBalancerOutboundRuleConfig** ，這會將輸出規則設定新增到負載平衡器。
