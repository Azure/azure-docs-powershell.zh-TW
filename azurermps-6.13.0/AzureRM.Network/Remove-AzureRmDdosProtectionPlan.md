...
## 說明
Remove-AzureRmDdosProtectionPlan Cmdlet 會移除 DDoS 保護方案。
...
接著，我們會將本機變數組成 **AzureRmVirtualNetwork** ，以保留新的狀態。 此時，該計畫已不再與虛擬網路建立關聯。
如果這是與計畫相關的最後一個專案，我們可以使用命令移除 AzureRmDdosProtectionPlan 來移除 DDoS 保護方案。
