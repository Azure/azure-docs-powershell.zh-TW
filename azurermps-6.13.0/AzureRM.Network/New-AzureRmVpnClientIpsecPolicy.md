...
這個 Cmdlet 是用來建立 vpn ipsec 原則物件，使用的是使用者可傳遞至 param 的一個或所有參數值： VpnClientIpsecPolicy (New-AzureRmVirtualNetworkGateway 的新 VPN 閘道建立) /Set-AzureRmVirtualNetworkGateway (在 ResourceGroup 中的現有 VPN 閘道更新) ：
