...
## 摘要
Remove-AzureRmVirtualHubVnetConnection Cmdlet 會將對遠端 VNET 的 Azure 虛擬網路連線與中樞 VNET 移除。
...
建立中樞虛擬網路連線之後，就會從 AzureRmHubVirtualNetworkConnection 的輸出中使用 powershell 管道來移除中心虛擬網路連線。
