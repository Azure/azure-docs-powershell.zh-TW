...
## 說明
**新的-AzureRmLoadBalancerOutboundRuleConfig** Cmdlet 會建立 Azure 負載平衡器的輸出規則配置。
...
### System.object
[System.object]. 清單 \` 1 [PSResourceId，6.5.0.0，"PSBackendAddressPool，Culture = 中性，PublicKeyToken = null，Culture = 中立，PublicKeyToken = null]] （）的集合....。
