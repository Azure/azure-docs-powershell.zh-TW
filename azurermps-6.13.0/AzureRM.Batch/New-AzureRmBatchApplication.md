...
## 說明
**新的-AzureRmBatchApplication** Cmdlet 會將應用程式新增至指定的 Azure Batch 帳戶。
...
這個命令會在 ContosoBatch 帳戶中建立 Litware 應用程式。
應用程式最初不會包含任何套件。

## 參數

### -AccountName
指定此 Cmdlet 要新增應用程式的批次帳戶名稱。
...
### Microsoft.Azure.Commands.Batch。PSApplication
