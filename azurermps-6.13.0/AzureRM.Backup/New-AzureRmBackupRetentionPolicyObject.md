...
- 日 
- 星期六 
- 星期天如果您指定 *WeeklyRetention* 、 *MonthlyRetentionInWeeklyFormat* 和 *YearlyRetentionInWeeklyFormat* 參數，請指定此參數。
...
### AzureRMBackupRetentionPolicy 中的 AzureBackup。
