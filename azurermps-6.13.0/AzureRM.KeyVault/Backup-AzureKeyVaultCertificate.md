...
## 說明
**AzureKeyVaultCertificate** Cmdlet 會透過下載並儲存在檔案中，以備份金鑰儲存庫中指定的憑證。
...
使用 **AzureKeyVaultCertificate** Cmdlet，以加密格式來檢索憑證，然後使用 **Restore-AzureKeyVaultCertificate** Cmdlet，並在第二個區域中指定一個金鑰保險存儲區。
