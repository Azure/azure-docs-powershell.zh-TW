...
### 範例1在 application insights 資源中移除 cotinuous 匯出配置
```
...
針對資源群組 "testgroup" 中名為 "test" 的資源，移除含匯出 id "uGOoki0jQsyEs3IdQ83Q4QsNr4 =" 的 application insights 連續匯出設定
...
### -PassThru
如果已指定，則會在操作成功時寫入 true。 這個參數是選用的。 預設值為 false。
