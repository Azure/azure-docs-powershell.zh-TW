...
## 說明
New-AzureRmEventHubKey Cmdlet 會為指定的事件中心授權規則重新產生主要或次要 SAS 金鑰。

## 示例

### 範例 1.1-命名空間-AuthorizationRule PrimaryKey
```
...
### 範例 1.2-AuthorizationRule PrimaryKey
```
...
### 範例 2.1-命名空間-AuthorizationRule SecondaryKey
```
