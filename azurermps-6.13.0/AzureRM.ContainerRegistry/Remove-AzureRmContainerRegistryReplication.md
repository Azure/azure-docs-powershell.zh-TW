...
## 說明
Remove-AzureRmContainerRegistryReplication Cmdlet 會移除容器註冊複本。
...
[AzureRmContainerRegistryReplication](Remove-AzureRmContainerRegistryReplication.md)
