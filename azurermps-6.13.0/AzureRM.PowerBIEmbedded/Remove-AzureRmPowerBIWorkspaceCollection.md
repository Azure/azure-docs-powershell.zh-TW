...
## 說明
**AzureRmPowerBIWorkspaceCollection** Cmdlet 會從您的 Azure 訂閱和資源群組中移除 Power BI 工作區集合。
...
這個命令會從指定的資源群組中移除名為 WCN11 的工作區集合。
...
指定此 Cmdlet 移除的 Power BI workspace 集合的名稱。
