...
## 說明
**新的-AzureRmServiceBusRule** Cmdlet 會為指定的訂閱建立新的規則。
...
New-AzureRmServiceBusRule Cmdlet 會為指定的訂閱建立新的規則。
...
New-AzureRmServiceBusRule Cmdlet 會使用 ActionFilter 為指定的訂閱建立新規則。
