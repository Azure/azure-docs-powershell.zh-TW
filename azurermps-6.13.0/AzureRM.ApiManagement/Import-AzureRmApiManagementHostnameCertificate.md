...
## 說明
匯 **入-AzureRmApiManagementHostnameCertificate** Cmdlet 會以適用于 API 管理服務的 PFX 格式匯入憑證。
證書將用於自訂主機名稱設定。
...
### PsApiManagementHostnameType 中的 ApiManagement。

## 輸出

### PsApiManagementHostnameCertificate 中的 ApiManagement。
