...
## 說明
**AzureRmApiManagementApiVersionSet** Cmdlet 會取得 api 管理內容中所設定 Api 版本集合的詳細資料。
...
[移除-AzureRmApiManagementApiSet](./Remove-AzureRmApiManagementApiVersionSet.md)
