...
## 說明
**新的-AzureRmApiManagementProduct** Cmdlet 會建立 API 管理產品。
...
### ApiManagement 為 Nullable "1 [PsApiManagementProductState，，，ServiceManagement，Version = ServiceManagement，Culture = 中性，PublicKeyToken = null]]。））。
