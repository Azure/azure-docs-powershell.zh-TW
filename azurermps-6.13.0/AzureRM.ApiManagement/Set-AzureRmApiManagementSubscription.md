...
## 說明
**AzureRmApiManagementSubscription** Cmdlet 會設定現有的訂閱詳細資料。
...
### ApiManagement 為 Nullable "1 [PsApiManagementSubscriptionState，，，ServiceManagement，Version = ServiceManagement，Culture = 中性，PublicKeyToken = null]]。））。
