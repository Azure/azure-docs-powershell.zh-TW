...
## 說明
**新的-AzureRmApiManagementGroup** Cmdlet 會建立 API 管理群組。
...
### ApiManagement 為 Nullable "1 [PsApiManagementGroupType，，，ServiceManagement，Version = ServiceManagement，Culture = 中性，PublicKeyToken = null]]。））。
