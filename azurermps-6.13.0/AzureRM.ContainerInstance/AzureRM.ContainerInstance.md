...
## 說明
本主題顯示 Azure 容器實例 Cmdlet 的說明主題。

## AzureRM ContainerInstance Cmdlet
### [AzureRmContainerGroup](Get-AzureRmContainerGroup.md)
取得容器群組。

### [AzureRmContainerInstanceLog](Get-AzureRmContainerInstanceLog.md)
在容器群組中取得容器實例的記錄。

### [新-AzureRmContainerGroup](New-AzureRmContainerGroup.md)
建立容器群組。

### [移除-AzureRmContainerGroup](Remove-AzureRmContainerGroup.md)
移除容器群組。
