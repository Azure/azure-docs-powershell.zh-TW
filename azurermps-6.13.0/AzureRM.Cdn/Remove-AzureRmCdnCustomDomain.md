...
## 說明
**AzureRmCdnCustomDomain** Cmdlet 會將自訂網域從 Azure 內容傳遞網路 (CDN) 端點中移除。
...
### PSCustomDomain （CustomDomain）的
參數： CdnCustomDomain (ByValue) 
