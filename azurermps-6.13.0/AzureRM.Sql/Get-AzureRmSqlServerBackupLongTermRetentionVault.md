...
## 說明
**AzureRmSqlServerBackupLongTermRetentionVault** Cmdlet 會取得已登錄至此伺服器的長期保留式保險存儲區。
...
### AzureSqlServerBackupLongTermRetentionVaultModel 中的 [.Sql]。
