...
## 說明
**AzureRmSqlElasticPool** Cmdlet 會在 Azure SQL Database 中設定彈性池的屬性。 這個 Cmdlet 可以針對每個池 ( *Dtu* ) 、每個池 ( *StorageMB* ) 、每個資料庫最大 eDTUs ( *DatabaseDtuMax* ) ，以及每個資料庫 () *eDTUs* 的每個 DatqabaseDtuMin 的儲存空間大小。
