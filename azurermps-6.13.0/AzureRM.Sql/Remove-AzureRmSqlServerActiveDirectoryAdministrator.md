...
## 說明
**AzureRmSqlServerActiveDirectoryAdministrator** Cmdlet 會將 Azure Active Directory (azure AD) 管理員，在目前的訂閱中移除 AzureSQL 伺服器。
...
這個命令會移除與資源群組 ResourceGroup01 相關聯之伺服器的 Azure AD 系統管理員（名為 Server01）。
