...
## 說明
**AzApplicationGatewayAuthenticationCertificate** Cmdlet 會從 Azure 應用程式閘道移除驗證憑證。
...
第二個命令會從應用程式閘道移除名為 cert01 的驗證憑證。
第三個命令會更新應用程式閘道。

## 參數

### -ApplicationGateway
指定此 Cmdlet 從中移除驗證憑證的應用程式閘道的名稱。
