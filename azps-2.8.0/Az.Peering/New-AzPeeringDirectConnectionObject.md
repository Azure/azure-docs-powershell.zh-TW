...
建立直接對等連線，且已啟用對等服務並使用 Microsoft 提供的 IP 位址
...
建立不含 bgp 會話 IP 位址的直接對等連接。 對等將必須先設定 IP 位址，然後才能設定 bgp 會話。
...
[啟用] 標誌，告訴 Microsoft 提供 BGP 會話位址。
...
### -PeeringDBFacilityId
在上找到的對等資金融通 Id https://peeringdb.com
