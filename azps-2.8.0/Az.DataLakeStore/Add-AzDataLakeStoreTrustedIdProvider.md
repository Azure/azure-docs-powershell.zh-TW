...
## 說明
**AzDataLakeStoreTrustedIdProvider** Cmdlet 會將信任的身分識別提供者新增至指定的資料 Lake store 帳戶。
...
將提供者 "MyProvider" 新增至提供者端點 "" 的帳戶 "ContosoADL" https://sts.windows.net/6b04908c-b91f-40ce-8024-7ee8a4fd6150

## 參數

### -帳戶
要新增指定信任身分識別提供者的 Data Lake Store 帳戶名稱。
...
### -ProviderEndpoint
有效的信任提供者端點，格式為：身分 https://sts.windows.net/\<provider 識別 \> "
