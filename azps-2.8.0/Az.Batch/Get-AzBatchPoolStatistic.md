...
## 說明
**AzBatchPoolStatistic** Cmdlet 會取得指定帳戶中所有池的存留期統計資料。
...
第一個命令會使用 **AzBatchAccountKeys** 建立名為 ContosoBatchAccount 的 batch 帳戶的帳戶金鑰的物件參考。
...
### Microsoft.Azure.Commands.Batch。PSPoolStatistics
