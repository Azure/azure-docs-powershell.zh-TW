...
## 說明
New-AzMapsAccountKey Cmdlet 會針對 Azure Maps 帳戶重新產生 API 金鑰。
...
在 [資源群組 MyResourceGroup] 中重新產生帳戶我的帳戶的主要 API 金鑰。
