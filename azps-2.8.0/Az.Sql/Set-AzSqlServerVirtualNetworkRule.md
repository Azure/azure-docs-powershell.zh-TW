...
## 說明
這個命令會修改 Azure SQL Server 虛擬網路規則的設定。
若要控制伺服器中的一組虛擬網路規則，請改用 [Add-AzSqlServerVirtualNetworkRule] 和 [Remove-AzSqlServerVirtualNetworkRule]。
...
使用新的虛擬網路子網 id （包含新虛擬網路的相關資訊）來修改現有的虛擬網路規則
