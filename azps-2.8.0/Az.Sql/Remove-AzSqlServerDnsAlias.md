...
## 說明
這個命令會從伺服器移除 Azure SQL Server DNS 別名，讓伺服器保持不變。
...
從伺服器名稱為 serverName 的名稱為 aliasName 的 Azure SQL Server DNS 別名移除。
...
### AzureSqlServerDnsAliasModel 中的 [ServerDnsAlias]
