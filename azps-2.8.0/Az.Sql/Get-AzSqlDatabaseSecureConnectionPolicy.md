...
這個命令會取得在伺服器 server01 上名為 database01 的 Azure SQL database 加密通道原則。
...
### DatabaseSecureConnectionPolicyModel 中的 [SecureConnection]
