...
## 說明
**新的-AzSqlSyncAgentKey** Cmdlet 會建立 Azure SQL 同步處理代理程式金鑰。

## 示例

### 範例1：建立 Azure SQL 同步處理代理程式的同步處理常式金鑰。
```
PS C:\> New-AzSqlSyncAgentKey -ResourceGroupName "ResourceGroup01" -ServerName "Server01" -SyncAgentName "SyncAgent01"
SyncAgentKey                  : Key
```

這個命令會建立 Azure SQL 同步處理代理程式的同步處理常式金鑰。
...
### AzureSqlSyncAgentKeyModel 中的 [DataSync]
