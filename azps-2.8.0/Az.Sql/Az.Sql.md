...
### [AzSqlDatabaseAdvancedThreatProtectionSettings](Get-AzSqlDatabaseAdvancedThreatProtectionSettings.md)
取得資料庫的高級威脅防護設定。
...
取得資料庫的安全連線原則。 安全連線已棄用，在未來版本中將會移除此命令。 請使用 Azure 入口網站中的 SQL 資料庫 blade 來查看連接字串
...
### [AzSqlServerAdvancedThreatProtectionSettings](Get-AzSqlServerAdvancedThreatProtectionSettings.md)
取得伺服器的高級威脅防護設定。
...
### [更新-AzSqlDatabaseAdvancedThreatProtectionSettings](Update-AzSqlDatabaseAdvancedThreatProtectionSettings.md)
在資料庫上設定高級威脅防護設定。
...
### [更新-AzSqlServerAdvancedThreatProtectionSettings](Update-AzSqlServerAdvancedThreatProtectionSettings.md)
在伺服器上設定高級威脅防護設定。
