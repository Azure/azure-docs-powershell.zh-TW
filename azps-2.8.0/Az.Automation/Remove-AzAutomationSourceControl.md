...
## 說明
Remove-AzAutomationSourceControl Cmdlet 會從 Azure 自動化中移除來源控制。

## 示例

### 範例1
這個命令會在名為 devAccount 的帳戶中，移除名為 VSTSNative 的自動化來源控制。
這個命令會指定 *Force* 參數。 因此，它不會提示您進行確認。
