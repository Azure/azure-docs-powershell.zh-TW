...
## 說明
Cmdlet **AzApiManagementUserToken** 會產生指定使用者的共用存取權杖

## 示例

### 範例1：針對 Git 使用者產生共用存取權杖
```powershell
...
此腳本會取得在 ApiManagement service 中設定的 Git 使用者，並使用有效期為8小時的主鍵來產生共用存取權杖。
...
### ServiceManagement. PsApiManagementUserKeyType （ApiManagement）

### 系統. Nullable "1 [[System. DateTime，mscorlib，版本 = 4.0.0.0，Culture = 中性，PublicKeyToken = b77a5c561934e089]]

## 輸出

### ServiceManagement. PsApiManagementUserToken （ApiManagement）
