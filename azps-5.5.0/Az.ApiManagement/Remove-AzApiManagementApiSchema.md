...
## 說明
從 Api **移除** 的 Cmdlet AzApiManagementSchema。
...
`2`如果沒有參照，腳本會從 Api 移除架構 `echo-api` 。

### 範例2

如果沒有參照 Api，腳本會從 Api echo-api 中移除架構2。  (自動生成) 
...
### -ResourceId
ApiSchema 的 Arm ResourceId。 這個參數是必要的。
