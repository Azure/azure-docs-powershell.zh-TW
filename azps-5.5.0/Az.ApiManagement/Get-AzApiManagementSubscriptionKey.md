...
## 說明
**AzApiManagementSubscriptionKey** Cmdlet 會取得指定訂閱的金鑰。
...
### ServiceManagement. PsApiManagementSubscriptionKey （ApiManagement）

## 筆記

## 相關連結

[新-AzApiManagementSubscription](./Get-AzApiManagementSubscription.md)
