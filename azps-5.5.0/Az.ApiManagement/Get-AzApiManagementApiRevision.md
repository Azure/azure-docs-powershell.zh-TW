...
## 說明
**AzApiManagementApiRevision** Cmdlet 會取得 API 所有修訂的詳細資料

## 示例

### 範例1：取得 API 的所有 API 修訂
```powershell
...
這個命令會針對特定的 ApiManagement 內容，取得指定 API 的所有 API 修正。
...
### ServiceManagement. PsApiManagementApiRevision （ApiManagement）
