...
## 說明
Set-AzWcfRelay Cmdlet 會更新指定的中繼命名空間中 WcfRelay 的描述。
...
### -UserMetadata
取得或設定 usermetadata 是一個預留位置，用來儲存 WcfRelay 端點的使用者定義字串資料。例如，它可以用來儲存描述性資料，例如小組清單和連絡人資訊，也可以儲存使用者定義的設定設定。
