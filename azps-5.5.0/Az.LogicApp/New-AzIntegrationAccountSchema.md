...
## 說明
**新的-AzIntegrationAccountSchema** Cmdlet 會建立整合帳戶架構。
這個 Cmdlet 會傳回代表整合帳戶架構的物件。
指定整合帳戶名稱、資源組名稱、架構名稱和架構定義。
...
這個命令會在指定的資源群組中建立名為 IntegrationAccountSchema1 的整合帳戶架構。
