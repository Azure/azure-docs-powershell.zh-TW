...
### 範例1：為 ImportExport 作業建立新的 DriveList
```powershell
...
這些 Cmdlet 會為 ImportExport 作業建立新的 DriveList。

## 參數

### -BitLockerKey
用來加密磁片磁碟機的 BitLocker 金鑰。
...
### -ManifestHash
磁片磁碟機上的資訊清單檔案的 Base16 編碼 MD5 雜湊值。
...
### IDriveStatus （ImportExport）。 Api20161101。
