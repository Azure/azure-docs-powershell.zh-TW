...
### -AcceptEULA
接受 AVS 的 EULA，法律詞彙將會彈出，但不提供此參數
...
### -NetworkBlock
在您的訂閱和內部部署中，位址區塊應該是在 VNet 中都是唯一的。
請確定 CIDR 格式符合 (A、B、C、D 在0到255之間，而 X 介於0和22之間的) 
...
### -NsxtPassword
或者，您也可以在建立私有雲端時，設定 NSX T 管理員密碼
...
### -VcenterPassword
或者，您也可以在建立私有雲端時設定 vCenter 管理員密碼
