...
## 說明
Remove-AzAttestationPolicySigner Cmdlet 會針對 Azure 證明中的租使用者，移除受信任的原則簽章者。
...
### -簽章者
指定包含名為 "maa-policyCertificate" 的 RFC7519 JSON Web 權杖，其值是包含要移除之受信任的簽章金鑰的 RFC7517 JSON Web 金鑰。
