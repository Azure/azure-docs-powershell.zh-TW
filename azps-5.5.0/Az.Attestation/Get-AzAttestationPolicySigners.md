...
## 說明
Get-AzAttestationPolicySigners Cmdlet 會從 Azure 證明中的租使用者取得受信任的原則簽名者。
...
針對資源群組 *psh-test-rg* 中的認證提供者 *pshtest* ，取得受信任的原則簽名者。  請注意，此認證提供者沒有受信任的簽署人。
...
針對資源群組 *psh-test-rg* 中的認證提供者 *pshtest2* ，取得受信任的原則簽名者。  請注意，此認證提供者只有一個受信任的簽章者。
...
取得 *位置中* 的證明預設提供者受信任的原則簽署者。  請注意，證明預設提供者沒有受信任的簽署者。
