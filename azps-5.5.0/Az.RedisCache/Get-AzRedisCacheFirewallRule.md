...
## 說明
如果提供 **RuleName** 參數，AzRedisCacheFirewallRule Cmdlet 會取得 Azure Redis 快 **取** 上指定防火牆規則的詳細資料。 如果只指定 **Name** ，此操作會取得該 Redis 快取上所有可用的防火牆規則。
...
### PSRedisFirewallRule 中的 RedisCache。
