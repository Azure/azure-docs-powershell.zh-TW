...
上述命令會針對群集 "testnewkustocluster" 中的資料庫 "mykustodatabase" 建立名為 "myeventhubdc" 的新 EventHub 資料連線。

### 範例2：建立新的 EventGrid 資料連線
```powershell
...
上述命令會針對群集 "testnewkustocluster" 中的資料庫 "mykustodatabase" 建立名為 "myeventgriddc" 的新 EventGrid 資料連線。

### 範例3：建立新的 IotHub 資料連線
```powershell
...
上述命令會針對群集 "testnewkustocluster" 中的資料庫 "mykustodatabase" 建立名為 "myiothubdc" 的新 IotHub 資料連線。
