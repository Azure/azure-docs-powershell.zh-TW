...
## 說明
**AzSearchService** Cmdlet 會修改 Azure 認知搜尋服務。
...
這個範例會將 Azure 認知搜尋服務的 [分區計數] 和 [複本計數] 變更為 [2]。
...
### -IdentityType
 (選用) Azure 認知搜尋服務身分識別 (無/SystemAssigned) 
