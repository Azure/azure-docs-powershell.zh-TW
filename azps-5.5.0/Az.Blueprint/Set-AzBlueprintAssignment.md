...
在指定的訂閱中，更新藍圖定義的現有藍圖指派 `$blueprintObject` ，並更新參數。 使用系統指派的身分識別。 位置定義建立受管理身分識別的區域。
...
透過作業檔案更新現有的藍圖作業。 您可以在 [要求/回應] 範例中找到作業檔的格式，網址如下： https://github.com/Azure/azure-rest-api-specs/tree/master/specification/blueprint/resource-manager/Microsoft.Blueprint/preview/2018-11-01-preview/examples
...
`$blueprintObject`使用已定義的參數，更新以指定的管理群組中指定訂閱為目標的藍圖定義的現有藍圖指派。
