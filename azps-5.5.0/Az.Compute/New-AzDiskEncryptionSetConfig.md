...
### -EncryptionType
使用此設定來設定磁片加密集的加密類型。 可用的值為： "EncryptionAtRestWithPlatformKey"、"EncryptionAtRestWithCustomerKey"。
...
### -IdentityType
DiskEncryptionSet 所使用的 Managed 身分識別類型。 僅支援 SystemAssigned。
