...
## 說明
**新的-AzImageConfig** Cmdlet 會建立可設定的影像物件。
...
接下來的三個命令會將 os 磁片和兩個數據磁片的路徑指派給 $osDiskVhdUri、$dataDiskVhdUri 1 及 $dataDiskVhdUri 2 個變數。 這個方法只是為了讓您瞭解下列命令的可讀性。
...
### -HyperVGeneration
指定從影像建立之虛擬機器的 HyperVGeneration 類型。  允許的值為 V1 和 V2。
