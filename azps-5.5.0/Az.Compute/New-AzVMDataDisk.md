...
## 說明
**新的-AzVMDataDisk** Cmdlet 會為虛擬機器或 Vmss VM 建立本機資料磁片物件。
...
為虛擬機器或 Vmss VM 建立本機資料磁片物件。  (自動生成) 
...
### PSVirtualMachineDataDisk 中的 [計算] 命令
