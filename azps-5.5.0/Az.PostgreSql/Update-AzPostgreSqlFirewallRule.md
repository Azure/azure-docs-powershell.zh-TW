...
這個 Cmdlet 會依名稱更新 PostgreSql 防火牆規則。

### 範例2：依身分識別來更新 PostgreSql 防火牆規則。
```powershell
...
這些 Cmdlet 會依身分識別來更新 PostgreSql 防火牆規則。

### 範例3：以-ClientIPAddress 更新 PostgreSql 防火牆規則。
```powershell
...
這些 Cmdlet 會透過-ClientIPAddress 來更新 PostgreSql 防火牆規則。
