...
### <span data-ttu-id="f8127-108">範例1：建立新的 PostgreSql 伺服器</span><span class="sxs-lookup"><span data-stu-id="f8127-108">Example 1: Create a new PostgreSql server</span></span>
```powershell
