...
這個 Cmdlet 會取得預設內容的 PostgreSql 伺服器。

### 範例2：依資源群組和伺服器名稱取得 PostgreSql 伺服器
```powershell
...
這個 Cmdlet 會透過資源群組和伺服器名稱來取得 PostgreSql 伺服器。

### 範例3：列出指定資源群組中的所有 PostgreSql 伺服器
```powershell
...
這個 Cmdlet 會列出指定資源群組中的所有 PostgreSql 伺服器。

### 範例4：依身分識別取得 PostgreSql 伺服器
```powershell
...
這個 Cmdlet 清單會透過身分識別來取得 PostgreSql 伺服器。
