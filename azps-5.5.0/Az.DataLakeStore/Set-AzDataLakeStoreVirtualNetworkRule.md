...
## 說明
**AzDataLakeStoreVirtualNetworkRule** Cmdlet 會修改指定資料 Lake store 中指定的虛擬網路規則。
...
將帳戶 "dl" 中的虛擬網路規則 "myVNET" 的子網 id 更新為 "updatedId"

## 參數

### -帳戶
要在其中更新虛擬網路規則的 Data Lake Store 帳戶
...
### DataLakeStoreVirtualNetworkRule 中的 DataLakeStore。
