...
## 說明
更新 CosmosDB 帳戶的屬性。 無法使用其他屬性來更新帳戶區域 simulataneously。
...
已將 DefaultConsistencyLevel 更新為「強勁」、啟用 AutomaticFailover、啟用 MultipleWriteLocations，並啟用 VirtualNetwork 的 CosmosDB 帳戶具有名稱 accountName。 
