...
## 摘要
建立 PSSpatialSpec 類型的新物件。 您可以將它作為 AzCosmosDBGremlinIndexingPolicy 的參數值來傳遞。
...
## 說明
建立對應至 Gremlin API SpatialSpec 的物件。
...
### -類型
含可接受值的字串陣列： Point、LineString、多邊、MultiPolygon。
代表的路徑空間類型。
