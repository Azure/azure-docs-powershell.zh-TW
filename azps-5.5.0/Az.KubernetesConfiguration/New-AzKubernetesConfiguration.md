...
這個命令會建立 kubernetes 群集的配置。

### 範例1：使用指定參數 OperatorNamespace 為 kubernetes 群集建立配置
```powershell
...
這個命令會在 kubernetes 群集的新操作員命名空間中建立配置。
注意，無法在現有的操作員命名空間中建立配置。
