...
## 說明
**AzFrontDoor** CmdletGet 會取得目前訂閱中符合所提供資訊的所有現有前門。

## 示例

### 範例1：取得目前訂閱中的所有 FrontDoors。
```powershell
...
取得目前訂閱中的所有 FrontDoors。

### 範例2：在目前的訂閱中取得資源群組 "rg1" 中的所有 FrontDoors。
```powershell
...
取得目前訂閱中資源群組 "rg1" 中的所有 FrontDoors。

### 範例3：在目前訂閱中取得名為 "frontDoor1" 的資源群組 "rg1" 中的 FrontDoors。
```powershell
...
在目前訂閱中取得名為 "frontDoor1" 的資源群組 "rg1" 中的 FrontDoors。
