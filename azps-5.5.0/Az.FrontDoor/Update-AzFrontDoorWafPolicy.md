...
## 說明
**AzFrontDoorWafPolicy** Cmdlet 會更新現有的 WAF 原則。 如果未提供輸入參數，則會使用來自現有 WAF 原則的舊參數。
...
### -RequestBodyCheck
定義是否應由受管理的規則來檢查主體。 可能的值包括：「已啟用」、「已停用」
...
[新-AzFrontDoorWafCustomRuleObject](./New-AzFrontDoorWafManagedRuleObject.md)
