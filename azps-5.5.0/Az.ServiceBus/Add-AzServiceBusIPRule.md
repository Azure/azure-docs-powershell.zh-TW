...
```
名稱：預設 DefaultAction： Allow Id：/subscriptions/SubscriptionId/resourceGroups/RSG-TestAzEventhub/providers/Microsoft.ServiceBus/namespaces/ServiceBus-Namespace-2389/networkRuleSets/default 類型： NetworkRuleSet = IpRules/命名空間/： {11.22.33.44，Allow} VirtualNetworkRules： 

新增具有 IpMask "11.22.33.44" 的 IPRule，並針對指定的命名空間進行動作允許。
...
### PSNWRuleSetIpRulesAttributes 中的 [.]
