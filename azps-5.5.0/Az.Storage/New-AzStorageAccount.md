...
### 範例10：使用 RoutingPreference 設定建立儲存空間帳戶
```powershell
...
這個命令會建立一個含有 RoutingPreference 設定的儲存空間帳戶： PublishMicrosoftEndpoint 和 PublishInternetEndpoint 為 true，而 RoutingChoice 為 MicrosoftRouting。
