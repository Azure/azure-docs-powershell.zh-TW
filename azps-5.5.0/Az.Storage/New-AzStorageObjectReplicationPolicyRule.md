...
## 說明
**AzStorageObjectReplicationPolicy** Cmdlet 會建立物件複製原則規則，這會在 Set-AzStorageObjectReplicationPolicy Cmdlet 中使用。

## 示例

### 範例1：建立只有來源與目的地帳戶的物件複製原則規則，並顯示其屬性
```
...
這個命令會建立只有來源和目的地帳戶的物件複製原則規則，並顯示其屬性。

### 範例2：使用所有屬性建立物件複製原則規則，並顯示其屬性
```
...
### PSObjectReplicationPolicyRule 中的 [管理]。
