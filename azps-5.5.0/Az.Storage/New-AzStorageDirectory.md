...
## 說明
**新的-AzStorageDirectory** Cmdlet 會建立目錄。
...
這個命令會使用 **AzStorageShare** Cmdlet 來取得名為 ContosoShare06 的檔案共用，然後使用管線運算子將它傳遞到目前的 Cmdlet。
...
### AzureStorageFileDirectory WindowsAzure. ResourceModel。
