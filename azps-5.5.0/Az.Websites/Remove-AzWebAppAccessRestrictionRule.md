...
## 說明
**AzWebAppAccessRestrictionRule** Cmdlet 會從 Azure Web App 中移除訪問限制規則

## 示例

### 範例1：移除 Web 應用程式存取限制規則
```
PS C:\>Remove-AzWebAppAccessRestrictionRule -ResourceGroupName "Default-Web-WestUS" -WebAppName "ContosoSite" -Name IpRule
```

這個命令會從 Azure Web App 中移除名為「Default-Web-WestUS」的資源群組的 IpRule 存取限制規則。

### 範例2：移除 Service 標記 Web App 存取限制規則
```
...
這個命令會從 Azure Web App 中移除名為 ServiceTag 等於 AzureFrontDoor 的 access 限制規則，該 ContosoSite 屬於名為 [預設-Web-WestUS] 的資源群組。
