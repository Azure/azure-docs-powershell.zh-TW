...
## 說明
匯 **入-AzWebAppKeyVaultCertificate** Cmdlet 會從主要電子倉庫將 SSL 憑證匯入至 web app。
...
這個命令會從主要電子倉庫將 SSL 憑證從 web app 匯入。
...
這個命令會使用資源識別碼從主要電子倉庫將 SSL 憑證匯入至 web app， (通常是在另一個訂閱) 中。

## 參數

### -CertName
在 keyvault 中建立的憑證 KeyVaultCertName
