...
## 說明
New-AzEventHubCluster Cmdlet 會在指定的資源群組中建立專用的 eventhub 群集
...
在 resourcegroup "RSG-Cluster27651" 中建立「Eventhub-Cluster-5557」專用群集，並將位置 southcentralus 和容量設為1

## 參數

### -容量
群集容量 (CU) ，curerntrly，允許值 = 1
