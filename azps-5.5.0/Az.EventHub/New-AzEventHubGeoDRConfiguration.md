...
## 說明
**新的-AzEventHubGeoDRConfiguration** Cmdlet 會建立新的別名 (災害復原配置) 
...
建立具有主要命名空間 "SampleNamespace_Primary" 的別名 "SampleDRConfigName" 與次要命名空間 "SampleNamespace_Secondary"

## 參數

### -AlternateName
當 DR 設定名稱與主要命名空間相同時，需要 AlternateName
...
### -PartnerNamespace
災害復原配置 PartnerNamespace ARM 識別碼
...
### PSEventHubDRConfigurationAttributes 的 [.]
