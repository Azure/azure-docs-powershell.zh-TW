...
## 說明
New-AzAutomationSourceControl Cmdlet 會建立一個設定，以將我的 Azure 自動化帳戶與我的 VSTS TFVC、VSTS Git 或 GitHub 連結在一起。

## 示例

### 範例1
建立來源控制設定，以將我的 Azure 自動化帳戶與我的 VSTS TFVC 專案連結在一起。 TFVC 專案沒有分支，因此沒有指定 Branch 參數。
...
### 範例2
建立來源控制設定，以將 Azure 自動化帳戶與我的 VSTS Git 專案連結在一起。
...
### 範例3
建立來源控制設定以將 Azure 自動化帳戶與我的 GitHub 專案連結。
...
如果已設定 DoNotPublishRunbook，這表示使用者 runbook 將匯入為「草稿」。
