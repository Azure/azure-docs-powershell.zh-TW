...
## 說明
**AzAutomationSourceControlSyncJobOutput** Cmdlet 會取得 Azure 自動化來源控制同步作業的輸出。

## 示例

### 範例1
這個命令會取得原始程式碼管理同步處理作業的輸出（含來源控制項 VSTSNative 的識別碼08d6d266-27b6-463c-beea-bc48a67ace15）。 
...
### SourceControlSyncJobStreamType （自動化）。

## 輸出

### SourceControlSyncJobStream 中的 [.]

### SourceControlSyncJobStreamRecord 中的 [.]
