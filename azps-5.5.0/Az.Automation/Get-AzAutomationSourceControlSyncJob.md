...
## 說明
Get-AzAutomationSourceControlSyncJob Cmdlet 會取得 Azure 自動化來源控制同步作業。 若要取得特定的來源控制同步作業，請指定其識別碼。

## 示例

### 範例1
這個命令會取得 [來源控制 VSTSNative] 的所有自動化來源控制同步作業。
...
### 範例2
這個命令會取得來源控制項 VSTSNative 的來源控制同步作業與 id 08d6d266-27b6-463c-beea-bc48a67ace15。 
