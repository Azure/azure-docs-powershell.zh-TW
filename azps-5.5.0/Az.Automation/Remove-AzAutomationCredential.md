...
## 說明
**AzAutomationCredential** Cmdlet 會從 Azure 自動化中移除認證。
...
這個命令會在 Azure 自動化帳戶（名為 Contoso17）中移除一個名為 ContosoCredential 的認證。

## 參數

### -AutomationAccountName
指定此 Cmdlet 移除認證的自動化帳戶名稱。
