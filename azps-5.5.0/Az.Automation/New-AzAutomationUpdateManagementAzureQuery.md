...
## 摘要
建立 azure 自動化軟體更新 configuration azure 查詢物件。
...
## 說明
建立將用來建立軟體更新設定的軟體更新 configuration azure 查詢物件，該設定將會在排程上執行，以更新 azure 虛擬機器清單的動態解析清單。
...
### UpdateManagement TagOperators 中的 []

### System.object

## 輸出

### UpdateManagement AzureQueryProperties 中的 []
