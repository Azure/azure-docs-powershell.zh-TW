...
這個命令會建立已連接的 kubernetes。

### 範例1：使用參數 kubeConfig 和 kubeCoNtext 建立已連接的 kubernetes
```powershell
...
這個命令會建立一個連接的 kubernetes，並使用參數 kubeConfig 和 kubeCoNtext。
