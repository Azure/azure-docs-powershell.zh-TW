...
## 說明
New-AzSqlVMGroup Cmdlet 會建立 Azure SQL 虛擬電腦群組。
...
使用 [資源群組 ResourceGroup01] 中的測試組 vm 建立新的 Azure SQL 虛擬電腦群組。
$profile 是 WsfcDomainProfile SqlVirtualMachine 類型的物件。
...
### -SqlServiceAccount
SQL 服務將在群集中所有參與的 SQL 虛擬機器上執行的名稱
