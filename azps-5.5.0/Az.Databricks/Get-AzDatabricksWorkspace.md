...
這個命令會取得資源群組中的 Databricks 工作區。

### 範例2：列出訂閱中的所有 Databricks 工作區
```powershell
...
這個命令會列出訂閱中的所有 Databricks 工作區。

### 範例3：列出資源群組中的所有 Databricks 工作區
```powershell
...
這個命令會列出資源群組中的所有 Databricks 工作區。
