...
## 說明
**AzDataLakeAnalyticsFirewallRule** Cmdlet 會從 Azure Data Lake Analytics 帳戶中移除防火牆規則。
...
這個命令會從帳戶 "ContosoAdlAcct" 移除名為「我的防火牆規則」的防火牆規則

## 參數

### -帳戶
要從中移除防火牆規則的資料 Lake Analytics 帳戶
