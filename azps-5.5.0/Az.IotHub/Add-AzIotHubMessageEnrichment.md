...
## 說明
在每個 IoT 中樞中新增最多10個郵件 enrichments。 這些會新增為應用程式屬性，以將郵件傳送到所選的端點 (s) 。
若要深入瞭解，請參閱 https://docs.microsoft.com/en-us/azure/iot-hub/iot-hub-message-enrichments-overview
...
新增具有索引鍵 "newKey" 和值 "newValue" 的新擴充。 這個新的擴充會套用至「endpoint1」和「endpoint2」端點。
