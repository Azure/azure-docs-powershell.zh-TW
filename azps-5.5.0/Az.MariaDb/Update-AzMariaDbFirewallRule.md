...
這個命令會更新 MariaDB 防火牆規則。

### 範例2：依身分識別來更新 MariaDB 防火牆規則。
```powershell
...
此 Cmdlet 會依身分識別來更新 MariaDB 防火牆規則。

### 範例3：以-ClientIPAddress 更新 MariaDB 防火牆規則。
```powershell
PS C:\> $ID = "/subscriptions/<SubscriptionId>/resourceGroups/mariadb-test-qu5ov0/providers/Microsoft.DBforMariaDB/servers/mariadb-test-4rmtig/firewallRules/fr-cfgl3y"
...
Cmdlet 會透過-ClientIPAddress 更新 MariaDB 防火牆規則。
