...
## 說明
**AzMetricAlertRule** Cmdlet 會新增或更新以公制為基礎的警示規則。
新增的規則與資源群組相關聯，且具有名稱。
...
### ConditionOperator 中的 [管理模型]。

### Double

### System.object

### 可為 Null 的 "1 [TimeAggregationOperator，.. Monitor，版本 = 1.0.0.0，Culture = 中性，PublicKeyToken = null]] （Culture = null）]
