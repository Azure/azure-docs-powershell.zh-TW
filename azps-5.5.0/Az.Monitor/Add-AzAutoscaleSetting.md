...
## 說明
**AzAutoscaleSetting** Cmdlet 會建立自動縮放設定。
...
前兩個命令使用 [New-AzAutoscaleRule](https://docs.microsoft.com/en-us/powershell/module/az.monitor/new-azautoscalerule) 來建立兩個自動縮放規則，$Rule 1 和 $Rule 2。
第三個和第四個命令使用 [New-AzAutoscaleProfile](https://docs.microsoft.com/en-us/powershell/module/az.monitor/new-azautoscaleprofile) 來建立自動縮放設定檔，$Profile 1 和 $Profile 2，使用 $Rule 1 和 $Rule 2。
最終命令會使用 $Profile 1 和 $Profile 2 中的設定檔來建立自動縮放設定。

## 參數

### -AutoscaleProfile
指定要新增到自動縮放設定的配置檔案清單，或 $Null 以新增無設定檔。
...
### PSAutoscaleSetting 中的 OutputClasses。

### System.object

### SwitchParameter 的系統管理功能

### [System.object]。清單 ' 1 [AutoscaleProfile，，Marvell. PowerShell. Monitor，版本 = 1.0.0.0，Culture = 中性，PublicKeyToken = null]]。）））

### [System.object]。清單 ' 1 [AutoscaleNotification，，Marvell. PowerShell. Monitor，版本 = 1.0.0.0，Culture = 中性，PublicKeyToken = null]]。）））

## 輸出

### PSAddAutoscaleSettingOperationResponse 中的 OutputClasses。
