...
## 說明
**新的-AzDataShareDataSet** Cmdlet 會在資料共用帳戶的 azure 資料共用中新增資料集。 您可以新增類型為 Blob、ADLS Gen2 和 ADLS Gen1 的資料集。
...
這個命令會將一個名為 blob 容器的資料集 AdsDataSet 到 azure data share AdsShare。
