...
### 範例1：使用 service id 參數取得服務的所有問題 classificaitons。
```powershell
...
### 範例2：使用上層服務物件取得服務的所有問題 classificaitons
```powershell
...
### 範例3：取得依管道服務物件識別碼 classificaiton 單一問題的詳細資料
```powershell
...
### PSSupportProblemClassification （支援）。
