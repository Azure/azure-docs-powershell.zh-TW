...
使用 ResourceId 設定 Exchange 對等的 Ipv4 位址
...
### -DirectConnection
使用 New-AzDirectPeeringConnectionObject 和 pipe 建立新的直接連線至此命令。
...
### -ExchangeConnection
使用 New-AzExchangePeeringConnectionObject 和管道建立新的 Exchange 連線至此命令。
