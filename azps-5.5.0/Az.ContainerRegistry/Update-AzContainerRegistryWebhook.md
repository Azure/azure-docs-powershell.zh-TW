...
## 說明
Update-AzContainerRegistryWebhook Cmdlet 會更新容器註冊表 webhook。

## 示例

### 範例1：更新現有的容器註冊表 webhook。
```powershell
...
### -頁首
\[ \] 將新增至 webhook 通知的 [金鑰 = 值] 格式中的自訂標頭（以空格分隔）。
