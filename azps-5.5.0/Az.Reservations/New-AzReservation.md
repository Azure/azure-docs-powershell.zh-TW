...
計算價格之後，客戶可以 purcahse RI 提供的 calculatePrice

## 參數

### -AppliedScope
將套用福利的訂閱。 如果已套用-作用欄位型別為 Single，則為必要。 請勿指定是否已共用套用範圍類型。
...
### ReservationOrderResponse 中的 [Azure. 管理]
