...
## 說明
Invoke-AzDataMigrationCommand Cmdlet 會建立要在現有的遷移工作上執行的新命令任務。
...
上述範例使用 Invoke-AzDataMigrationCommand Cmdlet 來建立現有服務、專案及工作的命令
...
### CommandProperties 中的 DataMigration。
