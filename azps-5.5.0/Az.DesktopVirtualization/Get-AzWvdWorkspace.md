...
這個命令會在資源群組中取得 Windows 虛擬桌面工作區。

### 範例2：列出 Windows 虛擬桌面工作區
```powershell
...
### IWorkspace （DesktopVirtualization）。 Api20201102Preview。
