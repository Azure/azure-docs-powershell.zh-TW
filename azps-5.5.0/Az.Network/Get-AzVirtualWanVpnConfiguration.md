...
### ByVirtualWanNameByVpnSiteObject (預設) 
```
...
接著，就會使用這個 commandlet 來下載該設定。

如果該 commandlet 成功，則會將下載設定寫入 SignedSasUrl 所指示的 blob。
...
### PSVirtualWanVpnSitesConfiguration 中的 [.]
