...
## 說明
**新的-AzRouteTable** Cmdlet 會建立 Azure 路由表。
...
第一個命令會使用 New-AzRouteConfig Cmdlet 來建立名為 Route07 的路由，然後將它儲存在 $Route 變數中。 此路由會將資料包轉寄到本機虛擬網路。
...
如需詳細資訊，請參閱 [Azure 地區](http://azure.microsoft.com/en-us/regions/)。
