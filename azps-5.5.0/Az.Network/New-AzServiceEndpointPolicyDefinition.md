...
## 說明
**AzServiceEndpointPolicyDefinition** Cmdlet 會建立服務端點原則定義。
...
這個命令會建立服務端點原則定義與 name ServiceEndpointPolicyDefinition1、service name、service 資源訂閱/sub1，以及將其儲存在 $policydef 變數中的資源群組。
...
### PSServiceEndpointPolicyDefinition 中的 [.]
