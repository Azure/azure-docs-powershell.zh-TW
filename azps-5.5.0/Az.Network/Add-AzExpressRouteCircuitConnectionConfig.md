...
## 說明
**AzExpressRouteCircuitConnectionConfig** Cmdlet 會將線路連線設定新增至 ExpressRoute 回路的專用對等。 這可讓跨地區或訂閱的兩個 Express 路線電路對等。請注意，執行 **附加 AzExpressRouteCircuitConnectionConfig** 之後，您必須呼叫 Set-AzExpressRouteCircuit Cmdlet 才能啟動設定。
