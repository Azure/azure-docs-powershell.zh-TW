...
## 說明
**新的-AzPrivateLinkServiceIpConfig** Cmdlet 會建立私人連結服務 ip 設定。 此設定是用於來源 NAT 對來自專用端點的入站流量進行運算。 
...
### -PrivateIpAddress
如果指定靜態配置，則為 ipConfiguration 的專用 ip 位址。
...
### PSPrivateLinkServiceIpConfiguration 中的 [.]
