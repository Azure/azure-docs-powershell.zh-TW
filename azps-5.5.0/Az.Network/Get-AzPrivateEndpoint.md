...
## 說明
**AzPrivateEndpoint** Cmdlet 會取得一或多個私人端點。
...
這個命令會在 [資源] 群組 TestResourceGroup 中取得名為 MyPrivateEndpoint1 的專用端點。

### 範例2：列出 ResourceGroup 中的所有私人端點
```powershell
...
這個命令會取得 [資源群組] TestResourceGroup 中的所有私人端點
