...
## 說明
New-AzNetworkWatcherConnectionMonitorTestConfigurationObject Cmdlet 會建立連線監視器測試組態。
...
Name （名稱）： HTTPTC TestFrequencySec： 120 PreferredIPVersion： ProtocolConfiguration： {"Port"：443，"方法"： "取得"，"RequestHeaders"： [{"Name"： "Allow"，"ValidStatusCodeRanges"： ["，" 300-308 "]，" PreferHTTPS "： true} SuccessThreshold： {" ChecksFailedPercent "：20，" RoundTripTimeMs "： 30} 
...
### -PreferredIPVersion
要在測試評估中使用的首選 IP 版本。 根據其他參數，連接監視器可能會選擇使用不同的版本。
...
### PSNetworkWatcherConnectionMonitorTestConfigurationObject 中的 [.]
