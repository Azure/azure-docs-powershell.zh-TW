...
## 摘要
在可與 VpnSiteLinkConnection 相關聯的 VpnGateway 上建立 NAT 規則。
...
## 說明
在可與 VpnGateway 相關聯的 VpnGateway 上建立 NAT 規則。
...
上述將會建立資源群組、虛擬 WAN、虛擬網路、虛擬中樞。 接著，我們會在該虛擬中樞下建立 VpnGateway。 接著，使用此命令： New-AzVpnGatewayNatRule，NAT 規則可以 createdand 與建立的 VpnGateway 相關聯。
