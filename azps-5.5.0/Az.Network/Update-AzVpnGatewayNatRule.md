...
## 說明
**AzVpnGatewayNatRule** Cmdlet 會更新與 VpnGateway 相關聯的 NAT 規則。
...
上述將會建立資源群組、虛擬 WAN、虛擬網路、虛擬中樞。 接著，我們會在該虛擬中樞下建立 VpnGateway。 接著，建立與建立的 VpnGateway 相關聯的新 NAT 規則。
使用此命令：更新-AzVpnGatewayNatRule、更新 NAT 規則。
