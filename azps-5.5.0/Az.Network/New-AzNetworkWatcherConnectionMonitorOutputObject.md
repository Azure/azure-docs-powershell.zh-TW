...
## 說明
New-AzNetworkWatcherConnectionMonitorOutputObject Cmdlet 會建立連接監視器輸出目的地物件。
...
類型： "workspace" WorkspaceSettings： {"WorkspaceResourceId"： "MyWSResourceId"}
...
### PSNetworkWatcherConnectionMonitorOutputObject 中的 [.]
