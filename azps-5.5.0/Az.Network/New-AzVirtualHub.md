...
這個範例與範例1類似，但使用資源識別碼來參照建立虛擬中樞所需的虛擬 WAN。
...
上述將會建立一個資源群組 "testRG"，也就是 Azure 中該資源群組的 [西部我們] 中的虛擬 WAN 和虛擬中樞。 虛擬中樞會將位址空間 "10.0.1.0/24" 和附加路由表。

這個範例與範例2類似，但也會將路由資料表附加至虛擬中樞。
