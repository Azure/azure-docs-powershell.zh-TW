...
## 說明
New-AzNetworkWatcherConnectionMonitorTestGroupObject Cmdlet 會建立連接監視器測試群組。

## 示例

### 範例1：建立含 2 testConfigurations、w 來源和2目的地端點的測試群組
...
### PSNetworkWatcherConnectionMonitorTestGroupObject 中的 [.]
