...
## 說明
**新的-AzApplicationGatewayRedirectConfiguration** Cmdlet 會為應用程式閘道建立重新導向配置。
...
這個命令會建立名為 Redirect01 的重新導向配置，並將結果儲存在名為 $RedirectConfig 的變數中。

### 範例2

建立應用程式閘道的重新導向設定。  (自動生成) 
