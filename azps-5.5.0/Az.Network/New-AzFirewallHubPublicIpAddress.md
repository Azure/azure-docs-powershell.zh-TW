...
這會在附加至虛擬中樞的防火牆上建立兩個公用 ip。 這會在後端建立 ip 位址。我們無法針對新的防火牆明確提供 ipaddresses。
...
這將會保留防火牆上已存在 $publicIp 1、$publicIp 2，以在防火牆上建立1個新的公用 ip。
...
### PSAzureFirewallHubPublicIpAddresses 中的 [.]
