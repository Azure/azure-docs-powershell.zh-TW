...
## 說明
**新的-AzStackEdgeOrder** Cmdlet 會針對堆疊 Edge 裝置建立新的訂單。 在建立訂單前，必須先建立堆疊邊緣裝置資源。 您可以指定 [連絡人]、[公司名稱]、[電子郵件]、[位址等] 等詳細資料。作為建立訂單的參數。
