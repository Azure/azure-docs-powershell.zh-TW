...
## 說明
**Sync-AzMediaServiceStorageKey** Cmdlet 會針對與媒體服務相關聯的儲存空間帳戶同步處理儲存空間帳戶金鑰。
...
第一個命令使用 Get-AzStorageAccount Cmdlet 來取得名為 Storage135 的 ResourceGroup001 儲存帳戶，並將結果儲存在名為 $StorageAccount 的變數中。
