...
針對在 [租使用者範圍] 下建立的私人儲存，建立 [私人 + 公用計畫]。 
...
更新：針對在租使用者範圍內建立的私人儲存，提供私人 + 公用方案。 需要 Etag。
...
只有在 [訂閱範圍] 下建立的專用方案，才會提供私人儲存的更新。 需要 Etag。
...
### -ETag
Azure Marketplace privateStore 提供的 eTag 以進行更新
...
### -OfferId
所需的 Azure Marketplace privateStore 優惠
...
### -PrivateStoreId
所需的 Azure Marketplace privateStore 提供
...
所需的 Azure Marketplace privateStore 優惠的特定方案識別碼限制
...
### [PrivateStore]. [PSPrivateStoreOffer]
