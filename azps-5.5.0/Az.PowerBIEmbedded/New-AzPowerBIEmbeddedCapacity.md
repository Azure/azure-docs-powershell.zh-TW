...
## 說明
New-AzPowerBIEmbeddedCapacity Cmdlet 會建立新的 PowerBI 內嵌容量
...
在 Azure 地區的 [美國] 和 [資源群組] testRG 中，建立名為 testcapacity 的容量。 容量的 sku 層級會是 A1。

## 參數

### -系統管理員
在容量上將逗號分隔的名稱設定為系統管理員
