...
## 說明
**AzProviderFeature** Cmdlet 會在您的帳戶中註冊 Azure 提供者功能。
...
這會將 Microsoft 的 AllowApplicationSecurityGroups 功能新增至您的帳戶。
...
### PSProviderFeature 中的 SdkModels （）
