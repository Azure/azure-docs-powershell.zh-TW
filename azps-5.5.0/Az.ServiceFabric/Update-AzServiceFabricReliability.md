...
## 說明
在群集中使用 **更新-AzServiceFabricReliability** 更新主要節點類型的可靠性。
...
這個命令會將主要節點類型的可靠性層級變更為銀色。

### 範例2

在群集中更新主要節點類型的可靠性層級。  (自動生成) 
...
### ReliabilityLevel 中的 ServiceFabric。
