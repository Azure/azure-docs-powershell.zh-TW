...
## 說明
**AzConsumptionUsageDetail** Cmdlet 會取得訂閱的使用詳細資料。 

## 示例

### 範例1：使用 [展開 MeterDetails] 來取得使用狀況詳細資料
```powershell
...
### 範例3：使用 InstanceName 篩選取得 BillingPeriodName 的使用狀況詳細資料
```powershell
...
### -展開
根據 MeterDetails 或 AdditionalInfo 展開使用實例。
