...
## 說明
在 Azure IoT 中樞裝置的 [提供服務] 中取得裝置註冊詳細資料或清單設備註冊。
...
在 Azure IoT 中樞裝置提供服務中取得裝置註冊的詳細資料。
...
在 Azure IoT 中樞裝置的 [提供服務] 中，列出裝置註冊。
...
### PSIndividualEnrollments []. DeviceProvisioningServices. []
