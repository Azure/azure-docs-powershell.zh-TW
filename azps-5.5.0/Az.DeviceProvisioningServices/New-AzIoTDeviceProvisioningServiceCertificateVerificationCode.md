...
## 說明
此驗證碼是用來完成憑證的已保管步驟證明。 使用此驗證碼作為使用 [根憑證私密金鑰] 簽署的新憑證的 CN。
如需 Azure IoT 中樞裝置提供服務中 CA 憑證的詳細說明，請參閱 https://docs.microsoft.com/en-us/azure/iot-dps/how-to-verify-certificates 。
...
### PSVerificationCodeResponse （DeviceProvisioningServices.）。
