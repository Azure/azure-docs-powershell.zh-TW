...
## 說明
**AzSqlSyncGroup** Cmdlet 會修改 Azure SQL Database 同步處理成員的屬性。
...
如果 UsePrivateLinkConnection 設定為 true，則會使用同步處理成員資料庫的資源識別碼。
