...
## 說明
**Enable-AzSqlInstanceActiveDirectoryOnlyAuthentication** Cmdlet 會啟用 Azure Active Directory (azure AD) 只有目前訂閱中 AzureSQL 受管理實例的驗證需求。
...
這個命令會啟用 Azure Active Directory (Azure AD) 只有與名為 ResourceGroup01 之資源群組相關聯之 AzureSQL Managed 實例的驗證需求。
