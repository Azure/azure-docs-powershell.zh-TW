...
## 說明
這個命令會在伺服器上取得特定的 Azure SQL Server 虛擬網路規則或 Azure SQL Server 虛擬網路規則清單。
...
在指定的伺服器下取得 Azure SQL Server 虛擬網路規則清單
...
取得以 "virtualNetworkRule" 開頭的指定伺服器的 Azure SQL Server 虛擬網路規則清單。
