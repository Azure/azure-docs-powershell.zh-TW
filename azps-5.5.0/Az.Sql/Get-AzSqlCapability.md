...
## 說明
**AzSqlCapability** Cmdlet 會取得在目前的區域訂閱中提供的 Azure SQL 資料庫功能。
...
如需詳細資訊，請參閱 Azure 地區 http://azure.microsoft.com/en-us/regions/ (http://azure.microsoft.com/en-us/regions/) 。
