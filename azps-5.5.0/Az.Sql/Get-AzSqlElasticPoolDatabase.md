...
## 說明
**AzSqlElasticPoolDatabase** Cmdlet 會在彈性池中取得彈性資料庫及其屬性值。
您可以在 Azure SQL Database 中指定彈性資料庫的名稱，只查看該資料庫的屬性值。
...
這個命令會取得一個名為 ElasticPool01 的彈性池中的所有資料庫。

### 範例2：使用篩選在彈性池中取得所有資料庫
```
PS C:\> Get-AzSqlElasticPoolDatabase -ResourceGroupName "ResourceGroup01" -ServerName "Server01" -ElasticPoolName "ElasticPool01" -DatabaseName "Database*"
```

這個命令會取得名為 ElasticPool01 且名為「Database」的彈性池中的所有資料庫。

## 參數

### -DatabaseName
指定此 Cmdlet 所取得之 SQL 資料庫的名稱。
