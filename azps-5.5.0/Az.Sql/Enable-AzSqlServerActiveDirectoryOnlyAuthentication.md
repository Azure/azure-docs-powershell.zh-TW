...
## 說明
**Enable-AzSqlServerActiveDirectoryOnlyAuthentication** Cmdlet 會啟用 Azure Active Directory (azure AD) 僅針對目前訂閱中的 AzureSQL 伺服器進行驗證需求。
...
這個命令會啟用 Azure Active Directory (Azure AD) 只有一個名為 Server01 的 AzureSQL 伺服器的驗證需求，該伺服器與名為 ResourceGroup01 的資源群組相關聯。
