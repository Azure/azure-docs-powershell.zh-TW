...
### StopByNameAndManagedInstanceAndResourceGroupParameterSet (預設) 
```
...
## 說明
Stop-AzSqlInstanceOperation Cmdlet 會在 SQL managed 實例上以提供的操作名稱停止操作。
...
這個命令會在 SQL managed 實例上停止使用「d0f5bef5-e2b1-4ef8-bb42-2e54073874f9」的 "name" 運算。
...
這個命令會停止作業，並使用資源識別碼 $managedInstanceOperation. Id。
...
這個命令會停止與物件 $managedInstanceOperation 的操作。
