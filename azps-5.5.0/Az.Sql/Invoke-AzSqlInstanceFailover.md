...
## 說明
**AzSqlInstanceFailover** Cmdlet 會針對 Azure SQL Managed 實例進行容錯移轉。
...
這個命令會將名為 "ManagedInstance01" 的實例的主要複本容錯移轉。
...
這個命令會自動容錯移轉受管理實例 "ManagedInstance01" 的可讀取次要複本。
