...
### [<span data-ttu-id="91322-111">附加 AzSqlInstanceKeyVaultKey</span><span class="sxs-lookup"><span data-stu-id="91322-111">Add-AzSqlInstanceKeyVaultKey</span></span>](Add-AzSqlInstanceKeyVaultKey.md)
...
### [<span data-ttu-id="91322-125">Clear-AzSqlInstanceDatabaseVulnerabilityAssessmentRuleBaseline</span><span class="sxs-lookup"><span data-stu-id="91322-125">Clear-AzSqlInstanceDatabaseVulnerabilityAssessmentRuleBaseline</span></span>](Clear-AzSqlInstanceDatabaseVulnerabilityAssessmentRuleBaseline.md)
...
### [<span data-ttu-id="91322-139">Convert-AzSqlInstanceDatabaseVulnerabilityAssessmentScan</span><span class="sxs-lookup"><span data-stu-id="91322-139">Convert-AzSqlInstanceDatabaseVulnerabilityAssessmentScan</span></span>](Convert-AzSqlInstanceDatabaseVulnerabilityAssessmentScan.md)
...
### [<span data-ttu-id="91322-151">Disable-AzSqlServerAdvancedDataSecurity</span><span class="sxs-lookup"><span data-stu-id="91322-151">Disable-AzSqlServerAdvancedDataSecurity</span></span>](Disable-AzSqlServerAdvancedDataSecurity.md)
...
### [<span data-ttu-id="91322-163">Enable-AzSqlServerActiveDirectoryOnlyAuthentication</span><span class="sxs-lookup"><span data-stu-id="91322-163">Enable-AzSqlServerActiveDirectoryOnlyAuthentication</span></span>](Enable-AzSqlServerActiveDirectoryOnlyAuthentication.md)
...
### [<span data-ttu-id="91322-177">AzSqlDatabaseAdvisor</span><span class="sxs-lookup"><span data-stu-id="91322-177">Get-AzSqlDatabaseAdvisor</span></span>](Get-AzSqlDatabaseAdvisor.md)
...
### [<span data-ttu-id="91322-191">AzSqlDatabaseFailoverGroup</span><span class="sxs-lookup"><span data-stu-id="91322-191">Get-AzSqlDatabaseFailoverGroup</span></span>](Get-AzSqlDatabaseFailoverGroup.md)
...
### [<span data-ttu-id="91322-205">AzSqlDatabaseRecommendedAction</span><span class="sxs-lookup"><span data-stu-id="91322-205">Get-AzSqlDatabaseRecommendedAction</span></span>](Get-AzSqlDatabaseRecommendedAction.md)
...
### [<span data-ttu-id="91322-219">AzSqlDatabaseUpgradeHint</span><span class="sxs-lookup"><span data-stu-id="91322-219">Get-AzSqlDatabaseUpgradeHint</span></span>](Get-AzSqlDatabaseUpgradeHint.md)
...
### [<span data-ttu-id="91322-233">AzSqlElasticJobAgent</span><span class="sxs-lookup"><span data-stu-id="91322-233">Get-AzSqlElasticJobAgent</span></span>](Get-AzSqlElasticJobAgent.md)
...
### [<span data-ttu-id="91322-247">AzSqlElasticPool</span><span class="sxs-lookup"><span data-stu-id="91322-247">Get-AzSqlElasticPool</span></span>](Get-AzSqlElasticPool.md)
...
### [<span data-ttu-id="91322-261">AzSqlInstanceActiveDirectoryAdministrator</span><span class="sxs-lookup"><span data-stu-id="91322-261">Get-AzSqlInstanceActiveDirectoryAdministrator</span></span>](Get-AzSqlInstanceActiveDirectoryAdministrator.md)
...
### [<span data-ttu-id="91322-273">AzSqlInstanceDatabaseGeoBackup</span><span class="sxs-lookup"><span data-stu-id="91322-273">Get-AzSqlInstanceDatabaseGeoBackup</span></span>](Get-AzSqlInstanceDatabaseGeoBackup.md)
...
### [<span data-ttu-id="91322-287">AzSqlInstanceDatabaseVulnerabilityAssessmentSetting</span><span class="sxs-lookup"><span data-stu-id="91322-287">Get-AzSqlInstanceDatabaseVulnerabilityAssessmentSetting</span></span>](Get-AzSqlInstanceDatabaseVulnerabilityAssessmentSetting.md)
...
### [<span data-ttu-id="91322-301">AzSqlServer</span><span class="sxs-lookup"><span data-stu-id="91322-301">Get-AzSqlServer</span></span>](Get-AzSqlServer.md)
...
### [<span data-ttu-id="91322-315">AzSqlServerCommunicationLink</span><span class="sxs-lookup"><span data-stu-id="91322-315">Get-AzSqlServerCommunicationLink</span></span>](Get-AzSqlServerCommunicationLink.md)
...
### [<span data-ttu-id="91322-329">AzSqlServerRecommendedAction</span><span class="sxs-lookup"><span data-stu-id="91322-329">Get-AzSqlServerRecommendedAction</span></span>](Get-AzSqlServerRecommendedAction.md)
...
### [<span data-ttu-id="91322-343">AzSqlSyncAgentLinkedDatabase</span><span class="sxs-lookup"><span data-stu-id="91322-343">Get-AzSqlSyncAgentLinkedDatabase</span></span>](Get-AzSqlSyncAgentLinkedDatabase.md)
...
### [<span data-ttu-id="91322-359">Invoke-AzSqlInstanceFailover</span><span class="sxs-lookup"><span data-stu-id="91322-359">Invoke-AzSqlInstanceFailover</span></span>](Invoke-AzSqlInstanceFailover.md)
...
### [<span data-ttu-id="91322-373">新-AzSqlDatabaseInstanceFailoverGroup</span><span class="sxs-lookup"><span data-stu-id="91322-373">New-AzSqlDatabaseInstanceFailoverGroup</span></span>](New-AzSqlDatabaseInstanceFailoverGroup.md)
...
### [<span data-ttu-id="91322-387">新-AzSqlElasticPool</span><span class="sxs-lookup"><span data-stu-id="91322-387">New-AzSqlElasticPool</span></span>](New-AzSqlElasticPool.md)
...
### [<span data-ttu-id="91322-403">新-AzSqlServerFirewallRule</span><span class="sxs-lookup"><span data-stu-id="91322-403">New-AzSqlServerFirewallRule</span></span>](New-AzSqlServerFirewallRule.md)
...
### [<span data-ttu-id="91322-419">移除-AzSqlDatabaseDataMaskingRule</span><span class="sxs-lookup"><span data-stu-id="91322-419">Remove-AzSqlDatabaseDataMaskingRule</span></span>](Remove-AzSqlDatabaseDataMaskingRule.md)
...
### [<span data-ttu-id="91322-433">移除-AzSqlDatabaseSensitivityClassification</span><span class="sxs-lookup"><span data-stu-id="91322-433">Remove-AzSqlDatabaseSensitivityClassification</span></span>](Remove-AzSqlDatabaseSensitivityClassification.md)
...
### [<span data-ttu-id="91322-447">移除-AzSqlElasticPool</span><span class="sxs-lookup"><span data-stu-id="91322-447">Remove-AzSqlElasticPool</span></span>](Remove-AzSqlElasticPool.md)
...
### [<span data-ttu-id="91322-461">移除-AzSqlInstancePool</span><span class="sxs-lookup"><span data-stu-id="91322-461">Remove-AzSqlInstancePool</span></span>](Remove-AzSqlInstancePool.md)
...
### [<span data-ttu-id="91322-475">移除-AzSqlServerFirewallRule</span><span class="sxs-lookup"><span data-stu-id="91322-475">Remove-AzSqlServerFirewallRule</span></span>](Remove-AzSqlServerFirewallRule.md)
...
### [<span data-ttu-id="91322-491">Restore-AzSqlDatabase</span><span class="sxs-lookup"><span data-stu-id="91322-491">Restore-AzSqlDatabase</span></span>](Restore-AzSqlDatabase.md)
...
### [<span data-ttu-id="91322-505">Set-AzSqlDatabaseBackupShortTermRetentionPolicy</span><span class="sxs-lookup"><span data-stu-id="91322-505">Set-AzSqlDatabaseBackupShortTermRetentionPolicy</span></span>](Set-AzSqlDatabaseBackupShortTermRetentionPolicy.md)
<span data-ttu-id="91322-506">設定 [備份短期保留原則]。</span><span class="sxs-lookup"><span data-stu-id="91322-506">Sets a backup short term retention policy.</span></span>

### [<span data-ttu-id="91322-507">Set-AzSqlDatabaseDataMaskingPolicy</span><span class="sxs-lookup"><span data-stu-id="91322-507">Set-AzSqlDatabaseDataMaskingPolicy</span></span>](Set-AzSqlDatabaseDataMaskingPolicy.md)
<span data-ttu-id="91322-508">為資料庫設定資料遮罩。</span><span class="sxs-lookup"><span data-stu-id="91322-508">Sets data masking for a database.</span></span>

### [<span data-ttu-id="91322-509">Set-AzSqlDatabaseDataMaskingRule</span><span class="sxs-lookup"><span data-stu-id="91322-509">Set-AzSqlDatabaseDataMaskingRule</span></span>](Set-AzSqlDatabaseDataMaskingRule.md)
<span data-ttu-id="91322-510">為資料庫設定資料遮罩規則的屬性。</span><span class="sxs-lookup"><span data-stu-id="91322-510">Sets the properties of a data masking rule for a database.</span></span>

### [<span data-ttu-id="91322-511">Set-AzSqlDatabaseFailoverGroup</span><span class="sxs-lookup"><span data-stu-id="91322-511">Set-AzSqlDatabaseFailoverGroup</span></span>](Set-AzSqlDatabaseFailoverGroup.md)
<span data-ttu-id="91322-512">修改 Azure SQL Database 容錯移轉群組的設定。</span><span class="sxs-lookup"><span data-stu-id="91322-512">Modifies the configuration of an Azure SQL Database Failover Group.</span></span>

### [<span data-ttu-id="91322-513">Set-AzSqlDatabaseGeoBackupPolicy</span><span class="sxs-lookup"><span data-stu-id="91322-513">Set-AzSqlDatabaseGeoBackupPolicy</span></span>](Set-AzSqlDatabaseGeoBackupPolicy.md)
<span data-ttu-id="91322-514">設定資料庫地域備份原則。</span><span class="sxs-lookup"><span data-stu-id="91322-514">Sets a database geo backup policy.</span></span>

### [<span data-ttu-id="91322-515">Set-AzSqlDatabaseInstanceFailoverGroup</span><span class="sxs-lookup"><span data-stu-id="91322-515">Set-AzSqlDatabaseInstanceFailoverGroup</span></span>](Set-AzSqlDatabaseInstanceFailoverGroup.md)
<span data-ttu-id="91322-516">修改實例容錯移轉群組的配置。</span><span class="sxs-lookup"><span data-stu-id="91322-516">Modifies the configuration of an Instance Failover Group.</span></span>

### [<span data-ttu-id="91322-517">Set-AzSqlDatabaseRecommendedActionState</span><span class="sxs-lookup"><span data-stu-id="91322-517">Set-AzSqlDatabaseRecommendedActionState</span></span>](Set-AzSqlDatabaseRecommendedActionState.md)
<span data-ttu-id="91322-518">更新 Azure SQL Database 建議動作的狀態。</span><span class="sxs-lookup"><span data-stu-id="91322-518">Updates the state of an Azure SQL Database recommended action.</span></span>

### [<span data-ttu-id="91322-519">Set-AzSqlDatabaseSecondary</span><span class="sxs-lookup"><span data-stu-id="91322-519">Set-AzSqlDatabaseSecondary</span></span>](Set-AzSqlDatabaseSecondary.md)
<span data-ttu-id="91322-520">將次要資料庫切換為主要資料庫，以便啟動容錯移轉。</span><span class="sxs-lookup"><span data-stu-id="91322-520">Switches a secondary database to be primary in order to initiate failover.</span></span>

### [<span data-ttu-id="91322-521">Set-AzSqlDatabaseSensitivityClassification</span><span class="sxs-lookup"><span data-stu-id="91322-521">Set-AzSqlDatabaseSensitivityClassification</span></span>](Set-AzSqlDatabaseSensitivityClassification.md)
<span data-ttu-id="91322-522">設定資料庫中資料行的資訊類型及敏感度標籤。</span><span class="sxs-lookup"><span data-stu-id="91322-522">Sets the information types and sensitivity labels of columns in the database.</span></span>

### [<span data-ttu-id="91322-523">Set-AzSqlDatabaseTransparentDataEncryption</span><span class="sxs-lookup"><span data-stu-id="91322-523">Set-AzSqlDatabaseTransparentDataEncryption</span></span>](Set-AzSqlDatabaseTransparentDataEncryption.md)
<span data-ttu-id="91322-524">修改資料庫的 TDE 屬性。</span><span class="sxs-lookup"><span data-stu-id="91322-524">Modifies TDE property for a database.</span></span>

### [<span data-ttu-id="91322-525">Set-AzSqlDatabaseVulnerabilityAssessmentRuleBaseline</span><span class="sxs-lookup"><span data-stu-id="91322-525">Set-AzSqlDatabaseVulnerabilityAssessmentRuleBaseline</span></span>](Set-AzSqlDatabaseVulnerabilityAssessmentRuleBaseline.md)
<span data-ttu-id="91322-526">設定漏洞評估規則比較基準。</span><span class="sxs-lookup"><span data-stu-id="91322-526">Sets the vulnerability assessment rule baseline.</span></span>

### [<span data-ttu-id="91322-527">Set-AzSqlElasticJob</span><span class="sxs-lookup"><span data-stu-id="91322-527">Set-AzSqlElasticJob</span></span>](Set-AzSqlElasticJob.md)
<span data-ttu-id="91322-528">更新作業</span><span class="sxs-lookup"><span data-stu-id="91322-528">Updates a job</span></span>

### [<span data-ttu-id="91322-529">Set-AzSqlElasticJobAgent</span><span class="sxs-lookup"><span data-stu-id="91322-529">Set-AzSqlElasticJobAgent</span></span>](Set-AzSqlElasticJobAgent.md)
<span data-ttu-id="91322-530">更新彈性作業代理程式</span><span class="sxs-lookup"><span data-stu-id="91322-530">Updates an elastic job agent</span></span>

### [<span data-ttu-id="91322-531">Set-AzSqlElasticJobCredential</span><span class="sxs-lookup"><span data-stu-id="91322-531">Set-AzSqlElasticJobCredential</span></span>](Set-AzSqlElasticJobCredential.md)
<span data-ttu-id="91322-532">更新作業認證</span><span class="sxs-lookup"><span data-stu-id="91322-532">Updates a job credential</span></span>

### [<span data-ttu-id="91322-533">Set-AzSqlElasticJobStep</span><span class="sxs-lookup"><span data-stu-id="91322-533">Set-AzSqlElasticJobStep</span></span>](Set-AzSqlElasticJobStep.md)
<span data-ttu-id="91322-534">更新作業步驟</span><span class="sxs-lookup"><span data-stu-id="91322-534">Updates a job step</span></span>

### [<span data-ttu-id="91322-535">Set-AzSqlElasticPool</span><span class="sxs-lookup"><span data-stu-id="91322-535">Set-AzSqlElasticPool</span></span>](Set-AzSqlElasticPool.md)
<span data-ttu-id="91322-536">修改 Azure SQL 資料庫中彈性資料庫池的屬性。</span><span class="sxs-lookup"><span data-stu-id="91322-536">Modifies properties of an elastic database pool in Azure SQL Database.</span></span>

### [<span data-ttu-id="91322-537">Set-AzSqlElasticPoolAdvisorAutoExecuteStatus</span><span class="sxs-lookup"><span data-stu-id="91322-537">Set-AzSqlElasticPoolAdvisorAutoExecuteStatus</span></span>](Set-AzSqlElasticPoolAdvisorAutoExecuteStatus.md)
<span data-ttu-id="91322-538">更新 Azure SQL 彈性 Pool Advisor 的自動執行狀態。</span><span class="sxs-lookup"><span data-stu-id="91322-538">Updates auto execute status of an Azure SQL Elastic Pool Advisor.</span></span>

### [<span data-ttu-id="91322-539">Set-AzSqlElasticPoolRecommendedActionState</span><span class="sxs-lookup"><span data-stu-id="91322-539">Set-AzSqlElasticPoolRecommendedActionState</span></span>](Set-AzSqlElasticPoolRecommendedActionState.md)
<span data-ttu-id="91322-540">更新 Azure SQL 彈性池建議動作的狀態。</span><span class="sxs-lookup"><span data-stu-id="91322-540">Updates the state of an Azure SQL Elastic Pool recommended action.</span></span>

### [<span data-ttu-id="91322-541">Set-AzSqlInstance</span><span class="sxs-lookup"><span data-stu-id="91322-541">Set-AzSqlInstance</span></span>](Set-AzSqlInstance.md)
<span data-ttu-id="91322-542">設定 Azure SQL Database Managed 實例的屬性。</span><span class="sxs-lookup"><span data-stu-id="91322-542">Sets properties for an Azure SQL Database Managed Instance.</span></span>

### [<span data-ttu-id="91322-543">Set-AzSqlInstanceActiveDirectoryAdministrator</span><span class="sxs-lookup"><span data-stu-id="91322-543">Set-AzSqlInstanceActiveDirectoryAdministrator</span></span>](Set-AzSqlInstanceActiveDirectoryAdministrator.md)
<span data-ttu-id="91322-544">為 SQL 管理實例提供 Azure AD 系統管理員。</span><span class="sxs-lookup"><span data-stu-id="91322-544">Provisions an Azure AD administrator for SQL Managed Instance.</span></span>

### [<span data-ttu-id="91322-545">Set-AzSqlInstanceDatabaseBackupLongTermRetentionPolicy</span><span class="sxs-lookup"><span data-stu-id="91322-545">Set-AzSqlInstanceDatabaseBackupLongTermRetentionPolicy</span></span>](Set-AzSqlInstanceDatabaseBackupLongTermRetentionPolicy.md)
<span data-ttu-id="91322-546">**AzSqlInstanceDatabaseLongTermRetentionBackup** Cmdlet 會設定受管理資料庫的長期保留原則。</span><span class="sxs-lookup"><span data-stu-id="91322-546">The **Set-AzSqlInstanceDatabaseLongTermRetentionBackup** cmdlet sets a managed database's long term retention policy.</span></span>

### [<span data-ttu-id="91322-547">Set-AzSqlInstanceDatabaseBackupShortTermRetentionPolicy</span><span class="sxs-lookup"><span data-stu-id="91322-547">Set-AzSqlInstanceDatabaseBackupShortTermRetentionPolicy</span></span>](Set-AzSqlInstanceDatabaseBackupShortTermRetentionPolicy.md)
<span data-ttu-id="91322-548">設定 [備份短期保留原則]。</span><span class="sxs-lookup"><span data-stu-id="91322-548">Sets a backup short term retention policy.</span></span>

### [<span data-ttu-id="91322-549">Set-AzSqlInstanceDatabaseSensitivityClassification</span><span class="sxs-lookup"><span data-stu-id="91322-549">Set-AzSqlInstanceDatabaseSensitivityClassification</span></span>](Set-AzSqlInstanceDatabaseSensitivityClassification.md)
<span data-ttu-id="91322-550">在 Azure SQL managed 實例資料庫中設定欄的資訊類型和敏感度標籤。</span><span class="sxs-lookup"><span data-stu-id="91322-550">Sets the information types and sensitivity labels of columns in the Azure SQL managed instance database.</span></span>

### [<span data-ttu-id="91322-551">Set-AzSqlInstanceDatabaseVulnerabilityAssessmentRuleBaseline</span><span class="sxs-lookup"><span data-stu-id="91322-551">Set-AzSqlInstanceDatabaseVulnerabilityAssessmentRuleBaseline</span></span>](Set-AzSqlInstanceDatabaseVulnerabilityAssessmentRuleBaseline.md)
<span data-ttu-id="91322-552">設定漏洞評估規則比較基準。</span><span class="sxs-lookup"><span data-stu-id="91322-552">Sets the vulnerability assessment rule baseline.</span></span>

### [<span data-ttu-id="91322-553">Set-AzSqlInstancePool</span><span class="sxs-lookup"><span data-stu-id="91322-553">Set-AzSqlInstancePool</span></span>](Set-AzSqlInstancePool.md)
<span data-ttu-id="91322-554">設定 Azure SQL 實例池的屬性。</span><span class="sxs-lookup"><span data-stu-id="91322-554">Sets properties for an Azure SQL Instance pool.</span></span>

### [<span data-ttu-id="91322-555">Set-AzSqlInstanceTransparentDataEncryptionProtector</span><span class="sxs-lookup"><span data-stu-id="91322-555">Set-AzSqlInstanceTransparentDataEncryptionProtector</span></span>](Set-AzSqlInstanceTransparentDataEncryptionProtector.md)
<span data-ttu-id="91322-556">針對 SQL managed 實例 (TDE) 保護器設定透明的資料加密。</span><span class="sxs-lookup"><span data-stu-id="91322-556">Sets the Transparent Data Encryption (TDE) protector for a SQL managed instance.</span></span>

### [<span data-ttu-id="91322-557">Set-AzSqlServer</span><span class="sxs-lookup"><span data-stu-id="91322-557">Set-AzSqlServer</span></span>](Set-AzSqlServer.md)
<span data-ttu-id="91322-558">修改 SQL 資料庫伺服器的屬性。</span><span class="sxs-lookup"><span data-stu-id="91322-558">Modifies properties of a SQL Database server.</span></span>

### [<span data-ttu-id="91322-559">Set-AzSqlServerActiveDirectoryAdministrator</span><span class="sxs-lookup"><span data-stu-id="91322-559">Set-AzSqlServerActiveDirectoryAdministrator</span></span>](Set-AzSqlServerActiveDirectoryAdministrator.md)
<span data-ttu-id="91322-560">為 SQL Server 置備 Azure AD 管理員。</span><span class="sxs-lookup"><span data-stu-id="91322-560">Provisions an Azure AD administrator for SQL Server.</span></span>

### [<span data-ttu-id="91322-561">Set-AzSqlServerAdvisorAutoExecuteStatus</span><span class="sxs-lookup"><span data-stu-id="91322-561">Set-AzSqlServerAdvisorAutoExecuteStatus</span></span>](Set-AzSqlServerAdvisorAutoExecuteStatus.md)
<span data-ttu-id="91322-562">更新 Azure SQL Server Advisor 的自動執行狀態。</span><span class="sxs-lookup"><span data-stu-id="91322-562">Updates the auto execute status of an Azure SQL Server Advisor.</span></span>

### [<span data-ttu-id="91322-563">Set-AzSqlServerAudit</span><span class="sxs-lookup"><span data-stu-id="91322-563">Set-AzSqlServerAudit</span></span>](Set-AzSqlServerAudit.md)
<span data-ttu-id="91322-564">變更 Azure SQL server 的審核設定。</span><span class="sxs-lookup"><span data-stu-id="91322-564">Changes the auditing settings of an Azure SQL server.</span></span>

### [<span data-ttu-id="91322-565">Set-AzSqlServerDisasterRecoveryConfiguration</span><span class="sxs-lookup"><span data-stu-id="91322-565">Set-AzSqlServerDisasterRecoveryConfiguration</span></span>](Set-AzSqlServerDisasterRecoveryConfiguration.md)
<span data-ttu-id="91322-566">修改資料庫伺服器的恢復設定。</span><span class="sxs-lookup"><span data-stu-id="91322-566">Modifies a database server recovery configuration.</span></span>

### [<span data-ttu-id="91322-567">Set-AzSqlServerDnsAlias</span><span class="sxs-lookup"><span data-stu-id="91322-567">Set-AzSqlServerDnsAlias</span></span>](Set-AzSqlServerDnsAlias.md)
<span data-ttu-id="91322-568">修改 Azure SQL Server DNS 別名指向的目標伺服器</span><span class="sxs-lookup"><span data-stu-id="91322-568">Modifies the server to which Azure SQL Server DNS Alias is pointing</span></span>

### [<span data-ttu-id="91322-569">Set-AzSqlServerFirewallRule</span><span class="sxs-lookup"><span data-stu-id="91322-569">Set-AzSqlServerFirewallRule</span></span>](Set-AzSqlServerFirewallRule.md)
<span data-ttu-id="91322-570">修改 Azure SQL 資料庫伺服器中的防火牆規則。</span><span class="sxs-lookup"><span data-stu-id="91322-570">Modifies a firewall rule in Azure SQL Database server.</span></span>

### [<span data-ttu-id="91322-571">Set-AzSqlServerMSSupportAudit</span><span class="sxs-lookup"><span data-stu-id="91322-571">Set-AzSqlServerMSSupportAudit</span></span>](Set-AzSqlServerMSSupportAudit.md)
<span data-ttu-id="91322-572">變更 Azure SQL 資料庫的 Microsoft 支援作業審核設定。</span><span class="sxs-lookup"><span data-stu-id="91322-572">Changes the Microsoft support operations auditing settings for an Azure SQL database.</span></span>

### [<span data-ttu-id="91322-573">Set-AzSqlServerRecommendedActionState</span><span class="sxs-lookup"><span data-stu-id="91322-573">Set-AzSqlServerRecommendedActionState</span></span>](Set-AzSqlServerRecommendedActionState.md)
<span data-ttu-id="91322-574">更新 Azure SQL Server 建議動作的狀態。</span><span class="sxs-lookup"><span data-stu-id="91322-574">Updates the state of an Azure SQL Server recommended action.</span></span>

### [<span data-ttu-id="91322-575">Set-AzSqlServerTransparentDataEncryptionProtector</span><span class="sxs-lookup"><span data-stu-id="91322-575">Set-AzSqlServerTransparentDataEncryptionProtector</span></span>](Set-AzSqlServerTransparentDataEncryptionProtector.md)
<span data-ttu-id="91322-576">針對 SQL server 設定透明的資料加密 (TDE) 保護程式。</span><span class="sxs-lookup"><span data-stu-id="91322-576">Sets the Transparent Data Encryption (TDE) protector for a SQL server.</span></span>

### [<span data-ttu-id="91322-577">Set-AzSqlServerVirtualNetworkRule</span><span class="sxs-lookup"><span data-stu-id="91322-577">Set-AzSqlServerVirtualNetworkRule</span></span>](Set-AzSqlServerVirtualNetworkRule.md)
<span data-ttu-id="91322-578">修改 Azure SQL Server 虛擬網路規則的設定。</span><span class="sxs-lookup"><span data-stu-id="91322-578">Modifies the configuration of an Azure SQL Server Virtual Network Rule.</span></span>

### [<span data-ttu-id="91322-579">開始-AzSqlDatabaseExecuteIndexRecommendation</span><span class="sxs-lookup"><span data-stu-id="91322-579">Start-AzSqlDatabaseExecuteIndexRecommendation</span></span>](Start-AzSqlDatabaseExecuteIndexRecommendation.md)
<span data-ttu-id="91322-580">啟動執行建議索引作業的工作流程。</span><span class="sxs-lookup"><span data-stu-id="91322-580">Starts the workflow that runs a recommended index operation.</span></span>

### [<span data-ttu-id="91322-581">開始-AzSqlDatabaseVulnerabilityAssessmentScan</span><span class="sxs-lookup"><span data-stu-id="91322-581">Start-AzSqlDatabaseVulnerabilityAssessmentScan</span></span>](Start-AzSqlDatabaseVulnerabilityAssessmentScan.md)
<span data-ttu-id="91322-582">啟動漏洞評估掃描。</span><span class="sxs-lookup"><span data-stu-id="91322-582">Starts a vulnerability assessment scan.</span></span>

### [<span data-ttu-id="91322-583">開始-AzSqlElasticJob</span><span class="sxs-lookup"><span data-stu-id="91322-583">Start-AzSqlElasticJob</span></span>](Start-AzSqlElasticJob.md)
<span data-ttu-id="91322-584">啟動作業，然後返回可輪詢以查看其狀態的作業執行 id。</span><span class="sxs-lookup"><span data-stu-id="91322-584">Starts a job, returning a job execution id that can be polled to view it's status</span></span>

### [<span data-ttu-id="91322-585">開始-AzSqlInstanceDatabaseLogReplay</span><span class="sxs-lookup"><span data-stu-id="91322-585">Start-AzSqlInstanceDatabaseLogReplay</span></span>](Start-AzSqlInstanceDatabaseLogReplay.md)
<span data-ttu-id="91322-586">使用指定的參數開機記錄重播服務。</span><span class="sxs-lookup"><span data-stu-id="91322-586">Starts a Log Replay service with the given parameters.</span></span>

### [<span data-ttu-id="91322-587">開始-AzSqlInstanceDatabaseVulnerabilityAssessmentScan</span><span class="sxs-lookup"><span data-stu-id="91322-587">Start-AzSqlInstanceDatabaseVulnerabilityAssessmentScan</span></span>](Start-AzSqlInstanceDatabaseVulnerabilityAssessmentScan.md)
<span data-ttu-id="91322-588">啟動漏洞評估掃描。</span><span class="sxs-lookup"><span data-stu-id="91322-588">Starts a vulnerability assessment scan.</span></span>

### [<span data-ttu-id="91322-589">開始-AzSqlSyncGroupSync</span><span class="sxs-lookup"><span data-stu-id="91322-589">Start-AzSqlSyncGroupSync</span></span>](Start-AzSqlSyncGroupSync.md)
<span data-ttu-id="91322-590">啟動同步處理群組同步處理。</span><span class="sxs-lookup"><span data-stu-id="91322-590">Starts a sync group synchronization.</span></span>

### [<span data-ttu-id="91322-591">停止 AzSqlDatabaseActivity</span><span class="sxs-lookup"><span data-stu-id="91322-591">Stop-AzSqlDatabaseActivity</span></span>](Stop-AzSqlDatabaseActivity.md)
<span data-ttu-id="91322-592">取消資料庫上的非同步更新操作。</span><span class="sxs-lookup"><span data-stu-id="91322-592">Cancels the asynchronous updates operation on the database.</span></span>

### [<span data-ttu-id="91322-593">停止 AzSqlDatabaseExecuteIndexRecommendation</span><span class="sxs-lookup"><span data-stu-id="91322-593">Stop-AzSqlDatabaseExecuteIndexRecommendation</span></span>](Stop-AzSqlDatabaseExecuteIndexRecommendation.md)
<span data-ttu-id="91322-594">停止執行建議索引作業的工作流程。</span><span class="sxs-lookup"><span data-stu-id="91322-594">Stops the workflow that runs a recommended index operation.</span></span>

### [<span data-ttu-id="91322-595">停止 AzSqlElasticJob</span><span class="sxs-lookup"><span data-stu-id="91322-595">Stop-AzSqlElasticJob</span></span>](Stop-AzSqlElasticJob.md)
<span data-ttu-id="91322-596">停止指定其工作執行 id 的工作</span><span class="sxs-lookup"><span data-stu-id="91322-596">Stops a job given it's job execution id</span></span>

### [<span data-ttu-id="91322-597">停止 AzSqlElasticPoolActivity</span><span class="sxs-lookup"><span data-stu-id="91322-597">Stop-AzSqlElasticPoolActivity</span></span>](Stop-AzSqlElasticPoolActivity.md)
<span data-ttu-id="91322-598">取消彈性池中的非同步更新作業。</span><span class="sxs-lookup"><span data-stu-id="91322-598">Cancels the asynchronous update operation on an elastic pool.</span></span>

### [<span data-ttu-id="91322-599">停止 AzSqlInstanceDatabaseLogReplay</span><span class="sxs-lookup"><span data-stu-id="91322-599">Stop-AzSqlInstanceDatabaseLogReplay</span></span>](Stop-AzSqlInstanceDatabaseLogReplay.md)
<span data-ttu-id="91322-600">刪除資料庫，以取消記錄重新播放服務。</span><span class="sxs-lookup"><span data-stu-id="91322-600">Cancels the Log Replay service by dropping the database.</span></span>

### [<span data-ttu-id="91322-601">停止 AzSqlInstanceOperation</span><span class="sxs-lookup"><span data-stu-id="91322-601">Stop-AzSqlInstanceOperation</span></span>](Stop-AzSqlInstanceOperation.md)
<span data-ttu-id="91322-602">停止 SQL managed 實例的作業。</span><span class="sxs-lookup"><span data-stu-id="91322-602">Stops a SQL managed instance's operations.</span></span>

### [<span data-ttu-id="91322-603">停止 AzSqlSyncGroupSync</span><span class="sxs-lookup"><span data-stu-id="91322-603">Stop-AzSqlSyncGroupSync</span></span>](Stop-AzSqlSyncGroupSync.md)
<span data-ttu-id="91322-604">停止同步處理群組同步處理。</span><span class="sxs-lookup"><span data-stu-id="91322-604">Stops a sync group synchronization.</span></span>

### [<span data-ttu-id="91322-605">暫停-AzSqlDatabase</span><span class="sxs-lookup"><span data-stu-id="91322-605">Suspend-AzSqlDatabase</span></span>](Suspend-AzSqlDatabase.md)
<span data-ttu-id="91322-606">暫停 SQL 資料倉儲資料庫。</span><span class="sxs-lookup"><span data-stu-id="91322-606">Suspends a SQL Data Warehouse database.</span></span>

### [<span data-ttu-id="91322-607">切換 AzSqlDatabaseFailoverGroup</span><span class="sxs-lookup"><span data-stu-id="91322-607">Switch-AzSqlDatabaseFailoverGroup</span></span>](Switch-AzSqlDatabaseFailoverGroup.md)
<span data-ttu-id="91322-608">執行 Azure SQL Database 容錯移轉群組的容錯移轉。</span><span class="sxs-lookup"><span data-stu-id="91322-608">Executes a failover of an Azure SQL Database Failover Group.</span></span>

### [<span data-ttu-id="91322-609">切換 AzSqlDatabaseInstanceFailoverGroup</span><span class="sxs-lookup"><span data-stu-id="91322-609">Switch-AzSqlDatabaseInstanceFailoverGroup</span></span>](Switch-AzSqlDatabaseInstanceFailoverGroup.md)
<span data-ttu-id="91322-610">執行實例容錯移轉群組的容錯移轉。</span><span class="sxs-lookup"><span data-stu-id="91322-610">Executes a failover of an Instance Failover Group.</span></span>

### [<span data-ttu-id="91322-611">更新-AzSqlDatabaseAdvancedThreatProtectionSetting</span><span class="sxs-lookup"><span data-stu-id="91322-611">Update-AzSqlDatabaseAdvancedThreatProtectionSetting</span></span>](Update-AzSqlDatabaseAdvancedThreatProtectionSetting.md)
<span data-ttu-id="91322-612">在資料庫上設定高級威脅防護設定。</span><span class="sxs-lookup"><span data-stu-id="91322-612">Sets a advanced threat protection settings on a database.</span></span>

### [<span data-ttu-id="91322-613">更新-AzSqlDatabaseVulnerabilityAssessmentSetting</span><span class="sxs-lookup"><span data-stu-id="91322-613">Update-AzSqlDatabaseVulnerabilityAssessmentSetting</span></span>](Update-AzSqlDatabaseVulnerabilityAssessmentSetting.md)
<span data-ttu-id="91322-614">更新資料庫的漏洞評估設定。</span><span class="sxs-lookup"><span data-stu-id="91322-614">Updates the vulnerability assessment settings of a database.</span></span>

### [<span data-ttu-id="91322-615">更新-AzSqlInstanceDatabaseVulnerabilityAssessmentSetting</span><span class="sxs-lookup"><span data-stu-id="91322-615">Update-AzSqlInstanceDatabaseVulnerabilityAssessmentSetting</span></span>](Update-AzSqlInstanceDatabaseVulnerabilityAssessmentSetting.md)
<span data-ttu-id="91322-616">更新受管理資料庫的漏洞評估設定。</span><span class="sxs-lookup"><span data-stu-id="91322-616">Updates the vulnerability assessment settings of a managed database.</span></span>

### [<span data-ttu-id="91322-617">更新-AzSqlInstanceVulnerabilityAssessmentSetting</span><span class="sxs-lookup"><span data-stu-id="91322-617">Update-AzSqlInstanceVulnerabilityAssessmentSetting</span></span>](Update-AzSqlInstanceVulnerabilityAssessmentSetting.md)
<span data-ttu-id="91322-618">更新受管理實例的漏洞評估設定。</span><span class="sxs-lookup"><span data-stu-id="91322-618">Updates the vulnerability assessment settings of a managed instance.</span></span>

### [<span data-ttu-id="91322-619">更新-AzSqlServerAdvancedThreatProtectionSetting</span><span class="sxs-lookup"><span data-stu-id="91322-619">Update-AzSqlServerAdvancedThreatProtectionSetting</span></span>](Update-AzSqlServerAdvancedThreatProtectionSetting.md)
<span data-ttu-id="91322-620">在伺服器上設定高級威脅防護設定。</span><span class="sxs-lookup"><span data-stu-id="91322-620">Sets a advanced threat protection settings on a server.</span></span>

### [<span data-ttu-id="91322-621">更新-AzSqlServerVulnerabilityAssessmentSetting</span><span class="sxs-lookup"><span data-stu-id="91322-621">Update-AzSqlServerVulnerabilityAssessmentSetting</span></span>](Update-AzSqlServerVulnerabilityAssessmentSetting.md)
<span data-ttu-id="91322-622">補救伺服器的漏洞評估設定。</span><span class="sxs-lookup"><span data-stu-id="91322-622">Updates the vulnerability assessment settings of a server.</span></span>

### [<span data-ttu-id="91322-623">更新-AzSqlSyncGroup</span><span class="sxs-lookup"><span data-stu-id="91322-623">Update-AzSqlSyncGroup</span></span>](Update-AzSqlSyncGroup.md)
<span data-ttu-id="91322-624">更新 Azure SQL 資料庫同步處理群組。</span><span class="sxs-lookup"><span data-stu-id="91322-624">Updates an Azure SQL Database Sync Group.</span></span>

### [<span data-ttu-id="91322-625">更新-AzSqlSyncMember</span><span class="sxs-lookup"><span data-stu-id="91322-625">Update-AzSqlSyncMember</span></span>](Update-AzSqlSyncMember.md)
<span data-ttu-id="91322-626">更新 Azure SQL 資料庫同步處理成員。</span><span class="sxs-lookup"><span data-stu-id="91322-626">Updates an Azure SQL Database Sync Member.</span></span>

### [<span data-ttu-id="91322-627">更新-AzSqlSyncSchema</span><span class="sxs-lookup"><span data-stu-id="91322-627">Update-AzSqlSyncSchema</span></span>](Update-AzSqlSyncSchema.md)
<span data-ttu-id="91322-628">更新同步處理成員資料庫或同步處理中樞資料庫的同步處理架構。</span><span class="sxs-lookup"><span data-stu-id="91322-628">Update the sync schema for a sync member database or a sync hub database.</span></span>
<span data-ttu-id="91322-629">它會從真實資料庫取得最新的資料庫架構，然後使用它來重新整理同步處理中繼資料資料庫所緩存的架構。</span><span class="sxs-lookup"><span data-stu-id="91322-629">It will get the latest database schema from the real database and then use it refresh the schema cached by Sync metadata database.</span></span>
<span data-ttu-id="91322-630">如果指定了 "SyncMemberName"，則會重新整理成員資料庫架構;如果不是，它會重新整理中心資料庫架構。</span><span class="sxs-lookup"><span data-stu-id="91322-630">If "SyncMemberName" is specified, it will refresh the member database schema; if not, it will refresh the hub database schema.</span></span>
