...
## 說明
**AzSqlDatabaseAdvisor** Cmdlet 會針對 Azure sql 資料庫取得一個或多個 Azure Sql database 顧問。
...
這個命令會列出一個名為 WIRunner 的所有顧問，該資料庫屬於名為 [wi-東] 的伺服器，並以字母 "d" 開頭。
