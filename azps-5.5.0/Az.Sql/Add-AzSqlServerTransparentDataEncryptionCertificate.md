...
### AddAzureRmSqlServerTransparentDataEncryptionCertificateDefaultParameterSet (預設) 
```
...
## 說明
Add-AzSqlManagedInstanceTransparentDataEncryptionCertificate 為指定的 SQL Server 實例新增透明的資料加密憑證
...
使用資源組名稱和 SQL Server 名稱將 TDE 憑證新增至 sql server
