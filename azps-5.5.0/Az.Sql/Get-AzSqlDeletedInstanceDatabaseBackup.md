...
## 說明
**AzSqlDeletedInstanceDatabaseBackup** Cmdlet 會取得您可以還原的指定已刪除 SQL 實例資料庫備份，或您可以還原的所有已刪除備份。
Azure 上的 SQL 實例延伸資料庫服務也支援這個 Cmdlet。

## 示例

### 範例1：在伺服器上取得所有已刪除的資料庫備份
```powershell
...
### AzureSqlDeletedManagedDatabaseBackupModel 中的 [ManagedDatabaseBackup]
