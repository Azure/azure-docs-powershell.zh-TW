...
## 說明
**AzSqlInstancePoolUsage** Cmdlet 會傳回有關 Azure SQL 實例池用法的資訊。

## 示例

### 範例1：取得 Azure SQL 實例池的使用方式
```powershell
...
取得 Azure SQL 實例池 instancepool0 的使用方式。

### 範例2：使用實例池物件取得 Azure SQL 實例池的使用方式
```powershell
...
使用實例池物件取得 Azure SQL 實例池 instancepool0 的使用方式。

### 範例3：使用實例池資源識別碼取得 Azure SQL 實例池的使用方式
```powershell
...
使用實例池資源識別碼取得 Azure SQL 實例池 instancepool0 的使用方式。

### 範例3：取得對池中的受管理實例使用方式進行細目分類的 Azure SQL 實例池的使用方式。
```powershell
...
取得 Azure SQL 實例池 instancepool0 的用法，以及 instancepool0 中受管理實例的使用方式。
...
### -ExpandChildren
此標記指出是否要將這個實例池的使用方式與其孩子的使用方式展開。
