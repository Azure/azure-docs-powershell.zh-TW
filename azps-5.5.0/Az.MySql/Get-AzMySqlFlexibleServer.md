...
這個 Cmdlet 會取得使用預設內容的 MySql 伺服器。

### 範例2：透過資源群組和伺服器名稱取得 MySql 伺服器
```powershell
...
這個 Cmdlet 透過資源群組和伺服器名稱來取得 MySql 伺服器。

### 範例3：列出指定資源群組中的所有 MySql 伺服器
```powershell
...
這個 Cmdlet 會列出指定資源群組中的所有 MySql 伺服器。

### 範例4：透過身分識別取得 MySql 伺服器
```powershell
...
這個 Cmdlet 清單會透過身分識別取得 MySql 伺服器。
