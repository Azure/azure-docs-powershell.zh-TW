...
### [AzOperationalInsightsCluster](Get-AzOperationalInsightsCluster.md)
取得或列出群集

### [AzOperationalInsightsDataSource](Get-AzOperationalInsightsDataSource.md)
在 Azure Log Analytics 工作區中取得資料來源。

### [AzOperationalInsightsDeletedWorkspace](Get-AzOperationalInsightsDeletedWorkspace.md)
列出已刪除的工作區。

### [AzOperationalInsightsIntelligencePack](Get-AzOperationalInsightsIntelligencePack.md)
取得可用的智慧套件。

### [AzOperationalInsightsLinkedService](Get-AzOperationalInsightsLinkedService.md)
取得或列出工作區的連結服務

### [AzOperationalInsightsLinkedStorageAccount](Get-AzOperationalInsightsLinkedStorageAccount.md)
取得或列出連結的儲存空間帳戶
...
### [新-AzOperationalInsightsCluster](New-AzOperationalInsightsCluster.md)
建立群集
...
### [新-AzOperationalInsightsLinkedStorageAccount](New-AzOperationalInsightsLinkedStorageAccount.md)
建立工作區的連結儲存空間帳戶
...
### [移除-AzOperationalInsightsCluster](Remove-AzOperationalInsightsCluster.md)
刪除群集

### [移除-AzOperationalInsightsDataSource](Remove-AzOperationalInsightsDataSource.md)
刪除資料來源。

### [移除-AzOperationalInsightsLinkedService](Remove-AzOperationalInsightsLinkedService.md)
取消連結工作區的服務

### [移除-AzOperationalInsightsLinkedStorageAccount](Remove-AzOperationalInsightsLinkedStorageAccount.md)
刪除工作區的連結儲存空間帳戶
...
### [更新-AzOperationalInsightsCluster](Update-AzOperationalInsightsCluster.md)
更新群集
