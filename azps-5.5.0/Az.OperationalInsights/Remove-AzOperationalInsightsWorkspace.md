...
## 說明
**AzOperationalInsightsWorkspace** Cmdlet 會刪除現有的工作區。
...
這個命令會使用 Get-AzOperationalInsightsWorkspace Cmdlet 來取得名為 MyWorkspace 的工作區，然後使用管線運算子將它傳送到 **Remove AzOperationalInsightsWorkspace** Cmdlet。
