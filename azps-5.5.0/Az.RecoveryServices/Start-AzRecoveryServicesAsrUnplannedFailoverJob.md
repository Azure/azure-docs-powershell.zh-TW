...
## 說明
**AzRecoveryServicesAsrUnplannedFailoverJob** Cmdlet 會啟動 Azure Site Recovery 複製受保護的專案或復原方案的未計畫式容錯移轉。
您可以使用 Get-AzRecoveryServicesAsrJob Cmdlet 來檢查作業是否已成功完成。
...
使用指定的參數為復原方案啟動未計畫的容錯移轉作業，並傳回用來追蹤作業的 ASR 作業。
...
指定 azure site recovery 複製受保護的專案。
