...
## 說明
**新的-AzRecoveryServicesAsrvCenter** Cmdlet 會新增 vCenter 伺服器來探索可保護的專案。 這個 Cmdlet 會註冊 vCenter 伺服器以供在佈建服務器中探索。
