...
## 說明
**AzRecoveryServicesAsrRecoveryPlan** Cmdlet 編輯 Azure 網站復原方案。
...
將群組附加至現有的 Azure 網站復原方案，並傳回記憶體更新的復原方案。 
...
### -InputObject
要在記憶體作業中 (編輯的 ASR 恢復方案物件。 若要更新復原方案，請執行 Update-AzASRRecoveryPlan 與已編輯的復原方案物件。 ) 
