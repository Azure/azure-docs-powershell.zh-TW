...
## 說明
Get-AzRecoveryServicesBackupRPMountScript Cmdlet 會下載一個腳本，此腳本會在執行此電腦的電腦上掛載復原點的磁片。
...
當腳本執行時，它會將復原點的檔案裝入 $rp \[ 0\]

### 範例2

下載腳本以掛載復原點的所有檔案。  (自動生成) 
...
### -Path
檔案恢復的情況下，應該下載檔案的位置。 如果未提供-Path，腳本檔案將會下載在目前的目錄中。
...
### RPMountScriptDetails 中的 RecoveryServices，然後再
