...
## 說明
**AzUserAssignedIdentity** 會取得指派給現有使用者的身分識別。

## 示例

### 範例1
這個範例 Cmdlet 會在 [資源] 群組 **PSRG** 的 [名稱 **ID1** ] 中取得指派身分識別的使用者。
...
### 範例2
這個範例 Cmdlet 會在 [資源] 群組 **PSRG** 下取得指派給所有使用者的身分識別
...
### 範例3
這個範例 Cmdlet 會取得訂閱下指派給所有使用者的身分識別。
