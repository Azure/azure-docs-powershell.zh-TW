...
## 說明
Get-AzIotSecuritySolution Cmdlet 會傳回一或多個 iot 安全解決方案。 IoT 安全解決方案會從 IoT 裝置和 IoT 中樞收集安全性資料和事件，以協助防範及偵測威脅。
...
在資源群組 "MyResourceGroup" 中取得「MySample」方案
...
取得資源群組 "MyResourceGroup" 中的所有安全性解決方案清單
