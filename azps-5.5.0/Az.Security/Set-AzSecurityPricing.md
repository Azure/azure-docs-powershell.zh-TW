...
啟用或停用 Azure 安全中心訂閱的 Azure Defender 方案。
...
為 **伺服器啟用 Azure Defender** for 訂閱。

"標準" 指的是 azure Defender 方案的「開啟」狀態，如 azure 安全中心的 azure 入口網站的 [定價] 和 [設定] 區域所示。
