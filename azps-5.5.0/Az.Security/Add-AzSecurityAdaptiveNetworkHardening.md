...
## 說明
[自我調整網路 Hardenings] 是由 Azure 安全中心自動計算，使用此 Cmdlet 強制執行要求中所列)  (上的指定規則。
...
將使用已建立的安全性規則（來自自我調整網路強化規則）來更新之有效網路安全性群組的 Azure 資源識別碼。
...
### SecurityCenter AdaptiveNetworkHardenings. PSSecurityAdaptiveNetworkHardeningsRule （）
