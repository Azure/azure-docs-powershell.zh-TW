...
## 說明
取得 spcific 合規性 satandard 詳細資料，或列出特定訂閱下的所有規章規範標準。
...
### SecurityCenter RegulatoryCompliance. PSSecurityRegulatoryComplianceStandard （）
