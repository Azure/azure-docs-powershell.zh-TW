...
## 說明
New-AzDeviceSecurityGroupAllowlistCustomAlertRuleObject Cmdlet 會在 IoT security 方案中為 device security 群組建立一份新的允許自訂警報規則清單。
...
從類型 "LocalUserNotAllowed" 建立新的 [允許清單] 自訂通知 rull，狀態設定為 [停用]
...
### PSAllowlistCustomAlertRule 中的 DeviceSecurityGroups （Security..。
