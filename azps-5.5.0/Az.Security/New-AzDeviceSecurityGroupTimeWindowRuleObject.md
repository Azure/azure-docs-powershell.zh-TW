...
## 說明
New-AzDeviceSecurityGroupTimeWindowRuleObject Cmdlet 會針對 IoT security 方案中的 device security 群組，建立一個新的時間視窗警報規則清單。
...
### PSTimeWindowCustomAlertRule 中的 DeviceSecurityGroups （Security..。
