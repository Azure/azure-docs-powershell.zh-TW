...
## 說明
**AzDataBoxCredential** Cmdlet 會取得特定作業之 databox 的認證。 針對不同的 Sku 類型，傳回的認證物件的內部屬性會有所不同。
...
### System.object. IEnumerable ' 1 [DataBox. UnencryptedCredentials，DataBox，版本 = 1.0.0.0，Culture = 中性，PublicKeyToken = 31bf3856ad364e35]]）。））））
