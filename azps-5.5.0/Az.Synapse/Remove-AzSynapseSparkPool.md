...
## 說明
**AzSynapseSparkPool** Cmdlet 會永久刪除 Azure Synapse 分析 Spark 池。
...
這個命令會刪除 Azure Synapse 分析 Spark 池。
...
這個命令會透過管線刪除 Azure Synapse 分析 Spark 池。
...
這個命令會刪除含資源識別碼的 Azure Synapse 分析 Spark 池。
