...
## 說明
**新的-AzSynapseWorkspace** Cmdlet 會建立 Azure Synapse 分析工作區。
...
這個命令會在名為 ContosoResourceGroup 的資源群組中，建立一個名為 ContosoWorkspace 的 Synapse 分析工作區，該工作區使用 ContosoAdlGenStorage 資料存放區。
...
專用於 Azure Synapse 工作區的 Synapse 管理虛擬網路的名稱。
