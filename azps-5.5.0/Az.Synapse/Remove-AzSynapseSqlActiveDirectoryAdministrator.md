...
## 說明
**AzSynapseSqlActiveDirectoryAdministrator** Cmdlet 會針對 Azure Synapse Analytics 工作區 (azure AD) 管理員，移除 Azure Active Directory。
...
這個命令會移除名為 ContosoWorkspace 之工作區的 Azure AD 系統管理員。
