...
## 說明
**AzSynapseSqlPoolAdvancedThreatProtectionSetting** Cmdlet 會取得 Azure SYNAPSE Analytics SQL pool 的高級威脅防護設定。
...
這個命令會在名為 ContosoWorkspace 的工作區下，取得名為 ContosoSqlPool 之 SQL pool 的高級威脅防護設定。
