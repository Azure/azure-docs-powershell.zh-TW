...
## 說明
**AzSynapseNotebook** Cmdlet 會建立或更新工作區中的筆記本。
...
這個命令會在名為 ContosoWorkspace 的工作區中，從筆記本檔案筆記本 ipynb 建立或更新筆記本。
...
這個命令會建立或更新筆記本檔案筆記本中的筆記本，ipynb 在名為 ContosoWorkspace 至管線的工作區中。
...
這個命令會從筆記本檔案筆記本中建立或更新筆記本。 ipynb 會附加到 ContosoSparkPool，並在名為 ContosoWorkspace 的工作區中使用2個執行程式。
