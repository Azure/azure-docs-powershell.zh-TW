...
## 說明
**AzSynapseWorkspace** Cmdlet 會更新 Azure Synapse 分析工作區。
...
這個命令會更新 specififed Azure Synapse 分析工作區的標記。
...
這個命令會透過管線更新 specififed Azure Synapse 分析工作區的標記。
...
這個命令會透過含資源識別碼的管線來更新 specififed Azure Synapse 分析工作區的標記。
