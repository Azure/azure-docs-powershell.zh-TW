...
## 說明
**AzSynapsePipeline** Cmdlet 會從工作區移除管線。
...
這個 Cmdlet 會從名為 ContosoWorkspace 的工作區移除名為 ContosoPipeline 的管線。
...
這個 Cmdlet 會從名為 ContosoWorkspace 的工作區，移除名為 ContosoPipeline 的管道。
