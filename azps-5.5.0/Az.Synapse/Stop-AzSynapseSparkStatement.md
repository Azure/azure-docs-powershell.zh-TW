...
### StopSparkStatementByIdParameterSet (預設) 
```
...
## 說明
**AzSynapseSparkStatement** Cmdlet 會取消 Synapse 分析 Spark 語句。
...
這個命令會取消具有指定 livy 識別碼的 Spark 語句。
...
這個命令會透過管線取消具有指定 livy ID 的 Spark 語句。
