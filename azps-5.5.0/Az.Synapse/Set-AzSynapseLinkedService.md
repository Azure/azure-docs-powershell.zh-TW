...
## 說明
**AzSynapseLinkedService** Cmdlet 會將資料存放區或雲端服務連結到工作區。
...
這個命令會在名為 [ContosoWorkspace] 的工作區中，建立名為 ContosoLinkedService 的連結服務。
...
這個命令會在名為 ContosoWorkspace 至管線的工作區中，建立名為 ContosoLinkedService 的連結服務。
