...
## 說明
[ **取得 AzSynapseTriggerRun** ] 命令會傳回指定的觸發程式在指定時間範圍內觸發程式執行的詳細資訊。
...
這個命令會顯示在 [2018-09-01T21： 00 "和" 2019-09-01T21： 00 "之間開始的工作區 ContosoWorkspace 中的 ContosoTrigger 執行資訊。
...
這個命令會顯示在工作區 ContosoWorkspace 中，在「2018-09-01T21： 00 "和" 2019-09-01T21： 00 "到管線之間啟動的 ContosoTrigger 中執行的資訊。
