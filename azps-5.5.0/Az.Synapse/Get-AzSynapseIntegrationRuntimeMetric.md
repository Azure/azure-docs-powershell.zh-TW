...
## 說明
**AzSynapseIntegrationRuntimeMetric** Cmdlet 會取得有關工作區中集成執行時間的度量資料。
...
這個命令會在名為 ContosoWorkspace 的工作區中，顯示名為「test-selfhost-ir」之整合執行時間的公制資料。
...
### PSIntegrationRuntimeMetrics 中的 Synapse。
