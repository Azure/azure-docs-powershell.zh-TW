...
### GetByWorkspaceNameAndIdParameterSet (預設) 
```
...
## 說明
**AzSynapseRoleDefinition** Cmdlet 會取得 Azure Synapse Analytics 角色定義。
如果您沒有指定角色名稱或角色識別碼，此 Cmdlet 會取得所有角色定義。
...
這個命令會在 [工作區 ContosoWorkspace] 下取得名稱為 ContosoRole 的角色定義。
