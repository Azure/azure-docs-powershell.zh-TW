...
## 說明
**AzSynapseWorkspace** Cmdlet 會永久刪除 Azure Synapse 分析工作區。
...
這個命令會透過管線刪除 Azure Synapse 分析工作區。
...
這個命令會透過具有指定資源識別碼的管線刪除 Azure Synapse 分析工作區。
