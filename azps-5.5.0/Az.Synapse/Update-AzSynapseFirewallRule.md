...
## 說明
**AzSynapseFirewallRule** Cmdlet Modifys Azure Synapse 分析防火牆規則。
...
這個命令會在 [工作區 ContosoWorkspace] 下更新名為 [ContosoFirewallRule] 的防火牆規則。
...
這個命令會透過管線在工作區下更新名為 ContosoFirewallRule 的防火牆規則。
