...
## 說明
**AzSynapseSparkPool** Cmdlet 會取得 Azure Synapse 分析 Spark 池的相關資訊。
...
這個命令會在 [工作區 ContosoWorkspace] 下取得 [名稱 ContosoSparkPool] 底下的 Spark 池。
