...
## 說明
[這項功能在有限預覽中，最初隻能在特定訂閱中存取。」 **AzSynapseSqlDatabase** Cmdlet 會取得有關 Azure SYNAPSE 分析 SQL 資料庫的資訊。
...
這個命令會在 [工作區 ContosoWorkspace] 下取得 name ContosoSqlDatabase 的 SQL 資料庫。
...
### PSSynapseSqlDatabase 中的 Synapse。
