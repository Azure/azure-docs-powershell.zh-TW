...
## 說明
**Export AzSynapseNotebook** Cmdlet 會將 Azure Synapse 筆記本匯出至筆記本 ( ipynb) 檔案。 筆記本的名稱會變成匯出檔案的名稱。 如果您指定筆記本的名稱，Cmdlet 會匯出該筆記本。 如果您沒有指定名稱，此 Cmdlet 會匯出工作區中的所有筆記本。
...
將工作區 ContosoWorkspace 中的所有筆記本匯出至資料夾 "C:\Notebook"。
...
將工作區 ContosoWorkspace 中稱為 ContosoNotebook 的單一筆記本匯出至資料夾 "C:\Notebook"。
...
在工作區 ContosoWorkspace 中，將稱為 ContosoNotebook 的單一筆記本匯出至透過管線的資料夾 "C:\Notebook"。
