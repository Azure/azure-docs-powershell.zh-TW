...
## 說明
**AzSynapseSqlPoolRestorePoint** Cmdlet 會檢索 Azure SYNAPSE Analytics SQL pool 可以還原的不同還原點。
...
這個命令會傳回 Azure Synapse Analytics SQL pool （名為 ContosoSqlPool）的所有可用還原點。
