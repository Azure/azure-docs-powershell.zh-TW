...
這個命令 reimages 2 個角色實例 ContosoFrontEnd_IN_0 和 ContosoBackEnd_IN_1 屬於名為 ContosOrg 之資源群組且名為 ContosoCS 的雲端服務。
...
這個命令會 reimages 雲端服務的所有角色實例，該名稱屬於名為 ContosOrg 的資源群組。
