...
### [備份-AzKeyVault](Backup-AzKeyVault.md)
完整備份受管理的 HSM。
...
### [AzKeyVaultRoleAssignment](Get-AzKeyVaultRoleAssignment.md)
取得或列出受管理 HSM 的角色指派。 使用個別的參數，將作業清單指派給特定的使用者或角色定義。

### [AzKeyVaultRoleDefinition](Get-AzKeyVaultRoleDefinition.md)
...
### [匯入-AzKeyVaultSecurityDomain](Import-AzKeyVaultSecurityDomain.md)
將先前匯出的安全網域資料匯入到受管理的 HSM。
...
### [新-AzKeyVaultRoleAssignment](New-AzKeyVaultRoleAssignment.md)
...
### [移除-AzKeyVaultRoleAssignment](Remove-AzKeyVaultRoleAssignment.md)
