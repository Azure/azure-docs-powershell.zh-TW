...
### 範例7：產生金鑰交換金鑰 (KEK) 為「攜帶您自己的金鑰」 (BYOK) 功能

```powershell
PS C:\> $key = Add-AzKeyVaultKey -VaultName $vaultName -Name $keyName -Destination HSM -Size 2048 -KeyOps "import"
```

產生 (稱為金鑰交換金鑰 (KEK) # A3 的金鑰。 KEK 必須是只有 import 金鑰操作的 RSA-HSM 金鑰。 只有主要的保存庫 Premium SKU 支援 RSA-HSM 金鑰。
如需詳細資訊，請參閱 https://docs.microsoft.com/en-us/azure/key-vault/keys/hsm-protected-keys
