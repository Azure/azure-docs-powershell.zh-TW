...
## 說明
**新的-AzKeyVaultCertificateOrganizationDetail** Cmdlet 會建立記憶體內部的憑證組織詳細資料物件。
...
### [System.object]. 清單 ' 1 [KeyVault. PSKeyVaultCertificateAdministratorDetails，KeyVault，版本 = 1.0.0.0，Culture = 中性，PublicKeyToken = null]]。）））））
