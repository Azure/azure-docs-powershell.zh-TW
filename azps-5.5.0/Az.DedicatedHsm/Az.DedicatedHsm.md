...
### [AzDedicatedHsm](Get-AzDedicatedHsm.md)
取得指定的 Azure 專用 HSM。

### [新-AzDedicatedHsm](New-AzDedicatedHsm.md)
在指定的訂閱中建立或更新專用的 HSM。

### [移除-AzDedicatedHsm](Remove-AzDedicatedHsm.md)
刪除指定的 Azure 專用 HSM。

### [更新-AzDedicatedHsm](Update-AzDedicatedHsm.md)
在指定的訂閱中更新專用的 HSM。
