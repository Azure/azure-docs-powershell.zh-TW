...
## 說明
**新的-AzMediaService** Cmdlet 會建立媒體服務。
如果媒體服務已存在，此 Cmdlet 會更新其屬性。

## 示例

### Example1：僅使用主要儲存空間帳戶建立媒體服務
```
PS C:\># Variables
## Global
...
此範例說明如何使用多個儲存空間帳戶建立媒體服務。
此腳本會使用幾個其他的 Cmdlet。

## 參數

### -AccountName
指定此 Cmdlet 所建立之媒體服務的名稱。
