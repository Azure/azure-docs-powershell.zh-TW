...
這個命令會在 applicaton 群組中取得 Windows 虛擬桌面應用程式。

### 範例2：列出 Windows 虛擬桌面應用程式
```powershell
...
這個命令會在 applicaton 群組中列出 Windows 虛擬桌面應用程式。
...
### IApplication （DesktopVirtualization）。 Api20201019Preview。
