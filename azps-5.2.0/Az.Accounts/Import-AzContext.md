...
## 說明
Import-AzContext Cmdlet 會從檔案載入驗證資訊，以設定 Azure 環境和內容。
...
這個範例會從傳遞到 Cmdlet 的 JSON 檔案選取內容。 您可以從 [儲存-AzCoNtext] 建立此 JSON 檔案。

## 參數

### -AzureCoNtext
{{Fill AzureCoNtext 說明}}
...
### -Path
指定使用 Save AzCoNtext 儲存之內容資訊的路徑。
