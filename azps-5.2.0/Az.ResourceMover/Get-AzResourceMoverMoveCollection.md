...
取得訂閱中指定的移動收藏名稱的移動集合詳細資料。

### 範例3：在訂閱中取得指定資源組名稱的移動集合詳細資料
```powershell
...
### IMoveCollection （ResourceMover）。 Api20191001Preview。
