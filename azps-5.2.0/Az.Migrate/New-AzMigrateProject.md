...
屬性 <IMigrateProjectProperties> ：指定專案屬性。
  - `[ProvisioningState <ProvisioningState?>]`： [遷移專案] 的預配狀態。
  - `[RegisteredTool <String[]>]`：取得或設定在 [遷移] 專案中註冊的工具清單。
