...
# [Az. Resources] 模組
## 說明
本主題顯示 Azure 資源管理器 Cmdlet 的說明主題。

## Az. 資源 Cmdlet
### [附加 AzADGroupMember](Add-AzADGroupMember.md)
將使用者新增至現有的 AD 群組。
...
### [AzADGroup](Get-AzADGroup.md)
篩選 active directory 群組。

### [AzADGroupMember](Get-AzADGroupMember.md)
列出目前租使用者中 AD 群組的成員。
...
### [AzDenyAssignment](Get-AzDenyAssignment.md)
列出指定範圍內的 Azure RBAC 拒絕作業。
根據預設，會列出所選 Azure 訂閱中的所有拒絕作業。
使用個別的參數，將 [拒絕作業] 指派給特定的使用者，或列出特定資源群組或資源上的 [拒絕作業]。

### [AzDeployment](Get-AzDeployment.md)
取得部署

### [AzDeploymentOperation](Get-AzDeploymentOperation.md)
取得部署作業

### [AzDeploymentScript](Get-AzDeploymentScript.md)
取得或列出部署腳本。

### [AzDeploymentScriptLog](Get-AzDeploymentScriptLog.md)
取得部署腳本執行的記錄。

### [AzDeploymentWhatIfResult](Get-AzDeploymentWhatIfResult.md)
取得在訂閱範圍中部署的 ARM 範本 What-If 結果。 

### [AzLocation](Get-AzLocation.md)
取得每個位置的所有位置和支援的資源提供者。

### [AzManagedApplication](Get-AzManagedApplication.md)
取得受管理的應用程式

### [AzManagedApplicationDefinition](Get-AzManagedApplicationDefinition.md)
取得受管理的應用程式定義

### [AzManagementGroup](Get-AzManagementGroup.md)
取得管理群組 (s) 

### [AzManagementGroupDeployment](Get-AzManagementGroupDeployment.md)
在管理群組中取得部署

### [AzManagementGroupDeploymentOperation](Get-AzManagementGroupDeploymentOperation.md)
取得管理群組部署的部署作業

### [AzManagementGroupDeploymentWhatIfResult](Get-AzManagementGroupDeploymentWhatIfResult.md)
取得在管理群組範圍中部署的 ARM 範本 What-If 結果。 

### [AzPolicyAlias](Get-AzPolicyAlias.md)
Get-AzPolicyAlias 檢索及輸出已定義別名並符合指定參數值的 Azure 提供者資源類型。 如果未提供任何參數，則會輸出包含別名的所有提供者資源類型。
-ListAvailable 開關會列出所有相符的資源類型，包括不含別名的那些資源類型來修改此行為。
...
### [AzPolicySetDefinition](Get-AzPolicySetDefinition.md)
取得原則集定義。

### [AzProviderFeature](Get-AzProviderFeature.md)
取得 Azure 提供者功能的相關資訊。
...
### [AzResourceGroupDeploymentOperation](Get-AzResourceGroupDeploymentOperation.md)
取得資源群組部署作業

### [AzResourceGroupDeploymentWhatIfResult](Get-AzResourceGroupDeploymentWhatIfResult.md)
取得在資源群組範圍中部署的 ARM 範本 What-If 結果。 

### [AzResourceLock](Get-AzResourceLock.md)
取得資源鎖。
...
### [AzTemplateSpec](Get-AzTemplateSpec.md)
取得或列出範本規格

### [AzTenantDeployment](Get-AzTenantDeployment.md)
在租使用者範圍中取得部署

### [AzTenantDeploymentOperation](Get-AzTenantDeploymentOperation.md)
在租使用者範圍中取得部署的部署作業

### [AzTenantDeploymentWhatIfResult](Get-AzTenantDeploymentWhatIfResult.md)
取得在租使用者範圍中部署的 ARM 範本 What-If 結果。 
...
### [新-AzDeployment](New-AzDeployment.md)
建立部署

### [新-AzManagedApplication](New-AzManagedApplication.md)
建立 Azure 管理的應用程式。

### [新-AzManagedApplicationDefinition](New-AzManagedApplicationDefinition.md)
建立受管理的應用程式定義。

### [新-AzManagementGroup](New-AzManagementGroup.md)
建立管理群組

### [新-AzManagementGroupDeployment](New-AzManagementGroupDeployment.md)
在管理群組建立部署

### [新-AzManagementGroupSubscription](New-AzManagementGroupSubscription.md)
新增訂閱給管理群組。
...
### [新-AzPolicySetDefinition](New-AzPolicySetDefinition.md)
建立原則集定義。
...
### [新-AzTemplateSpec](New-AzTemplateSpec.md)
建立新的範本規格。

### [新-AzTenantDeployment](New-AzTenantDeployment.md)
在租使用者範圍建立部署

### [Register-AzProviderFeature](Register-AzProviderFeature.md)
在您的帳戶中註冊 Azure 提供者功能。
...
### [移除-AzADGroup](Remove-AzADGroup.md)
刪除 active directory 群組。

### [移除-AzADGroupMember](Remove-AzADGroupMember.md)
從 AD 群組中移除使用者。
...
### [移除-AzDeployment](Remove-AzDeployment.md)
移除部署及任何相關聯的作業

### [移除-AzDeploymentScript](Remove-AzDeploymentScript.md)
移除部署腳本及其相關聯的資源。

### [移除-AzManagedApplication](Remove-AzManagedApplication.md)
移除受管理的應用程式

### [移除-AzManagedApplicationDefinition](Remove-AzManagedApplicationDefinition.md)
移除受管理的應用程式定義

### [移除-AzManagementGroup](Remove-AzManagementGroup.md)
移除管理群組

### [移除-AzManagementGroupDeployment](Remove-AzManagementGroupDeployment.md)
移除管理群組中的部署以及任何相關聯的作業

### [移除-AzManagementGroupSubscription](Remove-AzManagementGroupSubscription.md)
從管理群組中移除訂閱。
...
### [移除-AzPolicySetDefinition](Remove-AzPolicySetDefinition.md)
移除原則集定義。
...
### [移除-AzTemplateSpec](Remove-AzTemplateSpec.md)
移除範本規格

### [移除-AzTenantDeployment](Remove-AzTenantDeployment.md)
移除租使用者範圍及任何相關聯作業的部署

### [儲存-AzDeploymentScriptLog](Save-AzDeploymentScriptLog.md)
將部署腳本執行的記錄儲存至磁片。

### [儲存-AzDeploymentTemplate](Save-AzDeploymentTemplate.md)
將部署範本儲存至檔案。

### [儲存-AzManagementGroupDeploymentTemplate](Save-AzManagementGroupDeploymentTemplate.md)
將部署範本儲存至檔案。

### [儲存-AzResourceGroupDeploymentTemplate](Save-AzResourceGroupDeploymentTemplate.md)
將資源群組部署範本儲存至檔案。

### [儲存-AzTenantDeploymentTemplate](Save-AzTenantDeploymentTemplate.md)
將部署範本儲存至檔案。
...
### [停止 AzDeployment](Stop-AzDeployment.md)
取消執行中的部署

### [停止 AzManagementGroupDeployment](Stop-AzManagementGroupDeployment.md)
在管理群組取消執行中的部署

### [停止 AzResourceGroupDeployment](Stop-AzResourceGroupDeployment.md)
取消資源群組部署。

### [停止 AzTenantDeployment](Stop-AzTenantDeployment.md)
在租使用者範圍取消正在執行的部署
...
### [取消註冊-AzProviderFeature](Unregister-AzProviderFeature.md)
在您的帳戶中登出 Azure 提供者功能。

### [取消註冊-AzResourceProvider](Unregister-AzResourceProvider.md)
登出資源提供者。

### [更新-AzADApplication](Update-AzADApplication.md)
更新現有的 azure active directory 應用程式。
