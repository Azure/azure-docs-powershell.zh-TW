...
## 說明
New-AzAvailabilityGroupListener Cmdlet 會建立新的可用性群組偵聽程式。
...
針對 SQL 虛擬電腦群組 SqlVmGroup01 中的可用性群組 AvailabilityGroup01 建立新的可用性群組偵聽程式 AgListener01。
