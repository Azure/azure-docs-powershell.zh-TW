...
這個命令會透過資源識別碼取得監視記錄分析方案。

### 範例3：透過物件取得監視記錄分析解決方案
```powershell
...
這個命令會取得資源群組下的所有監視記錄分析方案。

### 範例5：取得訂閱下的所有監視器記錄分析解決方案
```powershell
