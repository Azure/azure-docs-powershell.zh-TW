...
### [AzSystemAssignedIdentity](Get-AzSystemAssignedIdentity.md)
取得在指定的 RP 作用域下可用的 systemAssignedIdentity。

### [GetAzWebAppConfig](GetAzWebAppConfig.md)


### [AzWebAppFunctionKey](Get-AzWebAppFunctionKey.md)
在網站或部署槽中取得函式功能鍵的描述。

### [AzWebAppFunctionKeySlot](Get-AzWebAppFunctionKeySlot.md)
在網站或部署槽中取得函式功能鍵的描述。

### [AzWebAppSettingKeyVaultReference](Get-AzWebAppSettingKeyVaultReference.md)
[描述] 可用於取得 app 的 config 參考 app 設定和狀態

### [AzWebAppSyncStatus](Get-AzWebAppSyncStatus.md)
此描述允許透過 powershell 和 ARM 範本呼叫。

### [AzWebAppSyncStatusSlot](Get-AzWebAppSyncStatusSlot.md)
此描述允許透過 powershell 和 ARM 範本呼叫。
...
### [同步處理-AzWebAppFunctionSlot](Sync-AzWebAppFunctionSlot.md)
同步處理函數觸發中繼資料至管理資料庫的描述
