...
這個 Cmdlet 透過資源名稱取得 MySql 伺服器。

### 範例2：透過身分識別取得 MySql 資料庫
```powershell
...
這個 Cmdlet 透過身分識別取得 MySql 伺服器。

### 範例3：列出指定伺服器中的所有 MySql 資料庫
```powershell
...
這個 Cmdlet 會列出指定伺服器中的所有 MySql 伺服器。
