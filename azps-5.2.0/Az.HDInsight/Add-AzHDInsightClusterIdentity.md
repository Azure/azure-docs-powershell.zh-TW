...
## 說明
**AzHDInsightClusterIdentity** Cmdlet 會將群集身分識別新增至由 New-AzHDInsightClusterConfig Cmdlet 建立的 Azure HDInsight 設定物件。

## 示例

### 範例1：將 [群集身分識別資訊] 新增到 [群集設定] 物件
```
...
這個命令會將群集身分識別資訊新增到名為 [hadoop-001] 的群集中，讓群集能夠存取 Azure Data Lake Store。
...
### -ApplicationId
用於存取 Azure Data Lake 的服務主體應用程式識別碼。
