...
## 說明
取得支援票證的通訊。 如果您沒有指定任何其他參數，就會取得票證的所有通訊。 您也可以使用 Filter 參數，以 CreatedDate 或 CommunicationType 篩選通訊。 以下是您可以指定之篩選值的一些範例。


| 例子                                                        | 條件                                                     |
|-----------------------------------------------------------------|------------------------------------------------------------|
| 取得 Web 通訊                                          | "CommunicationType eq" 網頁 ""                               |
| 取得電話通訊                                        | "CommunicationType eq" Phone ""                             |
| 取得2019年12月20日或之後所建立的通訊 | "CreatedDate ge 2019-12-20"                                |
| 取得2019年12月20日之後所建立的通訊       | "CreatedDate gt 2019-12-20"                                |
| 取得2019年12月20日之後建立的 Web 通訊            | "CreatedDate gt 2019-12-20 and CommunicationType eq" 網頁 " |


這個 Cmdlet 支援透過第一個和略過參數進行分頁。

您也可以透過指定通訊名稱來取得單一支援票證通訊。 
...
### 範例6：檢索支援票證2019年12月20日或之後所建立的所有通訊
```powershell
...
### 範例7：檢索支援票證2019年12月20日或之後所建立的所有 Web 通訊
```powershell
...
### PSSupportTicketCommunication （支援）。
