...
### -原則
指定 SQL 資訊保護原則定義。 您可以指定 json 檔案的路徑，或是定義該原則的 JSON 格式字串。
...
### SecurityCenter SqlInformationProtectionPolicy. PSSqlInformationProtectionPolicy （）
