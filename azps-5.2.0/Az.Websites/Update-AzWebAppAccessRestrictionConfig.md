...
## 說明
**AzWebAppAccessRestrictionConfig** Cmdlet 會更新 Azure Web App 的存取限制配置。

## 示例

### 範例1：更新 Web 應用程式 SCM 網站以使用主網站的存取限制

下列範例會更新屬於資源群組 MyResourceGroup 的 Web App，以在 scm 網站上使用主網站的存取限制配置。
