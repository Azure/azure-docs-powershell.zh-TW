...
### 範例1：依名稱移除 kubernetes 群集的 configuation
```powershell
...
這個命令會依名稱移除 kubernetes 群集的 configuation。

### 範例2：依物件移除 kubernetes 群集的 configuation
```powershell
...
這個命令會依物件移除 kubernetes 群集的 configuation。
