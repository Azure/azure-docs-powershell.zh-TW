...
## 說明
針對 application insights 資源設定定價規劃與日常資料量資訊。
此 Cmdlet 無法設定2018年4月之後所建立的 application insights 定價方案： https://docs.microsoft.com/en-us/azure/azure-monitor/app/pricing#legacy-enterprise-per-node-pricing-tier

## 示例

### 範例1設定 application insights 資源的定價規劃與日常資料量資訊
```
...
將定價方案設定為 [基本]，將 [每日資料量上限] 設定為 [每日 400GB]，並在 [資源] 群組 "testgroup" 中的資源 "test" 時停止傳送通知。
