...
## 說明
**AzDataFactoryV2TriggerRun** Cmdlet 會在使用觸發程式名稱和觸發程式 ID 指定的資料工廠中停止觸發觸發程式。
目前僅支援在 WaitingOnDependency 狀態中 TumblingWindowTriggers。
...
這個命令會在工廠 WikiADF 中停止 id 為「08586002468005888497807248799CU16」的觸發程式執行。
