...
## 說明
**AzStorageShare** Cmdlet 會取得儲存空間帳戶的檔案共用清單。
...
第一個命令使用 **AzStorageCoNtext** Cmdlet，以使用 *Local* 參數建立內容，然後將該內容物件儲存在 $CoNtext 變數中。
...
### AzureStorageFileShare WindowsAzure. ResourceModel。
