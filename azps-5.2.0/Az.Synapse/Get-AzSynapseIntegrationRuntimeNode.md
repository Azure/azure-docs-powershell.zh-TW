...
## 說明
**AzSynapseIntegrationRuntimeNode** Cmdlet 會取得整合執行時間節點的詳細資訊。
...
此 Cmdlet 會取得在工作區 ContosoWorkspace 中，在自行託管整合執行時間 "selfhost-ir" 中名為「Node_1 ' 的節點資訊。
...
此 Cmdlet 會取得在工作區「test-eu2」中，在自託管整合執行時間 "test-selfhost-ir" 中名為「Node_1」的節點資訊，包括 IP 位址。
...
### PSManagedIntegrationRuntimeNode 中的 Synapse。

### PSSelfHostedIntegrationRuntimeNode 中的 Synapse。
