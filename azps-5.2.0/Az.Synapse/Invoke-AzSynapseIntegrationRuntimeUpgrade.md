...
## 說明
如果有新的版本， **AzSynapseIntegrationRuntimeUpgrade** Cmdlet 會升級自託管整合執行時間。
...
Cmdlet 會在工作區 ContosoWorkspace 中升級一個名為「test-selfhost-ir」的 self 託管執行時間。
