...
## 說明
**AzSynapsePipelineRun** Cmdlet 會停止在使用管線執行 ID 指定的工作區中執行管線。
...
這個命令會在工作區 ContosoWorkspace 中停止執行 id 為 b9730a13-aa12-4926-a8b3-8e3a974ab0bd 的管道。
...
這個命令會在工作區 ContosoWorkspace 透過管線停止執行含有 id b9730a13-aa12-4926-a8b3-8e3a974ab0bd 的管道。
