...
這個命令會依名稱更新專用 HSM 的參數標記

### 範例2：依物件更新專用 HSM 的參數標記
```powershell
...
### IDedicatedHsmIdentity （DedicatedHsm）的
...
INPUTOBJECT <IDedicatedHsmIdentity> ：身分識別參數
  ...
  - `[ResourceGroupName <String>]`：資源所屬之資源群組的名稱。
