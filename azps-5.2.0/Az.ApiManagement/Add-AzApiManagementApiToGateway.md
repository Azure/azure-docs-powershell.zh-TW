...
## 說明
**AzApiManagementApiToGateway** Cmdlet 會將 Azure API 管理 API 新增至閘道。
...
### ApiManagement 為 Nullable "1 [PsApiManagementGatewayApiProvisioningState，，ServiceManagement，Version = ServiceManagement，Culture = 中立，PublicKeyToken = null]]。）），）的區域性 = 中性，PublicKeyToken = null]]
