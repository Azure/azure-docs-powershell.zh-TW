...
## 說明
使用功能強大的 SQL like 語言查詢 IoT 中樞，以取得裝置和模組 twins、作業及訊息路由的相關資訊。
如需詳細資訊，請參閱 https://docs.microsoft.com/azure/iot-hub/iot-hub-devguide-query-language 。
