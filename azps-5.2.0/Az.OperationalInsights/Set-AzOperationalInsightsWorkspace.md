...
## 說明
AzOperationalInsightsWorkspace Cmdlet 會變更工作區的 **設定** 。
...
這個命令會使用 Get-AzOperationalInsightsWorkspace Cmdlet 來取得名為 MyWorkSpace 的工作區，然後使用管線運算子將 SKU 傳送到 **AzOperationalInsightsWorkspace** Cmdlet，以將 SKU 設定為 Premium。
