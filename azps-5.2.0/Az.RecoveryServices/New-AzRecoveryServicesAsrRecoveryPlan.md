...
## 說明
**新的-AzRecoveryServicesAsrRecoveryPlan** Cmdlet 會在復原服務電子倉庫中建立 Azure Site recovery、復原方案。
...
開始針對 Azure zone 的復原方案建立作業來區域複製的專案，並傳回用於追蹤作業的 ASR 作業。

## 參數

### -Azure
Switch 參數指定 azure 到 azure 災害復原的案例，以及如何建立恢復方案。
...
### -AzureZoneToZone
Switch 參數指定在 azure zone 中建立複製專案至 zone 案例。
...
### -PrimaryZone
指定將成為此復原方案一部分之複製受保護專案的主要 Availabilty 區域。
