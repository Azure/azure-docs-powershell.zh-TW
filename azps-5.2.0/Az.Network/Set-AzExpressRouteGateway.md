...
**AzExpressRouteGateway** Cmdlet 可讓您更新現有 ExpressRouteGateway 的縮放單位，或更新資源標籤。
...
上述將會在 Azure 中的 [testRG] 資源群組中，建立一個資源群組、虛擬 WAN、虛擬網路、虛擬中樞。 在具有2個比例單位的虛擬中樞中將會建立 ExpressRoute 閘道，然後會將其修改成3個比例單位
...
### -ResourceGroupName
要更新之 ExpressRouteGateway 的資源組名稱。
