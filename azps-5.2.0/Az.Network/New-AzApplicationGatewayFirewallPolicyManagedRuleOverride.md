...
## 說明
**新的-AzApplicationGatewayFirewallPolicyManagedRuleOverride** 會建立 ruleOverride 專案。
...
建立 ruleOverride 專案，並將 RuleId 設為 $ruleId，並將狀態視為 Disabled。
...
### PSApplicationGatewayFirewallPolicyManagedRuleOverride 中的 [.]
