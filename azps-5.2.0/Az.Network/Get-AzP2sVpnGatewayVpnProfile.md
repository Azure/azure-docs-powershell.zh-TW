...
## 說明
**AzP2sVpnGatewayVpnProfile** Cmdlet 可讓您產生並取得 SAS url，讓客戶下載指向網站用戶端設定的 Vpn 設定檔，以指向網站連線到 P2SVpnGateway。 使用這個 Vpn 設定檔的 [網站用戶端設定] 只能連線到此特定 P2SVpnGateway。
...
**AzP2sVpnGatewayVpnProfile** Cmdlet 可讓您產生並取得 SAS url，讓客戶下載指向網站用戶端設定的 Vpn 設定檔，以指向網站連線到 P2SVpnGateway。 ProfileUrl 會顯示可供客戶下載指向網站用戶端設定之 Vpn 設定檔之位置的 SAS url。
