...
名稱： workspaceEndpoint 類型： MMAWorkspaceMachine ResourceId：/subscriptions/00000000-0000-0000-0000-000000000000/resourcegroups/myresourceGroup/providers/Microsoft.OperationalInsights/workspaces/myworkspace 位址： Scope： {"Include"： [{"Address"： "WIN-P0HGNDO2S1B"}]}
...
### -CoverageLevel
端點的測試覆蓋率。
支援的值為 Default、Low、BelowAverage、Average、AboveAvergae、Full。
