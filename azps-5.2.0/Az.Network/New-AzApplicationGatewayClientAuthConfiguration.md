...
## 說明
**新的-AzApplicationGatewayClientAuthConfiguration** Cmdlet 會為 SSL 設定檔建立新的用戶端驗證設定。
...
此命令會建立新的用戶端驗證設定，並將其儲存在 SSL 設定檔中要使用 $clientAuthConfig 變數中。 
