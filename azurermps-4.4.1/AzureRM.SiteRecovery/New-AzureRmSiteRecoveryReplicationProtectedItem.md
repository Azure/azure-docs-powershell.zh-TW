...
## 說明
**新的-AzureRmSiteRecoveryReplicationProtectedItem** Cmdlet 會建立新的受保護的複製專案。
使用此 Cmdlet 來為可保護的專案啟用複製。
...
### -名稱
指定 Azure Site Recovery 複製受保護的專案名稱。
...
指定要用於複製的 Azure Site Recovery 保護容器對應物件。
...
指定此 Cmdlet 複製的 Azure 儲存空間帳戶識別碼。
