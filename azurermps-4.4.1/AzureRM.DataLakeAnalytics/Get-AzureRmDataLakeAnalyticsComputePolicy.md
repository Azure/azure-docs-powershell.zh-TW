...
## 說明
**AzureRmDataLakeAnalyticsComputePolicy** 會取得指定的 Azure Data Lake Analytics 計算原則或原則清單。
...
System.object. IEnumerable "1 [Microsoft.Azure.Commands.DataLakeAnalytics.Models.PSDataLakeAnalyticsComputePolicy，DataLakeAnalytics，版本 = 3.0.0.0 版，Culture = 中性，PublicKeyToken = null）]
