...
這個命令會在帳戶 "contosoadla" 中針對 id 為 "83cb7ad2-3523-4b82-b909-d478b0d8aea3" 的使用者建立名為 "myPolicy" 的原則，以確保他們無法提交超過5個以上並行度的任何作業。
...
這個命令會在帳戶 "contosoadla" 中針對 id 為 "83cb7ad2-3523-4b82-b909-d478b0d8aea3" 的使用者建立名為 "myPolicy" 的原則，以確保他們無法提交超過5個並行度或優先順序低於100的任何作業。
...
### -MinPriorityPerJob
此原則的每個作業支援的最低優先順序。
必須指定 this、MaxDegreeOfParallelismPerJob 或這兩個參數。
