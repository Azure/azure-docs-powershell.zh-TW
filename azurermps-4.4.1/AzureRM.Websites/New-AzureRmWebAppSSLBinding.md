...
範例2也會將憑證 E3A38EBA60CAA1C162785A2E1C44A15AD450199C3 系結到名為 ContosoWebApp 的 Web App。
不過，在此情況下，憑證尚未上傳到 Azure。
因此， *CertificateFilePath* 參數是用來指定憑證的本機複本。PFX 檔案。
此憑證將會上傳到 Azure，然後會建立新的 SSL 系結。
