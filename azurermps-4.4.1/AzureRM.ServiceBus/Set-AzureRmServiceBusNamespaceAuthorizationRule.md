...
## 說明
**AzureRmServiceBusNamespaceAuthorizationRule** Cmdlet 會在指定的服務匯流排命名空間中更新指定授權規則的描述。
...
### -許可權
版權例如 @ ( 「聆聽」、「傳送」、「管理」 ) 。 如果未指定 **AuthruleObj** ，則為必要。
...
### -InputObj
已將 NameSpace AuthorizationRule 物件。
...
### -名稱
AuthorizationRule Name-如果未指定 ' AuthruleObj」則是必要的。
...
### -AuthRuleObj
 SharedAccessAuthorizationRuleAttributes 中的 [.]

## 輸出

### SharedAccessAuthorizationRuleAttributes 中的 [.]
識別碼：/subscriptions/854d368f-1828-428f-8f3c-f2affa9b2f7d/resourceGroups/Default-ServiceBus-WestUS/providers/Microsoft.ServiceBus/namespaces/SB-Example1/AuthorizationRules/AuthoRule1 類型： AuthorizationRules Name： AuthoRule1 Location：標記：許可權： {偵聽、傳送}
