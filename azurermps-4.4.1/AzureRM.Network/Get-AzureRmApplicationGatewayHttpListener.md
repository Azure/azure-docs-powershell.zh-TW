...
## 說明
**AzureRmApplicationGatewayHttpListener** Cmdlet 會取得應用程式閘道的 HTTP 偵聽程式。
...
這個命令會取得名為 Listener01 的 HTTP 偵聽程式。
...
這個命令會取得 HTTP 偵聽程式的清單。

## 參數

### -ApplicationGateway
指定包含 HTTP 偵聽程式的應用程式閘道物件。
