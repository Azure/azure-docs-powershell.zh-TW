...
## 說明
**AzureRmApplicationGatewayRequestRoutingRule** Cmdlet 會將要求路由規則新增至應用程式閘道。

## 示例

### 範例1：將要求路由規則新增至應用程式閘道
```
