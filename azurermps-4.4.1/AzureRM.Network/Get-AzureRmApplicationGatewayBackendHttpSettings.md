...
## 說明
Get-AzureRmApplicationGatewayBackendHttpSettings Cmdlet 會取得應用程式閘道的後端 HTTP 設定。
...
### AzureApplicationGatewayBackendHttpSettings 中的 [.]
...
[移除-AzureRmApplicationGatewayBackendHttpSettings]()
