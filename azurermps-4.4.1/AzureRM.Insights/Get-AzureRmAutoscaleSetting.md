...
## 說明
**AzureRmAutoscaleSetting** Cmdlet 會取得與資源群組相關聯的所有自動縮放設定或指定的自動縮放設定。
...
這個命令會取得指派給資源群組預設-Web EastUS 的自動縮放設定。
...
這個命令會取得名為 DefaultServerFarm-Default-Web EastUS 的自動縮放設定。
...
### [System.object]。清單 ' 1 [AutoscaleSettingResource] 管理模型.]
