...
### 更新語義中 Add-AzureRmAutoscaleSetting Cmdlet 的參數
```
...
### 建立語義中 Add-AzureRmAutoscaleSetting Cmdlet 的參數
```
...
### -SettingSpec
指定 **AutoscaleSetting** 物件。
您可以使用 Get-AzureRmAutoscaleSetting Cmdlet 取得 **AutoscaleSetting** 物件，也可以在 Windows PowerShell 腳本中構造一個物件。
