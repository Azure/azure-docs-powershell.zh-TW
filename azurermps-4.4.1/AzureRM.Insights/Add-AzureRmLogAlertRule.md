...
## 說明
**AzureRmLogAlertRule** Cmdlet 會新增或取代事件警報規則。
新增的規則與資源群組相關聯，且具有名稱。

如先前版本所宣告：在 **未來版本中，將會棄用 AzureRMLogAlertRule Cmdlet。** 2017年10月1日之後，使用此 Cmdlet 將不會有任何作用，因為此功能正在轉換為活動記錄通知。 如需 **_https://aka.ms/migratemealerts_** 詳細資訊，請參閱。
