...
## 說明
針對 IotHub 使用的不同 EventHubs，取得所有的 eventhub consumergroups。

## 示例

### 範例1取得遙測 eventhub 的所有 eventhub consumergroups
```
PS C:\> Get-AzureRmIotHubEventHubConsumerGroup -ResourceGroupName "myresourcegroup" -Name "myiothub" -EventHubEndpointName "events"
```

針對名為 myiothub 的 iothub，取得遙測 eventhub 的所有 eventhub consumergroups

### 範例2取得 operationsmonitoring eventhub 的所有 eventhub consumergroups
```
...
針對名稱為 myiothub 的 iothub，取得 operationsMonitoringEvents eventhub 的所有 eventhub consumergroups
...
### System.object. IEnumerable "1 [[System. 字串，mscorlib，版本 = 4.0.0.0，Culture = 中立，PublicKeyToken = b77a5c561934e089]]
