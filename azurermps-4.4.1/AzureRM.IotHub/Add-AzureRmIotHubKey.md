...
針對具有 RegistryRead 許可權的 iothub "myiothub" 建立名為 "mykey" 的金鑰。
...
### System.object
PSAccessRights （IotHub.）。

## 輸出

### PSSharedAccessSignatureAuthorizationRule （IotHub.）。
\` \[ \[ PSSharedAccessSignatureAuthorizationRule、IotHub = 1.0.0.0、Culture = 中性、PublicKeyToken = null、Culture = 中立、版本 = 1.0.0.0、Culture = 中性、PublicKeyToken = null\]\]
