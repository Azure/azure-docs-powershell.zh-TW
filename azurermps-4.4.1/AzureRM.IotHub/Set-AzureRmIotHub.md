...
針對名稱為 "myiothub" 的 IotHub，將 sku 更新為 S1，並將單位更新為5
...
針對名稱為 "myiothub" 的 IotHub，將 [遙測] 和 [operationsmonitoringevents] 事件的保留時間更新為4天

## 參數

### -CloudToDevice
雲端 to device 命令佇列的屬性。 
...
### System.object
IotHub PSCloudToDeviceProperties IotHub....... PSOperationsMonitoringProperties
