...
## 說明
**新的-AzureRmDataFactoryGateway** Cmdlet 會在 Azure 資料工廠中建立閘道。
...
這個命令會在名為 [ADF] 資源群組的資料工廠中，建立名為 ContosoGateway 的閘道。

## 參數

### -DataFactory
指定 **PSDataFactory** 物件。
這個 Cmdlet 會為此參數指定的資料工廠建立閘道。
