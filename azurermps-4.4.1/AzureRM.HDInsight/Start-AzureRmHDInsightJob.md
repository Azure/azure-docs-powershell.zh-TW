...
## 說明
**Start-AzureRMHDInsightJob** Cmdlet 會在指定的群集上啟動已定義的 Azure HDInsight 作業。
這可以是 MapReduce 作業、流式 MapReduce 作業、Hive 作業或豬作業。
...
這個命令會在名為 [您的-hadoop-001] 的群集上啟動作業。
...
形參 "JobDefinition" 接受管線中 "AzureHDInsightJobDefinition" 類型的值
