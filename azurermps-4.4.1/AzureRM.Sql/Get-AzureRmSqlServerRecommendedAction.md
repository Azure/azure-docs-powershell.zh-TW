...
## 說明
**AzureRmSqlServerRecommendedAction** Cmdlet 會針對 Azure SQL Server Advisor 取得一或多個建議的動作。

## 示例

### 範例1：取得特定 Advisor 的所有建議動作清單
```
...
這個命令會取得名為 CreateIndex 的 SQL Server Advisor 的所有建議動作清單，這些動作可供名為 [wi-東] 的伺服器使用。
