...
## 說明
**AzureRmSqlElasticPoolRecommendedAction** Cmdlet 會針對 Azure SQL 彈性 Pool Advisor 取得一或多個建議的動作。
...
這個命令會從名為 WIRunnerPool 的彈性池中取得名為「CreateIndex」的顧問所有建議動作清單。
...
這個命令會 \[ \] \[ \] 從名為 CreateIndex 的 Advisor 中取得名為 IR_ test_schema _ test_table_0 .0361551 _6C7AE8CC9C87E7FD5893 的建議動作。
...
### AzureSqlElasticPoolRecommendedActionModel 中的 [RecommendedAction]

## 筆記
* 關鍵字： azure、azurerm、arm、資源、管理、manager、sql、elasticpool、mssql、advisor、recommendedaction
