...
## 說明
**AzureRmSqlDatabaseSecondary** Cmdlet 會強制終止異地複製連結。
這個 Cmdlet 取代 Stop-AzureSqlDatabaseCopy Cmdlet。
終止前沒有複製同步處理。
...
### -DatabaseName
指定具有此 Cmdlet 移除之複製連結的主要 Azure SQL 資料庫名稱。
...
###  
您可以將主要或次要資料庫的 **資料庫** 物件的管道實例傳送到這個 Cmdlet。
