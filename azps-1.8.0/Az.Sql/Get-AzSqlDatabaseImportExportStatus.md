...
## 說明
**AzSqlDatabaseImportExportStatus** Cmdlet 會從儲存空間帳戶將 bacpac 檔案匯入到 Azure sql 資料庫，或是將 Azure SQL database 匯出為儲存空間帳戶的 bacpac 檔案。
...
### -OperationStatusLink
指定從 New-AzSqlDatabaseExport 或 New-AzSqlDatabaseImport Cmdlet 傳回的狀態連結。
