...
## 說明
New-AzNetworkWatcherProtocolConfiguration Cmdlet 會建立新的通訊協定設定物件。 這個物件是用來在 connecitivity 檢查會話期間使用指定準則來限制通訊協定 confiuration。 

## 示例

### 範例1：使用通訊協定設定，測試從 VM 到網站的網路觀察程式連線能力
```
...
### PSNetworkWatcherProtocolConfiguration 中的 [.]
