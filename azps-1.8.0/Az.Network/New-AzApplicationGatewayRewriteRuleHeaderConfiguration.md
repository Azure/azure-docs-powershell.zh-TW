...
## 說明
**AzApplicationGatewayRewriteRuleHeaderConfiguration** Cmdlet 會針對 Azure 應用程式閘道建立重寫規則 actionset。
...
這個命令會建立重寫規則頭設定，並將結果儲存在名為 $hc 的變數中。
...
### PSApplicationGatewayHeaderConfiguration 中的 [.]
