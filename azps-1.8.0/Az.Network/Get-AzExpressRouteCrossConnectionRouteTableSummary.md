...
## 說明
AzExpressRouteCrossConnectionRouteTableSummary Cmdlet 會針對特定路由內容， **取得** BGP 鄰居資訊摘要。 此資訊對判斷路由內容已建立的時間，以及對等路由器宣告的路由首碼數量很有用。
...
### PSExpressRouteCrossConnectionRoutesTableSummary 中的 [.]
