...
## 說明
**AzInterfaceEndpoint** Cmdlet 會取得介面端點。
...
這個命令會取得名為 InterfaceEndpoint1 的介面端點，該介面端點屬於名為 ResourceGroup01 的資源群組，並將它儲存在 $interfaceendpoint 變數中。
...
這個命令會取得具有 resourceId/subscriptions/sub1/resourceGroups/chsriniIEtest1/providers/Microsoft.Network/interfaceEndpoints/ie1.10 的介面端點，並將它儲存在 $interfaceendpoint 變數中。
...
這個命令會取得以 "InterfaceEndpoint" 開頭的介面端點
