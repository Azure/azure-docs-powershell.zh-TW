...
## 描述
Cmdlet Get-AzNetworkWatcherNextHop從 VM 獲得下一個躍點。
下一個躍點可讓您查看 Azure 資源的類型、該資源的關聯 IP 位址，以及負責路由的路由資料表規則。

## 例子

### 範例 1：使用網際網路 IP 進行通訊時取得下一個躍點
```
...
取得從指定虛擬 Vachine 上的主要網路介面到 204.79.197.200 (www.bing.com) 
