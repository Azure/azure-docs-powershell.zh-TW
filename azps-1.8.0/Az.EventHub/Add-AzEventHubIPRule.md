...
## 摘要
在指定命名空間的 NetworkRuleSet 中新增單一 IPrule

## 句法

### IPRulePropertiesParameterSet (預設) 
```
...
```
名稱：預設 DefaultAction： Allow Id：/subscriptions/SubscriptionId/resourceGroups/RSG-TestAzEventhub/providers/Microsoft.Eventhub/namespaces/Eventhub-Namespace-2389/networkRuleSets/default 類型： NetworkRuleSet/命名空間/IpRules： {11.22.33.44，Allow} VirtualNetworkRules： 

新增具有 IpMask "11.22.33.44" 的 IPRule，並針對指定的 namesapce 加入動作允許。
...
### PSNWRuleSetIpRulesAttributes 的 [.]

## 輸出

### PSNetworkRuleSetAttributes 的 [.]
