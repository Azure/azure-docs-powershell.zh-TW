...
若要更新 API 管理的部署，請使用已修改的 **PsApiManagementInstance** 到 Update-AzApiManagementDeployment Cmdlet。
...
這個命令會取得 API 管理 Premium SKU 服務，在美國中南部和北中央都有地區。 然後使用 **更新-AzApiManagementRegion** ，將北部的美國地區的容量增加到2。 下一個 Cmdlet Set-AzApiManagement 會將設定變更套用至 Api 管理服務。
