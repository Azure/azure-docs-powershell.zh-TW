...
若要更新 API 管理部署，請使用修改過的 **PsApiManagementInstance** 至 Set-AzApiManagement Cmdlet。
...
此命令會獲得 API Management Premium SKU 服務，其區域位於美國中南部及美國中北部。 然後使用 **Update-AzApiManagementRegion** 將美國中北部地方的容量增加為 2。 下一個 Cmdlet Set-AzApiManagement將組配置變更適用于 Api 管理服務。
