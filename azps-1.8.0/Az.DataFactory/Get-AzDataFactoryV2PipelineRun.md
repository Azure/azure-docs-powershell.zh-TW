...
## 說明
[ **取得 AzDataFactoryV2PipelineRun** ] 命令會傳回指定管線執行的相關資訊。 如果已指定 PipelineRunId，則會顯示該 ID 執行的詳細資料。 如果未指定 PipelineRunId，則會顯示在 LastUpdatedAfter 和 LastUpdatedBefore 值之間發生之特定管線的所有執行的相關資訊。
