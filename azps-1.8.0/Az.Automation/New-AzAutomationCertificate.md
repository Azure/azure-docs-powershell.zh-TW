...
### <span data-ttu-id="e4e41-109">範例1：建立新的憑證</span><span class="sxs-lookup"><span data-stu-id="e4e41-109">Example 1: Create a new certificate</span></span>
```
