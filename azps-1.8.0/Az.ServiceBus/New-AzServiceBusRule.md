...
## 說明
**新的-AzServiceBusRule** Cmdlet 會為指定的訂閱建立新的規則。
...
New-AzServiceBusRule Cmdlet 會為指定的訂閱建立新的規則。
...
New-AzServiceBusRule Cmdlet 會使用 ActionFilter 為指定的訂閱建立新規則。

## 參數

### -ActionSqlExpression
Action SqlFillter 運算式
