...
## 摘要
取得目前 Azure 訂閱中的命名空間事件中心 NetwrokruleSet 的詳細資料。
...
使用 ResourceGroup 和 Namesape 參數取得命名空間之事件中心 NetwrokruleSet 的詳細資料。 
...
使用目前訂閱中的命名空間來取得 namespace 事件中心 NetwrokruleSet 的詳細資料。
...
使用其他命名空間的資源識別碼來取得命名空間之事件中心 NetwrokruleSet 的詳細資料 
