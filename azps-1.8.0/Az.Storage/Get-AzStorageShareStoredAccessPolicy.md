...
## 說明
**AzStorageShareStoredAccessPolicy** Cmdlet 會針對 Azure 儲存空間共用取得儲存的存取原則。
若要取得特定原則，請依名稱指定。
...
### -內容
指定 Azure 儲存區內容。
若要取得內容，請使用 [AzStorageCoNtext](./New-AzStorageContext.md) Cmdlet。
...
### [WindowsAzure] SharedAccessFilePolicy
