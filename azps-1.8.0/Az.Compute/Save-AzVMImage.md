...
已儲存影像的 URL 類似： HTTPs:// \< storageAccountName \> . blob.core.windows.net/system/Microsoft.Compute/Images/ \< imagesContainer \> / \< vhdPrefix-osDisk \> . xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx..。
...
例如，作業系統磁片的首碼 vhdPrefix 會產生 name vhdPrefix-osdisk。 \<guid.empty \> 。
