...
這個 Cmdlet 會建立 MySql 伺服器防火牆規則。

### 範例2：使用-ClientIPAddress 建立新的 MySql 防火牆規則。
```powershell
...
這個 Cmdlet 會使用-ClientIPAddress 建立 MySql 防火牆規則。

### 範例3：建立新的 MySql 防火牆規則，以允許所有 Ip
```powershell
...
這個 Cmdlet 會建立新的 MySql 防火牆規則，以允許所有的 Ip。
