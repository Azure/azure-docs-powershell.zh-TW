...
### ByVirtualWanNameByVpnServerConfigurationObject (預設) 
```
...
## 說明
**AzVirtualWanVpnServerConfigurationVpnProfile** Cmdlet 可讓您在 VirtualWan-VpnServerConfiguration 階層建立並下載 Vpn 設定檔，以指向網站用戶端設定。 若要指向網站連線，請從指向網站用戶端到 Azure P2SVpnGateway，這是必要的。
...
上述命令會產生並傳回 SAS Url，以供客戶在 VirtualWan-VpnServerConfiguration 層級下載 Vpn 設定檔，以指向網站用戶端設定。
...
此虛擬 wan 將關聯之 Vpn server configuraiton 物件的識別碼。
...
### System.object
PSVirtualWan PSVpnServerConfiguration 中的 []，然後按 [.]

## 輸出

### PSVpnProfileResponse 中的 [.]
