...
## 說明
**新的-AzP2sVpnGateway** Cmdlet 可讓您在 VirtualHub 下建立新的 P2SVpnGateway，以從指向網站用戶端到 Azure VirtualWan。
...
**新的-AzP2sVpnGateway** Cmdlet 可讓您在 VirtualHub 中建立新的 P2SVpnGateway，以指向 [網站連線]。
