...
## 說明
Remove-AzApplicationGatewaySslPolicy Cmdlet 會從 Azure 應用程式閘道移除 SSL 原則。

## 示例

### 範例1：從應用程式閘道移除 SSL 原則
```
PS C:\>$AppGW = Get-AzApplicationGateway -Name "ApplicationGateway01" -ResourceGroupName "ResourceGroup01"
PS C:\> $AppGW = Remove-AzApplicationGatewaySslPolicy -ApplicationGateway $AppGW
```

這個命令會從名為 ApplicationGateway01 的應用程式閘道中移除 SSL 原則。

## 參數

### -ApplicationGateway
指定此 Cmdlet 移除 SSL 原則的應用程式閘道。
