...
### ByHubVirtualNetworkConnectionName (預設) 
```
...
建立中樞虛擬網路連線之後，就會使用其資源群組名稱、中樞名稱和連線名稱來移除中心虛擬網路連線。
...
建立中樞虛擬網路連線之後，就會從 AzHubVirtualNetworkConnection 的輸出中使用 powershell 管道來移除中心虛擬網路連線。
...
### -InputObject
要修改的 hubvirtualnetworkconnection 資源。
...
### -ResourceId
要修改之 hubvirtualnetworkconnection 資源的資源識別碼。
