...
這個命令會在 applicaton 群組中取得 Windows 虛擬桌面電腦。

### 範例2：列出 Windows 虛擬桌面桌面
```powershell
...
此命令會 listsWindows applicaton 群組中的虛擬桌面電腦。
...
### IDesktop （DesktopVirtualization）。 Api20191210Preview。

### IDesktopList （DesktopVirtualization）。 Api20191210Preview。
