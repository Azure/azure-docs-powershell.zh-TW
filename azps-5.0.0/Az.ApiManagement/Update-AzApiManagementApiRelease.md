...
## 說明
**AzApiManagementApiRelease** Cmdlet 會修改 Azure API 管理 API 版本。

## 示例

### 範例1：更新 API 版本的 api 發行
```powershell
PS C:\>$ApiMgmtContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-WestUS" -ServiceName "contoso"
PS C:\>Update-AzApiManagementApiRelease -Context $ApiMgmtContext -ApiId "echo-api" -ReleaseId "echo-api-release" -Note "Releasing version 2 of the echo-api to public"
```

這個命令會 `echo-api-release` 使用新的記事來更新 Api 發行 api `echo-api` 。
...
### -InputObject
ServiceManagement 的 ApiManagement 實例。） PsApiManagementApiRelease）。
...
### -PassThru
如果已指定，則 ServiceManagement PsApiManagementApiRelease 類型的 ApiManagement，代表設定 API 版本。
