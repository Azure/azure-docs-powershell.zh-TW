...
## 說明
**AzHDInsightStreamingMapReduceJobDefinition** Cmdlet 會定義流式處理 MapReduce 工作物件，以便與 Azure HDInsight 群集搭配使用。

## 示例

### 範例1：建立流式處理 MapReduce 作業定義
```
PS C:\># Cluster info
...
### AzureHDInsightStreamingMapReduceJobDefinition （即 Azure。
