...
## 說明
**AzSynapseSparkSession** Cmdlet 會取得 Azure Synapse 分析 Spark 會話的相關資訊。
...
這個命令會在指定的 Spark 池中取得所有的 Spark 會話。
...
這個命令會取得具有指定 livy 識別碼的 Spark 會話。
...
這個命令會透過管線取得指定 Spark 池中的所有 Spark 會話。
