...
## 說明
**AzSynapseSqlPool** Cmdlet 會永久刪除 Azure SYNAPSE 分析 SQL pool。
...
這個命令會刪除 Azure Synapse Analytics SQL pool。
...
這個命令會透過管線刪除 Azure Synapse Analytics SQL pool。
...
這個命令會刪除具有指定資源識別碼的 Azure Synapse 分析 SQL 池。
