...
## 摘要
建立 PSCompositePath 類型的新物件。 您可以將它作為 AzCosmosDBGremlinGraph 的參數值來傳遞。
...
## 說明
對應至 Gremlin API CompositePath 的物件。
