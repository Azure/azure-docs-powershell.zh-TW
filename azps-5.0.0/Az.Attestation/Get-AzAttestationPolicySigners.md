...
ms.locfileid: "94285689"
---
# <span data-ttu-id="5173c-101">Get-AzAttestationPolicySigners</span><span class="sxs-lookup"><span data-stu-id="5173c-101">Get-AzAttestationPolicySigners</span></span>

## <span data-ttu-id="5173c-102">摘要</span><span class="sxs-lookup"><span data-stu-id="5173c-102">SYNOPSIS</span></span>
<span data-ttu-id="5173c-103">從 Azure 證明中的租使用者取得受信任的原則簽名者。</span><span class="sxs-lookup"><span data-stu-id="5173c-103">Gets the trusted policy signers from a tenant in Azure Attestation.</span></span>

## <span data-ttu-id="5173c-104">句法</span><span class="sxs-lookup"><span data-stu-id="5173c-104">SYNTAX</span></span>

### <span data-ttu-id="5173c-105">NameParameterSet</span><span class="sxs-lookup"><span data-stu-id="5173c-105">NameParameterSet</span></span>
```
Get-AzAttestationPolicySigners [-Name] <String> [-ResourceGroupName] <String>
 [-DefaultProfile <IAzureContextContainer>] [<CommonParameters>]
```

### <span data-ttu-id="5173c-106">ResourceIdParameterSet</span><span class="sxs-lookup"><span data-stu-id="5173c-106">ResourceIdParameterSet</span></span>
```
Get-AzAttestationPolicySigners [-ResourceId] <String> [-DefaultProfile <IAzureContextContainer>]
 [<CommonParameters>]
```

### <span data-ttu-id="5173c-107">DefaultProviderParameterSet</span><span class="sxs-lookup"><span data-stu-id="5173c-107">DefaultProviderParameterSet</span></span>
```
Get-AzAttestationPolicySigners [-Location] <String> [-DefaultProvider]
 [-DefaultProfile <IAzureContextContainer>] [<CommonParameters>]
```

## <span data-ttu-id="5173c-108">說明</span><span class="sxs-lookup"><span data-stu-id="5173c-108">DESCRIPTION</span></span>
<span data-ttu-id="5173c-109">Get-AzAttestationPolicySigners Cmdlet 會從 Azure 證明中的租使用者取得受信任的原則簽名者。</span><span class="sxs-lookup"><span data-stu-id="5173c-109">The Get-AzAttestationPolicySigners cmdlet gets the trusted policy signers from a tenant in Azure Attestation.</span></span>

## <span data-ttu-id="5173c-110">示例</span><span class="sxs-lookup"><span data-stu-id="5173c-110">EXAMPLES</span></span>

### <span data-ttu-id="5173c-111">範例1</span><span class="sxs-lookup"><span data-stu-id="5173c-111">Example 1</span></span>
```powershell
...
<span data-ttu-id="5173c-112">針對資源群組 *psh-test-rg* 中的認證提供者 *pshtest* ，取得受信任的原則簽名者。</span><span class="sxs-lookup"><span data-stu-id="5173c-112">Gets the trusted policy signers for the Attestation Provider *pshtest* in Resource Group *psh-test-rg*.</span></span>  <span data-ttu-id="5173c-113">請注意，此認證提供者沒有受信任的簽署人。</span><span class="sxs-lookup"><span data-stu-id="5173c-113">Note that there are no trusted signers for this Attestation Provider.</span></span>

### <span data-ttu-id="5173c-114">範例2</span><span class="sxs-lookup"><span data-stu-id="5173c-114">Example 2</span></span>
```powershell
...
<span data-ttu-id="5173c-115">針對資源群組 *psh-test-rg* 中的認證提供者 *pshtest2* ，取得受信任的原則簽名者。</span><span class="sxs-lookup"><span data-stu-id="5173c-115">Gets the trusted policy signers for the Attestation Provider *pshtest2* in Resource Group *psh-test-rg*.</span></span>  <span data-ttu-id="5173c-116">請注意，此認證提供者只有一個受信任的簽章者。</span><span class="sxs-lookup"><span data-stu-id="5173c-116">Note that there is one trusted signer for this Attestation Provider.</span></span>

### <span data-ttu-id="5173c-117">範例3</span><span class="sxs-lookup"><span data-stu-id="5173c-117">Example 3</span></span>
```powershell
...
<span data-ttu-id="5173c-118">取得 *位置中* 的證明預設提供者受信任的原則簽署者。</span><span class="sxs-lookup"><span data-stu-id="5173c-118">Gets the trusted policy signers for the Attestation Default Provider in Location *Central US*.</span></span>  <span data-ttu-id="5173c-119">請注意，證明預設提供者沒有受信任的簽署者。</span><span class="sxs-lookup"><span data-stu-id="5173c-119">Note that there are no trusted signers for Attestation Default Provider.</span></span>

## <span data-ttu-id="5173c-120">參數</span><span class="sxs-lookup"><span data-stu-id="5173c-120">PARAMETERS</span></span>

### <span data-ttu-id="5173c-121">-DefaultProfile</span><span class="sxs-lookup"><span data-stu-id="5173c-121">-DefaultProfile</span></span>
<span data-ttu-id="5173c-122">用於與 Azure 進行通訊的認證、帳戶、租使用者及訂閱。</span><span class="sxs-lookup"><span data-stu-id="5173c-122">The credentials, account, tenant, and subscription used for communication with Azure.</span></span>
...
### <span data-ttu-id="5173c-123">-DefaultProvider</span><span class="sxs-lookup"><span data-stu-id="5173c-123">-DefaultProvider</span></span>
<span data-ttu-id="5173c-124">指定這是預設認證提供者的要求。</span><span class="sxs-lookup"><span data-stu-id="5173c-124">Specifies this is the request to a default attestation provider.</span></span>
...
### <span data-ttu-id="5173c-125">-位置</span><span class="sxs-lookup"><span data-stu-id="5173c-125">-Location</span></span>
<span data-ttu-id="5173c-126">指定預設認證提供者的位置。</span><span class="sxs-lookup"><span data-stu-id="5173c-126">Specifies the Location of the default attestation provider.</span></span>
...
### <span data-ttu-id="5173c-127">-名稱</span><span class="sxs-lookup"><span data-stu-id="5173c-127">-Name</span></span>
<span data-ttu-id="5173c-128">指定認證提供者的名稱。</span><span class="sxs-lookup"><span data-stu-id="5173c-128">Specifies the name of an attestation provider.</span></span>
...
### <span data-ttu-id="5173c-129">-ResourceGroupName</span><span class="sxs-lookup"><span data-stu-id="5173c-129">-ResourceGroupName</span></span>
<span data-ttu-id="5173c-130">指定證明提供者的資源組名稱。</span><span class="sxs-lookup"><span data-stu-id="5173c-130">Specifies the resource group name of an attestation provider.</span></span>
...
### <span data-ttu-id="5173c-131">-ResourceId</span><span class="sxs-lookup"><span data-stu-id="5173c-131">-ResourceId</span></span>
<span data-ttu-id="5173c-132">指定證明提供者的 ResourceID。</span><span class="sxs-lookup"><span data-stu-id="5173c-132">Specifies the ResourceID of an attestation provider.</span></span>
...
### <span data-ttu-id="5173c-133">CommonParameters</span><span class="sxs-lookup"><span data-stu-id="5173c-133">CommonParameters</span></span>
<span data-ttu-id="5173c-134">這個 Cmdlet 支援通用參數：-Debug、-ErrorAction、-ErrorVariable、-InformationAction、-InformationVariable、-OutVariable、-OutBuffer、-PipelineVariable、-WarningAction、-WarningVariable、-、-、-、-、-、-。</span><span class="sxs-lookup"><span data-stu-id="5173c-134">This cmdlet supports the common parameters: -Debug, -ErrorAction, -ErrorVariable, -InformationAction, -InformationVariable, -OutVariable, -OutBuffer, -PipelineVariable, -Verbose, -WarningAction, and -WarningVariable.</span></span> <span data-ttu-id="5173c-135">如需詳細資訊，請參閱 [about_CommonParameters](http://go.microsoft.com/fwlink/?LinkID=113216)。</span><span class="sxs-lookup"><span data-stu-id="5173c-135">For more information, see [about_CommonParameters](http://go.microsoft.com/fwlink/?LinkID=113216).</span></span>

## <span data-ttu-id="5173c-136">輸入</span><span class="sxs-lookup"><span data-stu-id="5173c-136">INPUTS</span></span>

### <span data-ttu-id="5173c-137">System.object</span><span class="sxs-lookup"><span data-stu-id="5173c-137">System.String</span></span>

## <span data-ttu-id="5173c-138">輸出</span><span class="sxs-lookup"><span data-stu-id="5173c-138">OUTPUTS</span></span>

### <span data-ttu-id="5173c-139">PSPolicySigners 中的 [.]</span><span class="sxs-lookup"><span data-stu-id="5173c-139">Microsoft.Azure.Commands.Attestation.Models.PSPolicySigners</span></span>

## <span data-ttu-id="5173c-140">筆記</span><span class="sxs-lookup"><span data-stu-id="5173c-140">NOTES</span></span>

## <span data-ttu-id="5173c-141">相關連結</span><span class="sxs-lookup"><span data-stu-id="5173c-141">RELATED LINKS</span></span>
