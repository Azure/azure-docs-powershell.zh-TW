...
## 說明
**AzPolicyDefinition** Cmdlet 會取得原則定義或由名稱或 ID 所識別的特定原則定義的集合。
...
### 範例2：透過名稱從目前的訂閱取得原則定義
```
PS C:\> Get-AzPolicyDefinition -Name 'VMPolicyDefinition'
```

這個命令會從目前的預設訂閱取得名為 VMPolicyDefinition 的原則定義。
...
這個命令會從名為 Dept42 的管理群組中取得名為 VMPolicyDefinition 的原則定義。
...
這個命令會從 ID 為3bf44b72-c631-427a-b8c8-53e2595398ca 的訂閱中取得所有內建的原則定義。
