...
將資源群組 "myRG" 中名為 "MyTemplateSpec" 的範本規格的版本 ' v 1.0」匯出到本機輸出檔案夾 "v1"。
...
將 [訂閱 subId] 資源群組 "myRG" 中名為 "MyTemplateSpec" 的範本規格的版本 ' v 1.0」匯出 \{ \} 到本機輸出檔案夾 "v1"。
