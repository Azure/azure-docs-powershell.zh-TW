...
### QueueCheckNameAvailabilitySet (預設) 
```
...
## 說明
**Test AzServiceBusNameAvailability** Cmdlet 會檢查提供的佇列或主題名稱是否有空
...
如果提供的 $nameQueue 名稱是 Availabile，則傳回 True; 如果未提供 $nameQueue 名稱，則傳回 False
...
如果提供的 $nameTopic 名稱是 Availabile，則傳回 True; 如果未提供 $nameTopic 名稱，則傳回 False
