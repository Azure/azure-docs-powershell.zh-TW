...
上述命令會更新在資源群組 "testrg" 中找到的群集 "testnewkustocluster" 中，Kusto 資料庫 "mykustodatabase" 的虛刪除期間和熱緩存期間。
...
上述命令會更新在資源群組 "testrg" 中找到的群集 "myfollowercluster" 中的 Kusto 資料庫 "mykustodatabase" 的熱緩存期間。

### 範例4：透過身分識別更新現有的 ReadOnly 資料庫
```powershell
