...
## 說明
**AzVMDscConfiguration** Cmdlet 會將所需的狀態設定上傳到 azure blob 儲存空間)  (，稍後就可以使用 Set-AzVMDscExtension Cmdlet 將它套用至 azure 虛擬機器。
...
透過 Set-AzVMDscExtension Cmdlet 提供的配置資料路徑會覆寫它
...
### 字串
"ConfigurationPath" 參數從管線接受類型 "String" 的值
