...
### 範例 2 - 使用 paging 列出 AD 服務主體

```
PS C:\> Get-AzADServicePrincipal -First 100
```

列出租使用者中前 100 個 AD 服務主體。
...
使用 SPN '36f81fc3-b00f-48cd-8218-3879f51ff39f'列出服務主體。
...
使用物件識別碼為 '39e64ec6-569b-4030-8e1c-c3c519a05d69' 的 AD 應用程式，並管道到 Get-AzADServicePrincipal Cmdlet，以列出該應用程式的所有服務主體。
