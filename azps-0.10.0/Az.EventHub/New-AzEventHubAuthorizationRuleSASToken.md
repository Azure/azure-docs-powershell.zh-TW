...
## 摘要
針對命名空間/eventhub 的 Azure eventhub 授權規則產生 SAS 權杖。 
...
## 說明
New-AzEventHubAuthorizationRuleSASToken Cmdlet 會針對 Azure Eventhub Namesapce 或 Azure Eventhub 產生共用存取簽名 (SAS) 權杖
...
針對具有開始和到期時間的命名空間，產生指定 authorixation 規則的 SAS 權杖。
...
針對具有到期時間的命名空間，為指定的 authorixation 規則產生 SAS 權杖。

## 參數

### -AuthorizationRuleId
Authoraization 規則的 ARM ResourceId
...
### PSSharedAccessSignatureAttributes 的 [.]
