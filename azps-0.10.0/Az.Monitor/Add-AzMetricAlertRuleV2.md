...
這個命令會建立虛擬機器的度量警報規則。 $condition 是 New-AzMetricAlertRuleV2Criteria Cmdlet 的輸出，而 $act 是 New-AzActionGroup Cmdlet 的輸出
...
這個命令會停用度量警示規則。 在這裡，我們會將 Get-AzMetricAlertRuleV2 的輸出管道到 Add-AzMetricAlertRuleV2 
...
若要建立更複雜的度量警報規則，例如選取維度值或有多個準則，您可以使用協助程式 Cmdlet New-AzMetricAlertRuleV2DimensionSelection 與 AzMetricAlertRuleV2Criteria。
