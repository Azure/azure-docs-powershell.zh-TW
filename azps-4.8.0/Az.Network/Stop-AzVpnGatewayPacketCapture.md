...
## 說明
停止 Vpn 閘道的 [資料包捕獲] 作業，並將在指定 SasUrl 的儲存空間容器中上傳結果。
...
### -ResourceId
要開始進行資料包捕獲之 VpnGateway 的 Azure 資源識別碼。
...
### PSVpnGatewayPacketCaptureResult 中的 [.]

## 筆記

## 相關連結

[開始-AzVpnGatewayPacketCapture](./Start-AzVpnGatewayPacketCapture.md)