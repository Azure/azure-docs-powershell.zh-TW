...
### ByP2SVpnGatewayNameNoVpnServerConfigurationUpdate (預設) 
```
...
## 說明
**AzP2sVpnGateway** Cmdlet 可讓您在 VirtualHub 中使用新的 VpnClientAddressPool 或新 VpnServerConfiguration 或變更 VpnGatewayScaleUnit 來更新現有 P2SVpnGateway。
...
**AzP2sVpnGateway** Cmdlet 可讓您在 VirtualHub 中使用新的 VpnClientAddressPool 來更新現有 P2SVpnGateway。 當指向網站用戶端與此 P2SVpnGateway 連線時，此 VpnClientAddressPool 的其中一個 ip 位址會指派給該用戶端。

### 範例2

在 [VirtualHub] 底下的 [網站連線] 底下，更新現有的 P2SVpnGateway。  (自動生成) 
...
[新-AzRoutingConfiguration](./New-AzRoutingConfiguration.md)
