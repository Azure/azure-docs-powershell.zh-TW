...
## 說明
**新的-AzOperationalInsightsWindowsEventDataSource** Cmdlet 會新增一個資料來源，從已連接的電腦，收集在 Azure Operational Insights 中執行 Windows 作業系統的 windows 事件記錄。

## 示例

### 範例1：建立系統 Windows 事件資料來源
```
$EventLogNames       = @()
...
### -CollectInformation
指示 Operational Insights 會收集資訊訊息。
...
### -CollectWarnings
指示 Operational Insights 會收集警告訊息。
