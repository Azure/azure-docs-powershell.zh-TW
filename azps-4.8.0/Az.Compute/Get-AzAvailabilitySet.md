...
這個命令會在名為 ResourceGroup11 的資源群組中取得名為 AvailabilitySet03 的可用性集。
...
這個命令會在名為 ResourceGroup11 的資源群組中，取得以 "AvailabilitySet0" 開頭的所有可用性集。

### 範例4：從 AvailabilitySet0 開始取得名稱的所有可用性集
```
...
這個命令會取得所有以 "AvailabilitySet0" 開頭的可用性集。
