...
## 說明
**新的-AzPrivateDnsZone** Cmdlet 會在指定的資源群組中， (DNS) 區域中建立新的私人網功能變數名稱稱系統。 您必須為 *name* 參數指定唯一的專用 DNS 區功能變數名稱稱，否則 Cmdlet 會傳回錯誤。 建立區域之後，請使用 New-AzPrivateDnsRecordSet Cmdlet 來建立區域中的記錄集。
