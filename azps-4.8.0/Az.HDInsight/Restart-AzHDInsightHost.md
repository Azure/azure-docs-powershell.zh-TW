...
## 說明
此 **重新開機 AzHDInsightHost** Cmdlet 會重新開機 HDInsight 群集的特定主機。
...
這個命令會重新開機兩個群集主機： worknode1、worknode2。
...
這個命令會說明如何與 Cmdlet 「AzHDInsightHost」共同合作。
...
### [System.object]。泛型. IList "1. AzureHDInsightHostInfo，3.2.0.0，，Culture = 中性，PublicKeyToken = null]] （" 區域性 = null）]]）。
