...
## 說明
Set-AzIotSecuritySolution Cmdlet 會建立或更新特定的 iot 安全方案。 IoT 安全解決方案會從 IoT 裝置和 IoT 中樞收集安全性資料和事件，以協助防範及偵測威脅。
Iot 安全解決方案的名稱應該與 iot 中樞的名稱相同。
...
建立新的 iot 安全解決方案 "MySample" （含資源 id "/subscriptions/XXXXXXXX-XXXX-XXXXX-XXXX-XXXXXXXXXXXX/resourceGroups/MichalResourceGroup/providers/Microsoft.Devices/IotHubs/MySample" 的 IoT 中樞） (方案的名稱應該與 IoT 中樞的名稱相同) 
...
### PSIotSecuritySolution 中的 IotSecuritySolutions （Security..。
...
### PSUserDefinedResources 中的 IotSecuritySolutions （Security..。

### PSRecommendationConfiguration []. IotSecuritySolutions. []
