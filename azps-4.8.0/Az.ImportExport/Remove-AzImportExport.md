...
### 範例1：依 resourceGroup 和伺服器名稱移除 ImportExport 工作
```powershell
PS C:\> Remove-AzImportExport -Name test-job -ResourceGroupName ImportTestRG
```

這個 Cmdlet 會依 resourceGroup 和伺服器名稱來移除 ImportExport 工作。

### 範例2：依身分識別移除 ImportExport 工作
```powershell
PS C:\> Get-AzImportExport -Name test-job -ResourceGroupName ImportTestRG | Remove-AzImportExport
 
```

這些 Cmdlet 會依身分識別來移除 ImportExport 工作。
