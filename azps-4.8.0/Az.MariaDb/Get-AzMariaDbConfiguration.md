...
ms.locfileid: "93971003"
---
# <span data-ttu-id="432d7-101">Get-AzMariaDbConfiguration</span><span class="sxs-lookup"><span data-stu-id="432d7-101">Get-AzMariaDbConfiguration</span></span>

## <span data-ttu-id="432d7-102">摘要</span><span class="sxs-lookup"><span data-stu-id="432d7-102">SYNOPSIS</span></span>
<span data-ttu-id="432d7-103">取得伺服器設定的相關資訊。</span><span class="sxs-lookup"><span data-stu-id="432d7-103">Gets information about a configuration of server.</span></span>

## <span data-ttu-id="432d7-104">句法</span><span class="sxs-lookup"><span data-stu-id="432d7-104">SYNTAX</span></span>

### <span data-ttu-id="432d7-105"> (預設) 清單</span><span class="sxs-lookup"><span data-stu-id="432d7-105">List (Default)</span></span>
```
Get-AzMariaDbConfiguration -ResourceGroupName <String> -ServerName <String> [-SubscriptionId <String[]>]
 [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### <span data-ttu-id="432d7-106">獲取</span><span class="sxs-lookup"><span data-stu-id="432d7-106">Get</span></span>
```
Get-AzMariaDbConfiguration -Name <String> -ResourceGroupName <String> -ServerName <String>
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### <span data-ttu-id="432d7-107">GetViaIdentity</span><span class="sxs-lookup"><span data-stu-id="432d7-107">GetViaIdentity</span></span>
```
Get-AzMariaDbConfiguration -InputObject <IMariaDbIdentity> [-DefaultProfile <PSObject>] [<CommonParameters>]
```

## <span data-ttu-id="432d7-108">說明</span><span class="sxs-lookup"><span data-stu-id="432d7-108">DESCRIPTION</span></span>
<span data-ttu-id="432d7-109">取得伺服器設定的相關資訊。</span><span class="sxs-lookup"><span data-stu-id="432d7-109">Gets information about a configuration of server.</span></span>

## <span data-ttu-id="432d7-110">示例</span><span class="sxs-lookup"><span data-stu-id="432d7-110">EXAMPLES</span></span>

### <span data-ttu-id="432d7-111">範例1：列出 MariaDB 下的所有設定</span><span class="sxs-lookup"><span data-stu-id="432d7-111">Example 1: List all configuration under a MariaDB</span></span>
```powershell
...
<span data-ttu-id="432d7-112">這個命令會列出 MariaDB 下的所有設定。</span><span class="sxs-lookup"><span data-stu-id="432d7-112">This command lists all configuration under a MariaDB.</span></span>

### <span data-ttu-id="432d7-113">範例2：取得 MariaDB 的設定</span><span class="sxs-lookup"><span data-stu-id="432d7-113">Example 2: Get a configuration of MariaDB</span></span>
```powershell
...
<span data-ttu-id="432d7-114">這個命令會取得 MariaDB 的配置。</span><span class="sxs-lookup"><span data-stu-id="432d7-114">This command gets a configuration of MariaDB.</span></span>

## <span data-ttu-id="432d7-115">參數</span><span class="sxs-lookup"><span data-stu-id="432d7-115">PARAMETERS</span></span>

### <span data-ttu-id="432d7-116">-DefaultProfile</span><span class="sxs-lookup"><span data-stu-id="432d7-116">-DefaultProfile</span></span>
<span data-ttu-id="432d7-117">用於與 Azure 進行通訊的認證、帳戶、租使用者及訂閱。</span><span class="sxs-lookup"><span data-stu-id="432d7-117">The credentials, account, tenant, and subscription used for communication with Azure.</span></span>
...
### <span data-ttu-id="432d7-118">-InputObject</span><span class="sxs-lookup"><span data-stu-id="432d7-118">-InputObject</span></span>
<span data-ttu-id="432d7-119">要構造的身分識別參數，請參閱 INPUTOBJECT 屬性的 [記事] 區段，然後建立雜湊表。</span><span class="sxs-lookup"><span data-stu-id="432d7-119">Identity Parameter To construct, see NOTES section for INPUTOBJECT properties and create a hash table.</span></span>
...
### <span data-ttu-id="432d7-120">-名稱</span><span class="sxs-lookup"><span data-stu-id="432d7-120">-Name</span></span>
<span data-ttu-id="432d7-121">伺服器配置的名稱。</span><span class="sxs-lookup"><span data-stu-id="432d7-121">The name of the server configuration.</span></span>
...
### <span data-ttu-id="432d7-122">-ResourceGroupName</span><span class="sxs-lookup"><span data-stu-id="432d7-122">-ResourceGroupName</span></span>
<span data-ttu-id="432d7-123">包含資源之資源群組的名稱。</span><span class="sxs-lookup"><span data-stu-id="432d7-123">The name of the resource group that contains the resource.</span></span>
<span data-ttu-id="432d7-124">您可以從 Azure 資源管理器 API 或入口網站取得此值。</span><span class="sxs-lookup"><span data-stu-id="432d7-124">You can obtain this value from the Azure Resource Manager API or the portal.</span></span>
...
### <span data-ttu-id="432d7-125">-ServerName</span><span class="sxs-lookup"><span data-stu-id="432d7-125">-ServerName</span></span>
<span data-ttu-id="432d7-126">伺服器的名稱。</span><span class="sxs-lookup"><span data-stu-id="432d7-126">The name of the server.</span></span>
...
### <span data-ttu-id="432d7-127">-SubscriptionId</span><span class="sxs-lookup"><span data-stu-id="432d7-127">-SubscriptionId</span></span>
<span data-ttu-id="432d7-128">識別 Azure 訂閱的訂閱 ID。</span><span class="sxs-lookup"><span data-stu-id="432d7-128">The subscription ID that identifies an Azure subscription.</span></span>
...
### <span data-ttu-id="432d7-129">CommonParameters</span><span class="sxs-lookup"><span data-stu-id="432d7-129">CommonParameters</span></span>
<span data-ttu-id="432d7-130">這個 Cmdlet 支援通用參數：-Debug、-ErrorAction、-ErrorVariable、-InformationAction、-InformationVariable、-OutVariable、-OutBuffer、-PipelineVariable、-WarningAction、-WarningVariable、-、-、-、-、-、-。</span><span class="sxs-lookup"><span data-stu-id="432d7-130">This cmdlet supports the common parameters: -Debug, -ErrorAction, -ErrorVariable, -InformationAction, -InformationVariable, -OutVariable, -OutBuffer, -PipelineVariable, -Verbose, -WarningAction, and -WarningVariable.</span></span> <span data-ttu-id="432d7-131">如需詳細資訊，請參閱 [about_CommonParameters](http://go.microsoft.com/fwlink/?LinkID=113216)。</span><span class="sxs-lookup"><span data-stu-id="432d7-131">For more information, see [about_CommonParameters](http://go.microsoft.com/fwlink/?LinkID=113216).</span></span>

## <span data-ttu-id="432d7-132">輸入</span><span class="sxs-lookup"><span data-stu-id="432d7-132">INPUTS</span></span>

### <span data-ttu-id="432d7-133">IMariaDbIdentity （MariaDb）的</span><span class="sxs-lookup"><span data-stu-id="432d7-133">Microsoft.Azure.PowerShell.Cmdlets.MariaDb.Models.IMariaDbIdentity</span></span>

## <span data-ttu-id="432d7-134">輸出</span><span class="sxs-lookup"><span data-stu-id="432d7-134">OUTPUTS</span></span>

### <span data-ttu-id="432d7-135">IConfiguration （MariaDb）。 Api20180601Preview。</span><span class="sxs-lookup"><span data-stu-id="432d7-135">Microsoft.Azure.PowerShell.Cmdlets.MariaDb.Models.Api20180601Preview.IConfiguration</span></span>

## <span data-ttu-id="432d7-136">筆記</span><span class="sxs-lookup"><span data-stu-id="432d7-136">NOTES</span></span>

<span data-ttu-id="432d7-137">別名</span><span class="sxs-lookup"><span data-stu-id="432d7-137">ALIASES</span></span>

<span data-ttu-id="432d7-138">複雜的參數屬性</span><span class="sxs-lookup"><span data-stu-id="432d7-138">COMPLEX PARAMETER PROPERTIES</span></span>

<span data-ttu-id="432d7-139">若要建立如下所述的參數，請構造包含適當屬性的雜湊資料表。</span><span class="sxs-lookup"><span data-stu-id="432d7-139">To create the parameters described below, construct a hash table containing the appropriate properties.</span></span> <span data-ttu-id="432d7-140">如需雜湊資料表的詳細資訊，請執行 Get-Help about_Hash_Tables。</span><span class="sxs-lookup"><span data-stu-id="432d7-140">For information on hash tables, run Get-Help about_Hash_Tables.</span></span>


<span data-ttu-id="432d7-141">INPUTOBJECT <IMariaDbIdentity> ：身分識別參數</span><span class="sxs-lookup"><span data-stu-id="432d7-141">INPUTOBJECT <IMariaDbIdentity>: Identity Parameter</span></span>
  - <span data-ttu-id="432d7-142">`[ConfigurationName <String>]`：伺服器配置的名稱。</span><span class="sxs-lookup"><span data-stu-id="432d7-142">`[ConfigurationName <String>]`: The name of the server configuration.</span></span>
  - <span data-ttu-id="432d7-143">`[DatabaseName <String>]`：資料庫的名稱。</span><span class="sxs-lookup"><span data-stu-id="432d7-143">`[DatabaseName <String>]`: The name of the database.</span></span>
  - <span data-ttu-id="432d7-144">`[FirewallRuleName <String>]`：伺服器防火牆規則的名稱。</span><span class="sxs-lookup"><span data-stu-id="432d7-144">`[FirewallRuleName <String>]`: The name of the server firewall rule.</span></span>
  - <span data-ttu-id="432d7-145">`[Id <String>]`：資源身分識別路徑</span><span class="sxs-lookup"><span data-stu-id="432d7-145">`[Id <String>]`: Resource identity path</span></span>
  - <span data-ttu-id="432d7-146">`[LocationName <String>]`：位置的名稱。</span><span class="sxs-lookup"><span data-stu-id="432d7-146">`[LocationName <String>]`: The name of the location.</span></span>
  - <span data-ttu-id="432d7-147">`[ResourceGroupName <String>]`：包含資源之資源群組的名稱。</span><span class="sxs-lookup"><span data-stu-id="432d7-147">`[ResourceGroupName <String>]`: The name of the resource group that contains the resource.</span></span> <span data-ttu-id="432d7-148">您可以從 Azure 資源管理器 API 或入口網站取得此值。</span><span class="sxs-lookup"><span data-stu-id="432d7-148">You can obtain this value from the Azure Resource Manager API or the portal.</span></span>
  - <span data-ttu-id="432d7-149">`[SecurityAlertPolicyName <SecurityAlertPolicyName?>]`：安全警示原則的名稱。</span><span class="sxs-lookup"><span data-stu-id="432d7-149">`[SecurityAlertPolicyName <SecurityAlertPolicyName?>]`: The name of the security alert policy.</span></span>
  - <span data-ttu-id="432d7-150">`[ServerName <String>]`：伺服器的名稱。</span><span class="sxs-lookup"><span data-stu-id="432d7-150">`[ServerName <String>]`: The name of the server.</span></span>
  - <span data-ttu-id="432d7-151">`[SubscriptionId <String>]`：識別 Azure 訂閱的訂閱 ID。</span><span class="sxs-lookup"><span data-stu-id="432d7-151">`[SubscriptionId <String>]`: The subscription ID that identifies an Azure subscription.</span></span>
  - <span data-ttu-id="432d7-152">`[VirtualNetworkRuleName <String>]`：虛擬網路規則的名稱。</span><span class="sxs-lookup"><span data-stu-id="432d7-152">`[VirtualNetworkRuleName <String>]`: The name of the virtual network rule.</span></span>

## <span data-ttu-id="432d7-153">相關連結</span><span class="sxs-lookup"><span data-stu-id="432d7-153">RELATED LINKS</span></span>
