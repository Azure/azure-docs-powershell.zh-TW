...
## 描述
此Remove-AzDataFactoryV2DataFlow Cmdlet 會從 Azure Data Factory 移除資料流程。
...
此命令會從名稱為 WikiADF 的資料工廠移除名為 Dataflow5 的資料流程。
