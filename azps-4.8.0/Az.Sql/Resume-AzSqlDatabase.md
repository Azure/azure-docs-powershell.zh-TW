...
## 說明
**Resume AzSqlDatabase** Cmdlet 會繼續執行 Azure SQL 資料倉儲資料庫。
...
## 筆記
* **Resume AzSqlDatabase** Cmdlet 只適用于 Azure SQL 資料倉儲資料庫。 Azure SQL Database Basic、Standard 和 Premium 版本不支援此操作。
