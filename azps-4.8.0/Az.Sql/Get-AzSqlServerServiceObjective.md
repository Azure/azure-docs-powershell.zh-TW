...
## 說明
**AzSqlServerServiceObjective** Cmdlet 會取得 Azure SQL 資料庫伺服器可用的服務目標。
...
這個命令會取得以「System」開頭的名為 Server01 的伺服器服務目標。
