...
## 說明
**更新-AzSynapseIntegrationRuntime** Cmdlet 會更新整合執行時間屬性。 目前這個 Cmdlet 只支援針對自行託管的執行時間更新「自動更新」和「AutoUpdateDelayOffset」。
...
### PSSelfHostedIntegrationRuntimeStatus 中的 Synapse。
