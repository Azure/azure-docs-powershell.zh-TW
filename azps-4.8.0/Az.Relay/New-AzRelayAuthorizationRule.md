...
## 說明
**新的-AzRelayAuthorizationRule** Cmdlet 會為指定的中繼實體建立新的授權規則， (命名空間/WcfRelay/HybridConnection) 。
...
`AuthoRule1`使用 [混合式連接] 的 [ **聆聽** ] 權利建立 `TestHybridConnection` 。
