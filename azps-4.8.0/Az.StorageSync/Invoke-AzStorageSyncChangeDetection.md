...
> [!Note]  
> Invoke-AzStorageSyncChangeDetection Cmdlet 不會偵測到 Azure 檔案共用中刪除的檔案。 如果檔案已在 Azure 檔案共用中刪除，則會在執行 [變更偵測作業](https://docs.microsoft.com/azure/storage/files/storage-sync-files-troubleshoot?tabs=portal1%2Cazure-portal#afs-change-detection) 時偵測到這些檔案。
