...
## 說明
**Disable AzRecoveryServicesBackupAutoProtection** Cmdlet 會在能保護的專案上停用保護。
...
第一個 Cmdlet 會取得類型 AzureVMAppContainer 的備份容器。  第二個 Cmdlet 會取得可保護的 BackupItem，並停用自動保護。
