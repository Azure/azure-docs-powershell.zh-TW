...
## 說明
**AzRecoveryServicesAsrReplicationProtectedItemDisk** Cmdlet 會為已受保護的 azure 虛擬機器加入保護磁片。
...
啟動作業以新增指定的磁片設定以進行保護。[管道輸入複製受保護的專案]。

## 參數

### -AzureToAzureDiskReplicationConfiguration
指定要用於 Azure 到 Azure 災害復原案例之磁片保護的磁片配置。
...
### -InputObject
Cmdlet 的輸入物件：與要保護的新磁片相對應的 ASR 複製受保護專案物件。
