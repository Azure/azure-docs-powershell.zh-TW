...
## 說明
建立在排程上執行的軟體更新設定，以更新電腦清單。 電腦同時包含 azure 虛擬機器或非 az 電腦。

## 示例

### 範例1
建立軟體更新設定，以便在每星期六9PM 一次安裝兩個 Windows azure 虛擬機器上的重要更新。 在這個範例中，[更新持續時間] 設定為 [2 小時]。
...
### WindowsUpdateClasses [] 的 UpdateManagement [命令]。

### LinuxPackageClasses [] 的 UpdateManagement [命令]。
