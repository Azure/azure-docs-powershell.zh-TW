...
ms.locfileid: "94128174"
---
# <span data-ttu-id="1cdb4-101">New-AzFrontDoorBackendPoolsSettingObject</span><span class="sxs-lookup"><span data-stu-id="1cdb4-101">New-AzFrontDoorBackendPoolsSettingObject</span></span>

## <span data-ttu-id="1cdb4-102">摘要</span><span class="sxs-lookup"><span data-stu-id="1cdb4-102">SYNOPSIS</span></span>
<span data-ttu-id="1cdb4-103">建立用來建立前門的 PSBackendPoolsSetting 物件。</span><span class="sxs-lookup"><span data-stu-id="1cdb4-103">Create a PSBackendPoolsSetting object for Front Door creation.</span></span>
...
<span data-ttu-id="1cdb4-106">**新的-AzFrontDoorBackendpoolsSettingObject** Cmdlet 會建立新的 PSBackendPoolsSettings 物件供前門建立。</span><span class="sxs-lookup"><span data-stu-id="1cdb4-106">The **New-AzFrontDoorBackendpoolsSettingObject** cmdlet creates a new PSBackendPoolsSettings object for Front Door creation.</span></span>

## <span data-ttu-id="1cdb4-107">示例</span><span class="sxs-lookup"><span data-stu-id="1cdb4-107">EXAMPLES</span></span>

### <span data-ttu-id="1cdb4-108">範例1：使用預設值建立 BackendPoolsSettings 物件</span><span class="sxs-lookup"><span data-stu-id="1cdb4-108">Example 1: Create BackendPoolsSettings object using defaults</span></span>
```powershell
...
### <span data-ttu-id="1cdb4-109">範例2：使用使用者指定的值建立 BackendPoolsSettings 物件</span><span class="sxs-lookup"><span data-stu-id="1cdb4-109">Example 2: Create BackendPoolsSettings object with user specified values</span></span>
```powershell
...
### <span data-ttu-id="1cdb4-113">-EnforceCertificateNameCheck</span><span class="sxs-lookup"><span data-stu-id="1cdb4-113">-EnforceCertificateNameCheck</span></span>
<span data-ttu-id="1cdb4-114">是否要強制對所有後端池的 HTTPS 要求進行憑證名稱檢查。</span><span class="sxs-lookup"><span data-stu-id="1cdb4-114">Whether to enforce certificate name check on HTTPS requests to all backend pools.</span></span>
<span data-ttu-id="1cdb4-115">對非 HTTPS 式要求沒有作用。</span><span class="sxs-lookup"><span data-stu-id="1cdb4-115">No effect on non-HTTPS requests.</span></span>
...
### <span data-ttu-id="1cdb4-116">-SendRecvTimeoutInSeconds</span><span class="sxs-lookup"><span data-stu-id="1cdb4-116">-SendRecvTimeoutInSeconds</span></span>
<span data-ttu-id="1cdb4-117">傳送和接收到後端的轉寄要求超時。</span><span class="sxs-lookup"><span data-stu-id="1cdb4-117">Send and receive timeout on forwarding request to the backend.</span></span> <span data-ttu-id="1cdb4-118">當達到超時時間時，要求會失敗並傳回。</span><span class="sxs-lookup"><span data-stu-id="1cdb4-118">When timeout is reached, the request fails and returns.</span></span>
...
### <span data-ttu-id="1cdb4-123">所有</span><span class="sxs-lookup"><span data-stu-id="1cdb4-123">None</span></span>

## <span data-ttu-id="1cdb4-124">輸出</span><span class="sxs-lookup"><span data-stu-id="1cdb4-124">OUTPUTS</span></span>

### <span data-ttu-id="1cdb4-125">PSBackendPoolsSetting 中的 FrontDoor。</span><span class="sxs-lookup"><span data-stu-id="1cdb4-125">Microsoft.Azure.Commands.FrontDoor.Models.PSBackendPoolsSetting</span></span>
