...
## 說明
**新的-AzureRmDeploymentManagerServiceUnit** Cmdlet 會在服務拓朴中的服務下建立服務，並傳回代表該服務單元的物件。
依其名稱、服務名稱、服務拓撲結構，以及資源組名稱來指定服務單位。 

這個 Cmdlet 會傳回 ServiceUnit 物件。 您可以在本機修改這個物件，然後使用 Set-AzureRmDeploymentManagerService Cmdlet 將變更套用至服務。
