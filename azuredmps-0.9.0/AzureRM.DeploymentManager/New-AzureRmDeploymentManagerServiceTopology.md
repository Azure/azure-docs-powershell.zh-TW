...
## 說明
**新的-AzureRmDeploymentManagerServiceTopology** Cmdlet 會建立服務拓撲。

您可以在本機修改傳回的 ServiceTopology 物件，然後使用 Set-AzureRmDeploymentManagerServiceTopology Cmdlet 將變更套用到拓撲。
傳回的物件 
