...
- 由於 .NET Standard 的驗證流程有變，我們暫時移除透過 PSCredential 來登入使用者的功能。 這項功能會在 2019 年 1 月 15 日版本的 Windows PowerShell 5.1 重新引進。 我們會在[此問題](https://github.com/Azure/azure-powershell/issues/7430)中詳細討論此項目。
