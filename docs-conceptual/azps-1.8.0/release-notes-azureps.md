...
#### <a name="azcdn"></a><span data-ttu-id="a7a7d-114">Az.Cdn</span><span class="sxs-lookup"><span data-stu-id="a7a7d-114">Az.Cdn</span></span>
...
#### <a name="azhdinsight"></a><span data-ttu-id="a7a7d-130">Az.HDInsight</span><span class="sxs-lookup"><span data-stu-id="a7a7d-130">Az.HDInsight</span></span>
...
#### <a name="aznetwork"></a><span data-ttu-id="a7a7d-149">Az.Network</span><span class="sxs-lookup"><span data-stu-id="a7a7d-149">Az.Network</span></span>
...
#### <a name="azresources"></a><span data-ttu-id="a7a7d-165">Az.Resources</span><span class="sxs-lookup"><span data-stu-id="a7a7d-165">Az.Resources</span></span>
...
* <span data-ttu-id="a7a7d-186">新增僅適用於 Windows PowerShell 5.1 的互動式和使用者名稱/密碼驗證</span><span class="sxs-lookup"><span data-stu-id="a7a7d-186">Added interactive and username/password authentication for Windows PowerShell 5.1 only</span></span>
...
#### <a name="azdatafactory"></a><span data-ttu-id="a7a7d-203">Az.DataFactory</span><span class="sxs-lookup"><span data-stu-id="a7a7d-203">Az.DataFactory</span></span>
...
* <span data-ttu-id="a7a7d-223">Blob 的 -AsJob 支援和檔案上傳及下載 Cmdlet</span><span class="sxs-lookup"><span data-stu-id="a7a7d-223">-AsJob support for Blob and file upload and download cmdlets</span></span>
    ...
    - <span data-ttu-id="a7a7d-226">Get-AzStorageFileContent</span><span class="sxs-lookup"><span data-stu-id="a7a7d-226">Get-AzStorageFileContent</span></span>
...
#### <a name="azkeyvault"></a><span data-ttu-id="a7a7d-245">Az.KeyVault</span><span class="sxs-lookup"><span data-stu-id="a7a7d-245">Az.KeyVault</span></span>
...
#### <a name="azwebsites"></a><span data-ttu-id="a7a7d-266">Az.Websites</span><span class="sxs-lookup"><span data-stu-id="a7a7d-266">Az.Websites</span></span>
...
#### <a name="aznetwork"></a><span data-ttu-id="a7a7d-284">Az.Network</span><span class="sxs-lookup"><span data-stu-id="a7a7d-284">Az.Network</span></span>
...
#### <a name="azstorage"></a><span data-ttu-id="a7a7d-301">Az.Storage</span><span class="sxs-lookup"><span data-stu-id="a7a7d-301">Az.Storage</span></span>
...
#### <a name="azdatalakestore"></a><span data-ttu-id="a7a7d-317">Az.DataLakeStore</span><span class="sxs-lookup"><span data-stu-id="a7a7d-317">Az.DataLakeStore</span></span>
...
#### <a name="aznetwork"></a><span data-ttu-id="a7a7d-339">Az.Network</span><span class="sxs-lookup"><span data-stu-id="a7a7d-339">Az.Network</span></span>
...
## <a name="130---february-2019"></a><span data-ttu-id="a7a7d-355">1.3.0 - 2019 年 2 月</span><span class="sxs-lookup"><span data-stu-id="a7a7d-355">1.3.0 - February 2019</span></span>
...
#### <a name="azsql"></a><span data-ttu-id="a7a7d-371">Az.Sql</span><span class="sxs-lookup"><span data-stu-id="a7a7d-371">Az.Sql</span></span>
...
#### <a name="azaks"></a><span data-ttu-id="a7a7d-387">Az.Aks</span><span class="sxs-lookup"><span data-stu-id="a7a7d-387">Az.Aks</span></span>
...
#### <a name="aziothub"></a><span data-ttu-id="a7a7d-406">Az.IotHub</span><span class="sxs-lookup"><span data-stu-id="a7a7d-406">Az.IotHub</span></span>
...
#### <a name="azsignalr"></a><span data-ttu-id="a7a7d-425">Az.SignalR</span><span class="sxs-lookup"><span data-stu-id="a7a7d-425">Az.SignalR</span></span>
...
## <a name="110---january-2019"></a><span data-ttu-id="a7a7d-443">1.1.0 - 2019 年 1 月</span><span class="sxs-lookup"><span data-stu-id="a7a7d-443">1.1.0 - January 2019</span></span>
...
#### <a name="azsql"></a><span data-ttu-id="a7a7d-479">Az.Sql</span><span class="sxs-lookup"><span data-stu-id="a7a7d-479">Az.Sql</span></span>
* <span data-ttu-id="a7a7d-480">將儲存體管理用戶端相依性轉換為一般的 SDK 實作。</span><span class="sxs-lookup"><span data-stu-id="a7a7d-480">Converted the Storage management client dependency to the common SDK implementation.</span></span>

#### <a name="azstorage"></a><span data-ttu-id="a7a7d-481">Az.Storage</span><span class="sxs-lookup"><span data-stu-id="a7a7d-481">Az.Storage</span></span>
* <span data-ttu-id="a7a7d-482">使用 Sas 權杖、OAuth 或匿名來建立儲存體內容的 StorageAccountName 時，將其設定為實際的儲存體帳戶名稱</span><span class="sxs-lookup"><span data-stu-id="a7a7d-482">Set the StorageAccountName of Storage context as the real Storage Account Name, when it's created with Sas Token, OAuth or Anonymous</span></span>
    - <span data-ttu-id="a7a7d-483">New-AzStorageContext</span><span class="sxs-lookup"><span data-stu-id="a7a7d-483">New-AzStorageContext</span></span>
* <span data-ttu-id="a7a7d-484">使用 '-FullUri' 參數建立 Blob 快照集物件的 Sas 權杖、將傳回的 Uri 修正為快照集 Uri</span><span class="sxs-lookup"><span data-stu-id="a7a7d-484">Create Sas Token of Blob Snapshot Object with '-FullUri' parameter, fix the returned Uri to be the sanpshot Uri</span></span>
    - <span data-ttu-id="a7a7d-485">New-AzStorageBlobSASToken</span><span class="sxs-lookup"><span data-stu-id="a7a7d-485">New-AzStorageBlobSASToken</span></span>

#### <a name="azwebsites"></a><span data-ttu-id="a7a7d-486">Az.Websites</span><span class="sxs-lookup"><span data-stu-id="a7a7d-486">Az.Websites</span></span>
* <span data-ttu-id="a7a7d-487">修正 'Get-AzDeletedWebApp' 中的日期剖析錯誤</span><span class="sxs-lookup"><span data-stu-id="a7a7d-487">Fixed a date parsing bug in 'Get-AzDeletedWebApp'</span></span>
* <span data-ttu-id="a7a7d-488">修正 Az.Accounts 模組的回溯相容性問題</span><span class="sxs-lookup"><span data-stu-id="a7a7d-488">Fix backward compatibility issue with Az.Accounts module</span></span>

## <a name="100---december-2018"></a><span data-ttu-id="a7a7d-489">1.0.0 - 2018 年 12 月</span><span class="sxs-lookup"><span data-stu-id="a7a7d-489">1.0.0 - December 2018</span></span>
### <a name="general"></a><span data-ttu-id="a7a7d-490">一般</span><span class="sxs-lookup"><span data-stu-id="a7a7d-490">General</span></span>

- <span data-ttu-id="a7a7d-491">Az 模組正式運作</span><span class="sxs-lookup"><span data-stu-id="a7a7d-491">General Availability of Az Module</span></span>
- <span data-ttu-id="a7a7d-492">每個模組的線上說明</span><span class="sxs-lookup"><span data-stu-id="a7a7d-492">Online help for each module</span></span>
- <span data-ttu-id="a7a7d-493">如需詳細資訊和藍圖，請參閱 [Az 公告頁面](https://aka.ms/azps-announce)</span><span class="sxs-lookup"><span data-stu-id="a7a7d-493">For more details and a roadmap, see the [Az Announcement page](https://aka.ms/azps-announce)</span></span>
- <span data-ttu-id="a7a7d-494">如需從 AzureRM 遷移的相關資訊，請參閱[移轉指南](https://aka.ms/azps-migration-guide)</span><span class="sxs-lookup"><span data-stu-id="a7a7d-494">See the [Migration Guide](https://aka.ms/azps-migration-guide) for information on migrating from AzureRM</span></span>

### <a name="azaccounts"></a><span data-ttu-id="a7a7d-495">Az.Accounts</span><span class="sxs-lookup"><span data-stu-id="a7a7d-495">Az.Accounts</span></span>
- <span data-ttu-id="a7a7d-496">已從 Az.Profile 變更</span><span class="sxs-lookup"><span data-stu-id="a7a7d-496">Changed from Az.Profile</span></span>
- <span data-ttu-id="a7a7d-497">設定檔和內容類型有固定的資料表格式</span><span class="sxs-lookup"><span data-stu-id="a7a7d-497">Fixed table formats for profile and context types</span></span>

### <a name="azapimanagement"></a><span data-ttu-id="a7a7d-498">Az.ApiManagement</span><span class="sxs-lookup"><span data-stu-id="a7a7d-498">Az.ApiManagement</span></span>
- <span data-ttu-id="a7a7d-499">#7002 的修正</span><span class="sxs-lookup"><span data-stu-id="a7a7d-499">Fixes for #7002</span></span>
- <span data-ttu-id="a7a7d-500">次要重大變更，詳情請參閱[移轉指南](https://aka.ms/azps-migration-guide)</span><span class="sxs-lookup"><span data-stu-id="a7a7d-500">Minor breaking changes, see the [Migration Guide](https://aka.ms/azps-migration-guide)  for details</span></span>

### <a name="azbatch"></a><span data-ttu-id="a7a7d-501">Az.Batch</span><span class="sxs-lookup"><span data-stu-id="a7a7d-501">Az.Batch</span></span>
- <span data-ttu-id="a7a7d-502">已新增功能，可透過 `PSComputeNode` 上新的 `NodeAgentInformation` 屬性，查看集區中每個 VM 上所執行的 Azure Batch 節點代理程式是哪個版本。</span><span class="sxs-lookup"><span data-stu-id="a7a7d-502">Added the ability to see what version of the Azure Batch Node Agent is running on each of the VMs in a pool, via the new `NodeAgentInformation` property on `PSComputeNode`.</span></span>
- <span data-ttu-id="a7a7d-503">`PSDataDisk` 的 `Caching` 預設值現在為 `ReadWrite` 而非 `None`。</span><span class="sxs-lookup"><span data-stu-id="a7a7d-503">The `Caching` default for `PSDataDisk` is now `ReadWrite` instead of `None`.</span></span>
- <span data-ttu-id="a7a7d-504">次要重大變更，詳情請參閱[移轉指南](https://aka.ms/azps-migration-guide)</span><span class="sxs-lookup"><span data-stu-id="a7a7d-504">Minor breaking changes, see the [Migration Guide](https://aka.ms/azps-migration-guide)  for details</span></span>

### <a name="azbilling"></a><span data-ttu-id="a7a7d-505">Az.Billing</span><span class="sxs-lookup"><span data-stu-id="a7a7d-505">Az.Billing</span></span>
- <span data-ttu-id="a7a7d-506">結合 Billing、Consumption 和 UsageAggregates Cmdlet，詳情請參閱[移轉指南](https://aka.ms/azps-migration-guide)</span><span class="sxs-lookup"><span data-stu-id="a7a7d-506">Combines Billing, Consumption, and UsageAggregates cmdlets, see the [Migration Guide](https://aka.ms/azps-migration-guide)  for details</span></span>

### <a name="azcognitivservices"></a><span data-ttu-id="a7a7d-507">Az.CognitivServices</span><span class="sxs-lookup"><span data-stu-id="a7a7d-507">Az.CognitivServices</span></span>
- <span data-ttu-id="a7a7d-508">針對 New-AzureRmCognitiveServicesAccount 作業上可用的 SkuName 和 Typem 新增完成器</span><span class="sxs-lookup"><span data-stu-id="a7a7d-508">Add completers for SkuName and Typem available on New-AzureRmCognitiveServicesAccount operation</span></span>
- <span data-ttu-id="a7a7d-509">已從 Get-AzCognitiveServicesAccountSkus 移除 GetSkusWithAccountParamSetName 參數集</span><span class="sxs-lookup"><span data-stu-id="a7a7d-509">Removed GetSkusWithAccountParamSetName parameter set from Get-AzCognitiveServicesAccountSkus</span></span>

### <a name="azcontainerinstance"></a><span data-ttu-id="a7a7d-510">Az.ContainerInstance</span><span class="sxs-lookup"><span data-stu-id="a7a7d-510">Az.ContainerInstance</span></span>
- <span data-ttu-id="a7a7d-511">已新增 ManagedIdentity 支援</span><span class="sxs-lookup"><span data-stu-id="a7a7d-511">Added ManagedIdentity support</span></span>

### <a name="azdatalakeanalytics"></a><span data-ttu-id="a7a7d-512">Az.DataLakeAnalytics</span><span class="sxs-lookup"><span data-stu-id="a7a7d-512">Az.DataLakeAnalytics</span></span>
- <span data-ttu-id="a7a7d-513">次要重大變更，詳情請參閱[移轉指南](https://aka.ms/azps-migration-guide)</span><span class="sxs-lookup"><span data-stu-id="a7a7d-513">Minor breaking changes, see the [Migration Guide](https://aka.ms/azps-migration-guide)  for details</span></span>

### <a name="azdatalakestore"></a><span data-ttu-id="a7a7d-514">Az.DataLakeStore</span><span class="sxs-lookup"><span data-stu-id="a7a7d-514">Az.DataLakeStore</span></span>
- <span data-ttu-id="a7a7d-515">次要重大變更，詳情請參閱[移轉指南](https://aka.ms/azps-migration-guide)</span><span class="sxs-lookup"><span data-stu-id="a7a7d-515">Minor breaking changes, see the [Migration Guide](https://aka.ms/azps-migration-guide)  for details</span></span>

### <a name="azmonitor"></a><span data-ttu-id="a7a7d-516">Az.Monitor</span><span class="sxs-lookup"><span data-stu-id="a7a7d-516">Az.Monitor</span></span>
- <span data-ttu-id="a7a7d-517">Az.Insights 已重新命名為 Az.Monitor，並有次要重大變更，詳情請參閱[移轉指南](https://aka.ms/azps-migration-guide)</span><span class="sxs-lookup"><span data-stu-id="a7a7d-517">Renamed Az.Insights to Az.Monitor and other minor breaking changes, see the [Migration Guide](https://aka.ms/azps-migration-guide)  for details</span></span>

### <a name="azkeyvault"></a><span data-ttu-id="a7a7d-518">Az.KeyVault</span><span class="sxs-lookup"><span data-stu-id="a7a7d-518">Az.KeyVault</span></span>
- <span data-ttu-id="a7a7d-519">已從輸出類型中移除淘汰的 'PurgeDisabled' 屬性</span><span class="sxs-lookup"><span data-stu-id="a7a7d-519">Removed the deprecated 'PurgeDisabled' property from output types</span></span>

### <a name="azmachinelearning"></a><span data-ttu-id="a7a7d-520">Az.MachineLearning</span><span class="sxs-lookup"><span data-stu-id="a7a7d-520">Az.MachineLearning</span></span>
- <span data-ttu-id="a7a7d-521">已納入來自 Az.MachineLearningCompute 模組的 Cmdlet</span><span class="sxs-lookup"><span data-stu-id="a7a7d-521">Included cmdlets from Az.MachineLearningCompute module</span></span>

### <a name="azmedia"></a><span data-ttu-id="a7a7d-522">Az.Media</span><span class="sxs-lookup"><span data-stu-id="a7a7d-522">Az.Media</span></span>
- <span data-ttu-id="a7a7d-523">從 New-AzMediaService 移除淘汰的 -Tags 別名</span><span class="sxs-lookup"><span data-stu-id="a7a7d-523">Remove deprecated -Tags alias from New-AzMediaService</span></span>

### <a name="aznetwork"></a><span data-ttu-id="a7a7d-524">Az.Network</span><span class="sxs-lookup"><span data-stu-id="a7a7d-524">Az.Network</span></span>
<span data-ttu-id="a7a7d-525">已新增在應用程式閘道中設定 RewriteRuleSets 的支援</span><span class="sxs-lookup"><span data-stu-id="a7a7d-525">Added support for the configuring RewriteRuleSets in the Application Gateway</span></span>
    - <span data-ttu-id="a7a7d-526">已新增新的 Cmdlet：</span><span class="sxs-lookup"><span data-stu-id="a7a7d-526">New cmdlets added:</span></span>
        - <span data-ttu-id="a7a7d-527">Add-AzureRmApplicationGatewayRewriteRuleSet</span><span class="sxs-lookup"><span data-stu-id="a7a7d-527">Add-AzureRmApplicationGatewayRewriteRuleSet</span></span>
        - <span data-ttu-id="a7a7d-528">Get-AzureRmApplicationGatewayRewriteRuleSet</span><span class="sxs-lookup"><span data-stu-id="a7a7d-528">Get-AzureRmApplicationGatewayRewriteRuleSet</span></span>
        - <span data-ttu-id="a7a7d-529">New-AzureRmApplicationGatewayRewriteRuleSet</span><span class="sxs-lookup"><span data-stu-id="a7a7d-529">New-AzureRmApplicationGatewayRewriteRuleSet</span></span>
        - <span data-ttu-id="a7a7d-530">Remove-AzureRmApplicationGatewayRewriteRuleSet</span><span class="sxs-lookup"><span data-stu-id="a7a7d-530">Remove-AzureRmApplicationGatewayRewriteRuleSet</span></span>
        - <span data-ttu-id="a7a7d-531">Set-AzureRmApplicationGatewayRewriteRuleSet</span><span class="sxs-lookup"><span data-stu-id="a7a7d-531">Set-AzureRmApplicationGatewayRewriteRuleSet</span></span>
        - <span data-ttu-id="a7a7d-532">New-AzureRmApplicationGatewayRewriteRule</span><span class="sxs-lookup"><span data-stu-id="a7a7d-532">New-AzureRmApplicationGatewayRewriteRule</span></span>
        - <span data-ttu-id="a7a7d-533">New-AzureRmApplicationGatewayRewriteRuleActionSet</span><span class="sxs-lookup"><span data-stu-id="a7a7d-533">New-AzureRmApplicationGatewayRewriteRuleActionSet</span></span>
        - <span data-ttu-id="a7a7d-534">New-AzureRmApplicationGatewayRewriteRuleHeaderConfiguration</span><span class="sxs-lookup"><span data-stu-id="a7a7d-534">New-AzureRmApplicationGatewayRewriteRuleHeaderConfiguration</span></span>
    - <span data-ttu-id="a7a7d-535">Cmdlets updated with optional parameter -RewriteRuleSet</span><span class="sxs-lookup"><span data-stu-id="a7a7d-535">Cmdlets updated with optional parameter -RewriteRuleSet</span></span>
        - <span data-ttu-id="a7a7d-536">New-AzureRmApplicationGateway</span><span class="sxs-lookup"><span data-stu-id="a7a7d-536">New-AzureRmApplicationGateway</span></span>
        - <span data-ttu-id="a7a7d-537">New-AzureRmApplicationGatewayRequestRoutingRule</span><span class="sxs-lookup"><span data-stu-id="a7a7d-537">New-AzureRmApplicationGatewayRequestRoutingRule</span></span>
        - <span data-ttu-id="a7a7d-538">Add-AzureRmApplicationGatewayRequestRoutingRule</span><span class="sxs-lookup"><span data-stu-id="a7a7d-538">Add-AzureRmApplicationGatewayRequestRoutingRule</span></span>
        - <span data-ttu-id="a7a7d-539">New-AzureRmApplicationGatewayPathRuleConfig</span><span class="sxs-lookup"><span data-stu-id="a7a7d-539">New-AzureRmApplicationGatewayPathRuleConfig</span></span>
        - <span data-ttu-id="a7a7d-540">Add-AzureRmApplicationGatewayUrlPathMapConfig</span><span class="sxs-lookup"><span data-stu-id="a7a7d-540">Add-AzureRmApplicationGatewayUrlPathMapConfig</span></span>
        - <span data-ttu-id="a7a7d-541">New-AzureRmApplicationGatewayUrlPathMapConfig 已使用身分識別對應用程式閘道新增 KeyVault 支援。</span><span class="sxs-lookup"><span data-stu-id="a7a7d-541">New-AzureRmApplicationGatewayUrlPathMapConfig Added KeyVault Support to Application Gateway using Identity.</span></span>
    - <span data-ttu-id="a7a7d-542">已使用選擇性參數 -KeyVaultSecretId, -KeyVaultSecret 更新了 Cmdlet</span><span class="sxs-lookup"><span data-stu-id="a7a7d-542">Cmdlets updated with optonal parameter -KeyVaultSecretId, -KeyVaultSecret</span></span>
        - <span data-ttu-id="a7a7d-543">Add-AzApplicationGatewaySslCertificate</span><span class="sxs-lookup"><span data-stu-id="a7a7d-543">Add-AzApplicationGatewaySslCertificate</span></span>
        - <span data-ttu-id="a7a7d-544">New-AzApplicationGatewaySslCertificate</span><span class="sxs-lookup"><span data-stu-id="a7a7d-544">New-AzApplicationGatewaySslCertificate</span></span>
        - <span data-ttu-id="a7a7d-545">Set-AzApplicationGatewaySslCertificate</span><span class="sxs-lookup"><span data-stu-id="a7a7d-545">Set-AzApplicationGatewaySslCertificate</span></span>
    - <span data-ttu-id="a7a7d-546">已使用選擇性參數 -UserAssignedIdentity 更新了 New-AzApplicationGateway Cmdlet</span><span class="sxs-lookup"><span data-stu-id="a7a7d-546">New-AzApplicationGateway cmdlet updated with optional parameter -UserAssignedIdentity</span></span>
- <span data-ttu-id="a7a7d-547">次要重大變更，詳情請參閱[移轉指南](https://aka.ms/azps-migration-guide)</span><span class="sxs-lookup"><span data-stu-id="a7a7d-547">Minor breaking changes, see the [Migration Guide](https://aka.ms/azps-migration-guide)  for details</span></span>

### <a name="azoperationalinsights"></a><span data-ttu-id="a7a7d-548">Az.OperationalInsights</span><span class="sxs-lookup"><span data-stu-id="a7a7d-548">Az.OperationalInsights</span></span>
- <span data-ttu-id="a7a7d-549">次要重大變更，詳情請參閱[移轉指南](https://aka.ms/azps-migration-guide)</span><span class="sxs-lookup"><span data-stu-id="a7a7d-549">Minor breaking changes, see the [Migration Guide](https://aka.ms/azps-migration-guide)  for details</span></span>

### <a name="azprofile"></a><span data-ttu-id="a7a7d-550">Az.Profile</span><span class="sxs-lookup"><span data-stu-id="a7a7d-550">Az.Profile</span></span>
- <span data-ttu-id="a7a7d-551">模組名稱已變更為 Az.Accounts</span><span class="sxs-lookup"><span data-stu-id="a7a7d-551">Changed module name to Az.Accounts</span></span>

### <a name="azrecoveryservices"></a><span data-ttu-id="a7a7d-552">Az.RecoveryServices</span><span class="sxs-lookup"><span data-stu-id="a7a7d-552">Az.RecoveryServices</span></span>
- <span data-ttu-id="a7a7d-553">次要重大變更，詳情請參閱[移轉指南](https://aka.ms/azps-migration-guide)</span><span class="sxs-lookup"><span data-stu-id="a7a7d-553">Minor breaking changes, see the [Migration Guide](https://aka.ms/azps-migration-guide)  for details</span></span>

### <a name="azresources"></a><span data-ttu-id="a7a7d-554">Az.Resources</span><span class="sxs-lookup"><span data-stu-id="a7a7d-554">Az.Resources</span></span>
- <span data-ttu-id="a7a7d-555">次要重大變更，詳情請參閱[移轉指南](https://aka.ms/azps-migration-guide)</span><span class="sxs-lookup"><span data-stu-id="a7a7d-555">Minor breaking changes, see the [Migration Guide](https://aka.ms/azps-migration-guide)  for details</span></span>

### <a name="azservicefabric"></a><span data-ttu-id="a7a7d-556">Az.ServiceFabric</span><span class="sxs-lookup"><span data-stu-id="a7a7d-556">Az.ServiceFabric</span></span>
- <span data-ttu-id="a7a7d-557">支援依通用名稱和指紋來指定憑證</span><span class="sxs-lookup"><span data-stu-id="a7a7d-557">Support specfying certificate by common name and thumbprint</span></span>
- <span data-ttu-id="a7a7d-558">次要重大變更，詳情請參閱[移轉指南](https://aka.ms/azps-migration-guide)</span><span class="sxs-lookup"><span data-stu-id="a7a7d-558">Mnor breaking changes, see the [Migration Guide](https://aka.ms/azps-migration-guide)  for details</span></span>

### <a name="azsignalr"></a><span data-ttu-id="a7a7d-559">Az.SIgnalR</span><span class="sxs-lookup"><span data-stu-id="a7a7d-559">Az.SIgnalR</span></span>
- <span data-ttu-id="a7a7d-560">SIgnalR 的 PowerShell Cmdlet 正式運作</span><span class="sxs-lookup"><span data-stu-id="a7a7d-560">General Availability for PowerShell cmdlets for SIgnalR</span></span>

### <a name="azsql"></a><span data-ttu-id="a7a7d-561">Az.Sql</span><span class="sxs-lookup"><span data-stu-id="a7a7d-561">Az.Sql</span></span>
- <span data-ttu-id="a7a7d-562">已對威脅偵測的 Cmdlet 新增 Data_Exfiltration 和 Unsafe_Action 偵測類型</span><span class="sxs-lookup"><span data-stu-id="a7a7d-562">Added new Data_Exfiltration and Unsafe_Action detection types to Threat Detection's cmdlets</span></span>
- <span data-ttu-id="a7a7d-563">已更新 SQL 稽核 Cmdlet 的文件範例</span><span class="sxs-lookup"><span data-stu-id="a7a7d-563">Updated documentation examples for Sql Auditing cmdlets</span></span>
- <span data-ttu-id="a7a7d-564">次要重大變更，詳情請參閱[移轉指南](https://aka.ms/azps-migration-guide)</span><span class="sxs-lookup"><span data-stu-id="a7a7d-564">Minor breaking changes, see the [Migration Guide](https://aka.ms/azps-migration-guide)  for details</span></span>

### <a name="azstorage"></a><span data-ttu-id="a7a7d-565">Az.Storage</span><span class="sxs-lookup"><span data-stu-id="a7a7d-565">Az.Storage</span></span>
- <span data-ttu-id="a7a7d-566">次要重大變更，詳情請參閱[移轉指南](https://aka.ms/azps-migration-guide)</span><span class="sxs-lookup"><span data-stu-id="a7a7d-566">Minor breaking changes, see the [Migration Guide](https://aka.ms/azps-migration-guide)  for details</span></span>

### <a name="azwebsites"></a><span data-ttu-id="a7a7d-567">Az.Websites</span><span class="sxs-lookup"><span data-stu-id="a7a7d-567">Az.Websites</span></span>
- <span data-ttu-id="a7a7d-568">次要重大變更，詳情請參閱[移轉指南](https://aka.ms/azps-migration-guide)</span><span class="sxs-lookup"><span data-stu-id="a7a7d-568">Minor breaking changes, see the [Migration Guide](https://aka.ms/azps-migration-guide)  for details</span></span>

## <a name="070---december-2018"></a><span data-ttu-id="a7a7d-569">0.7.0 - 2018 年 12 月</span><span class="sxs-lookup"><span data-stu-id="a7a7d-569">0.7.0 - December 2018</span></span>

### <a name="general"></a><span data-ttu-id="a7a7d-570">一般</span><span class="sxs-lookup"><span data-stu-id="a7a7d-570">General</span></span>

* <span data-ttu-id="a7a7d-571">即將推出的「AzureRM 對 Az 轉換」有些微變更</span><span class="sxs-lookup"><span data-stu-id="a7a7d-571">Minor changes for upcoming AzureRM to Az transition</span></span>

### <a name="azcompute"></a><span data-ttu-id="a7a7d-572">Az.Compute</span><span class="sxs-lookup"><span data-stu-id="a7a7d-572">Az.Compute</span></span>

* <span data-ttu-id="a7a7d-573">針對 `New-AzVm(ss)` Cmdlet 簡單參數集內的 UltraSSD 和資源庫映像新增支援。</span><span class="sxs-lookup"><span data-stu-id="a7a7d-573">Add support for UltraSSD and Gallery Images in the simple param sets for `New-AzVm(ss)` cmdlets.</span></span>

### <a name="azdatalakestore"></a><span data-ttu-id="a7a7d-574">Az.DataLakeStore</span><span class="sxs-lookup"><span data-stu-id="a7a7d-574">Az.DataLakeStore</span></span>

* <span data-ttu-id="a7a7d-575">修正 adls 帳戶網域的尾端斜線</span><span class="sxs-lookup"><span data-stu-id="a7a7d-575">Fix the trailing slash of the domain of adls account</span></span>

### <a name="azfrontdoor"></a><span data-ttu-id="a7a7d-576">Az.FrontDoor</span><span class="sxs-lookup"><span data-stu-id="a7a7d-576">Az.FrontDoor</span></span>

* <span data-ttu-id="a7a7d-577">已修正一些中斷的連結</span><span class="sxs-lookup"><span data-stu-id="a7a7d-577">Fixed some broken links</span></span>
    - <span data-ttu-id="a7a7d-578">在 New-AzureRmFrontDoor 和 Set-AzureRmFrontDoor 文章中，已修正 New-AzureRmFrontDoorHealthProbeSettingObject Cmdlet 文章的連結。</span><span class="sxs-lookup"><span data-stu-id="a7a7d-578">In the New-AzureRmFrontDoor and Set-AzureRmFrontDoor articles, fixed the link to the New-AzureRmFrontDoorHealthProbeSettingObject cmdlet article.</span></span>
    - <span data-ttu-id="a7a7d-579">在 New-AzureRmFrontDoorManagedRuleObject 文章中，已修正 New-AzureRmFrontDoorRuleGroupOverrideObject Cmdlet 文章的連結。</span><span class="sxs-lookup"><span data-stu-id="a7a7d-579">In the New-AzureRmFrontDoorManagedRuleObject article, fixed the link to the New-AzureRmFrontDoorRuleGroupOverrideObject cmdlet article.</span></span>

### <a name="azrecoveryservices"></a><span data-ttu-id="a7a7d-580">Az.RecoveryServices</span><span class="sxs-lookup"><span data-stu-id="a7a7d-580">Az.RecoveryServices</span></span>

* <span data-ttu-id="a7a7d-581">已針對 Azure 檔案共用的還原作業新增用戶端驗證。</span><span class="sxs-lookup"><span data-stu-id="a7a7d-581">Added client side validations for Azure File Share restore operations.</span></span>
* <span data-ttu-id="a7a7d-582">已將 storageAccountName 和 storageAccountResourceGroupName 設為 afs 還原作業的選擇性項目。</span><span class="sxs-lookup"><span data-stu-id="a7a7d-582">Made storageAccountName and storageAccountResourceGroupName optional for afs restore.</span></span>

### <a name="azresources"></a><span data-ttu-id="a7a7d-583">Az.Resources</span><span class="sxs-lookup"><span data-stu-id="a7a7d-583">Az.Resources</span></span>

* <span data-ttu-id="a7a7d-584">修正 https://github.com/Azure/azure-powershell/issues/7679</span><span class="sxs-lookup"><span data-stu-id="a7a7d-584">Fix for https://github.com/Azure/azure-powershell/issues/7679</span></span>
    - <span data-ttu-id="a7a7d-585">將 Get-AzureRmRoleAssignment 更新為使用訂用帳戶範圍 (如果有在要求傳統管理員時提供的話)。</span><span class="sxs-lookup"><span data-stu-id="a7a7d-585">Update Get-AzureRmRoleAssignment to use the subscription scope if it is provided when requesting classic administrators.</span></span>

### <a name="azsql"></a><span data-ttu-id="a7a7d-586">Az.Sql</span><span class="sxs-lookup"><span data-stu-id="a7a7d-586">Az.Sql</span></span>

* <span data-ttu-id="a7a7d-587">即將推出的「AzureRM 對 Az 轉換」有些微變更</span><span class="sxs-lookup"><span data-stu-id="a7a7d-587">Minor changes for upcoming AzureRM to Az transition</span></span>
* <span data-ttu-id="a7a7d-588">已修正搭配使用 Get-AzureRmSqlDatabaseVulnerabilityAssessment 和 DotNet core 時所會發生的問題</span><span class="sxs-lookup"><span data-stu-id="a7a7d-588">Fixed issue with using Get-AzureRmSqlDatabaseVulnerabilityAssessment with DotNet core</span></span>
* <span data-ttu-id="a7a7d-589">已修改 SQL 稽核 Cmdlet 相關說明訊息的文件。</span><span class="sxs-lookup"><span data-stu-id="a7a7d-589">Modified documentation of help messages related to SQL Auditing cmdlets.</span></span>

### <a name="azstorage"></a><span data-ttu-id="a7a7d-590">Az.Storage</span><span class="sxs-lookup"><span data-stu-id="a7a7d-590">Az.Storage</span></span>

* <span data-ttu-id="a7a7d-591">對 New-AzureRmStorageAccount 新增 -EnableHierarchicalNamespace</span><span class="sxs-lookup"><span data-stu-id="a7a7d-591">Add -EnableHierarchicalNamespace to New-AzureRmStorageAccount</span></span>
* <span data-ttu-id="a7a7d-592">已修正下列問題：如果沒有輸入 -DestContext，複製檔案 Cmdlet 無法重複使用目的地中的來源內容</span><span class="sxs-lookup"><span data-stu-id="a7a7d-592">Fix issue that Copy File cmdlet can't reuse source context in destination when not input -DestContext</span></span>
    - <span data-ttu-id="a7a7d-593">Start-AzureStorageFileCopy</span><span class="sxs-lookup"><span data-stu-id="a7a7d-593">Start-AzureStorageFileCopy</span></span>
* <span data-ttu-id="a7a7d-594">支援靜態網站設定</span><span class="sxs-lookup"><span data-stu-id="a7a7d-594">Support Static Website configuration</span></span>
    - <span data-ttu-id="a7a7d-595">Enable-AzureStorageStaticWebsite</span><span class="sxs-lookup"><span data-stu-id="a7a7d-595">Enable-AzureStorageStaticWebsite</span></span>
    - <span data-ttu-id="a7a7d-596">Disable-AzureStorageStaticWebsite</span><span class="sxs-lookup"><span data-stu-id="a7a7d-596">Disable-AzureStorageStaticWebsite</span></span>

### <a name="azwebsites"></a><span data-ttu-id="a7a7d-597">Az.Websites</span><span class="sxs-lookup"><span data-stu-id="a7a7d-597">Az.Websites</span></span>

* <span data-ttu-id="a7a7d-598">Set-AzureRmWebApp 和 Set-AzureRmWebAppSlot</span><span class="sxs-lookup"><span data-stu-id="a7a7d-598">Set-AzureRmWebApp and Set-AzureRmWebAppSlot</span></span> 
    - <span data-ttu-id="a7a7d-599">已新增新的參數 (-AzureStoragePath)，指定要將 Azure 儲存體路徑掛接至 Windows 和 Linux 容器應用程式中。</span><span class="sxs-lookup"><span data-stu-id="a7a7d-599">New parameter (-AzureStoragePath) added to specify Azure Storage paths to be mounted in Windows and Linux container apps.</span></span> <span data-ttu-id="a7a7d-600">使用新 Cmdlet New-AzureRmWebAppAzureStoragePath 的輸出作為參數來設定 Azure 儲存體路徑。</span><span class="sxs-lookup"><span data-stu-id="a7a7d-600">Use the output of the new cmdlet New-AzureRmWebAppAzureStoragePath as a parameter to set the Azure Storage paths.</span></span>

## <a name="061---november-2018"></a><span data-ttu-id="a7a7d-601">0.6.1 - 2018 年 11 月</span><span class="sxs-lookup"><span data-stu-id="a7a7d-601">0.6.1 - November 2018</span></span>

### <a name="azapimanagement"></a><span data-ttu-id="a7a7d-602">Az.ApiManagement</span><span class="sxs-lookup"><span data-stu-id="a7a7d-602">Az.ApiManagement</span></span>
* <span data-ttu-id="a7a7d-603">針對類型對應問題更新相依性</span><span class="sxs-lookup"><span data-stu-id="a7a7d-603">Update dependencies for type mapping issue</span></span>

### <a name="azautomation"></a><span data-ttu-id="a7a7d-604">Az.Automation</span><span class="sxs-lookup"><span data-stu-id="a7a7d-604">Az.Automation</span></span>
* <span data-ttu-id="a7a7d-605">以 Swagger 為基礎的 Azure 自動化 Cmdlet</span><span class="sxs-lookup"><span data-stu-id="a7a7d-605">Swagger based Azure Automation cmdlets</span></span>
* <span data-ttu-id="a7a7d-606">已新增更新管理 Cmdlet</span><span class="sxs-lookup"><span data-stu-id="a7a7d-606">Added Update Management cmdlets</span></span>
* <span data-ttu-id="a7a7d-607">已新增原始檔控制 Cmdlet</span><span class="sxs-lookup"><span data-stu-id="a7a7d-607">Added Source Control cmdlets</span></span>
* <span data-ttu-id="a7a7d-608">已新增 Remove-AzureRmAutomationHybridWorkerGroup Cmdlet</span><span class="sxs-lookup"><span data-stu-id="a7a7d-608">Added Remove-AzureRmAutomationHybridWorkerGroup cmdlet</span></span>
* <span data-ttu-id="a7a7d-609">已修正 DSC 註冊節點命令</span><span class="sxs-lookup"><span data-stu-id="a7a7d-609">Fixed the DSC Register Node command</span></span>

### <a name="azcompute"></a><span data-ttu-id="a7a7d-610">Az.Compute</span><span class="sxs-lookup"><span data-stu-id="a7a7d-610">Az.Compute</span></span>
* <span data-ttu-id="a7a7d-611">已修正 SystemAssigned 身分識別的身份識別問題</span><span class="sxs-lookup"><span data-stu-id="a7a7d-611">Fixed identity issue for SystemAssigned identity</span></span>
* <span data-ttu-id="a7a7d-612">針對類型對應問題更新相依性</span><span class="sxs-lookup"><span data-stu-id="a7a7d-612">Update dependencies for type mapping issue</span></span>

### <a name="azcontainerinstance"></a><span data-ttu-id="a7a7d-613">Az.ContainerInstance</span><span class="sxs-lookup"><span data-stu-id="a7a7d-613">Az.ContainerInstance</span></span>
* <span data-ttu-id="a7a7d-614">針對類型對應問題更新相依性</span><span class="sxs-lookup"><span data-stu-id="a7a7d-614">Update dependencies for type mapping issue</span></span>

### <a name="azmarketplaceordering"></a><span data-ttu-id="a7a7d-615">Az.MarketplaceOrdering</span><span class="sxs-lookup"><span data-stu-id="a7a7d-615">Az.MarketplaceOrdering</span></span>
* <span data-ttu-id="a7a7d-616">更新市集 Cmdlet 的範例描述</span><span class="sxs-lookup"><span data-stu-id="a7a7d-616">update the examples description for marketplace cmdlets</span></span>

### <a name="aznetwork"></a><span data-ttu-id="a7a7d-617">Az.Network</span><span class="sxs-lookup"><span data-stu-id="a7a7d-617">Az.Network</span></span>
* <span data-ttu-id="a7a7d-618">已新增 Cmdlet：New-AzureRmApplicationGatewayCustomError、Add-AzureRmApplicationGatewayCustomError、Get-AzureRmApplicationGatewayCustomError、Set-AzureRmApplicationGatewayCustomError、Remove-AzureRmApplicationGatewayCustomError、Add-AzureRmApplicationGatewayHttpListenerCustomError、Get-AzureRmApplicationGatewayHttpListenerCustomError、Set-AzureRmApplicationGatewayHttpListenerCustomError、Remove-AzureRmApplicationGatewayHttpListenerCustomError</span><span class="sxs-lookup"><span data-stu-id="a7a7d-618">Added cmdlet New-AzureRmApplicationGatewayCustomError, Add-AzureRmApplicationGatewayCustomError, Get-AzureRmApplicationGatewayCustomError, Set-AzureRmApplicationGatewayCustomError, Remove-AzureRmApplicationGatewayCustomError, Add-AzureRmApplicationGatewayHttpListenerCustomError, Get-AzureRmApplicationGatewayHttpListenerCustomError, Set-AzureRmApplicationGatewayHttpListenerCustomError, Remove-AzureRmApplicationGatewayHttpListenerCustomError</span></span>
* <span data-ttu-id="a7a7d-619">已將 ICMP 加回支援的 AzureFirewall 網路通訊協定</span><span class="sxs-lookup"><span data-stu-id="a7a7d-619">Added ICMP back to supported AzureFirewall Network Protocols</span></span>
* <span data-ttu-id="a7a7d-620">更新 Test-AzureRmNetworkWatcherConnectivity Cmdlet，在目的地識別碼、位址和連接埠上新增驗證。</span><span class="sxs-lookup"><span data-stu-id="a7a7d-620">Update cmdlet Test-AzureRmNetworkWatcherConnectivity, add validation on destination id, address and port.</span></span> 
* <span data-ttu-id="a7a7d-621">修正 VirtualNetwork 對應中的記憶體使用量問題</span><span class="sxs-lookup"><span data-stu-id="a7a7d-621">Fix issues with memory usage in VirtualNetwork map</span></span>

### <a name="azrecoveryservicesbackup"></a><span data-ttu-id="a7a7d-622">Az.RecoveryServices.Backup</span><span class="sxs-lookup"><span data-stu-id="a7a7d-622">Az.RecoveryServices.Backup</span></span>
* <span data-ttu-id="a7a7d-623">提供修正程式以修改受保護的檔案共用原則。</span><span class="sxs-lookup"><span data-stu-id="a7a7d-623">Fix for modifying policy for a protected file share.</span></span>
* <span data-ttu-id="a7a7d-624">已將原則時區轉換為大寫。</span><span class="sxs-lookup"><span data-stu-id="a7a7d-624">Converted policy timezone to uppercase.</span></span>

### <a name="azrecoveryservicessiterecovery"></a><span data-ttu-id="a7a7d-625">Az.RecoveryServices.SiteRecovery</span><span class="sxs-lookup"><span data-stu-id="a7a7d-625">Az.RecoveryServices.SiteRecovery</span></span>
* <span data-ttu-id="a7a7d-626">已修正 New-AzureRmRecoveryServicesAsrProtectableItem 中的範例</span><span class="sxs-lookup"><span data-stu-id="a7a7d-626">Corrected example in New-AzureRmRecoveryServicesAsrProtectableItem</span></span>
* <span data-ttu-id="a7a7d-627">針對類型對應問題更新相依性</span><span class="sxs-lookup"><span data-stu-id="a7a7d-627">Update dependencies for type mapping issue</span></span>

### <a name="azrelay"></a><span data-ttu-id="a7a7d-628">Az.Relay</span><span class="sxs-lookup"><span data-stu-id="a7a7d-628">Az.Relay</span></span>
* <span data-ttu-id="a7a7d-629">已將選擇性參數 -KeyValue 新增至 New-AzureRmRelayKey Cmdlet，這樣會要求使用者提供 KeyValue。</span><span class="sxs-lookup"><span data-stu-id="a7a7d-629">Added optional Parameter -KeyValue to New-AzureRmRelayKey cmdlet, which enables user to provide KeyValue.</span></span>

### <a name="azresources"></a><span data-ttu-id="a7a7d-630">Az.Resources</span><span class="sxs-lookup"><span data-stu-id="a7a7d-630">Az.Resources</span></span>
* <span data-ttu-id="a7a7d-631">更新 `New-AzureRmPolicyAssignment` 和 `Set-AzureRmPolicyAssignment` 中資源身分識別相關參數的說明文件</span><span class="sxs-lookup"><span data-stu-id="a7a7d-631">Update help documentation for resource identity related parameters in `New-AzureRmPolicyAssignment` and `Set-AzureRmPolicyAssignment`</span></span>
* <span data-ttu-id="a7a7d-632">新增使用 -Metadata 的 New-AzureRmPolicyDefinition 範例</span><span class="sxs-lookup"><span data-stu-id="a7a7d-632">Add an example for New-AzureRmPolicyDefinition that uses -Metadata</span></span>
* <span data-ttu-id="a7a7d-633">修正：允許在 NetStandard: #7678 #7703 的標籤索引鍵中保留大小寫</span><span class="sxs-lookup"><span data-stu-id="a7a7d-633">Fix to allow case preservation in Tag keys in NetStandard: #7678 #7703</span></span>

### <a name="azservicefabric"></a><span data-ttu-id="a7a7d-634">Az.ServiceFabric</span><span class="sxs-lookup"><span data-stu-id="a7a7d-634">Az.ServiceFabric</span></span>
* <span data-ttu-id="a7a7d-635">針對即將推出的重大變更新增取代資訊</span><span class="sxs-lookup"><span data-stu-id="a7a7d-635">Add deprecation messages for upcoming breaking changes</span></span>

### <a name="azsql"></a><span data-ttu-id="a7a7d-636">Az.Sql</span><span class="sxs-lookup"><span data-stu-id="a7a7d-636">Az.Sql</span></span>
* <span data-ttu-id="a7a7d-637">已在 Azure SQL Database 受控執行個體和 Azure SQL 受控資料庫上新增 CRUD 作業的 Cmdlet</span><span class="sxs-lookup"><span data-stu-id="a7a7d-637">Added new cmdlets for CRUD operations on Azure Sql Database Managed Instance and Azure Sql Managed Database</span></span>
    - <span data-ttu-id="a7a7d-638">Get-AzureRmSqlInstance</span><span class="sxs-lookup"><span data-stu-id="a7a7d-638">Get-AzureRmSqlInstance</span></span>
    - <span data-ttu-id="a7a7d-639">New-AzureRmSqlInstance</span><span class="sxs-lookup"><span data-stu-id="a7a7d-639">New-AzureRmSqlInstance</span></span>
    - <span data-ttu-id="a7a7d-640">Set-AzureRmSqlInstance</span><span class="sxs-lookup"><span data-stu-id="a7a7d-640">Set-AzureRmSqlInstance</span></span>
    - <span data-ttu-id="a7a7d-641">Remove-AzureRmSqlInstance</span><span class="sxs-lookup"><span data-stu-id="a7a7d-641">Remove-AzureRmSqlInstance</span></span>
    - <span data-ttu-id="a7a7d-642">Get-AzureRmSqlInstanceDatabase</span><span class="sxs-lookup"><span data-stu-id="a7a7d-642">Get-AzureRmSqlInstanceDatabase</span></span>
    - <span data-ttu-id="a7a7d-643">New-AzureRmSqlInstanceDatabase</span><span class="sxs-lookup"><span data-stu-id="a7a7d-643">New-AzureRmSqlInstanceDatabase</span></span>
    - <span data-ttu-id="a7a7d-644">Restore-AzureRmSqlInstanceDatabase</span><span class="sxs-lookup"><span data-stu-id="a7a7d-644">Restore-AzureRmSqlInstanceDatabase</span></span>
    - <span data-ttu-id="a7a7d-645">Remove-AzureRmSqlInstanceDatabase</span><span class="sxs-lookup"><span data-stu-id="a7a7d-645">Remove-AzureRmSqlInstanceDatabase</span></span>
* <span data-ttu-id="a7a7d-646">已在伺服器或資料庫上啟用擴充的稽核原則管理。</span><span class="sxs-lookup"><span data-stu-id="a7a7d-646">Enabled Extended Auditing Policy management on a server or a database.</span></span>
    - <span data-ttu-id="a7a7d-647">已新增參數 (PredicateExpression) 以啟用稽核記錄的篩選。</span><span class="sxs-lookup"><span data-stu-id="a7a7d-647">New parameter (PredicateExpression) was added to enable filtering of audit logs.</span></span>
    - <span data-ttu-id="a7a7d-648">已將 Cmdlet 修改為使用 SQL 用戶端，而不是傳統用戶端。</span><span class="sxs-lookup"><span data-stu-id="a7a7d-648">Cmdlets were modified to use SQL clients instead of Legacy clients.</span></span>
    - <span data-ttu-id="a7a7d-649">Set-AzureRmSqlServerAuditing。</span><span class="sxs-lookup"><span data-stu-id="a7a7d-649">Set-AzureRmSqlServerAuditing.</span></span>
    - <span data-ttu-id="a7a7d-650">Get-AzureRmSqlServerAuditing。</span><span class="sxs-lookup"><span data-stu-id="a7a7d-650">Get-AzureRmSqlServerAuditing.</span></span>
    - <span data-ttu-id="a7a7d-651">Set-AzureRmSqlDatabaseAuditing。</span><span class="sxs-lookup"><span data-stu-id="a7a7d-651">Set-AzureRmSqlDatabaseAuditing.</span></span>
    - <span data-ttu-id="a7a7d-652">Get-AzureRmSqlDatabaseAuditing。</span><span class="sxs-lookup"><span data-stu-id="a7a7d-652">Get-AzureRmSqlDatabaseAuditing.</span></span>
* <span data-ttu-id="a7a7d-653">已修正使用 Update-AzureRmSqlDatabaseVulnerabilityAssessmentSettings 和儲存體帳戶名稱參數集的問題</span><span class="sxs-lookup"><span data-stu-id="a7a7d-653">Fixed issue with using Update-AzureRmSqlDatabaseVulnerabilityAssessmentSettings with storage account name parameter set</span></span>

## <a name="050---november-2018"></a><span data-ttu-id="a7a7d-654">0.5.0 - 2018 年 11 月</span><span class="sxs-lookup"><span data-stu-id="a7a7d-654">0.5.0 - November 2018</span></span>
#### <a name="general"></a><span data-ttu-id="a7a7d-655">一般</span><span class="sxs-lookup"><span data-stu-id="a7a7d-655">General</span></span>
* <span data-ttu-id="a7a7d-656">已在許多核心 Cmdlet 新增資源完成器 - 這些 Cmdlet 可讓您在以互動方式叫用 Cmdlet 時，使用 TAB 鍵瀏覽現有資源名稱</span><span class="sxs-lookup"><span data-stu-id="a7a7d-656">Added Resource Completers to many core cmdlets - these alloow you to tab through existing resource names when invoking cmdlets interactively</span></span>

#### <a name="azprofile"></a><span data-ttu-id="a7a7d-657">Az.Profile</span><span class="sxs-lookup"><span data-stu-id="a7a7d-657">Az.Profile</span></span>
* <span data-ttu-id="a7a7d-658">更新通用程式碼，以使用最新版 ClientRuntime</span><span class="sxs-lookup"><span data-stu-id="a7a7d-658">Update common code to use latest version of ClientRuntime</span></span>
* <span data-ttu-id="a7a7d-659">將 Cmdlet Connect-AzAccount 中的參數 TenantId 重新命名為 Tenant 並新增 TenantId 的別名</span><span class="sxs-lookup"><span data-stu-id="a7a7d-659">Rename param TenantId in cmdlet Connect-AzAccount to Tenant and add an alias for TenantId</span></span>
* <span data-ttu-id="a7a7d-660">更新 Connect-AzAccount 的 TenantId 說明</span><span class="sxs-lookup"><span data-stu-id="a7a7d-660">Updated TenantId description for Connect-AzAccount</span></span>
* <span data-ttu-id="a7a7d-661">修正提供租用戶網域時登入失敗的錯誤訊息</span><span class="sxs-lookup"><span data-stu-id="a7a7d-661">Fix error message for failed login when providing tenant domain</span></span>
    - https://github.com/Azure/azure-powershell/issues/6936
* <span data-ttu-id="a7a7d-662">修正租用戶中無訂用帳戶之帳戶內容衝突的問題</span><span class="sxs-lookup"><span data-stu-id="a7a7d-662">Fix issue with context name clashing for accounts with no subscriptions in tenant</span></span>
    - https://github.com/Azure/azure-powershell/issues/7453
* <span data-ttu-id="a7a7d-663">修正使用 MSI 時 DataLake 端點的問題</span><span class="sxs-lookup"><span data-stu-id="a7a7d-663">Fix issue with DataLake endpoints when using MSI</span></span>
    - https://github.com/Azure/azure-powershell/issues/7462
* <span data-ttu-id="a7a7d-664">修正若未連線，'Disconnect-AzAccount' 會擲出錯誤的問題</span><span class="sxs-lookup"><span data-stu-id="a7a7d-664">Fix issue where 'Disconnect-AzAccount' would throw if not connected</span></span>
    - https://github.com/Azure/azure-powershell/issues/7167

#### <a name="azcognitiveservices"></a><span data-ttu-id="a7a7d-665">Az.CognitiveServices</span><span class="sxs-lookup"><span data-stu-id="a7a7d-665">Az.CognitiveServices</span></span>
* <span data-ttu-id="a7a7d-666">新增 Get-AzCognitiveServicesAccountSkus 作業。</span><span class="sxs-lookup"><span data-stu-id="a7a7d-666">Add Get-AzCognitiveServicesAccountSkus operation.</span></span>

#### <a name="azcompute"></a><span data-ttu-id="a7a7d-667">Az.Compute</span><span class="sxs-lookup"><span data-stu-id="a7a7d-667">Az.Compute</span></span>
* <span data-ttu-id="a7a7d-668">新增 Add-AzVmssVMDataDisk 和 Remove-AzVmssVMDataDisk Cmdlet</span><span class="sxs-lookup"><span data-stu-id="a7a7d-668">Add Add-AzVmssVMDataDisk and Remove-AzVmssVMDataDisk cmdlets</span></span>
* <span data-ttu-id="a7a7d-669">Get-AzVMImage 顯示 AutomaticOSUpgradeProperties</span><span class="sxs-lookup"><span data-stu-id="a7a7d-669">Get-AzVMImage shows AutomaticOSUpgradeProperties</span></span>
* <span data-ttu-id="a7a7d-670">已修正 SetAzVMChefExtension -BootstrapOptions 和 -JsonAttribute 選項值並未以 json 格式設定的問題。</span><span class="sxs-lookup"><span data-stu-id="a7a7d-670">Fixed SetAzVMChefExtension -BootstrapOptions and -JsonAttribute option values are not setting in json format.</span></span>

#### <a name="azdatalakestore"></a><span data-ttu-id="a7a7d-671">Az.DataLakeStore</span><span class="sxs-lookup"><span data-stu-id="a7a7d-671">Az.DataLakeStore</span></span>
* <span data-ttu-id="a7a7d-672">將 DataLake 套件更新為 1.1.10。</span><span class="sxs-lookup"><span data-stu-id="a7a7d-672">Update the DataLake package to 1.1.10.</span></span>
* <span data-ttu-id="a7a7d-673">將預設並行新增至多執行作業。</span><span class="sxs-lookup"><span data-stu-id="a7a7d-673">Add default Concurrency to multithreaded operations.</span></span>

#### <a name="azinsights"></a><span data-ttu-id="a7a7d-674">Az.Insights</span><span class="sxs-lookup"><span data-stu-id="a7a7d-674">Az.Insights</span></span>
* <span data-ttu-id="a7a7d-675">已修正問題 #7267 (自動調整區域)</span><span class="sxs-lookup"><span data-stu-id="a7a7d-675">Fixed issue #7267 (Autoscale area)</span></span>
    - <span data-ttu-id="a7a7d-676">建立新自動調整規則時未適當設定列舉的參數 (一律會設為預設值) 的問題。</span><span class="sxs-lookup"><span data-stu-id="a7a7d-676">Issues with creating a new autoscale rule not properly setting enumerated parameters (would always set them to the default value).</span></span>
* <span data-ttu-id="a7a7d-677">已修正問題 #7513 [Insights] Set-AzDiagnosticSetting 在建立設定時需要明確的類別規格</span><span class="sxs-lookup"><span data-stu-id="a7a7d-677">Fixed issue #7513 [Insights] Set-AzDiagnosticSetting requires explicit specification of categories during creation of setting</span></span>
    - <span data-ttu-id="a7a7d-678">目前 Cmdlet 在建立期間不需要明確的類別指示也能啟用，例如 Cmdlet 會如說明所述之方式運作</span><span class="sxs-lookup"><span data-stu-id="a7a7d-678">Now the cmdlet does not require explicit indication of the categories to enable during creation, i.e. it works as it is documented</span></span>

#### <a name="aznetwork"></a><span data-ttu-id="a7a7d-679">Az.Network</span><span class="sxs-lookup"><span data-stu-id="a7a7d-679">Az.Network</span></span>
* <span data-ttu-id="a7a7d-680">已將 PeeringType 變更為下列 Cmdlet 的必要參數：-</span><span class="sxs-lookup"><span data-stu-id="a7a7d-680">Changed PeeringType to be a mandatory parameter for the following cmdlets:-</span></span>
    - <span data-ttu-id="a7a7d-681">Get-AzExpressRouteCircuitRouteTable</span><span class="sxs-lookup"><span data-stu-id="a7a7d-681">Get-AzExpressRouteCircuitRouteTable</span></span>
    - <span data-ttu-id="a7a7d-682">Get-AzExpressRouteCircuitARPTable</span><span class="sxs-lookup"><span data-stu-id="a7a7d-682">Get-AzExpressRouteCircuitARPTable</span></span>
    - <span data-ttu-id="a7a7d-683">Get-AzExpressRouteCircuitRouteTableSummary</span><span class="sxs-lookup"><span data-stu-id="a7a7d-683">Get-AzExpressRouteCircuitRouteTableSummary</span></span>
    - <span data-ttu-id="a7a7d-684">Get-AzExpressRouteCrossConnectionArpTable</span><span class="sxs-lookup"><span data-stu-id="a7a7d-684">Get-AzExpressRouteCrossConnectionArpTable</span></span>
    - <span data-ttu-id="a7a7d-685">Get-AzExpressRouteCrossConnectionRouteTable</span><span class="sxs-lookup"><span data-stu-id="a7a7d-685">Get-AzExpressRouteCrossConnectionRouteTable</span></span>
    - <span data-ttu-id="a7a7d-686">Get-AzExpressRouteCrossConnectionRouteTableSummary</span><span class="sxs-lookup"><span data-stu-id="a7a7d-686">Get-AzExpressRouteCrossConnectionRouteTableSummary</span></span>

#### <a name="azpolicyinsights"></a><span data-ttu-id="a7a7d-687">Az.PolicyInsights</span><span class="sxs-lookup"><span data-stu-id="a7a7d-687">Az.PolicyInsights</span></span>
* <span data-ttu-id="a7a7d-688">已新增原則修復 Cmdlet</span><span class="sxs-lookup"><span data-stu-id="a7a7d-688">Added policy remediation cmdlets</span></span>

#### <a name="azresources"></a><span data-ttu-id="a7a7d-689">Az.Resources</span><span class="sxs-lookup"><span data-stu-id="a7a7d-689">Az.Resources</span></span>
* <span data-ttu-id="a7a7d-690">修正 https://github.com/Azure/azure-powershell/issues/7402</span><span class="sxs-lookup"><span data-stu-id="a7a7d-690">Fix for https://github.com/Azure/azure-powershell/issues/7402</span></span>
    - <span data-ttu-id="a7a7d-691">允許使用 'Get-AzResource' 的 '-ResourceId' 參數列出資源</span><span class="sxs-lookup"><span data-stu-id="a7a7d-691">Allow listing resources using the '-ResourceId' parameter for 'Get-AzResource'</span></span>

#### <a name="azservicebus"></a><span data-ttu-id="a7a7d-692">Az.ServiceBus</span><span class="sxs-lookup"><span data-stu-id="a7a7d-692">Az.ServiceBus</span></span>
* <span data-ttu-id="a7a7d-693">已將 MigrationState 唯讀屬性新增至 PSServiceBusMigrationConfigurationAttributes，以便協助了解移轉狀態。</span><span class="sxs-lookup"><span data-stu-id="a7a7d-693">Added MigrationState read-only property to PSServiceBusMigrationConfigurationAttributes which will help to know the Migration state.</span></span>

#### <a name="azservicefabric"></a><span data-ttu-id="a7a7d-694">Az.ServiceFabric</span><span class="sxs-lookup"><span data-stu-id="a7a7d-694">Az.ServiceFabric</span></span>
* <span data-ttu-id="a7a7d-695">修正將憑證新增至 Linux Vmss。</span><span class="sxs-lookup"><span data-stu-id="a7a7d-695">Fix add certificate to Linux Vmss.</span></span>
* <span data-ttu-id="a7a7d-696">修正 'Add-AzServiceFabricClusterCertificate'</span><span class="sxs-lookup"><span data-stu-id="a7a7d-696">Fix 'Add-AzServiceFabricClusterCertificate'</span></span>
    - <span data-ttu-id="a7a7d-697">使用新憑證中正確的指紋 (Azure/service-fabric-issues#932)。</span><span class="sxs-lookup"><span data-stu-id="a7a7d-697">Using correct thumbprint from new certificate (Azure/service-fabric-issues#932).</span></span>
    - <span data-ttu-id="a7a7d-698">正確顯示例外狀況 (Azure/service-fabric-issues#1054)。</span><span class="sxs-lookup"><span data-stu-id="a7a7d-698">Display exception correctly (Azure/service-fabric-issues#1054).</span></span>
* <span data-ttu-id="a7a7d-699">修正 'Update-AzServiceFabricDurability' 以在啟動 Vmss CreateOrUpdate operation 之前更新叢集組態。</span><span class="sxs-lookup"><span data-stu-id="a7a7d-699">Fix 'Update-AzServiceFabricDurability' to update cluster configuration before starting Vmss CreateOrUpdate operation.</span></span>

## <a name="040---october-2018"></a><span data-ttu-id="a7a7d-700">0.4.0 - 2018 年 10 月</span><span class="sxs-lookup"><span data-stu-id="a7a7d-700">0.4.0 - October 2018</span></span>
#### <a name="azprofile"></a><span data-ttu-id="a7a7d-701">Az.Profile</span><span class="sxs-lookup"><span data-stu-id="a7a7d-701">Az.Profile</span></span>
* <span data-ttu-id="a7a7d-702">修正 CloudShell 中 Get-AzSubscription 的問題</span><span class="sxs-lookup"><span data-stu-id="a7a7d-702">Fix issue with Get-AzSubscription in CloudShell</span></span>
* <span data-ttu-id="a7a7d-703">更新通用程式碼，以使用最新版 ClientRuntime</span><span class="sxs-lookup"><span data-stu-id="a7a7d-703">Update common code to use latest version of ClientRuntime</span></span>

#### <a name="azcompute"></a><span data-ttu-id="a7a7d-704">Az.Compute</span><span class="sxs-lookup"><span data-stu-id="a7a7d-704">Az.Compute</span></span>
* <span data-ttu-id="a7a7d-705">已將新的大小新增至虛擬機器大小允許清單，當使用 'New-AzVm' 的簡單參數集合時，將會開啟加速的網路</span><span class="sxs-lookup"><span data-stu-id="a7a7d-705">Added new sizes to the whitelist of VM sizes for which accelerated networking will be turned on when using the simple param set for 'New-AzVm'</span></span>
* <span data-ttu-id="a7a7d-706">已將 ResourceName 引數完成器新增至所有 Cmdlet。</span><span class="sxs-lookup"><span data-stu-id="a7a7d-706">Added ResourceName argument completer to all cmdlets.</span></span>

#### <a name="azdatalakestore"></a><span data-ttu-id="a7a7d-707">Az.DataLakeStore</span><span class="sxs-lookup"><span data-stu-id="a7a7d-707">Az.DataLakeStore</span></span>
* <span data-ttu-id="a7a7d-708">新增虛擬網路規則的支援</span><span class="sxs-lookup"><span data-stu-id="a7a7d-708">Adding support for Virtual Network Rules</span></span>
    - <span data-ttu-id="a7a7d-709">Get-AzDataLakeStoreVirtualNetworkRule：取得或列出 Azure Data Lake Store 的虛擬網路規則。</span><span class="sxs-lookup"><span data-stu-id="a7a7d-709">Get-AzDataLakeStoreVirtualNetworkRule: Gets or Lists Azure Data Lake Store virtual network rule.</span></span>
    - <span data-ttu-id="a7a7d-710">Add-AzDataLakeStoreVirtualNetworkRule：將虛擬網路規則新增至指定的 Data Lake Store 帳戶。</span><span class="sxs-lookup"><span data-stu-id="a7a7d-710">Add-AzDataLakeStoreVirtualNetworkRule: Adds a virtual network rule to the specified Data Lake Store account.</span></span>
    - <span data-ttu-id="a7a7d-711">Set-AzDataLakeStoreVirtualNetworkRule：修改指定 Data Lake Store 帳戶中的特定虛擬網路規則。</span><span class="sxs-lookup"><span data-stu-id="a7a7d-711">Set-AzDataLakeStoreVirtualNetworkRule: Modifies the specified virtual network rule in the specified Data Lake Store account.</span></span>
    - <span data-ttu-id="a7a7d-712">Remove-AzDataLakeStoreVirtualNetworkRule：刪除 Azure Data Lake Store 的虛擬網路規則。</span><span class="sxs-lookup"><span data-stu-id="a7a7d-712">Remove-AzDataLakeStoreVirtualNetworkRule: Deletes an Azure Data Lake Store virtual network rule.</span></span>

#### <a name="aznetwork"></a><span data-ttu-id="a7a7d-713">Az.Network</span><span class="sxs-lookup"><span data-stu-id="a7a7d-713">Az.Network</span></span>
* <span data-ttu-id="a7a7d-714">更新 Cmdlet Test-AzNetworkWatcherConnectivity，將通訊協定值傳遞至後端。</span><span class="sxs-lookup"><span data-stu-id="a7a7d-714">Update cmdlet Test-AzNetworkWatcherConnectivity, pass the protocol value to backend.</span></span>
* <span data-ttu-id="a7a7d-715">已將 ResourceName 引數完成器新增至所有 Cmdlet。</span><span class="sxs-lookup"><span data-stu-id="a7a7d-715">Added ResourceName argument completer to all cmdlets.</span></span>

#### <a name="azresources"></a><span data-ttu-id="a7a7d-716">Az.Resources</span><span class="sxs-lookup"><span data-stu-id="a7a7d-716">Az.Resources</span></span>
* <span data-ttu-id="a7a7d-717">修正當 Get-AzRoleDefinition 藉由在案例中加上有意義的例外狀況，而擲回無法辨識的例外狀況 (當預設的設定檔中沒有訂用帳戶，且未指定範圍) 問題。</span><span class="sxs-lookup"><span data-stu-id="a7a7d-717">Fix isssue where Get-AzRoleDefinition throws an unintelligible exception (when the default profile has no subscription in it and no scope is specified) by adding a meaningful exception in the scenario.</span></span> <span data-ttu-id="a7a7d-718">也將預設參數集合設定為 'RoleDefinitionNameParameterSet'。</span><span class="sxs-lookup"><span data-stu-id="a7a7d-718">Also set the default param set to 'RoleDefinitionNameParameterSet'.</span></span>

## <a name="030---october-2018"></a><span data-ttu-id="a7a7d-719">0.3.0 - 2018 年 10 月</span><span class="sxs-lookup"><span data-stu-id="a7a7d-719">0.3.0 - October 2018</span></span>
#### <a name="azurestorage"></a><span data-ttu-id="a7a7d-720">Azure.Storage</span><span class="sxs-lookup"><span data-stu-id="a7a7d-720">Azure.Storage</span></span>
* <span data-ttu-id="a7a7d-721">修正當目的地有中繼資料問題時，複製 Blob/檔案不會一併複製中繼資料的問題</span><span class="sxs-lookup"><span data-stu-id="a7a7d-721">Fix Copy Blob/File won't copy metadata when destination has metadata issue</span></span>
    - <span data-ttu-id="a7a7d-722">Start-AzureStorageBlobCopy</span><span class="sxs-lookup"><span data-stu-id="a7a7d-722">Start-AzureStorageBlobCopy</span></span>
    - <span data-ttu-id="a7a7d-723">Start-AzureStorageFileCopy</span><span class="sxs-lookup"><span data-stu-id="a7a7d-723">Start-AzureStorageFileCopy</span></span>
* <span data-ttu-id="a7a7d-724">支援取得特定位置的儲存體資源使用量，並針對取得全域儲存體資源使用量已過時的情況新增警告訊息。</span><span class="sxs-lookup"><span data-stu-id="a7a7d-724">Support get the Storage resource usage of a specific location, and add warning message for get global Storage resource usage is obsolete.</span></span>
    - <span data-ttu-id="a7a7d-725">Get-AzStorageUsage</span><span class="sxs-lookup"><span data-stu-id="a7a7d-725">Get-AzStorageUsage</span></span>
    
#### <a name="azcognitiveservices"></a><span data-ttu-id="a7a7d-726">Az.CognitiveServices</span><span class="sxs-lookup"><span data-stu-id="a7a7d-726">Az.CognitiveServices</span></span>
* <span data-ttu-id="a7a7d-727">在沒有現有帳戶的情況下支援 Get-AzCognitiveServicesAccountSkus。</span><span class="sxs-lookup"><span data-stu-id="a7a7d-727">Support Get-AzCognitiveServicesAccountSkus without an existing account.</span></span>

#### <a name="azcompute"></a><span data-ttu-id="a7a7d-728">Az.Compute</span><span class="sxs-lookup"><span data-stu-id="a7a7d-728">Az.Compute</span></span>
* <span data-ttu-id="a7a7d-729">修正 Get-AzVM -ResourceGroupName <rg> 以在必要時傳回超過 50 個結果</span><span class="sxs-lookup"><span data-stu-id="a7a7d-729">Fix Get-AzVM -ResourceGroupName <rg> to return more than 50 results if needed</span></span>
* <span data-ttu-id="a7a7d-730">已將 'SimpleParameterSet' 的範例新增到 New-AzVmss Cmdlet 說明中。</span><span class="sxs-lookup"><span data-stu-id="a7a7d-730">Added an example of the 'SimpleParameterSet' to New-AzVmss cmdlet help.</span></span>
* <span data-ttu-id="a7a7d-731">已修正 Azure 磁碟加密進度訊息中的錯字</span><span class="sxs-lookup"><span data-stu-id="a7a7d-731">Fixed a typo in the Azure Disk Encryption progress message</span></span>

#### <a name="azdatafactoryv2"></a><span data-ttu-id="a7a7d-732">Az.DataFactoryV2</span><span class="sxs-lookup"><span data-stu-id="a7a7d-732">Az.DataFactoryV2</span></span>
* <span data-ttu-id="a7a7d-733">已將 ADF .Net SDK 版本更新為 2.3.0。</span><span class="sxs-lookup"><span data-stu-id="a7a7d-733">Updated the ADF .Net SDK version to 2.3.0.</span></span>

#### <a name="aznetwork"></a><span data-ttu-id="a7a7d-734">Az.Network</span><span class="sxs-lookup"><span data-stu-id="a7a7d-734">Az.Network</span></span>
* <span data-ttu-id="a7a7d-735">已新增 NetworkProfile 功能。</span><span class="sxs-lookup"><span data-stu-id="a7a7d-735">Added NetworkProfile functionality.</span></span> <span data-ttu-id="a7a7d-736">已新增新的 Cmdlet</span><span class="sxs-lookup"><span data-stu-id="a7a7d-736">new cmdlets added</span></span>
    - <span data-ttu-id="a7a7d-737">Get-AzNetworkProfile</span><span class="sxs-lookup"><span data-stu-id="a7a7d-737">Get-AzNetworkProfile</span></span>
    - <span data-ttu-id="a7a7d-738">New-AzNetworkProfile</span><span class="sxs-lookup"><span data-stu-id="a7a7d-738">New-AzNetworkProfile</span></span>
    - <span data-ttu-id="a7a7d-739">Remove-AzNetworkProfile</span><span class="sxs-lookup"><span data-stu-id="a7a7d-739">Remove-AzNetworkProfile</span></span>
    - <span data-ttu-id="a7a7d-740">Set-AzNetworkProfile</span><span class="sxs-lookup"><span data-stu-id="a7a7d-740">Set-AzNetworkProfile</span></span>
    - <span data-ttu-id="a7a7d-741">New-AzContainerNicConfig</span><span class="sxs-lookup"><span data-stu-id="a7a7d-741">New-AzContainerNicConfig</span></span>
    - <span data-ttu-id="a7a7d-742">New-AzContainerNicConfigIpConfig</span><span class="sxs-lookup"><span data-stu-id="a7a7d-742">New-AzContainerNicConfigIpConfig</span></span>
* <span data-ttu-id="a7a7d-743">已在子網路模型中新增服務關聯連結</span><span class="sxs-lookup"><span data-stu-id="a7a7d-743">Added service association link on Subnet Model</span></span>
* <span data-ttu-id="a7a7d-744">已新增 New-AzVirtualNetworkTap、Get-AzVirtualNetworkTap、Set-AzVirtualNetworkTap、Remove-AzVirtualNetworkTap Cmdlet</span><span class="sxs-lookup"><span data-stu-id="a7a7d-744">Added cmdlet New-AzVirtualNetworkTap, Get-AzVirtualNetworkTap, Set-AzVirtualNetworkTap, Remove-AzVirtualNetworkTap</span></span>
* <span data-ttu-id="a7a7d-745">已新增 Set-AzNEtworkInterfaceTapConfig、Get-AzNEtworkInterfaceTapConfig 和 Remove-AzNEtworkInterfaceTapConfig Cmdlet</span><span class="sxs-lookup"><span data-stu-id="a7a7d-745">Added cmdlet Set-AzNEtworkInterfaceTapConfig, Get-AzNEtworkInterfaceTapConfig, Remove-AzNEtworkInterfaceTapConfig</span></span>

#### <a name="azrediscache"></a><span data-ttu-id="a7a7d-746">Az.RedisCache</span><span class="sxs-lookup"><span data-stu-id="a7a7d-746">Az.RedisCache</span></span>
* <span data-ttu-id="a7a7d-747">日後允許任何字串做為 Size 參數。</span><span class="sxs-lookup"><span data-stu-id="a7a7d-747">Allow any string as Size parameter going forward.</span></span> <span data-ttu-id="a7a7d-748">在 P5 PSArgumentCompleter 快顯視窗中新增 P5</span><span class="sxs-lookup"><span data-stu-id="a7a7d-748">Add P5 in PSArgumentCompleter popup</span></span>

#### <a name="azresources"></a><span data-ttu-id="a7a7d-749">Az.Resources</span><span class="sxs-lookup"><span data-stu-id="a7a7d-749">Az.Resources</span></span>
* <span data-ttu-id="a7a7d-750">將遺漏的 -Mode 參數新增至 Set-AzPolicyDefinition</span><span class="sxs-lookup"><span data-stu-id="a7a7d-750">Add missing -Mode parameter to Set-AzPolicyDefinition</span></span>
* <span data-ttu-id="a7a7d-751">修正 Get-AzProviderOperation Commandlet 錯誤 (bug)，以進行包含使用者的 Origin 作業</span><span class="sxs-lookup"><span data-stu-id="a7a7d-751">Fix Get-AzProviderOperation commandlet bug for operations with Origin containing User</span></span>

#### <a name="azsql"></a><span data-ttu-id="a7a7d-752">Az.Sql</span><span class="sxs-lookup"><span data-stu-id="a7a7d-752">Az.Sql</span></span>
* <span data-ttu-id="a7a7d-753">已修正部分備份 Cmdlet 無法辨識目前 Azure 訂用帳戶的問題</span><span class="sxs-lookup"><span data-stu-id="a7a7d-753">Fixed issue where some backup cmdlets would not recognize the current azure subscription</span></span>

#### <a name="azwebsites"></a><span data-ttu-id="a7a7d-754">Az.Websites</span><span class="sxs-lookup"><span data-stu-id="a7a7d-754">Az.Websites</span></span>
* <span data-ttu-id="a7a7d-755">新 Cmdlet Get-AzWebAppContainerContinuousDeploymentUrl - 取得容器連續部署 Webhook URL</span><span class="sxs-lookup"><span data-stu-id="a7a7d-755">New Cmdlet Get-AzWebAppContainerContinuousDeploymentUrl - Gets the Container Continuous Deployment Webhook URL</span></span>
* <span data-ttu-id="a7a7d-756">新 Cmdlet New-AzWebAppContainerPSSession 與 Enter-WebAppContainerPSSession  - 在 Windows 容器應用程式中初始 PowerShell 遠端工作階段</span><span class="sxs-lookup"><span data-stu-id="a7a7d-756">New Cmdlets New-AzWebAppContainerPSSession and Enter-WebAppContainerPSSession  - Initiates a PowerShell remote session into a windows container app</span></span>

## <a name="020---september-2018"></a><span data-ttu-id="a7a7d-757">0.2.0 - 2018 年 9 月</span><span class="sxs-lookup"><span data-stu-id="a7a7d-757">0.2.0 - September 2018</span></span>
 <span data-ttu-id="a7a7d-758">初始版本</span><span class="sxs-lookup"><span data-stu-id="a7a7d-758">Initial Release</span></span>