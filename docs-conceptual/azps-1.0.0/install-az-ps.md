...
Azure PowerShell 可搭配 Windows 7 或更新版本上的 PowerShell 5.x 或任何平台上的 PowerShell 6.x 運作。
...
如果您在 Windows 上使用 PowerShell 5.x，則還需要安裝 .NET Framework 4.7.2。 如需更新或安裝新版 .NET Framework 的指示，請參閱 [.NET Framework 安裝指南](/dotnet/framework/install)。
