...
## 說明
**AzSynapseSqlPool** Cmdlet 會取得 Azure SYNAPSE Analytics SQL pool 的相關資訊。
...
這個命令會在 [工作區 ContosoWorkspace] 下取得名稱為 ContosoSqlPool 的 SQL pool。
...
### -版本
[這項功能在有限預覽中，最初隻能在特定訂閱中存取。」Synapse SQL pool 的版本。 例如，2或3。
