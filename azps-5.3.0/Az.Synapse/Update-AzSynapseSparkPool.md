...
## 說明
**AzSynapseSparkPool** Cmdlet 會更新 Azure Synapse 分析 Spark 池。
...
這個命令會更新 Azure Synapse 分析 Spark 池。
...
這個命令會透過管線更新 Azure Synapse 分析 Spark 池。
...
這個命令會更新含有資源識別碼的 Azure Synapse 分析 Spark 池。
...
這個命令會針對 Azure Synapse Analytics Spark 池啟用自動縮放。
...
這個命令會針對 Azure Synapse 分析 Spark 池停用自動調整。
...
此命令會針對 Azure Synapse Analytics Spark 池啟用自動暫停功能。
...
此命令會針對 Azure Synapse Analytics Spark 池停用自動暫停。
