...
## 說明
**Reset AzSynapseSqlPoolAdvancedThreatProtectionSetting** Cmdlet 會從 Azure SYNAPSE Analytics SQL pool 中移除高級威脅防護設定。
...
這個命令會從名為 ContosoWorkspace 的工作區下，從名為 ContosoSqlPool 的 SQL pool 中移除 [高級威脅防護] 設定。
