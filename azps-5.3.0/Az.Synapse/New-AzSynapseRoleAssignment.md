...
### NewByWorkspaceNameAndNameParameterSet (預設) 
```
...
## 說明
**新的-AzSynapseRoleAssignment** Cmdlet 會建立 Azure Synapse 分析角色分派。
...
這個命令會將 ContosoRole 指派給其主要名稱為 ContosoName 的使用者。
...
這個命令會將 ContosoRole 指派給主要名稱是透過管道 ContosoName 的使用者。
