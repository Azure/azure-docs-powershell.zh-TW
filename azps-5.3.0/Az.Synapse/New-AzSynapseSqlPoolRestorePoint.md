...
## 說明
**新的-AzSynapseSqlPoolRestorePoint** Cmdlet 會建立新的還原點，以供您還原 Azure SYNAPSE 分析 SQL pool。
...
這個命令會在工作區 ContosoWorkspace 中建立名為 ContosoSqlPool 的 SQL pool 的還原點。
