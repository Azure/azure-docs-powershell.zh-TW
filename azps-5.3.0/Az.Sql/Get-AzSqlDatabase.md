...
## 說明
**AzSqlDatabase** Cmdlet 會從 Azure Sql Database Server 取得一個或多個 azure sql 資料庫。
...
這個命令會從名為 Server01 的伺服器中取得名為 Database02 的資料庫。

### 範例3：使用篩選取得伺服器上的所有資料庫
```
...
這個命令會取得伺服器上名為 server01 的所有資料庫，其開頭為「database」。
