...
### [附加 AzSqlElasticJobStep](Add-AzSqlElasticJobStep.md)
新增作業步驟至作業

### [附加 AzSqlElasticJobTarget](Add-AzSqlElasticJobTarget.md)
將目標新增至目標群組

### [附加 AzSqlInstanceKeyVaultKey](Add-AzSqlInstanceKeyVaultKey.md)
將主要保存庫金鑰新增至提供的受管理實例。 
...
### [完成-AzSqlInstanceDatabaseLogReplay](Complete-AzSqlInstanceDatabaseLogReplay.md)
完成指定資料庫的記錄重新播放服務。
...
針對 Azure SQL managed 實例資料庫中的欄停用 (關閉) 敏感度建議。
...
### [AzSqlDatabaseAdvancedThreatProtectionSetting](Get-AzSqlDatabaseAdvancedThreatProtectionSetting.md)
取得資料庫的高級威脅防護設定。

### [AzSqlDatabaseAdvisor](Get-AzSqlDatabaseAdvisor.md)
取得一或多個 Azure SQL 資料庫的顧問。

### [AzSqlDatabaseAudit](Get-AzSqlDatabaseAudit.md)
...
### [AzSqlDatabaseInstanceFailoverGroup](Get-AzSqlDatabaseInstanceFailoverGroup.md)
取得或列出實例容錯移轉群組。
...
### [AzSqlElasticJob](Get-AzSqlElasticJob.md)
取得一或多個作業

### [AzSqlElasticJobAgent](Get-AzSqlElasticJobAgent.md)
取得 Azure SQL 彈性作業代理程式

### [AzSqlElasticJobCredential](Get-AzSqlElasticJobCredential.md)
取得一或多個認證

### [AzSqlElasticJobExecution](Get-AzSqlElasticJobExecution.md)
取得一或多個作業執行

### [AzSqlElasticJobStep](Get-AzSqlElasticJobStep.md)
取得一或多個作業步驟

### [AzSqlElasticJobStepExecution](Get-AzSqlElasticJobStepExecution.md)
取得一或多個作業步驟執行

### [AzSqlElasticJobTargetExecution](Get-AzSqlElasticJobTargetExecution.md)
取得一或多個作業目標執行

### [AzSqlElasticJobTargetGroup](Get-AzSqlElasticJobTargetGroup.md)
取得一個或多個作業目標群組
...
取得適用于 SQL 管理實例的 Azure AD 管理員的相關資訊。
...
### [AzSqlInstanceDatabaseBackupLongTermRetentionPolicy](Get-AzSqlInstanceDatabaseBackupLongTermRetentionPolicy.md)
取得受管理資料庫的長期保留原則
...
### [AzSqlInstanceDatabaseLogReplay](Get-AzSqlInstanceDatabaseLogReplay.md)
取得記錄重播服務狀態。
...
### [AzSqlInstanceKeyVaultKey](Get-AzSqlInstanceKeyVaultKey.md)
取得 SQL managed 實例的主要保存庫金鑰。

### [AzSqlInstanceOperation](Get-AzSqlInstanceOperation.md)
取得 SQL managed 實例的操作。

### [AzSqlInstancePool](Get-AzSqlInstancePool.md)
傳回有關 Azure SQL 實例池的資訊。

### [AzSqlInstancePoolUsage](Get-AzSqlInstancePoolUsage.md)
傳回有關 Azure SQL 實例池用法的資訊。

### [AzSqlInstanceTransparentDataEncryptionProtector](Get-AzSqlInstanceTransparentDataEncryptionProtector.md)
取得 SQL managed 實例的透明資料加密 (TDE) 保護程式。
...
針對特定的 SQL Server，取得 Azure AD 專用驗證。

### [AzSqlServerAdvancedDataSecurityPolicy](Get-AzSqlServerAdvancedDataSecurityPolicy.md)
取得伺服器的高級資料安全性原則。

### [AzSqlServerAdvancedThreatProtectionSetting](Get-AzSqlServerAdvancedThreatProtectionSetting.md)
取得伺服器的高級威脅防護設定。

### [AzSqlServerAdvisor](Get-AzSqlServerAdvisor.md)
取得一或多個 Azure SQL Server 顧問。

### [AzSqlServerAudit](Get-AzSqlServerAudit.md)
取得 Azure SQL server 的審核設定。

### [AzSqlServerCommunicationLink](Get-AzSqlServerCommunicationLink.md)
取得資料庫伺服器間彈性資料庫事務的通訊連結。

### [AzSqlServerMSSupportAudit](Get-AzSqlServerMSSupportAudit.md)
取得 Azure SQL server 的 Microsoft 支援作業審核設定。
...
### [新-AzSqlDatabaseInstanceFailoverGroup](New-AzSqlDatabaseInstanceFailoverGroup.md)
這個命令會建立新的 Azure SQL 資料庫實例 [容錯移轉] 群組。
...
### [新-AzSqlElasticJob](New-AzSqlElasticJob.md)
建立新工作

### [新-AzSqlElasticJobAgent](New-AzSqlElasticJobAgent.md)
建立新的彈性作業代理程式

### [新-AzSqlElasticJobCredential](New-AzSqlElasticJobCredential.md)
建立新的作業認證

### [新-AzSqlElasticJobTargetGroup](New-AzSqlElasticJobTargetGroup.md)
建立新的目標群組
...
### [新-AzSqlInstancePool](New-AzSqlInstancePool.md)
建立 Azure SQL 實例池。
...
### [移除-AzSqlDatabaseAudit](Remove-AzSqlDatabaseAudit.md)
...
### [移除-AzSqlDatabaseInstanceFailoverGroup](Remove-AzSqlDatabaseInstanceFailoverGroup.md)
移除實例容錯移轉群組。
...
### [移除-AzSqlElasticJob](Remove-AzSqlElasticJob.md)
移除作業

### [移除-AzSqlElasticJobAgent](Remove-AzSqlElasticJobAgent.md)
移除彈性作業代理程式

### [移除-AzSqlElasticJobCredential](Remove-AzSqlElasticJobCredential.md)
移除彈性作業認證

### [移除-AzSqlElasticJobStep](Remove-AzSqlElasticJobStep.md)
移除作業步驟

### [移除-AzSqlElasticJobTarget](Remove-AzSqlElasticJobTarget.md)
從目標群組中移除目標

### [移除-AzSqlElasticJobTargetGroup](Remove-AzSqlElasticJobTargetGroup.md)
移除目標群組
...
### [移除-AzSqlInstanceKeyVaultKey](Remove-AzSqlInstanceKeyVaultKey.md)
從 SQL managed 實例中移除金鑰保存庫金鑰

### [移除-AzSqlInstancePool](Remove-AzSqlInstancePool.md)
移除 Azure SQL 實例池。
...
### [移除-AzSqlServerAudit](Remove-AzSqlServerAudit.md)
移除 Azure SQL server 的審核設定。
...
### [移除-AzSqlServerMSSupportAudit](Remove-AzSqlServerMSSupportAudit.md)
移除 Azure SQL server 的 Microsoft 支援作業審核設定。
...
**AzSqlInstanceDatabaseLongTermRetentionBackup** Cmdlet 會設定受管理資料庫的長期保留原則。
...
針對 SQL managed 實例 (TDE) 保護器設定透明的資料加密。
...
變更 Azure SQL 資料庫的 Microsoft 支援作業審核設定。
...
### [開始-AzSqlElasticJob](Start-AzSqlElasticJob.md)
啟動作業，然後返回可輪詢以查看其狀態的作業執行 id。

### [開始-AzSqlInstanceDatabaseLogReplay](Start-AzSqlInstanceDatabaseLogReplay.md)
使用指定的參數開機記錄重播服務。
...
### [停止 AzSqlElasticJob](Stop-AzSqlElasticJob.md)
停止指定其工作執行 id 的工作

### [停止 AzSqlElasticPoolActivity](Stop-AzSqlElasticPoolActivity.md)
取消彈性池中的非同步更新作業。

### [停止 AzSqlInstanceDatabaseLogReplay](Stop-AzSqlInstanceDatabaseLogReplay.md)
刪除資料庫，以取消記錄重新播放服務。

### [停止 AzSqlInstanceOperation](Stop-AzSqlInstanceOperation.md)
停止 SQL managed 實例的作業。
...
### [切換 AzSqlDatabaseInstanceFailoverGroup](Switch-AzSqlDatabaseInstanceFailoverGroup.md)
執行實例容錯移轉群組的容錯移轉。

### [更新-AzSqlDatabaseAdvancedThreatProtectionSetting](Update-AzSqlDatabaseAdvancedThreatProtectionSetting.md)
在資料庫上設定高級威脅防護設定。
...
### [更新-AzSqlServerAdvancedThreatProtectionSetting](Update-AzSqlServerAdvancedThreatProtectionSetting.md)
在伺服器上設定高級威脅防護設定。
