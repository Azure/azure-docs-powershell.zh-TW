...
## 說明
**AzSqlServerActiveDirectoryOnlyAuthentication** Cmdlet 會取得 Azure Active Directory (azure AD) 僅針對目前訂閱中的 AzureSQL 伺服器進行驗證需求。
...
這個命令會取得 Azure Active Directory (Azure AD) 只有與名為 Server01 的資源群組相關聯之 AzureSQL 伺服器的驗證需求。
