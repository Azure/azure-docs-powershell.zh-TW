...
## 說明
**AzSqlDeletedDatabaseBackup** Cmdlet 會取得您可以還原的指定已刪除 SQL 資料庫備份，或是您可以還原的所有已刪除備份。
...
這個命令會取得 ContosoDatabase 的已刪除資料庫備份。
...
### AzureSqlDeletedDatabaseBackupModel 中的 [.Sql]。
