...
## 說明
**AzDataLakeAnalyticsFirewallRule** Cmdlet 會更新 Azure Data Lake Analytics 帳戶中的防火牆規則。
...
這個命令會更新帳戶 "ContosoAdlAcct" 中名為「我的防火牆規則」的防火牆規則，讓新的 IP 範圍： 127.0.0.1-127.0.0.10

## 參數

### -帳戶
要在其中更新防火牆規則的 Data Lake Analytics 帳戶
