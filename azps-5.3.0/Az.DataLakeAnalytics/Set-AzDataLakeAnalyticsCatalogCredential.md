...
## 說明
Set-AzDataLakeAnalyticsCatalogCredential Cmdlet 會修改與 Azure Data Lake Analytics 目錄相關聯的認證密碼。
...
這個命令會將認證密碼設定為 NewPassword 中指定的密碼。
...
### -DatabaseName
在包含認證的 Data Lake Analytics 帳戶中指定資料庫的名稱。
