...
## 說明
**更新-AzSentinelAlertRuleAction** Cmdlet 會更新指定工作區中的書簽。
您可以將 **AlertRuleAction** 物件傳遞為參數或使用管線運算子，或者也可以指定 *AlertRuleId* 和 *ActionId* 參數。
...
這個範例會更新以新屬性取代現有 *動作* 的 **AlertRuleAction** 。
...
這個範例會使用 InputObject 來更新含有新屬性的現有 *動作* 來更新 **AlertRuleAction** 。
