...
## 說明
Cmdlet **移除-AzApiManagementApiRevision** 會移除特定的 API 修訂版本。
...
這個命令會 `2` `echo-api` 從 api 管理服務移除 api 的修訂版本。

### 範例2

這個命令會從 API 管理服務移除 API echo api 的2個修正版本。  (自動生成) 
