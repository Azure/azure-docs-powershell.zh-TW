...
## 說明
針對私人連結範圍資源建立，範圍資源可以是 Log Analytics 工作區或 Application Insights 元件
...
建立連結至 application insights 元件 "ai_name" 的範圍資源 "scoped_resource_name"
...
### PSMonitorPrivateLinkScope 中的 OutputClasses。

### System.object

## 輸出

### PSMonitorPrivateLinkScopedResource 中的 OutputClasses。
