...
## 說明
**AzStorageServiceProperty** Cmdlet 會修改 Azure 儲存空間服務的屬性。
...
DefaultServiceVersion 表示如果未指定傳入要求的版本，則用於 Blob 服務要求的預設版本。 可能的值包括版本2008-10-27 和所有最新版本。 在中查看更多詳細資料 https://docs.microsoft.com/en-us/rest/api/storageservices/versioning-for-the-az-storage-services
