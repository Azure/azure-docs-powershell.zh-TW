...
## 說明
New-AzHDInsightCluster 會使用指定的參數或使用 New-AzHDInsightClusterConfig Cmdlet 建立的設定物件來建立 Azure HDInsight 群集。
...
### 範例3：建立 Azure HDInsight 群集，以便在中轉時加密
```
PS C:\&gt; # Primary storage account info
        $storageAccountResourceGroupName = "Group"
        $storageAccountResourceId = "yourstorageaccountresourceid"
...
### 範例4：使用 [中繼出站] 和 [私人連結] 功能建立 Azure HDInsight 群集
```
PS C:\&gt; # Primary storage account info
        $storageAccountResourceGroupName = "Group"
        $storageAccountResourceId = "yourstorageaccountresourceid"
...
### 範例5：建立 Azure HDInsight 群集，在主機上啟用加密
```
PS C:\&gt; # Primary storage account info
        $storageAccountResourceGroupName = "Group"
        $storageAccountResourceId = "yourstorageaccountresourceid"
...
### 範例6：建立可啟用自動縮放的 Azure HDInsight 群集。
```
PS C:\&gt; # Primary storage account info
        $storageAccountResourceGroupName = "Group"
        $storageAccountResourceId = "yourstorageaccountresourceid"
...
### 範例7：使用 Kafka Rest Proxy 建立 Azure HDInsight 群集。
```
PS C:\&gt; # Primary storage account info
        $storageAccountResourceGroupName = "Group"
        $storageAccountResourceId = "yourstorageaccountresourceid"
...
### 範例8：建立含 Azure Data Lake Gen2 儲存空間的 Azure HDInsight 群集。
```
PS C:\&gt; # Primary storage account info
        $storageAccountResourceGroupName = "Group"
        $storageAccountResourceId = "yourstorageaccountresourceid"
...
### 範例9：使用企業安全性套件 (ESP) 建立 Azure HDInsight 群集，並啟用 HDInsight ID 代理程式。
```
PS C:\&gt; # Primary storage account info
        $storageAccountResourceGroupName = "Group"
        $storageAccountResourceId = "yourstorageaccountresourceid"
...
您也可以使用 Add-AzHDInsightStorage Cmdlet。
...
### -ApplicationId
取得或設定用於存取 Azure Data Lake 的服務主體應用程式識別碼。
...
### -ClusterType
指定要建立的群集類型。
選項包括： Hadoop、HBase、風暴、Spark、INTERACTIVEHIVE、Kafka 和 RServer
...
### -Config
指定要用來建立群集的群集物件。
您可以使用 New-AzHDInsightClusterConfig Cmdlet 來建立此物件。
...
### -配置
指定此 HDInsight 群集的設定。
您也可以使用 Add-AzHDInsightConfigValues Cmdlet。
...
您也可以使用 [載入 AzHDInsightScriptAction]。
...
### -SecurityProfile
指定用來建立安全群集的安全性相關屬性。
您也可以使用 Add-AzHDInsightSecurityProfile Cmdlet。
...
### -StorageContainer
取得或設定預設 Azure 儲存空間帳戶的 StorageContainer 名稱
...
### -StorageFileSystem
取得或設定預設 Azure Data Lake Storage Gen2 帳戶的檔案系統。
...
### -StorageRootPath
取得或設定預設資料 Lake Store 帳戶中群集根目錄的路徑。
