...
### [AzNetAppFilesActiveDirectory](Get-AzNetAppFilesActiveDirectory.md)
取得 Azure NetApp 檔案 (ANF) Active Directory 設定的詳細資料。

### [AzNetAppFilesBackup](Get-AzNetAppFilesBackup.md)
取得 Azure NetApp 檔案 (ANF) 備份的詳細資料。

### [AzNetAppFilesBackupPolicy](Get-AzNetAppFilesBackupPolicy.md)
取得 (ANF) 備份原則的 Azure NetApp 檔案的詳細資料。
...
### [AzNetAppFilesSnapshotPolicy](Get-AzNetAppFilesSnapshotPolicy.md)
取得 (ANF) 快照原則的 Azure NetApp 檔案的詳細資料。

### [AzNetAppFilesVault](Get-AzNetAppFilesVault.md)
...
### [新-AzNetAppFilesActiveDirectory](New-AzNetAppFilesActiveDirectory.md)
 (ANF) active directory 設定中建立新的 Azure NetApp 檔案。

### [新-AzNetAppFilesBackup](New-AzNetAppFilesBackup.md)
在 (ANF) 備份] 中建立新的 Azure NetApp 檔案。

### [新-AzNetAppFilesBackupPolicy](New-AzNetAppFilesBackupPolicy.md)
 () ANF ANF 帳戶的備份原則中，建立新的 Azure NetApp 檔案。
...
### [新-AzNetAppFilesSnapshotPolicy](New-AzNetAppFilesSnapshotPolicy.md)
 () ANF ANF 帳戶的快照原則中，建立新的 Azure NetApp 檔案。
...
### [移除-AzNetAppFilesActiveDirectory](Remove-AzNetAppFilesActiveDirectory.md)
刪除 (ANF) active directory 設定中的 Azure NetApp 檔案。

### [移除-AzNetAppFilesBackup](Remove-AzNetAppFilesBackup.md)
刪除 (ANF) 備份的 Azure NetApp 檔案。

### [移除-AzNetAppFilesBackupPolicy](Remove-AzNetAppFilesBackupPolicy.md)
...
### [移除-AzNetAppFilesSnapshotPolicy](Remove-AzNetAppFilesSnapshotPolicy.md)
刪除 (ANF) 快照原則的 Azure NetApp 檔案。
...
變更 Azure NetApp 檔案的 pool (ANF) 音量。
...
### [更新-AzNetAppFilesActiveDirectory](Update-AzNetAppFilesActiveDirectory.md)
將 Azure NetApp 檔案 (ANF) active directory 設定更新為提供的選擇性修飾符。

### [更新-AzNetAppFilesBackup](Update-AzNetAppFilesBackup.md)
更新 (ANF) 備份的 Azure NetApp 檔案至提供的選擇性修飾符。

### [更新-AzNetAppFilesBackupPolicy](Update-AzNetAppFilesBackupPolicy.md)
將 (ANF) 備份原則的 Azure NetApp 檔案更新為所提供的選擇性修飾符。

### [更新-AzNetAppFilesPool](Update-AzNetAppFilesPool.md)
根據提供的選擇性修飾符，更新 (ANF) 池的 Azure NetApp 檔案。

### [更新-AzNetAppFilesSnapshotPolicy](Update-AzNetAppFilesSnapshotPolicy.md)
將 (ANF) 快照原則的 Azure NetApp 檔案更新為所提供的選擇性修飾符。
