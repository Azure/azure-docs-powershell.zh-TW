...
## 說明
**AzNetAppFilesSnapshotPolicy** Cmdlet 會修改 ANF 快照原則。
...
這個命令會將 ANF 備份原則 "MySnapshotPolicy" 變更為擁有指定的 HourlySchedule。
...
### PSNetAppFilesSnapshotPolicy 中的 NetAppFiles。
