...
## 摘要
在 Azure Data Lake 中還原已刪除的檔案或資料夾。
...
## 說明
**Restore-AzDataLakeStoreDeletedItem** Cmdlet 會在 Data Lake store 中還原已刪除的檔案或資料夾。 需要由 AzDataLakeStoreDeletedItem 傳回的 [垃圾桶] 中的已刪除專案路徑。
...
### 範例1：使用-force 選項從 Data Lake Store 還原檔案
```
...
[AzDataLakeStoreDeletedItem](./Get-AzDataLakeStoreDeletedItem.md)