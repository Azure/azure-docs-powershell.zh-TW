...
這個命令會取得訂閱下的所有 Windows IoT 服務。

### 範例2：取得資源群組底下的所有 Windows IoT 服務
```powershell
...
這個命令會取得資源群組底下的所有 Windows IoT 服務。

### 範例3：依名稱取得 Windows IoT 服務
```powershell
...
這個命令會透過名稱取得 Windows IoT 服務。

### 範例4：透過物件取得 Windows IoT 服務
```powershell
...
這個命令會透過物件取得 Windows IoT 服務。

### 範例4：透過管道取得 Windows IoT 服務
```powershell
