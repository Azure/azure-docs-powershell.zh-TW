...
# Az ResourceGraph 模組
## 說明
Microsoft Azure PowerShell： ResourceGraph Cmdlet

## Az ResourceGraph Cmdlet
### [AzResourceGraphQuery](Get-AzResourceGraphQuery.md)
透過其使用方式來取得單一圖形查詢。

### [新-AzResourceGraphQuery](New-AzResourceGraphQuery.md)
建立新的圖表查詢。

### [移除-AzResourceGraphQuery](Remove-AzResourceGraphQuery.md)
刪除圖表查詢。

### [搜尋-AzGraph](Search-AzGraph.md)
查詢由 Azure 資源管理器管理的資源。

### [更新-AzResourceGraphQuery](Update-AzResourceGraphQuery.md)
更新已新增的圖形查詢。
