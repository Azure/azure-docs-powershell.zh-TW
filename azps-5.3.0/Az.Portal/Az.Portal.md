...
# Az. 入口模組
## 說明
Microsoft Azure PowerShell：入口網站儀表板 Cmdlet

## Az. 入口網站 Cmdlet
### [AzPortalDashboard](Get-AzPortalDashboard.md)
取得儀表板。

### [新-AzPortalDashboard](New-AzPortalDashboard.md)
建立或更新儀表板。

### [移除-AzPortalDashboard](Remove-AzPortalDashboard.md)
刪除儀表板。

### [Set-AzPortalDashboard](Set-AzPortalDashboard.md)
建立或更新儀表板。

### [更新-AzPortalDashboard](Update-AzPortalDashboard.md)
更新現有的儀表板。
