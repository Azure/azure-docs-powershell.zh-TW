...
## 說明
**AzP2sVpnGateway** Cmdlet 可讓您在 VirtualHub 中移除現有的 P2SVpnGateway。 移除 P2SVpnGateway 之後，所有指向網站用戶端的連線都將會失敗。
...
**AzP2sVpnGateway** Cmdlet 可讓您在 VirtualHub 中移除現有的 P2SVpnGateway。
...
### -ResourceId
要刪除之 p2sVpnGateway 的 Azure 資源識別碼。
