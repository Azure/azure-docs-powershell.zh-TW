...
**新的-AzPrivateEndpoint** Cmdlet 會建立一個專用端點。

## 示例

### 範例1：建立私人端點

下列範例會在虛擬網路的指定子網上，建立具有特定私人連結服務識別碼的專用端點。
...
指定私人端點的位置。 使用 [AzLocation](/powershell/module/az.resources/get-azlocation) 來判斷此參數的有效值。
