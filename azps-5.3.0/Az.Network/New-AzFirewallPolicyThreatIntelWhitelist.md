...
## 說明
**新的-AzFirewallPolicyThreatIntelWhitelist** Cmdlet 會建立一個威脅英特爾白名單物件，可在建立或設定 Azure 防火牆原則時使用。
...
這個範例會建立一個威脅英特爾白名單，其中包含一個專案的 FQDN 白名單，以及兩個專案的 Ip 位址白名單
...
### PSAzureFirewallPolicyThreatIntelWhitelist 中的 [.]
