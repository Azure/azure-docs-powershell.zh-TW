...
## 說明
**新的-AzApplicationGatewayFirewallPolicyManagedRuleGroupOverride** 會在防火牆原則的 managedRuleSet 中建立 ruleGroupOverride 專案。
...
建立 RuleGroupOverride 專案，並將組名作為 $rule 1、$rule 2 的 $ruleName 與規則。 指派相同的 $overrideEntry
...
### -RuleGroupName
在 override RuleGroup 專案中指定 ruleGroupName。
...
### PSApplicationGatewayFirewallPolicyManagedRuleGroupOverride 中的 [.]
