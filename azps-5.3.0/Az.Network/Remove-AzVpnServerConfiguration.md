...
### ByVpnServerConfigurationName (預設) 
```
...
上述命令會移除現有的 VpnServerConfiguration。
...
### -InputObject
要刪除的 vpnServerConfiguration 物件。
...
### -ResourceId
要刪除之 vpnServerConfiguration 的 Azure 資源識別碼。
