...
## 說明
**AzFirewallPolicyRuleCollectionGroup** Cmdlet 會從 Azure 防火牆原則中移除規則集合群組。
...
這個範例會移除防火牆原則物件中名為「testRcGroup」的防火牆原則規則 colelction 群組 $fp
...
這個範例會在名為「fpName」的防火牆中，移除名為「testRcGroup」的防火牆原則規則 colelction 群組 frpm resourcegroup 名稱 "testRg"
...
### PSAzureFirewallPolicyRuleCollectionGroupWrapper 中的 [.]
