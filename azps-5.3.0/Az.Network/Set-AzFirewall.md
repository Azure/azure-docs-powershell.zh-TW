...
在這個範例中，DNS Proxy 和 DNS 伺服器設定會附加到防火牆。
...
這個範例會更新 Azure 防火牆的規則集合中現有規則的目的地。 這可讓您在 IP 位址動態變更時，自動更新您的規則。

### 11：允許 Azure 防火牆上的 Active FTP
```
$azFw = Get-AzFirewall -Name "AzureFirewall" -ResourceGroupName "rg"
