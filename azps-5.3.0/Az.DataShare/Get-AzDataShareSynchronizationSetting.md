...
## 說明
**AzDataShareSynchronizationSetting** Cmdlet 會提供在共用上啟用同步處理的相關資訊。 
...
這個命令會提供在 [資料共用帳戶 WikiAds] 下的 [共用 AdsShare] 中啟用同步處理 ShareSynchronization 的相關資訊。
