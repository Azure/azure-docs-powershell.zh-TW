...
### 範例1移除 application insights 資源的 application insights api 金鑰
```
...
在資源群組 "9C29aa0f867" 中，移除 id 為「dd173f38-4fd1-4c75-8af5-9 testGroup」的特定 application insights api 金鑰。
