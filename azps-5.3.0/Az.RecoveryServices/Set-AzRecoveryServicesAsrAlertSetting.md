...
## 說明
AzRecoveryServicesAsrNotificationSetting Cmdlet 會針對保存庫 (電子郵件通知) 來 **設定** Azure 網站復原通知設定。
...
針對保存庫 (電子郵件通知) 設定 Azure 網站復原通知設定。  (自動生成) 
...
### -LocaleID
從 microsoft)  (支援的區域性代碼，以電子郵件傳送通知/notification 給使用者的語言。 
...
### RecoveryServices. SiteRecovery. ASRAlertSetting
