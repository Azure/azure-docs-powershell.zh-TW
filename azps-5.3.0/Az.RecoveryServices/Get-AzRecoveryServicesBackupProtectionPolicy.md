...
## 說明
**AzRecoveryServicesBackupProtectionPolicy** Cmdlet 會取得保存庫的 Azure 備份保護原則。
...
這個命令會取得名為 DefaultPolicy 的保護原則，然後將它儲存在 $Pol 變數中。

## 參數

### -BackupManagementType
受保護的資源類別。 這個 Cmdlet 支援的值目前是 AzureStorage、AzureWorkload
...
### -WorkloadType
資源的工作負荷類型。 目前支援的值為 Add-azurevm、AzureFiles、MSSQL
