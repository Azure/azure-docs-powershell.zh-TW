...
## 說明
**AzPolicyDefinition** Cmdlet 會修改原則定義。
...
這個命令會使用 Set-AzPolicyDefinition Cmdlet 來更新名為 VMPolicyDefinition 的原則定義，將其 mode 屬性設定為 ' All」。
...
這個命令會更新名為 VMPolicyDefinition 的原則定義中繼資料，以指出其類別是「虛擬機器」。
