...
## 說明
Set-AzDeviceSecurityGroup Cmdlet 會建立或更新在 iot 安全解決方案中定義的裝置安全性群組。
...
從 IoT Hub "/subscriptions/XXXXXXXX-XXXX-XXXXX-XXXX-XXXXXXXXXXXX/resourceGroups/MyResourceGroup/providers/Microsoft.Devices/IotHubs/MyHub" 使用規則類型 "ActiveConnectionsNotInAllowedRange" 更新現有的裝置安全性群組
...
### PSThresholdCustomAlertRule []. DeviceSecurityGroups. []

### PSTimeWindowCustomAlertRule []. DeviceSecurityGroups. []

### PSAllowlistCustomAlertRule []. DeviceSecurityGroups. []
