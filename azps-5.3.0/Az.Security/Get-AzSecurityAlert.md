...
ms.locfileid: "98448715"
---
# <span data-ttu-id="3d324-101">Get-AzSecurityAlert</span><span class="sxs-lookup"><span data-stu-id="3d324-101">Get-AzSecurityAlert</span></span>

## <span data-ttu-id="3d324-102">摘要</span><span class="sxs-lookup"><span data-stu-id="3d324-102">SYNOPSIS</span></span>
<span data-ttu-id="3d324-103">取得 Azure 安全中心檢測到的安全性警示</span><span class="sxs-lookup"><span data-stu-id="3d324-103">Gets security alerts that were detected by Azure Security Center</span></span>

## <span data-ttu-id="3d324-104">句法</span><span class="sxs-lookup"><span data-stu-id="3d324-104">SYNTAX</span></span>

### <span data-ttu-id="3d324-105">SubscriptionScope (預設) </span><span class="sxs-lookup"><span data-stu-id="3d324-105">SubscriptionScope (Default)</span></span>
```
Get-AzSecurityAlert [-DefaultProfile <IAzureContextContainer>] [<CommonParameters>]
```

### <span data-ttu-id="3d324-106">ResourceGroupScope</span><span class="sxs-lookup"><span data-stu-id="3d324-106">ResourceGroupScope</span></span>
```
Get-AzSecurityAlert -ResourceGroupName <String> [-DefaultProfile <IAzureContextContainer>] [<CommonParameters>]
```

### <span data-ttu-id="3d324-107">ResourceGroupLevelResource</span><span class="sxs-lookup"><span data-stu-id="3d324-107">ResourceGroupLevelResource</span></span>
```
Get-AzSecurityAlert -ResourceGroupName <String> -Name <String> -Location <String>
 [-DefaultProfile <IAzureContextContainer>] [<CommonParameters>]
```

### <span data-ttu-id="3d324-108">SubscriptionLevelResource</span><span class="sxs-lookup"><span data-stu-id="3d324-108">SubscriptionLevelResource</span></span>
```
Get-AzSecurityAlert -Name <String> -Location <String> [-DefaultProfile <IAzureContextContainer>]
 [<CommonParameters>]
```

### <span data-ttu-id="3d324-109">ResourceId</span><span class="sxs-lookup"><span data-stu-id="3d324-109">ResourceId</span></span>
```
Get-AzSecurityAlert -ResourceId <String> [-DefaultProfile <IAzureContextContainer>] [<CommonParameters>]
```

## <span data-ttu-id="3d324-110">說明</span><span class="sxs-lookup"><span data-stu-id="3d324-110">DESCRIPTION</span></span>
<span data-ttu-id="3d324-111">取得 Azure 安全中心檢測到的安全性警示</span><span class="sxs-lookup"><span data-stu-id="3d324-111">Gets security alerts that were detected by Azure Security Center</span></span>

## <span data-ttu-id="3d324-112">示例</span><span class="sxs-lookup"><span data-stu-id="3d324-112">EXAMPLES</span></span>

### <span data-ttu-id="3d324-113">範例1</span><span class="sxs-lookup"><span data-stu-id="3d324-113">Example 1</span></span>
```powershell
...
<span data-ttu-id="3d324-114">取得訂閱中資源上偵測到的所有安全性警報</span><span class="sxs-lookup"><span data-stu-id="3d324-114">Gets all the security alerts that were detected on resources inside a subscription</span></span>

### <span data-ttu-id="3d324-115">範例2</span><span class="sxs-lookup"><span data-stu-id="3d324-115">Example 2</span></span>
```powershell
...
<span data-ttu-id="3d324-116">取得在「myService1」資源群組內的資源上偵測到的所有安全性警報</span><span class="sxs-lookup"><span data-stu-id="3d324-116">Gets all the security alerts that were detected on resources inside the "myService1" resource group</span></span>

### <span data-ttu-id="3d324-117">範例3</span><span class="sxs-lookup"><span data-stu-id="3d324-117">Example 3</span></span>
```powershell
...
<span data-ttu-id="3d324-118">取得在 "myService1" 資源群組內的資源上偵測到的特定安全性警告</span><span class="sxs-lookup"><span data-stu-id="3d324-118">Gets a specific security alert that were detected on resources inside the "myService1" resource group</span></span>

## <span data-ttu-id="3d324-119">參數</span><span class="sxs-lookup"><span data-stu-id="3d324-119">PARAMETERS</span></span>

### <span data-ttu-id="3d324-120">-DefaultProfile</span><span class="sxs-lookup"><span data-stu-id="3d324-120">-DefaultProfile</span></span>
<span data-ttu-id="3d324-121">用於與 Azure 進行通訊的認證、帳戶、租使用者及訂閱。</span><span class="sxs-lookup"><span data-stu-id="3d324-121">The credentials, account, tenant, and subscription used for communication with Azure.</span></span>
...
### <span data-ttu-id="3d324-122">-位置</span><span class="sxs-lookup"><span data-stu-id="3d324-122">-Location</span></span>
<span data-ttu-id="3d324-123">位於.</span><span class="sxs-lookup"><span data-stu-id="3d324-123">Location.</span></span>
...
### <span data-ttu-id="3d324-124">-名稱</span><span class="sxs-lookup"><span data-stu-id="3d324-124">-Name</span></span>
<span data-ttu-id="3d324-125">資源名稱。</span><span class="sxs-lookup"><span data-stu-id="3d324-125">Resource name.</span></span>
...
### <span data-ttu-id="3d324-126">-ResourceGroupName</span><span class="sxs-lookup"><span data-stu-id="3d324-126">-ResourceGroupName</span></span>
<span data-ttu-id="3d324-127">資源組名稱。</span><span class="sxs-lookup"><span data-stu-id="3d324-127">Resource group name.</span></span>
...
### <span data-ttu-id="3d324-128">-ResourceId</span><span class="sxs-lookup"><span data-stu-id="3d324-128">-ResourceId</span></span>
<span data-ttu-id="3d324-129">[資源識別碼]。</span><span class="sxs-lookup"><span data-stu-id="3d324-129">Resource ID.</span></span>
...
### <span data-ttu-id="3d324-130">CommonParameters</span><span class="sxs-lookup"><span data-stu-id="3d324-130">CommonParameters</span></span>
<span data-ttu-id="3d324-131">這個 Cmdlet 支援通用參數：-Debug、-ErrorAction、-ErrorVariable、-InformationAction、-InformationVariable、-OutVariable、-OutBuffer、-PipelineVariable、-WarningAction、-WarningVariable、-、-、-、-、-、-。</span><span class="sxs-lookup"><span data-stu-id="3d324-131">This cmdlet supports the common parameters: -Debug, -ErrorAction, -ErrorVariable, -InformationAction, -InformationVariable, -OutVariable, -OutBuffer, -PipelineVariable, -Verbose, -WarningAction, and -WarningVariable.</span></span> <span data-ttu-id="3d324-132">如需詳細資訊，請參閱 [about_CommonParameters](http://go.microsoft.com/fwlink/?LinkID=113216)。</span><span class="sxs-lookup"><span data-stu-id="3d324-132">For more information, see [about_CommonParameters](http://go.microsoft.com/fwlink/?LinkID=113216).</span></span>

## <span data-ttu-id="3d324-133">輸入</span><span class="sxs-lookup"><span data-stu-id="3d324-133">INPUTS</span></span>

### <span data-ttu-id="3d324-134">System.object</span><span class="sxs-lookup"><span data-stu-id="3d324-134">System.String</span></span>

## <span data-ttu-id="3d324-135">輸出</span><span class="sxs-lookup"><span data-stu-id="3d324-135">OUTPUTS</span></span>

### <span data-ttu-id="3d324-136">PSSecurityAlert （Security. 命令）。</span><span class="sxs-lookup"><span data-stu-id="3d324-136">Microsoft.Azure.Commands.Security.Models.Alerts.PSSecurityAlert</span></span>

## <span data-ttu-id="3d324-137">筆記</span><span class="sxs-lookup"><span data-stu-id="3d324-137">NOTES</span></span>

## <span data-ttu-id="3d324-138">相關連結</span><span class="sxs-lookup"><span data-stu-id="3d324-138">RELATED LINKS</span></span>
