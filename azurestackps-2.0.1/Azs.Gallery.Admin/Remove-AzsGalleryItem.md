...
INPUTOBJECT <IGalleryIdentity> ：身分識別參數
  - `[GalleryItemName <String>]`：圖庫專案的身分識別。 包括發行者名稱、專案名稱，並且可能包含以句點字元分隔的版本。
  - `[Id <String>]`：資源身分識別路徑
