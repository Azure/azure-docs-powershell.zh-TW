...
## 說明
**AzCosmosDBGremlinGraph** Cmdlet 會設定 CosmosDB Gremlin 圖形。
...
資源物件包含 IndexingPolicy、PartitionKey、DefaultTtl、UniqueKeyPolicy、ConflictResolutionPolicy、_rid、_ts _etag。
