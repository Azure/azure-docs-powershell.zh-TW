...
## 描述
**Get-AzApiManagementApiVersionSet** Cmdlet 會取得 API 管理環境中所設定 API 版本集的詳細資訊。
...
### -ResourceId
ApiVersionSet 的 Arm 資源識別碼。 如果指定，會嘗試根據識別碼尋找 apiVersionSet。 此參數為必填專案。
