...
## 說明
Add-AzAttestationPolicySigner Cmdlet 會針對 Azure 證明中的租使用者新增受信任的原則簽章者。
...
為名為 *pshtest* 的 Atteestation 提供者新增受信任的簽章者。
...
### -簽章者
指定包含名為「.aas-policyCertificate」的 RFC7519 JSON Web 權杖，其值是一個 RFC7517 JSON 網路金鑰，其中包含要新增的新信任簽章金鑰。
RFC7519 JWT 必須以其中一個現有的信任簽入金鑰來簽署。
