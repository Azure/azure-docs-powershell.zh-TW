...
## 摘要
針對命名空間/佇列/主題的 Azure tolen 授權規則產生 SAS。 
...
## 說明
New-AzServiceBusAuthorizationRuleSASToken Cmdlet 會針對 Azure Eventhub Namesapce 或 Azure Eventhub 產生共用存取簽名 (SAS) 權杖
...
### PSSharedAccessSignatureAttributes 中的 [.]
