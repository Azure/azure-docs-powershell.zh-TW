...
## 說明
**AzDataShare** Cmdlet 會取得 Azure 資料共用 accoount 中資料共用的相關資訊。
如果您指定資料共用的名稱，此 Cmdlet 會取得該資料共用的相關資訊。
如果您沒有指定名稱，此 Cmdlet 會取得 Azure 資料共用帳戶中所有資料共用的相關資訊。
...
這個命令會在 Azure 資料共用帳戶 WikiAdsAccount 和資源群組廣告中顯示資料共用 AdsShare 的相關資訊。
