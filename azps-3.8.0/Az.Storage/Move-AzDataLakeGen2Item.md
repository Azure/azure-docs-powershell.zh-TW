...
這個命令會將目錄 ' dir1」移至同一個 Filesystem 中的目錄 ' dir3」。

### 範例2：依流水線將檔案移動到另一個儲存空間帳戶中的另一個檔案系統，而不會出現提示
```
...
這個命令會將 [filesystem1] 中的檔案 "dir1/file1" 移至相同儲存空間帳戶中的 [dir2/file2]，而不會出現提示。
...
### -InputObject
要從中移出的 Azure Datalake Gen2 Item 物件。
