...
## 說明
**AzPrivateEndpointConnection** Cmdlet 會檢索私人端點連接資源。
...
這個範例會傳回屬於「Mysql」的 sql server 所有私人端點連線的清單。
...
這個範例會取得名為 MyPrivateEndpointConnection1 的私人端點連線屬於名為 MyPrivateLinkService 的私人連結服務
...
私人端點連線所屬之私人連結資源的 Azure 資源管理器識別碼。
