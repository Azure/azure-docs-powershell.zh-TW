...
## 說明
**AzFirewall** Cmdlet 會取得資源群組中的一個或多個防火牆。
...
這個範例會檢索以 "azFw" 為開頭的所有防火牆

### 4：檢索防火牆，然後將應用程式規則集合新增到防火牆
```
...
### System.object. IEnumerable ' 1 [PSAzureFirewall，#..... Network，版本 = 1.0.0.0，Culture = 中性，PublicKeyToken = null]]。）））
