...
## 說明
在虛擬網路閘道連線時停止 [資料包捕獲] 作業，並將在指定的儲存空間 SasUrl 容器上上傳結果。
...
### -ResourceId
要開始進行資料包捕獲之 VirtualNetworkGatewayConnection 的 Azure 資源識別碼。
...
### PSVirtualNetworkGatewayPacketCaptureResult 中的 [.]
