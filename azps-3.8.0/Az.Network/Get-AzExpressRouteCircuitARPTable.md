...
## 描述
**Get-AzExpressRouteRouteCircuitARPTable** Cmdlet 會從 ExpressRoute 回路的兩個介面中，取得 ARP 資料表。 ARP 資料表提供特定對等的 IPv4 位址與 MAC 位址的映射。 您可以使用 ARP 資料表驗證第 2 層組配置和連接。

## 例子

### 範例 1：顯示 ExpressRoute 對等的 ARP 表格
```
