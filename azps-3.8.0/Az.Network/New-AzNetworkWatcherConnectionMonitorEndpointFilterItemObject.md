...
## 說明
New-AzNetworkWatcherConnectionMonitorEndpointFilterItemObject Cmdlet 會建立端點篩選項目。
...
### -類型
篩選中所包含的專案類型。 目前僅支援 ' AgentAddress」。
...
### PSConnectionMonitorEndpointFilterItem 中的 [.]
