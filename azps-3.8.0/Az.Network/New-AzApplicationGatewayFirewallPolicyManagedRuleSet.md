...
## 說明
**新的-AzApplicationGatewayFirewallPolicyManagedRuleSet** 會建立防火牆原則的管理規則。
...
建立一個 ManagedRuleSet，並將 ruleSetType 設為 $ruleSetType，ruleSetVersion 為 $ruleSetVersion，而 RuleGroupOverrides 做為 entires 為 $ruleGroupOverride 1 的清單，$ruleGroupOverride 2 新的 ManagedRuleSet 指派給 $managedRuleSet
...
### -RuleSetType
在 managedRuleSet 中指定 RuleSetType
...
### -RuleSetVersion
在 managedRuleSet 中指定 RuleSetVersion
...
### PSApplicationGatewayFirewallPolicyManagedRuleSet 中的 [.]
