...
取得 3ede3c26-b443-4e0b-9efc-b05e68338dc3 Cmdlet 之物件 id 為「」和管道 New-AzADServicePrincipal 的應用程式，以為該應用程式建立新的廣告服務主體。

### 範例 7-使用 DisplayName 及密碼認證建立新的廣告服務主體
...
建立名為 "ServicePrincipalName" 且密碼為 "StrongPassworld！ 23" 的新應用程式，並根據剛剛建立的應用程式建立服務主體。 [開始日期] 和 [結束日期] 會新增至 [密碼認證]。

### 範例 8-使用 DisplayName 和 [一般] 金鑰認證建立新的廣告服務主體
...
建立名為 "ServicePrincipalName" 的新應用程式，並 certifcate "$cert"，並根據剛建立的應用程式建立服務主體。 [結束日期] 會新增到 [金鑰認證] 中。
