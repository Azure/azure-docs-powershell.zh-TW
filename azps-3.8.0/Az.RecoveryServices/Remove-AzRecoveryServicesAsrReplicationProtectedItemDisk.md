...
## 說明
**AzRecoveryServicesAsrReplicationProtectedItemDisk** Cmdlet 會從 ASR 複製受保護的專案中移除磁片。
...
啟動作業以移除指定的磁片，並傳回用於追蹤 [移除受保護磁片] 作業的 ASR 作業。
...
### -InputObject
Cmdlet 的輸入物件：與要移除之磁片對應的 ASR 複製受保護專案物件。
