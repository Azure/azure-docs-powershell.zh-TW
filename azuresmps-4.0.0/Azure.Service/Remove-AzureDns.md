...
## 說明
**AzureDns** Cmdlet 會從 Azure 服務中移除 DNS 伺服器。
...
這個命令會從 ContosoService 中移除名為 Dns07 的 DNS 伺服器。
