...
## 說明
**AzureVMPuppetExtension** Cmdlet 會為虛擬機器設定 Puppet 延伸。

## 示例

### 範例1：為虛擬機器設定 Puppet 延伸
```
PS C:\> Set-AzureVMPuppetExtension -VM $VM
```

這個範例會為指定的虛擬機器設定 Puppet 延伸，$VM 儲存在變數中。
