...
## 說明
**AzureDns** Cmdlet 會修改 Azure 服務之 DNS 伺服器的 IP 位址。

## 示例

### 範例1：修改 DNS 伺服器的 IP 位址
```
PS C:\> Set-AzureDns -ServiceName "ContosoService" -IPAddress 10.1.2.5 -Name "Dns07"
```

這個命令會修改名為 ContosoService 之服務之名為 Dns07 的 DNS 伺服器的 IP 位址。
