...
## 摘要
針對 Azure VPN 閘道與本機網路網站之間的連線設定預共用的金鑰。
...
## 說明
**AzureVNetGatewayKey** Cmdlet 會針對 Azure 虛擬私人網路 (VPN) 閘道與內部部署本機網路網站之間的連線設定預先共用的金鑰。
此金鑰必須等於本機網路網站閘道所設定的金鑰。
如果金鑰不相符，就無法建立連線。
...
[AzureVNetGatewayKey](./Get-AzureVNetGatewayKey.md)
