...
## 說明
**AzureAvailabilitySet** Cmdlet 會在部署後設定 Azure 虛擬機器上的可用性集名稱。
...
[移除-AzureAvailabilitySet](./Remove-AzureAvailabilitySet.md)
