...
## 說明
**AzureVMExtension** Cmdlet 會從虛擬機器中移除資源延伸。
...
這個命令會從指定的虛擬機器中移除所有延伸，並儲存在 $VM 變數中。
...
[AzureVMExtension](./Get-AzureVMExtension.md)
