...
**授與 AzureHDInsightHttpServicesAccess** Cmdlet 會使用 ODBC、Ambari、Oozie 和 web 服務，將 HTTP 存取權授予 Azure HDInsight 群集。
...
### -名稱
指定群集的名稱。
這個 Cmdlet 會將 HTTP 存取權授予此參數指定的群集。
...
[吊銷-AzureHDInsightHttpServicesAccess](./Revoke-AzureHDInsightHttpServicesAccess.md)
