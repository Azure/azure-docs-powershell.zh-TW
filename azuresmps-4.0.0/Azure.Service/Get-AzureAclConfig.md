...
## 說明
**AzureAclConfig** Cmdlet 會從現有的 Azure 虛擬機器中取得存取控制清單 (ACL) 設定物件。

## 示例

### 範例1：取得虛擬機器端點的 ACL 設定物件
```
