...
## 摘要
取得雲端服務 Active Directory (AD) 網域延伸適用于指定部署槽中的所有角色或命名角色。
...
## 說明
**AzureServiceADDomainExtension** Cmdlet 會取得雲端服務 AD 網域延伸，該功能會套用至指定部署槽中的所有角色或命名角色。
