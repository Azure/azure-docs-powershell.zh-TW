...
## 摘要
檢索集合的一或多個已發佈 Azure RemoteApp 程式的屬性。
...
## 說明
**AzureRemoteAppProgram** Cmdlet 會針對集合檢索一或多個已發佈之 Azure RemoteApp 程式的屬性。
...
這個命令會顯示 Azure RemoteApp 程式的屬性。
名為 ContosoApps 的 Azure RemoteApp 集合中有名為「財務 App」的程式。
