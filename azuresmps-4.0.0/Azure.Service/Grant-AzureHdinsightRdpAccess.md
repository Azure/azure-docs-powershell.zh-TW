...
**Grant AzureHDInsightRdpAccess** Cmdlet 會授權遠端桌面通訊協定 (RDP) 存取 Azure HDInsight 群集。
...
[吊銷-AzureHdinsightRdpAccess](./Revoke-AzureHdinsightRdpAccess.md)
