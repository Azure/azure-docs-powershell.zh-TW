...
## 說明
**AzureVMImageOSDiskConfig** Cmdlet 會從 DiskConfigSet 物件中移除作業系統磁片設定。

## 示例

### 範例1：從 DiskConfigSet 移除作業系統磁片設定
```
...
這個命令會從 DiskConfigSet 物件中移除作業系統磁片設定
