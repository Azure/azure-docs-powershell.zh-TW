...
## 說明
**AzureVNetGatewayIPsecParameters** Cmdlet 會取得目前的網際網路通訊協定安全性 (IPsec) 和網際網路金鑰交換 (IKE) 連線網路閘道與本機網路網站之間連線的參數。
...
### -VNetName
指定此 Cmdlet 取得連接之 IPsec 參數的虛擬網路。
